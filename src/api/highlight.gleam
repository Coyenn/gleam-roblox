...
import api/types.{type Actor, type Color3, type Highlight, type HighlightDepthMode, type Instance, type Object, type OptionDouble, type OptionInt64, type ReservedHighlightId, type SecurityCapabilities, type UniqueId}
