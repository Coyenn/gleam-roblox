...
import api/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Snap, type UniqueId}
