...
import api/types.{type Actor, type BodyColors, type BrickColor, type CharacterAppearance, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
