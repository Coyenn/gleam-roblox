...
import api/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Instance, type InstanceAdornment, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
