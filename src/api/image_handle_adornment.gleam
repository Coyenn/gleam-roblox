...
import api/types.{type Actor, type AdornCullingMode, type CFrame, type Color3, type ContentId, type GuiBase, type GuiBase3d, type HandleAdornment, type ImageHandleAdornment, type Instance, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector2, type Vector3}
