...
import api/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Humanoid, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SelectionLasso, type SelectionPointLasso, type UniqueId, type Vector3}
