...
import api/types.{type Actor, type AvatarBodyRules, type AvatarSettingsAppearanceMode, type AvatarSettingsBuildMode, type AvatarSettingsCustomBodyType, type AvatarSettingsScaleMode, type Instance, type NumberRange, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
