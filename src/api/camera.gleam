...
import api/types.{type Actor, type CFrame, type Camera, type CameraType, type FieldOfViewMode, type Instance, type Object, type OptionDouble, type OptionInt64, type PVInstance, type Ray, type SecurityCapabilities, type UniqueId, type Vector2, type Vector3}
