...
import api/types.{type Actor, type AlphaMode, type Color3, type Content, type ContentId, type Instance, type Material, type MaterialPattern, type MaterialVariant, type Object, type OptionDouble, type OptionInt64, type PhysicalProperties, type SecurityCapabilities, type UniqueId}
