...
import api/types.{type Actor, type BasePart, type CFrame, type ControllerPartSensor, type ControllerSensor, type Instance, type Material, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SensorBase, type SensorMode, type SensorUpdateType, type UniqueId, type Vector3}
