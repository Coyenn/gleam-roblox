...
import api/types.{type Actor, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UDim, type UDim2, type UIBase, type UIComponent, type UIShadow, type UniqueId}
