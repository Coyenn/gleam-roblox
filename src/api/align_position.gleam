...
import api/types.{type Actor, type ActuatorRelativeTo, type AlignPosition, type Attachment, type BrickColor, type Constraint, type ForceLimitMode, type Instance, type Object, type OptionDouble, type OptionInt64, type PositionAlignmentMode, type SecurityCapabilities, type UniqueId, type Vector3}
