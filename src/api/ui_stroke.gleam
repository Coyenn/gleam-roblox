...
import api/types.{type Actor, type ApplyStrokeMode, type BorderStrokePosition, type Color3, type Instance, type LineJoinMode, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StrokeSizingMode, type UDim, type UIBase, type UIComponent, type UIStroke, type UniqueId}
