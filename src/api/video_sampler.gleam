...
import api/types.{type Content, type Object, type OptionDouble, type VideoSampler}
...
pub fn get_property_changed_signal(instance: VideoSampler, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: VideoSampler, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Content, _: OptionDouble, _: VideoSampler, _: Object, _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}