...
import api/types.{type Actor, type CFrame, type EulerRotationCurve, type FloatCurve, type Instance, type Object, type OptionDouble, type OptionInt64, type RotationOrder, type SecurityCapabilities, type UniqueId}
