...
import api/types.{type Actor, type ActuatorRelativeTo, type Attachment, type BrickColor, type Constraint, type ForceLimitMode, type Instance, type LinearVelocity, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector2, type Vector3, type VelocityConstraintMode}
