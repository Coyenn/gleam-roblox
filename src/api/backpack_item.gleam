...
import api/types.{type Actor, type BackpackItem, type BasePart, type CFrame, type Content, type ContentId, type Instance, type Model, type ModelLevelOfDetail, type ModelStreamingMode, type Object, type OptionDouble, type OptionInt64, type PVInstance, type Player, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: BackpackItem, value: parent) -> BackpackItem
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BackpackItem) -> Nil
...
pub fn get_attribute_changed_signal(instance: BackpackItem, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BackpackItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BackpackItem) -> List(String)
...
pub fn wait_for_child(instance: BackpackItem, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BackpackItem) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BackpackItem, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BackpackItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BackpackItem, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BackpackItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BackpackItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BackpackItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BackpackItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BackpackItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BackpackItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BackpackItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BackpackItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BackpackItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BackpackItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BackpackItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BackpackItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BackpackItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BackpackItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BackpackItem, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: Vector3, _: Player, _: BasePart, _: ModelStreamingMode, _: ModelLevelOfDetail, _: ContentId, _: Content, _: BackpackItem, _: Model, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}