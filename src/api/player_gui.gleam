...
import api/types.{type Actor, type BasePlayerGui, type GuiObject, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerGui, type ScreenOrientation, type SecurityCapabilities, type UniqueId}
