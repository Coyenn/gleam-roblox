...
import api/keyframe_marker
import api/types.{type Instance, type KeyframeMarker, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(KeyframeMarker)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: KeyframeMarker) -> Nil {
  Nil
}