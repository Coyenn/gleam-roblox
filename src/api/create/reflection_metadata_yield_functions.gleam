...
import api/reflection_metadata_yield_functions
import api/types.{type Instance, type ReflectionMetadataYieldFunctions, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(ReflectionMetadataYieldFunctions)), children: List(Node)) -> Node {
...
pub fn archivable(value: Bool) -> Property(ReflectionMetadataYieldFunctions) {
  Property(fn(instance) { reflection_metadata_yield_functions.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(ReflectionMetadataYieldFunctions) {
  Property(fn(instance) { reflection_metadata_yield_functions.set_capabilities(instance, value) })
}
...
pub fn name(value: String) -> Property(ReflectionMetadataYieldFunctions) {
  Property(fn(instance) { reflection_metadata_yield_functions.set_name(instance, value) })
}
...
pub fn parent(value: Instance) -> Property(ReflectionMetadataYieldFunctions) {
  Property(fn(instance) { reflection_metadata_yield_functions.set_parent(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(ReflectionMetadataYieldFunctions) {
  Property(fn(instance) { reflection_metadata_yield_functions.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: ReflectionMetadataYieldFunctions) -> Nil {
  Nil
}