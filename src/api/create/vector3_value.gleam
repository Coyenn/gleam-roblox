...
import api/vector3_value
import api/types.{type Instance, type SecurityCapabilities, type Vector3, type Vector3Value}
...
@target(luau)
pub fn node(properties: List(Property(Vector3Value)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: Vector3, _: Vector3Value) -> Nil {
  Nil
}