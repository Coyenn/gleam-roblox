...
import api/ball_socket_constraint
import api/types.{type Attachment, type BallSocketConstraint, type BrickColor, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(BallSocketConstraint)), children: List(Node)) -> Node {
...
pub fn limits_enabled(value: Bool) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_limits_enabled(instance, value) })
}
...
pub fn max_friction_torque(value: Float) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_max_friction_torque(instance, value) })
}
...
pub fn restitution(value: Float) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_restitution(instance, value) })
}
...
pub fn twist_limits_enabled(value: Bool) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_twist_limits_enabled(instance, value) })
}
...
pub fn twist_lower_angle(value: Float) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_twist_lower_angle(instance, value) })
}
...
pub fn twist_upper_angle(value: Float) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_twist_upper_angle(instance, value) })
}
...
pub fn upper_angle(value: Float) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_upper_angle(instance, value) })
}
...
pub fn attachment0(value: Attachment) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_attachment0(instance, value) })
}
...
pub fn attachment1(value: Attachment) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_attachment1(instance, value) })
}
...
pub fn archivable(value: Bool) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_capabilities(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(BallSocketConstraint) {
  Property(fn(instance) { ball_socket_constraint.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: BallSocketConstraint) -> Nil {
  Nil
}