...
import api/spot_light
import api/types.{type Color3, type Instance, type NormalId, type SecurityCapabilities, type SpotLight}
...
@target(luau)
pub fn node(properties: List(Property(SpotLight)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: Color3, _: NormalId, _: SpotLight) -> Nil {
  Nil
}