...
import api/bubble_chat_message_properties
import api/types.{type BubbleChatMessageProperties, type Color3, type Font, type Instance, type OptionDouble, type OptionInt64, type SecurityCapabilities}
