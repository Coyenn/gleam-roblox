...
import api/align_orientation
import api/types.{type AlignOrientation, type AlignType, type Attachment, type BrickColor, type CFrame, type Instance, type OrientationAlignmentMode, type SecurityCapabilities, type Vector3}
