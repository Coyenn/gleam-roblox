...
import api/rt_animation_tracker
import api/types.{type Instance, type RTAnimationTracker, type SecurityCapabilities, type TrackerType}
...
@target(luau)
pub fn node(properties: List(Property(RTAnimationTracker)), children: List(Node)) -> Node {
...
@target(luau)
pub fn enable_fallback_audio_input(value: Bool) -> Property(RTAnimationTracker) {
  Property(fn(instance) { rt_animation_tracker.set_enable_fallback_audio_input(instance, value) })
}
...
pub fn session_name(value: String) -> Property(RTAnimationTracker) {
  Property(fn(instance) { rt_animation_tracker.set_session_name(instance, value) })
}
...
pub fn tracker_type(value: TrackerType) -> Property(RTAnimationTracker) {
  Property(fn(instance) { rt_animation_tracker.set_tracker_type(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(RTAnimationTracker) {
  Property(fn(instance) { rt_animation_tracker.set_capabilities(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: TrackerType, _: RTAnimationTracker) -> Nil {
  Nil
}