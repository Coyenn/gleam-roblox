...
import api/frame
import api/types.{type AutomaticSize, type BorderMode, type Color3, type Frame, type FrameStyle, type GuiObject, type InputSink, type Instance, type LocalizationTable, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type UDim2, type Vector2}
