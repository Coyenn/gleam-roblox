...
import api/starter_gear
import api/types.{type Instance, type SecurityCapabilities, type StarterGear}
...
@target(luau)
pub fn node(properties: List(Property(StarterGear)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: StarterGear) -> Nil {
  Nil
}