...
import api/wireframe_handle_adornment
import api/types.{type AdornCullingMode, type CFrame, type Color3, type Instance, type PVInstance, type SecurityCapabilities, type Vector3, type WireframeHandleAdornment}
