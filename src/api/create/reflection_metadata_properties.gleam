...
import api/reflection_metadata_properties
import api/types.{type Instance, type ReflectionMetadataProperties, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(ReflectionMetadataProperties)), children: List(Node)) -> Node {
...
pub fn archivable(value: Bool) -> Property(ReflectionMetadataProperties) {
  Property(fn(instance) { reflection_metadata_properties.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(ReflectionMetadataProperties) {
  Property(fn(instance) { reflection_metadata_properties.set_capabilities(instance, value) })
}
...
pub fn name(value: String) -> Property(ReflectionMetadataProperties) {
  Property(fn(instance) { reflection_metadata_properties.set_name(instance, value) })
}
...
pub fn parent(value: Instance) -> Property(ReflectionMetadataProperties) {
  Property(fn(instance) { reflection_metadata_properties.set_parent(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(ReflectionMetadataProperties) {
  Property(fn(instance) { reflection_metadata_properties.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: ReflectionMetadataProperties) -> Nil {
  Nil
}