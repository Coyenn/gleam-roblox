...
import api/negate_operation
import api/types.{type BrickColor, type CFrame, type Color3, type Instance, type Material, type NegateOperation, type PhysicalProperties, type SecurityCapabilities, type SurfaceType, type Vector3}
