...
import api/int_value
import api/types.{type Instance, type IntValue, type OptionInt64, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(IntValue)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: OptionInt64, _: IntValue) -> Nil {
  Nil
}