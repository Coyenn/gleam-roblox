...
import api/data_store_get_options
import api/types.{type DataStoreGetOptions, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(DataStoreGetOptions)), children: List(Node)) -> Node {
...
pub fn use_cache(value: Bool) -> Property(DataStoreGetOptions) {
  Property(fn(instance) { data_store_get_options.set_use_cache(instance, value) })
}
...
pub fn archivable(value: Bool) -> Property(DataStoreGetOptions) {
  Property(fn(instance) { data_store_get_options.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(DataStoreGetOptions) {
  Property(fn(instance) { data_store_get_options.set_capabilities(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(DataStoreGetOptions) {
  Property(fn(instance) { data_store_get_options.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: DataStoreGetOptions) -> Nil {
  Nil
}