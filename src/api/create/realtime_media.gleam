...
import api/realtime_media
import api/types.{type Instance, type RealtimeMedia, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(RealtimeMedia)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: RealtimeMedia) -> Nil {
  Nil
}