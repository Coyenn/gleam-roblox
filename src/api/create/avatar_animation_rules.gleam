...
import api/avatar_animation_rules
import api/types.{type AvatarAnimationRules, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(AvatarAnimationRules)), children: List(Node)) -> Node {
...
pub fn archivable(value: Bool) -> Property(AvatarAnimationRules) {
  Property(fn(instance) { avatar_animation_rules.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(AvatarAnimationRules) {
  Property(fn(instance) { avatar_animation_rules.set_capabilities(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(AvatarAnimationRules) {
  Property(fn(instance) { avatar_animation_rules.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: AvatarAnimationRules) -> Nil {
  Nil
}