...
import api/color3_value
import api/types.{type Color3, type Color3Value, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(Color3Value)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: Color3, _: Color3Value) -> Nil {
  Nil
}