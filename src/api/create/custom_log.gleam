...
import api/custom_log
import api/types.{type CustomLog, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(CustomLog)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: CustomLog) -> Nil {
  Nil
}