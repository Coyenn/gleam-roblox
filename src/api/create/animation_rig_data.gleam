...
import api/animation_rig_data
import api/types.{type AnimationRigData, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(AnimationRigData)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: AnimationRigData) -> Nil {
  Nil
}