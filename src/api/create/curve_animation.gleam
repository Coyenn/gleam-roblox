...
import api/curve_animation
import api/types.{type AnimationPriority, type CurveAnimation, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(CurveAnimation)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: AnimationPriority, _: CurveAnimation) -> Nil {
  Nil
}