...
import api/drag_detector
import api/types.{type CFrame, type Content, type ContentId, type DragDetector, type DragDetectorDragStyle, type DragDetectorPermissionPolicy, type DragDetectorResponseStyle, type Instance, type KeyCode, type SecurityCapabilities, type Vector3}
