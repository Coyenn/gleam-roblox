...
import api/standalone_plugin_scripts
import api/types.{type Instance, type SecurityCapabilities, type StandalonePluginScripts}
...
@target(luau)
pub fn node(properties: List(Property(StandalonePluginScripts)), children: List(Node)) -> Node {
...
pub fn archivable(value: Bool) -> Property(StandalonePluginScripts) {
  Property(fn(instance) { standalone_plugin_scripts.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(StandalonePluginScripts) {
  Property(fn(instance) { standalone_plugin_scripts.set_capabilities(instance, value) })
}
...
pub fn parent(value: Instance) -> Property(StandalonePluginScripts) {
  Property(fn(instance) { standalone_plugin_scripts.set_parent(instance, value) })
}
...
pub fn sandboxed(value: Bool) -> Property(StandalonePluginScripts) {
  Property(fn(instance) { standalone_plugin_scripts.set_sandboxed(instance, value) })
}


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: StandalonePluginScripts) -> Nil {
  Nil
}