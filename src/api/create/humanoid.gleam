...
import api/humanoid
import api/types.{type BasePart, type Humanoid, type HumanoidDisplayDistanceType, type HumanoidHealthDisplayType, type HumanoidRigType, type Instance, type NameOcclusion, type SecurityCapabilities, type Vector3}
