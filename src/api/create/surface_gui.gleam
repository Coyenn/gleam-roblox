...
import api/surface_gui
import api/types.{type Instance, type LocalizationTable, type NormalId, type SecurityCapabilities, type SelectionBehavior, type SurfaceGui, type SurfaceGuiSizingMode, type Vector2, type ZIndexBehavior}
...
@target(luau)
pub fn node(properties: List(Property(SurfaceGui)), children: List(Node)) -> Node {
...
pub fn tool_punch_through_distance(value: Float) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_tool_punch_through_distance(instance, value) })
}
...
@target(luau)
pub fn root_localization_table(value: LocalizationTable) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_root_localization_table(instance, value) })
}
...
@target(luau)
pub fn selection_behavior_down(value: SelectionBehavior) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_selection_behavior_down(instance, value) })
}
...
@target(luau)
pub fn selection_behavior_left(value: SelectionBehavior) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_selection_behavior_left(instance, value) })
}
...
@target(luau)
pub fn selection_behavior_right(value: SelectionBehavior) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_selection_behavior_right(instance, value) })
}
...
pub fn selection_behavior_up(value: SelectionBehavior) -> Property(SurfaceGui) {
  Property(fn(instance) { surface_gui.set_selection_behavior_up(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: SelectionBehavior, _: LocalizationTable, _: ZIndexBehavior, _: NormalId, _: SurfaceGuiSizingMode, _: Vector2, _: SurfaceGui) -> Nil {
  Nil
}