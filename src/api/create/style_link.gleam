...
import api/style_link
import api/types.{type Instance, type SecurityCapabilities, type StyleLink, type StyleSheet}
...
@target(luau)
pub fn node(properties: List(Property(StyleLink)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: StyleSheet, _: StyleLink) -> Nil {
  Nil
}