...
import api/mesh_part
import api/types.{type BrickColor, type CFrame, type Color3, type Content, type ContentId, type Instance, type Material, type MeshPart, type PhysicalProperties, type SecurityCapabilities, type SurfaceType, type Vector3}
...
@target(luau)
pub fn node(properties: List(Property(MeshPart)), children: List(Node)) -> Node {
...
pub fn assembly_angular_velocity(value: Vector3) -> Property(MeshPart) {
  Property(fn(instance) { mesh_part.set_assembly_angular_velocity(instance, value) })
}
...
pub fn assembly_linear_velocity(value: Vector3) -> Property(MeshPart) {
  Property(fn(instance) { mesh_part.set_assembly_linear_velocity(instance, value) })
}
...
@target(luau)
pub fn custom_physical_properties(value: PhysicalProperties) -> Property(MeshPart) {
  Property(fn(instance) { mesh_part.set_custom_physical_properties(instance, value) })
}
...
pub fn local_transparency_modifier(value: Float) -> Property(MeshPart) {
  Property(fn(instance) { mesh_part.set_local_transparency_modifier(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: SurfaceType, _: Vector3, _: CFrame, _: Material, _: PhysicalProperties, _: Color3, _: BrickColor, _: ContentId, _: Content, _: MeshPart) -> Nil {
  Nil
}