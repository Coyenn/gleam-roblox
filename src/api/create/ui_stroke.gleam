...
import api/ui_stroke
import api/types.{type ApplyStrokeMode, type BorderStrokePosition, type Color3, type Instance, type LineJoinMode, type SecurityCapabilities, type StrokeSizingMode, type UDim, type UIStroke}
...
@target(luau)
pub fn node(properties: List(Property(UIStroke)), children: List(Node)) -> Node {
...
@target(luau)
pub fn border_stroke_position(value: BorderStrokePosition) -> Property(UIStroke) {
  Property(fn(instance) { ui_stroke.set_border_stroke_position(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: StrokeSizingMode, _: LineJoinMode, _: Color3, _: BorderStrokePosition, _: UDim, _: ApplyStrokeMode, _: UIStroke) -> Nil {
  Nil
}