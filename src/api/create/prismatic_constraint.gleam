...
import api/prismatic_constraint
import api/types.{type ActuatorType, type Attachment, type BrickColor, type Instance, type PrismaticConstraint, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(PrismaticConstraint)), children: List(Node)) -> Node {
...
pub fn actuator_type(value: ActuatorType) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_actuator_type(instance, value) })
}
...
pub fn limits_enabled(value: Bool) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_limits_enabled(instance, value) })
}
...
pub fn linear_responsiveness(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_linear_responsiveness(instance, value) })
}
...
pub fn lower_limit(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_lower_limit(instance, value) })
}
...
pub fn motor_max_acceleration(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_motor_max_acceleration(instance, value) })
}
...
pub fn motor_max_force(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_motor_max_force(instance, value) })
}
...
pub fn restitution(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_restitution(instance, value) })
}
...
pub fn servo_max_force(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_servo_max_force(instance, value) })
}
...
pub fn target_position(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_target_position(instance, value) })
}
...
pub fn upper_limit(value: Float) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_upper_limit(instance, value) })
}
...
pub fn attachment0(value: Attachment) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_attachment0(instance, value) })
}
...
pub fn attachment1(value: Attachment) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_attachment1(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(PrismaticConstraint) {
  Property(fn(instance) { prismatic_constraint.set_capabilities(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: ActuatorType, _: PrismaticConstraint) -> Nil {
  Nil
}