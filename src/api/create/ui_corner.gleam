...
import api/ui_corner
import api/types.{type Instance, type SecurityCapabilities, type UDim, type UICorner}
...
@target(luau)
pub fn node(properties: List(Property(UICorner)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: UDim, _: UICorner) -> Nil {
  Nil
}