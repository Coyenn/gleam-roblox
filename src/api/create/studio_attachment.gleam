...
import api/studio_attachment
import api/types.{type Instance, type SecurityCapabilities, type StudioAttachment, type Vector2}
...
@target(luau)
pub fn node(properties: List(Property(StudioAttachment)), children: List(Node)) -> Node {
...
pub fn auto_hide_parent(value: Bool) -> Property(StudioAttachment) {
  Property(fn(instance) { studio_attachment.set_auto_hide_parent(instance, value) })
}
...
pub fn is_arrow_visible(value: Bool) -> Property(StudioAttachment) {
  Property(fn(instance) { studio_attachment.set_is_arrow_visible(instance, value) })
}
...
pub fn source_anchor_point(value: Vector2) -> Property(StudioAttachment) {
  Property(fn(instance) { studio_attachment.set_source_anchor_point(instance, value) })
}
...
pub fn target_anchor_point(value: Vector2) -> Property(StudioAttachment) {
  Property(fn(instance) { studio_attachment.set_target_anchor_point(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: Vector2, _: StudioAttachment) -> Nil {
  Nil
}