...
import api/image_label
import api/types.{type AutomaticSize, type BorderMode, type Color3, type Content, type ContentId, type GuiObject, type ImageLabel, type InputSink, type Instance, type LocalizationTable, type Rect, type ResamplerMode, type ScaleType, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type UDim2, type Vector2}
