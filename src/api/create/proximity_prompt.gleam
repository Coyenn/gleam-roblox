...
import api/proximity_prompt
import api/types.{type Instance, type KeyCode, type LocalizationTable, type ProximityPrompt, type ProximityPromptExclusivity, type ProximityPromptStyle, type SecurityCapabilities, type Vector2}
