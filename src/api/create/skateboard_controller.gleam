...
import api/skateboard_controller
import api/types.{type Instance, type SecurityCapabilities, type SkateboardController}
...
@target(luau)
pub fn node(properties: List(Property(SkateboardController)), children: List(Node)) -> Node {
...
pub fn archivable(value: Bool) -> Property(SkateboardController) {
  Property(fn(instance) { skateboard_controller.set_archivable(instance, value) })
}
...
@target(luau)
pub fn capabilities(value: SecurityCapabilities) -> Property(SkateboardController) {
  Property(fn(instance) { skateboard_controller.set_capabilities(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: SkateboardController) -> Nil {
  Nil
}