...
import api/block_mesh
import api/types.{type BlockMesh, type Instance, type SecurityCapabilities, type Vector3}
...
@target(luau)
pub fn node(properties: List(Property(BlockMesh)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: Vector3, _: BlockMesh) -> Nil {
  Nil
}