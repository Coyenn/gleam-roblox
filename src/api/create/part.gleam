...
import api/part
import api/types.{type BrickColor, type CFrame, type Color3, type Instance, type Material, type Part, type PartType, type PhysicalProperties, type SecurityCapabilities, type SurfaceType, type Vector3}
