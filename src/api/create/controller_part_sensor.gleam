...
import api/controller_part_sensor
import api/types.{type BasePart, type CFrame, type ControllerPartSensor, type Instance, type Material, type SecurityCapabilities, type SensorMode, type SensorUpdateType, type Vector3}
