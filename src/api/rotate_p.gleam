...
import api/types.{type Actor, type BasePart, type CFrame, type DynamicRotate, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type RotateP, type SecurityCapabilities, type UniqueId}
