...
import api/types.{type Actor, type Color3, type Content, type ContentId, type Instance, type MaterialPattern, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TerrainDetail, type TerrainFace, type UniqueId}
