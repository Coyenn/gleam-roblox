...
import api/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Instance, value: parent) -> Instance
...
pub fn get_source_asset_id(instance: Instance) -> OptionInt64
...
pub fn get_attribute_changed_signal(instance: Instance, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Instance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Instance) -> List(String)
...
pub fn ancestry_changed(instance: Instance) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Instance, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Instance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Instance, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Instance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Instance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Instance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Instance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Instance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Instance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Instance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Instance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Instance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Instance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Instance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Instance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Instance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Instance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Instance, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}