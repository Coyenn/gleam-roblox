...
import api/types.{type AccessModifierType, type Actor, type AudioDeviceInput, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioDeviceInput` instance.
///
/// Roblox: `Instance.new("AudioDeviceInput")`
@target(luau)
@luau.global("Instance.new(\"AudioDeviceInput\")")
pub fn new() -> AudioDeviceInput
...
pub fn get_input_pins(instance: AudioDeviceInput) -> List(String)
...
pub fn get_output_pins(instance: AudioDeviceInput) -> List(String)
...
pub fn set_user_id_access_list(instance: AudioDeviceInput, user_ids: List(Int)) -> Nil
...
pub fn wiring_changed(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioDeviceInput.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioDeviceInput via a Wire.
///
/// Roblox: `AudioDeviceInput.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioDeviceInput, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioDeviceInput, value: parent) -> AudioDeviceInput
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioDeviceInput) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioDeviceInput, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioDeviceInput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioDeviceInput) -> List(String)
...
pub fn wait_for_child(instance: AudioDeviceInput, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioDeviceInput, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioDeviceInput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioDeviceInput, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioDeviceInput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioDeviceInput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioDeviceInput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioDeviceInput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioDeviceInput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioDeviceInput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioDeviceInput, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: Player, _: AccessModifierType, _: AudioDeviceInput, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}