...
import api/types.{type Actor, type Annotation, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3, type WorkspaceAnnotation}
