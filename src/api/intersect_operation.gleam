...
pub fn touch_ended(instance: IntersectOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: IntersectOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Touched")
pub fn touched(instance: IntersectOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touched(instance: IntersectOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: IntersectOperation, value: parent) -> IntersectOperation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: IntersectOperation) -> Nil
...
pub fn get_attribute_changed_signal(instance: IntersectOperation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: IntersectOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: IntersectOperation) -> List(String)
...
pub fn wait_for_child(instance: IntersectOperation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: IntersectOperation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: IntersectOperation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: IntersectOperation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: IntersectOperation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: IntersectOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: IntersectOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: IntersectOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: IntersectOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: IntersectOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: IntersectOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: IntersectOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: IntersectOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: IntersectOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: IntersectOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: IntersectOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: IntersectOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: IntersectOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: IntersectOperation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: IntersectOperation, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: BasePart, _: CollisionFidelity, _: RenderFidelity, _: Vector3, _: Player, _: NormalId, _: SurfaceType, _: Faces, _: Material, _: PhysicalProperties, _: Color3, _: BrickColor, _: FluidFidelity, _: IntersectOperation, _: PartOperation, _: TriangleMeshPart, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}