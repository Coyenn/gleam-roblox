...
import api/types.{type Actor, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type PlayerViewService, type SecurityCapabilities, type UniqueId}
