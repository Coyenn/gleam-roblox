...
import api/types.{type Actor, type BasePlayerGui, type CoreGui, type GuiObject, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
