...
import api/types.{type Actor, type Color3, type Instance, type Light, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SurfaceLight, type UniqueId}
