...
import api/types.{type Actor, type CharacterAppearance, type Clothing, type Color3, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type Pants, type SecurityCapabilities, type UniqueId}
