...
import api/types.{type Actor, type FillDirection, type HorizontalAlignment, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SortOrder, type StartCorner, type UDim2, type UIBase, type UIComponent, type UIGridLayout, type UIGridStyleLayout, type UILayout, type UniqueId, type Vector2, type VerticalAlignment}

/// Creates a new Roblox `UIGridLayout` instance.
///
/// Roblox: `Instance.new("UIGridLayout")`
@target(luau)
@luau.global("Instance.new(\"UIGridLayout\")")
...
pub fn set_parent(instance: UIGridLayout, value: parent) -> UIGridLayout
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIGridLayout) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIGridLayout, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIGridLayout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIGridLayout) -> List(String)
...
pub fn wait_for_child(instance: UIGridLayout, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIGridLayout) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIGridLayout, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIGridLayout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIGridLayout, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIGridLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIGridLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIGridLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIGridLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIGridLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIGridLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIGridLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIGridLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIGridLayout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIGridLayout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIGridLayout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIGridLayout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIGridLayout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIGridLayout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIGridLayout, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VerticalAlignment, _: SortOrder, _: HorizontalAlignment, _: FillDirection, _: Vector2, _: StartCorner, _: UDim2, _: UIGridLayout, _: UIGridStyleLayout, _: UILayout, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}