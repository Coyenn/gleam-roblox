...
import api/types.{type Actor, type BasePart, type Color3, type GuiBase, type GuiBase3d, type Instance, type NormalId, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type SurfaceSelection, type UniqueId}
