...
pub fn touch_ended(instance: NegateOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: NegateOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Touched")
pub fn touched(instance: NegateOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touched(instance: NegateOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: NegateOperation, value: parent) -> NegateOperation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NegateOperation) -> Nil
...
pub fn get_attribute_changed_signal(instance: NegateOperation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NegateOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NegateOperation) -> List(String)
...
pub fn wait_for_child(instance: NegateOperation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NegateOperation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NegateOperation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NegateOperation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NegateOperation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NegateOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NegateOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NegateOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NegateOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NegateOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NegateOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NegateOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NegateOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NegateOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NegateOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NegateOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NegateOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NegateOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NegateOperation) -> RBXScriptSignal(fn(String) -> Nil)
