...
import api/types.{type Actor, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Sparkles, type UniqueId}
