...
import api/types.{type Capture, type CaptureType, type DateTime, type Object, type OptionInt64}
...
pub fn get_property_changed_signal(instance: Capture, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: Capture, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: OptionInt64, _: CaptureType, _: DateTime, _: Capture, _: Object, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}