...
import api/types.{type MLSession, type Object}
...
pub fn get_property_changed_signal(instance: MLSession, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MLSession) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MLSession, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: MLSession, _: Object, _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}