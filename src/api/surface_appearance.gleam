...
import api/types.{type Actor, type AlphaMode, type Color3, type Content, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type ResamplerMode, type SecurityCapabilities, type SurfaceAppearance, type UniqueId}
