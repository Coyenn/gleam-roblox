...
import api/types.{type Actor, type BaseWrap, type CFrame, type Content, type ContentId, type EditableMesh, type Instance, type Object, type OptionCoordinateFrame, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WrapDeformer}
