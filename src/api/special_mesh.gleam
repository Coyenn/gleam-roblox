...
import api/types.{type Actor, type ContentId, type DataModelMesh, type FileMesh, type Instance, type MeshType, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SpecialMesh, type UniqueId, type Vector3}
