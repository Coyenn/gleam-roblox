...
import api/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type ManualSurfaceJointInstance, type ManualWeld, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
