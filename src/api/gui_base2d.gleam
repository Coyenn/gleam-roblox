...
import api/types.{type Actor, type GuiBase, type GuiBase2d, type GuiObject, type Instance, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type Rect, type SecurityCapabilities, type SelectionBehavior, type UniqueId, type Vector2}
...
pub fn selection_changed(instance: GuiBase2d) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: GuiBase2d, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: GuiBase2d, value: parent) -> GuiBase2d
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GuiBase2d) -> Nil
...
pub fn get_attribute_changed_signal(instance: GuiBase2d, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GuiBase2d, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GuiBase2d) -> List(String)
...
pub fn wait_for_child(instance: GuiBase2d, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GuiBase2d) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GuiBase2d, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GuiBase2d) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GuiBase2d, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GuiBase2d) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GuiBase2d, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GuiBase2d) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GuiBase2d, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GuiBase2d) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GuiBase2d, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GuiBase2d) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GuiBase2d, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GuiBase2d) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GuiBase2d, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GuiBase2d) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GuiBase2d, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GuiBase2d, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GuiBase2d) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GuiBase2d, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}