...
import api/types.{type StudioScriptEditorColorPresets}
...
pub fn javascript_type_anchor(_: RobloxEnum(StudioScriptEditorColorPresets), _: StudioScriptEditorColorPresets) -> Nil {
  Nil
}