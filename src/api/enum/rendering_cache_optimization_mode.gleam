...
import api/types.{type RenderingCacheOptimizationMode}
...
pub fn javascript_type_anchor(_: RobloxEnum(RenderingCacheOptimizationMode), _: RenderingCacheOptimizationMode) -> Nil {
  Nil
}