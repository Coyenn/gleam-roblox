...
import api/types.{type AvatarSettingsAccessoryLimitMethod}
...
pub fn javascript_type_anchor(_: RobloxEnum(AvatarSettingsAccessoryLimitMethod), _: AvatarSettingsAccessoryLimitMethod) -> Nil {
  Nil
}