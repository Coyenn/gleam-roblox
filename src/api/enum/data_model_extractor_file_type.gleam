...
import api/types.{type DataModelExtractorFileType}
...
pub fn javascript_type_anchor(_: RobloxEnum(DataModelExtractorFileType), _: DataModelExtractorFileType) -> Nil {
  Nil
}