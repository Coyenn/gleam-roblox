...
import api/types.{type Actor, type ArcHandles, type Axes, type Axis, type BasePart, type Color3, type GuiBase, type GuiBase3d, type HandlesBase, type Instance, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type UniqueId}
