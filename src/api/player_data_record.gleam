...
import api/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type PlayerDataErrorState, type PlayerDataRecord, type SecurityCapabilities, type UniqueId}
...
pub fn get_value_changed_signal(instance: PlayerDataRecord, key: String) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlayerDataRecord) -> RBXScriptSignal(fn(String, Dynamic) -> Nil)

/// Connects to Roblox event `PlayerDataRecord.Changed`.
///
/// Roblox: `PlayerDataRecord.Changed`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/PlayerDataRecord#Changed
...
pub fn on_changed(instance: PlayerDataRecord, callback: fn(String, Dynamic) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Flushed")
pub fn flushed(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Bool, Option(String)) -> Nil)

/// Connects to Roblox event `PlayerDataRecord.Flushed`.
///
/// Roblox: `PlayerDataRecord.Flushed`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/PlayerDataRecord#Flushed
@target(luau)
@luau.global("(function(instance, callback) return instance.Flushed:Connect(callback) end)")
pub fn on_flushed(instance: PlayerDataRecord, callback: fn(Bool, Option(String)) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Loaded")
pub fn loaded(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Bool, Option(String)) -> Nil)

/// Connects to Roblox event `PlayerDataRecord.Loaded`.
///
/// Roblox: `PlayerDataRecord.Loaded`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/PlayerDataRecord#Loaded
...
pub fn on_loaded(instance: PlayerDataRecord, callback: fn(Bool, Option(String)) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: PlayerDataRecord, value: parent) -> PlayerDataRecord
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlayerDataRecord) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlayerDataRecord, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlayerDataRecord, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlayerDataRecord) -> List(String)
...
pub fn wait_for_child(instance: PlayerDataRecord, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlayerDataRecord, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlayerDataRecord) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlayerDataRecord, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlayerDataRecord, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlayerDataRecord, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlayerDataRecord, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlayerDataRecord) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlayerDataRecord, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlayerDataRecord) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlayerDataRecord, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlayerDataRecord) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlayerDataRecord, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlayerDataRecord, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: PlayerDataErrorState, _: PlayerDataRecord, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}