...
pub fn set_auto_recovery_interval_minutes_(instance: Studio, value: Int) -> Studio
...
pub fn get_attribute_changed_signal(instance: Studio, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Studio, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: Studio, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Studio) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Studio, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_attribute_changed(instance: Studio, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_child_added(instance: Studio, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_child_removed(instance: Studio, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Studio) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Studio, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Studio) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Studio, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: Studio, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Studio) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Studio, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Studio, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: Studio, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: StudioScriptEditorColorPresets, _: RuntimeUndoBehavior, _: PreferredTextSize, _: QDir, _: PermissionLevelShown, _: OutputLayoutMode, _: QFont, _: HoverAnimateSpeed, _: ExternalEditorMode, _: DefaultScriptSyncFileType, _: CameraSpeedAdjustBinding, _: CameraNavigationModel, _: ListDisplayMode, _: CompletionAcceptanceBehavior, _: AutoIndentRule, _: ActionOnStopSync, _: ActionOnAutoResumeSync, _: Studio, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}