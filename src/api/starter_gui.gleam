...
import api/types.{type Actor, type BasePlayerGui, type CoreGuiType, type Instance, type Object, type OptionDouble, type OptionInt64, type ScreenOrientation, type SecurityCapabilities, type StarterGui, type StyleSheet, type UniqueId}
...
pub fn set_parent(instance: StarterGui, value: parent) -> StarterGui
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StarterGui) -> Nil
...
pub fn get_attribute_changed_signal(instance: StarterGui, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StarterGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StarterGui) -> List(String)
...
pub fn wait_for_child(instance: StarterGui, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StarterGui) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StarterGui, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StarterGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StarterGui, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StarterGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StarterGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StarterGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StarterGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StarterGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StarterGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StarterGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StarterGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StarterGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StarterGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StarterGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StarterGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StarterGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StarterGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StarterGui, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CoreGuiType, _: StyleSheet, _: ScreenOrientation, _: StarterGui, _: BasePlayerGui, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}