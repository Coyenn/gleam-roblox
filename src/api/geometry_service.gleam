...
import api/types.{type Actor, type BasePart, type CFrame, type GeometryService, type Instance, type MeshPart, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SolidPrimitiveType, type UniqueId}
