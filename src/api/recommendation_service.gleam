...
import api/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type RecommendationActionType, type RecommendationImpressionType, type RecommendationPages, type RecommendationPreferenceTargetType, type RecommendationPreferenceType, type RecommendationService, type SecurityCapabilities, type UniqueId}
...
/// - `actionEventDetails`: A dictionary containing the following fields: Weight &mdash; A number representing the weight of the action. Default is 1. DestinationPlaceId &mdash; The ID of the place the user was sent to after the action. Used for Play. CommentText &mdash; Any text associated with the action, such as a comment. Used for Comment. ReactionType &mdash; A string describing the type of reaction, for example, "like" or "dislike". Used for AddReaction or RemoveReaction.
@target(luau)
...
/// - `itemId`: The item ID returned from registration and GenerateItemListAsync.
/// - `tracingId`: The tracing ID returned from the GenerateItemListAsync response. Each item has a TracingId.
/// - `impressionEventDetails`: A dictionary containing the following fields: Duration &mdash; The duration of the impression in seconds. Weight &mdash; A number representing the weight of the impression. Default is 1. ItemPosition &mdash; The position of the item in the recommendation list. DepartureIntent &mdash; The RecommendationDepartureIntent indicating the user's intent when leaving a view. For example, Positive if the view is considered good.
@target(luau)
...
///
/// Returns:
/// - A dictionary representing the recommendation item with the following fields: ItemId &mdash; The unique ID for the item. ReferenceId &mdash; The developer-provided ID for the item. TracingId &mdash; An ID for tracking recommendation sessions. This will be empty when fetching a single item directly. Creator &mdash; A table containing the CreatorId and CreatorType. Attributes &mdash; A list of content attributes associated with the item. CustomTags &mdash; A list of custom string tags. Visibility &mdash; An enum of type RecommendationItemVisibility.
@target(luau)
...
/// Parameters:
/// - `instance`: A service that provides an interface for you to manage and display personalized content recommendations.
/// - `updateRecommendationItemRequest`: A dictionary containing the following fields: ItemId &mdash; The ID of the item to update. ReferenceId &mdash; The new developer-defined string to identify the item. Creator &mdash; The new creator for the item. Creator is a table containing two fields: CreatorId: number and CreatorType: Enum.CreatorType. Duration &mdash; The new duration for the content in seconds. Visibility &mdash; The new visibility setting for the item. Attributes &mdash; The new table of attributes for the item. CustomTags &mdash; The new list of string tags.
@target(luau)
...
pub fn set_parent(instance: RecommendationService, value: parent) -> RecommendationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RecommendationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: RecommendationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RecommendationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RecommendationService) -> List(String)
...
pub fn wait_for_child(instance: RecommendationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RecommendationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RecommendationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RecommendationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RecommendationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RecommendationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RecommendationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RecommendationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RecommendationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RecommendationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RecommendationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RecommendationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RecommendationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RecommendationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RecommendationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RecommendationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RecommendationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RecommendationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RecommendationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RecommendationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: RecommendationPages, _: RecommendationPreferenceType, _: RecommendationPreferenceTargetType, _: RecommendationImpressionType, _: RecommendationActionType, _: RecommendationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}