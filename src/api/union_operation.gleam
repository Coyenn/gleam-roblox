...
import api/types.{type Actor, type BasePart, type BrickColor, type CFrame, type CollisionFidelity, type Color3, type Faces, type FluidFidelity, type Instance, type Material, type NormalId, type Object, type OptionDouble, type OptionInt64, type PVInstance, type PartOperation, type PhysicalProperties, type Player, type RenderFidelity, type SecurityCapabilities, type SurfaceType, type TriangleMeshPart, type UnionOperation, type UniqueId, type Vector3}

/// Creates a new Roblox `UnionOperation` instance.
///
/// Roblox: `Instance.new("UnionOperation")`
@target(luau)
@luau.global("Instance.new(\"UnionOperation\")")
...
pub fn touch_ended(instance: UnionOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: UnionOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Touched")
pub fn touched(instance: UnionOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touched(instance: UnionOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: UnionOperation, value: parent) -> UnionOperation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UnionOperation) -> Nil
...
pub fn get_attribute_changed_signal(instance: UnionOperation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UnionOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UnionOperation) -> List(String)
...
pub fn wait_for_child(instance: UnionOperation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UnionOperation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UnionOperation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UnionOperation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UnionOperation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UnionOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UnionOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UnionOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UnionOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UnionOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UnionOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UnionOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UnionOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UnionOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UnionOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UnionOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UnionOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UnionOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UnionOperation) -> RBXScriptSignal(fn(String) -> Nil)
