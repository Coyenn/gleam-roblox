...
import api/types.{type Actor, type AvatarChatService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
