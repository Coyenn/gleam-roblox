...
import api/types.{type Actor, type BasePart, type Color3, type Faces, type GuiBase, type GuiBase3d, type Handles, type HandlesBase, type HandlesStyle, type Instance, type NormalId, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type UniqueId}
