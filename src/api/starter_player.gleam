...
import api/types.{type Actor, type CameraMode, type CharacterControlMode, type DevCameraOcclusionMode, type DevComputerCameraMovementMode, type DevComputerMovementMode, type DevTouchCameraMovementMode, type DevTouchMovementMode, type GameAvatarType, type Instance, type NumberRange, type Object, type OptionDouble, type OptionInt64, type R15CollisionType, type RolloutState, type SecurityCapabilities, type StarterPlayer, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: StarterPlayer, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StarterPlayer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: StarterPlayer, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StarterPlayer) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StarterPlayer, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StarterPlayer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StarterPlayer, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StarterPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StarterPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StarterPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StarterPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StarterPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StarterPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StarterPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StarterPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: StarterPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StarterPlayer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StarterPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StarterPlayer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: StarterPlayer, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CharacterControlMode, _: NumberRange, _: R15CollisionType, _: GameAvatarType, _: DevTouchMovementMode, _: DevTouchCameraMovementMode, _: DevComputerMovementMode, _: DevComputerCameraMovementMode, _: DevCameraOcclusionMode, _: CameraMode, _: RolloutState, _: StarterPlayer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}