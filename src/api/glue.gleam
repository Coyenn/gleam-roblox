...
import api/types.{type Actor, type BasePart, type CFrame, type Glue, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
