...
import api/types.{type Actor, type Color3, type Instance, type Lighting, type LightingStyle, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Technology, type UniqueId, type Vector3}
