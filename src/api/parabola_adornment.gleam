...
import api/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Instance, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type ParabolaAdornment, type SecurityCapabilities, type UniqueId}
