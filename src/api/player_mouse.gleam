...
import api/types.{type Actor, type BasePart, type CFrame, type Content, type ContentId, type Instance, type Mouse, type NormalId, type Object, type OptionDouble, type OptionInt64, type PlayerMouse, type Ray, type SecurityCapabilities, type UniqueId}
