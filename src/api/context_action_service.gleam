...
import api/types.{type Actor, type ContextActionService, type Instance, type KeyCode, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UDim2, type UniqueId, type UserInputType}
...
pub fn local_tool_equipped(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `ContextActionService.LocalToolEquipped`.
///
/// Fires when the current player equips a Tool.
///
/// Roblox: `ContextActionService.LocalToolEquipped`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/ContextActionService#LocalToolEquipped
@target(luau)
@luau.global("(function(instance, callback) return instance.LocalToolEquipped:Connect(callback) end)")
pub fn on_local_tool_equipped(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn local_tool_unequipped(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `ContextActionService.LocalToolUnequipped`.
///
/// Fires when the current player unequips a Tool.
///
/// Roblox: `ContextActionService.LocalToolUnequipped`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/ContextActionService#LocalToolUnequipped
@target(luau)
@luau.global("(function(instance, callback) return instance.LocalToolUnequipped:Connect(callback) end)")
pub fn on_local_tool_unequipped(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ContextActionService, value: parent) -> ContextActionService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ContextActionService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ContextActionService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ContextActionService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ContextActionService) -> List(String)
...
pub fn wait_for_child(instance: ContextActionService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ContextActionService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ContextActionService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ContextActionService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ContextActionService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ContextActionService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ContextActionService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ContextActionService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ContextActionService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ContextActionService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ContextActionService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ContextActionService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ContextActionService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ContextActionService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UserInputType, _: KeyCode, _: UDim2, _: ContextActionService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}