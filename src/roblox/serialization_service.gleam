...
import roblox/types.{
  type Actor, type Buffer, type Instance, type Int64, type Object,
  type SecurityCapabilities, type SerializationService, type UniqueId,
}
...
pub fn deserialize_instances_async(
  instance: SerializationService,
  buffer: Buffer,
) -> List(Instance)
...
pub fn serialize_instances_async(
  instance: SerializationService,
  input_instances: List(Instance),
) -> Buffer
...
pub fn get_source_asset_id(instance: SerializationService) -> Int64
