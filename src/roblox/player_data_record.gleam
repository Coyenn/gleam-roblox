...
import roblox/types.{
  type Actor, type Instance, type Object, type Player, type PlayerDataErrorState,
  type PlayerDataRecord, type SecurityCapabilities, type UniqueId,
}
...
pub fn changed(
  instance: PlayerDataRecord,
) -> RBXScriptSignal(fn(String, Dynamic) -> Nil)
...
pub fn flushed(
  instance: PlayerDataRecord,
) -> RBXScriptSignal(fn(Bool, Option(String)) -> Nil)
...
pub fn on_flushed(
  instance: PlayerDataRecord,
  callback: fn(Bool, Option(String)) -> Nil,
) -> RBXScriptConnection
