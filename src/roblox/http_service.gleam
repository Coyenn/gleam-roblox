...
import roblox/types.{
  ...
  type OptionDouble, type OptionInt64, type Secret, type SecurityCapabilities,
  type UniqueId, type WebStreamClient, type WebStreamClientType,
}
...
pub fn generate_g_uid(
  instance: HttpService,
  wrap_in_curly_braces: Bool,
) -> String
