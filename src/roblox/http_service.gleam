...
import roblox/types.{type Actor, type HttpContentType, type HttpService, type Instance, type Object, type OptionDouble, type OptionInt64, type Secret, type SecurityCapabilities, type UniqueId, type WebStreamClient, type WebStreamClientType}
...
pub fn set_parent(instance: HttpService, value: parent) -> HttpService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HttpService) -> Nil
...
pub fn get_attribute_changed_signal(instance: HttpService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HttpService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HttpService) -> List(String)
...
pub fn wait_for_child(instance: HttpService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HttpService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HttpService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HttpService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HttpService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HttpService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HttpService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HttpService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HttpService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HttpService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HttpService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HttpService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HttpService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HttpService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HttpService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HttpService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HttpService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HttpService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HttpService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HttpService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: HttpContentType, _: Secret, _: WebStreamClient, _: WebStreamClientType, _: HttpService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}