...
import roblox/types.{
  ...
  type Object, type PVAdornment, type PVInstance, type ParabolaAdornment,
...
pub fn get_source_asset_id(instance: ParabolaAdornment) -> Int
