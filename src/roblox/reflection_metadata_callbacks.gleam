...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type ReflectionMetadataCallbacks, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ReflectionMetadataCallbacks` instance.
///
/// Roblox: `Instance.new("ReflectionMetadataCallbacks")`
@target(luau)
@luau.global("Instance.new(\"ReflectionMetadataCallbacks\")")
pub fn new() -> ReflectionMetadataCallbacks

/// Treats `ReflectionMetadataCallbacks` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: ReflectionMetadataCallbacks, value: parent) -> ReflectionMetadataCallbacks
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ReflectionMetadataCallbacks) -> Nil
...
pub fn get_attribute_changed_signal(instance: ReflectionMetadataCallbacks, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ReflectionMetadataCallbacks, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ReflectionMetadataCallbacks) -> List(String)
...
pub fn wait_for_child(instance: ReflectionMetadataCallbacks, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ReflectionMetadataCallbacks, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ReflectionMetadataCallbacks, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ReflectionMetadataCallbacks, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ReflectionMetadataCallbacks, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ReflectionMetadataCallbacks, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ReflectionMetadataCallbacks, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ReflectionMetadataCallbacks, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ReflectionMetadataCallbacks, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ReflectionMetadataCallbacks, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ReflectionMetadataCallbacks) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ReflectionMetadataCallbacks, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ReflectionMetadataCallbacks, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}