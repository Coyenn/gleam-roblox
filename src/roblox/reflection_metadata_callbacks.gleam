...
import roblox/types.{
  ...
  type ReflectionMetadataCallbacks, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataCallbacks,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataCallbacks) -> Int64
