...
import roblox/types.{type Actor, type Instance, type NetworkMarker, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
@target(luau)
@luau.event("Received")
pub fn received(instance: NetworkMarker) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `NetworkMarker.Received`.
///
/// Fired when the server has finished replicating the world to the client.
///
/// Roblox: `NetworkMarker.Received`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/NetworkMarker#Received
@target(luau)
@luau.global("(function(instance, callback) return instance.Received:Connect(callback) end)")
pub fn on_received(instance: NetworkMarker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: NetworkMarker, value: parent) -> NetworkMarker
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NetworkMarker) -> Nil
...
pub fn get_attribute_changed_signal(instance: NetworkMarker, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NetworkMarker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NetworkMarker) -> List(String)
...
pub fn wait_for_child(instance: NetworkMarker, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NetworkMarker) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NetworkMarker, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NetworkMarker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NetworkMarker, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NetworkMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NetworkMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NetworkMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NetworkMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NetworkMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NetworkMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NetworkMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NetworkMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NetworkMarker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NetworkMarker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NetworkMarker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NetworkMarker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NetworkMarker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NetworkMarker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: NetworkMarker, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NetworkMarker, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}