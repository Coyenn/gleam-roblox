...
import roblox/types.{
  ...
  type PerformanceControlService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PerformanceControlService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PerformanceControlService) -> Int64
