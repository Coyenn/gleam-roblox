...
import roblox/types.{
  ...
  type ScriptCloneWatcherHelper, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ScriptCloneWatcherHelper,
  value: Bool,
...
pub fn get_source_asset_id(instance: ScriptCloneWatcherHelper) -> Int64
