...
import roblox/types.{type Actor, type Instance, type LocalStorageService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type UserStorageService}
...
pub fn set_parent(instance: UserStorageService, value: parent) -> UserStorageService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UserStorageService) -> Nil
...
pub fn get_attribute_changed_signal(instance: UserStorageService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UserStorageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UserStorageService) -> List(String)
...
pub fn wait_for_child(instance: UserStorageService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UserStorageService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UserStorageService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UserStorageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UserStorageService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UserStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UserStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UserStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UserStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UserStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UserStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UserStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UserStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UserStorageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UserStorageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UserStorageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UserStorageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UserStorageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UserStorageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UserStorageService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UserStorageService, _: LocalStorageService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}