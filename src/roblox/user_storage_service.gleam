...
import roblox/types.{
  ...
  type SecurityCapabilities, type UniqueId, type UserStorageService,
}
...
pub fn get_source_asset_id(instance: UserStorageService) -> Int64
