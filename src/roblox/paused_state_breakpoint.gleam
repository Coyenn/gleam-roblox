...
import roblox/types.{
  ...
  type Object, type OptionDouble, type OptionInt64, type PausedState,
  type PausedStateBreakpoint, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PausedStateBreakpoint,
  value: Bool,
