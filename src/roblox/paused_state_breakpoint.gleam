...
import roblox/types.{type Actor, type Breakpoint, type DebuggerPauseReason, type Instance, type Object, type OptionDouble, type OptionInt64, type PausedState, type PausedStateBreakpoint, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PausedStateBreakpoint, value: parent) -> PausedStateBreakpoint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PausedStateBreakpoint) -> Nil
...
pub fn get_attribute_changed_signal(instance: PausedStateBreakpoint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PausedStateBreakpoint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PausedStateBreakpoint) -> List(String)
...
pub fn wait_for_child(instance: PausedStateBreakpoint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PausedStateBreakpoint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PausedStateBreakpoint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PausedStateBreakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PausedStateBreakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PausedStateBreakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PausedStateBreakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PausedStateBreakpoint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PausedStateBreakpoint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PausedStateBreakpoint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PausedStateBreakpoint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PausedStateBreakpoint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DebuggerPauseReason, _: Breakpoint, _: PausedStateBreakpoint, _: PausedState, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}