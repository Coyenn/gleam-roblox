...
import roblox/types.{type Actor, type Instance, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `LocalizationTable` instance.
///
/// Roblox: `Instance.new("LocalizationTable")`
@target(luau)
@luau.global("Instance.new(\"LocalizationTable\")")
...
pub fn set_parent(instance: LocalizationTable, value: parent) -> LocalizationTable
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LocalizationTable) -> Nil
...
pub fn get_attribute_changed_signal(instance: LocalizationTable, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LocalizationTable, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LocalizationTable) -> List(String)
...
pub fn wait_for_child(instance: LocalizationTable, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LocalizationTable) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LocalizationTable, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LocalizationTable) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LocalizationTable, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LocalizationTable) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LocalizationTable, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LocalizationTable) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LocalizationTable, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LocalizationTable) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LocalizationTable, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LocalizationTable) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LocalizationTable, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LocalizationTable) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LocalizationTable, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LocalizationTable) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LocalizationTable, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LocalizationTable, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LocalizationTable) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LocalizationTable, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: LocalizationTable, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}