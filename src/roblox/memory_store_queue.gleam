...
import roblox/types.{type Actor, type Instance, type MemoryStoreQueue, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: MemoryStoreQueue, value: parent) -> MemoryStoreQueue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MemoryStoreQueue) -> Nil
...
pub fn get_attribute_changed_signal(instance: MemoryStoreQueue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MemoryStoreQueue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MemoryStoreQueue) -> List(String)
...
pub fn wait_for_child(instance: MemoryStoreQueue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MemoryStoreQueue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MemoryStoreQueue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MemoryStoreQueue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MemoryStoreQueue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MemoryStoreQueue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MemoryStoreQueue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MemoryStoreQueue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MemoryStoreQueue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MemoryStoreQueue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MemoryStoreQueue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MemoryStoreQueue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MemoryStoreQueue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MemoryStoreQueue, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MemoryStoreQueue, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}