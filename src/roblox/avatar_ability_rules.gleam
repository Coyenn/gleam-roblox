...
import roblox/types.{
  type Actor, type AvatarAbilityRules,
  type AvatarSettingsCharacterControllerMode, type Instance, type Int64,
...
pub fn get_character_controller_mode(
  instance: AvatarAbilityRules,
...
pub fn get_source_asset_id(instance: AvatarAbilityRules) -> Int64
