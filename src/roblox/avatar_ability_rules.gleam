...
import roblox/types.{type Actor, type AvatarAbilityRules, type AvatarSettingsCharacterControllerMode, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `AvatarAbilityRules` instance.
///
/// Roblox: `Instance.new("AvatarAbilityRules")`
@target(luau)
@luau.global("Instance.new(\"AvatarAbilityRules\")")
pub fn new() -> AvatarAbilityRules
...
pub fn set_parent(instance: AvatarAbilityRules, value: parent) -> AvatarAbilityRules
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AvatarAbilityRules) -> Nil
...
pub fn get_attribute_changed_signal(instance: AvatarAbilityRules, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AvatarAbilityRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AvatarAbilityRules) -> List(String)
...
pub fn wait_for_child(instance: AvatarAbilityRules, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AvatarAbilityRules, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AvatarAbilityRules, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AvatarAbilityRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AvatarAbilityRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AvatarAbilityRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AvatarAbilityRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AvatarAbilityRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AvatarAbilityRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AvatarAbilityRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AvatarAbilityRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AvatarAbilityRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AvatarAbilityRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AvatarAbilityRules, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AvatarSettingsCharacterControllerMode, _: AvatarAbilityRules, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}