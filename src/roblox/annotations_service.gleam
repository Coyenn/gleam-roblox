...
import roblox/types.{
  type Actor, type Annotation, type AnnotationEditingMode,
  type AnnotationRequestStatus, type AnnotationsService, type Instance,
...
pub fn get_annotations_loading_status(
  instance: AnnotationsService,
...
pub fn get_resolved_loading_status(
  instance: AnnotationsService,
) -> AnnotationRequestStatus
...
pub fn get_source_asset_id(instance: AnnotationsService) -> Int64
