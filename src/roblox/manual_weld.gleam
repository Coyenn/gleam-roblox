...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type ManualSurfaceJointInstance, type ManualWeld, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: ManualWeld, value: parent) -> ManualWeld
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ManualWeld) -> Nil
...
pub fn get_attribute_changed_signal(instance: ManualWeld, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ManualWeld, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ManualWeld) -> List(String)
...
pub fn wait_for_child(instance: ManualWeld, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ManualWeld) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ManualWeld, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ManualWeld) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ManualWeld, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ManualWeld) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ManualWeld, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ManualWeld) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ManualWeld, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ManualWeld) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ManualWeld, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ManualWeld) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ManualWeld, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ManualWeld) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ManualWeld, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ManualWeld) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ManualWeld, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ManualWeld, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ManualWeld) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ManualWeld, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: ManualWeld, _: ManualSurfaceJointInstance, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}