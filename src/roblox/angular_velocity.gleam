...
import roblox/types.{
  type Actor, type ActuatorRelativeTo, type AngularVelocity, type Attachment,
  type BrickColor, type Constraint, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: AngularVelocity) -> Int64
