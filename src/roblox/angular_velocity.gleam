...
import roblox/types.{type Actor, type ActuatorRelativeTo, type AngularVelocity, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `AngularVelocity` instance.
///
/// Roblox: `Instance.new("AngularVelocity")`
@target(luau)
@luau.global("Instance.new(\"AngularVelocity\")")
...
pub fn set_parent(instance: AngularVelocity, value: parent) -> AngularVelocity
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AngularVelocity) -> Nil
...
pub fn get_attribute_changed_signal(instance: AngularVelocity, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AngularVelocity, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AngularVelocity) -> List(String)
...
pub fn wait_for_child(instance: AngularVelocity, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AngularVelocity) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AngularVelocity, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AngularVelocity) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AngularVelocity, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AngularVelocity) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AngularVelocity, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AngularVelocity) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AngularVelocity, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AngularVelocity) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AngularVelocity, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AngularVelocity) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AngularVelocity, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AngularVelocity) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AngularVelocity, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AngularVelocity) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AngularVelocity, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AngularVelocity, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AngularVelocity) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AngularVelocity, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: ActuatorRelativeTo, _: Vector3, _: AngularVelocity, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}