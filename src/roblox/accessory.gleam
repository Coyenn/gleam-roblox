...
import roblox/types.{type Accessory, type AccessoryType, type Accoutrement, type Actor, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Accessory` instance.
///
/// Roblox: `Instance.new("Accessory")`
@target(luau)
@luau.global("Instance.new(\"Accessory\")")
...
pub fn set_parent(instance: Accessory, value: parent) -> Accessory
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Accessory) -> Nil
...
pub fn get_attribute_changed_signal(instance: Accessory, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Accessory, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Accessory) -> List(String)
...
pub fn wait_for_child(instance: Accessory, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Accessory) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Accessory, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Accessory) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Accessory, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Accessory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Accessory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Accessory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Accessory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Accessory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Accessory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Accessory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Accessory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Accessory) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Accessory, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Accessory) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Accessory, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Accessory, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Accessory) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Accessory, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: CFrame, _: AccessoryType, _: Accessory, _: Accoutrement, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}