...
import roblox/types.{type Actor, type DataStoreGetOptions, type DataStoreIncrementOptions, type DataStorePages, type DataStoreSetOptions, type GlobalDataStore, type Instance, type Object, type OptionDouble, type OptionInt64, type OrderedDataStore, type SecurityCapabilities, type UniqueId}
...
pub fn increment_async(instance: OrderedDataStore, key: String, delta: Int, user_ids: List(Int), options: DataStoreIncrementOptions) -> Dynamic
...
pub fn set_async(instance: OrderedDataStore, key: String, value: Dynamic, user_ids: List(Int), options: DataStoreSetOptions) -> Dynamic
...
pub fn set_parent(instance: OrderedDataStore, value: parent) -> OrderedDataStore
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: OrderedDataStore) -> Nil
...
pub fn get_attribute_changed_signal(instance: OrderedDataStore, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: OrderedDataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: OrderedDataStore) -> List(String)
...
pub fn wait_for_child(instance: OrderedDataStore, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: OrderedDataStore) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: OrderedDataStore, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: OrderedDataStore) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: OrderedDataStore, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: OrderedDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: OrderedDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: OrderedDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: OrderedDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: OrderedDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: OrderedDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: OrderedDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: OrderedDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: OrderedDataStore) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: OrderedDataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: OrderedDataStore) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: OrderedDataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: OrderedDataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: OrderedDataStore) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: OrderedDataStore, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreSetOptions, _: DataStoreIncrementOptions, _: DataStoreGetOptions, _: DataStorePages, _: OrderedDataStore, _: GlobalDataStore, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}