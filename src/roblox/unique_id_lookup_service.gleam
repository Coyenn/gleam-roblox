...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type UniqueIdLookupService}
...
pub fn set_parent(instance: UniqueIdLookupService, value: parent) -> UniqueIdLookupService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UniqueIdLookupService) -> Nil
...
pub fn get_attribute_changed_signal(instance: UniqueIdLookupService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UniqueIdLookupService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UniqueIdLookupService) -> List(String)
...
pub fn wait_for_child(instance: UniqueIdLookupService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UniqueIdLookupService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UniqueIdLookupService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UniqueIdLookupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UniqueIdLookupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UniqueIdLookupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UniqueIdLookupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UniqueIdLookupService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UniqueIdLookupService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UniqueIdLookupService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UniqueIdLookupService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UniqueIdLookupService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UniqueIdLookupService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UniqueIdLookupService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UniqueIdLookupService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}