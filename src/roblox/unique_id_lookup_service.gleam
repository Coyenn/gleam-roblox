...
import roblox/types.{
  ...
  type UniqueId, type UniqueIdLookupService,
}
...
pub fn get_or_create_unique_id_remote_command(
  instance: UniqueIdLookupService,
  instance_: Instance,
) -> String
...
pub fn get_source_asset_id(instance: UniqueIdLookupService) -> Int64
