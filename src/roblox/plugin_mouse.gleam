...
import roblox/types.{type Actor, type BasePart, type CFrame, type Content, type ContentId, type Instance, type Mouse, type NormalId, type Object, type OptionDouble, type OptionInt64, type PluginMouse, type Ray, type SecurityCapabilities, type UniqueId}
...
pub fn on_button1_down(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_button1_up(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_button2_down(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_button2_up(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_idle(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_move(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_wheel_backward(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_wheel_forward(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: PluginMouse, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PluginMouse, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: PluginMouse, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PluginMouse) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PluginMouse, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PluginMouse) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PluginMouse, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PluginMouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PluginMouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PluginMouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PluginMouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PluginMouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PluginMouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PluginMouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PluginMouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PluginMouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PluginMouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PluginMouse, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: PluginMouse, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Ray, _: NormalId, _: BasePart, _: CFrame, _: Content, _: ContentId, _: PluginMouse, _: Mouse, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}