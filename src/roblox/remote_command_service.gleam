...
import roblox/types.{
  ...
  type RemoteCommandService, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_received_update_signal(
  instance: RemoteCommandService,
...
pub fn get_source_asset_id(instance: RemoteCommandService) -> Int64
