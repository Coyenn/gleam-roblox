...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type RemoteCommandService, type SecurityCapabilities, type UniqueId}
...
pub fn get_received_update_signal(instance: RemoteCommandService) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn get_stopping_signal(instance: RemoteCommandService) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn set_parent(instance: RemoteCommandService, value: parent) -> RemoteCommandService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RemoteCommandService) -> Nil
...
pub fn get_attribute_changed_signal(instance: RemoteCommandService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RemoteCommandService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RemoteCommandService) -> List(String)
...
pub fn wait_for_child(instance: RemoteCommandService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RemoteCommandService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RemoteCommandService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RemoteCommandService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RemoteCommandService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RemoteCommandService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RemoteCommandService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RemoteCommandService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RemoteCommandService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RemoteCommandService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RemoteCommandService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RemoteCommandService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RemoteCommandService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RemoteCommandService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RemoteCommandService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RemoteCommandService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RemoteCommandService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RemoteCommandService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RemoteCommandService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RemoteCommandService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: RemoteCommandService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}