...
import roblox/types.{
  type Actor, type DebuggerConnection, type Instance, type Int64,
  type LocalDebuggerConnection, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: LocalDebuggerConnection) -> Int64
