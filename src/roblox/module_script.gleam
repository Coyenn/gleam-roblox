...
import roblox/types.{type Actor, type Instance, type LuaSourceContainer, type ModuleScript, type Object, type OptionDouble, type OptionInt64, type ProtectedString, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ModuleScript` instance.
///
/// Roblox: `Instance.new("ModuleScript")`
@target(luau)
@luau.global("Instance.new(\"ModuleScript\")")
...
pub fn set_parent(instance: ModuleScript, value: parent) -> ModuleScript
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ModuleScript) -> Nil
...
pub fn get_attribute_changed_signal(instance: ModuleScript, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ModuleScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ModuleScript) -> List(String)
...
pub fn wait_for_child(instance: ModuleScript, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ModuleScript) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ModuleScript, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ModuleScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ModuleScript, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ModuleScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ModuleScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ModuleScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ModuleScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ModuleScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ModuleScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ModuleScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ModuleScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ModuleScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ModuleScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ModuleScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ModuleScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ModuleScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ModuleScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ModuleScript, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ProtectedString, _: ModuleScript, _: LuaSourceContainer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}