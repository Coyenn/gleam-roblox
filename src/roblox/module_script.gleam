...
import roblox/types.{
  type Actor, type Instance, type Int64, type LuaSourceContainer,
  type ModuleScript, type Object, type ProtectedString,
...
pub fn get_source_asset_id(instance: ModuleScript) -> Int64
