...
import roblox/types.{type Actor, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Sparkles, type UniqueId}

/// Creates a new Roblox `Sparkles` instance.
///
/// Roblox: `Instance.new("Sparkles")`
@target(luau)
@luau.global("Instance.new(\"Sparkles\")")
pub fn new() -> Sparkles
...
pub fn set_parent(instance: Sparkles, value: parent) -> Sparkles
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Sparkles) -> Nil
...
pub fn get_attribute_changed_signal(instance: Sparkles, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Sparkles, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Sparkles) -> List(String)
...
pub fn wait_for_child(instance: Sparkles, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Sparkles) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Sparkles, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Sparkles) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Sparkles, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Sparkles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Sparkles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Sparkles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Sparkles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Sparkles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Sparkles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Sparkles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Sparkles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Sparkles) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Sparkles, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Sparkles) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Sparkles, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Sparkles, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Sparkles) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Sparkles, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Sparkles, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}