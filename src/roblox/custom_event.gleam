...
import roblox/types.{
  type Actor, type CustomEvent, type Instance, type Object, type OptionDouble,
...
pub fn on_receiver_disconnected(
  instance: CustomEvent,
  callback: fn(Instance) -> Nil,
) -> RBXScriptConnection
