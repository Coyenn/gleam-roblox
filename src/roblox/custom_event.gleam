...
import roblox/types.{type Actor, type CustomEvent, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn receiver_connected(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `CustomEvent.ReceiverConnected`.
///
/// Fires when a receiver is connected to the CustomEvent.
///
/// Roblox: `CustomEvent.ReceiverConnected`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CustomEvent#ReceiverConnected
@target(luau)
@luau.global("(function(instance, callback) return instance.ReceiverConnected:Connect(callback) end)")
pub fn on_receiver_connected(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn receiver_disconnected(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `CustomEvent.ReceiverDisconnected`.
///
/// Fires when a receiver is disconnected from the CustomEvent.
///
/// Roblox: `CustomEvent.ReceiverDisconnected`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CustomEvent#ReceiverDisconnected
@target(luau)
@luau.global("(function(instance, callback) return instance.ReceiverDisconnected:Connect(callback) end)")
pub fn on_receiver_disconnected(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: CustomEvent, value: parent) -> CustomEvent
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CustomEvent) -> Nil
...
pub fn get_attribute_changed_signal(instance: CustomEvent, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CustomEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CustomEvent) -> List(String)
...
pub fn wait_for_child(instance: CustomEvent, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CustomEvent) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CustomEvent, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CustomEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CustomEvent, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CustomEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CustomEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CustomEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CustomEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CustomEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CustomEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CustomEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CustomEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CustomEvent, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CustomEvent, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}