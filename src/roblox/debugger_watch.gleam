...
import roblox/types.{type Actor, type DebuggerWatch, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DebuggerWatch` instance.
///
/// Roblox: `Instance.new("DebuggerWatch")`
@target(luau)
@luau.global("Instance.new(\"DebuggerWatch\")")
pub fn new() -> DebuggerWatch
...
pub fn set_parent(instance: DebuggerWatch, value: parent) -> DebuggerWatch
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DebuggerWatch) -> Nil
...
pub fn get_attribute_changed_signal(instance: DebuggerWatch, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DebuggerWatch, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DebuggerWatch) -> List(String)
...
pub fn wait_for_child(instance: DebuggerWatch, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DebuggerWatch) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DebuggerWatch, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DebuggerWatch) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DebuggerWatch, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DebuggerWatch) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DebuggerWatch, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DebuggerWatch) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DebuggerWatch, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DebuggerWatch) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DebuggerWatch, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DebuggerWatch) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DebuggerWatch, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DebuggerWatch) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DebuggerWatch, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DebuggerWatch) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DebuggerWatch, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DebuggerWatch, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DebuggerWatch) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DebuggerWatch, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DebuggerWatch, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}