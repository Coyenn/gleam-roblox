...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Teams, type UniqueId}
...
pub fn set_parent(instance: Teams, value: parent) -> Teams
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Teams) -> Nil
...
pub fn get_attribute_changed_signal(instance: Teams, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Teams, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Teams) -> List(String)
...
pub fn wait_for_child(instance: Teams, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Teams) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Teams, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Teams) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Teams, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Teams) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Teams, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Teams) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Teams, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Teams) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Teams, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Teams) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Teams, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Teams) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Teams, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Teams) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Teams, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Teams, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Teams) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Teams, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Teams, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}