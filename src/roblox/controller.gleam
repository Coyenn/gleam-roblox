...
import roblox/types.{type Actor, type Button, type Controller, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn button_changed(instance: Controller) -> RBXScriptSignal(fn(Button) -> Nil)
...
pub fn on_button_changed(instance: Controller, callback: fn(Button) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Controller, value: parent) -> Controller
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Controller) -> Nil
...
pub fn get_attribute_changed_signal(instance: Controller, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Controller, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Controller) -> List(String)
...
pub fn wait_for_child(instance: Controller, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Controller) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Controller, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Controller) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Controller, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Controller) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Controller, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Controller) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Controller, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Controller) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Controller, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Controller) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Controller, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Controller) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Controller, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Controller) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Controller, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Controller, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Controller) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Controller, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Button, _: Controller, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}