...
import roblox/types.{type Actor, type CacheableContentProvider, type HSRDataContentProvider, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `HSRDataContentProvider` as its Roblox ancestor `CacheableContentProvider`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_cacheable_content_provider(instance: HSRDataContentProvider) -> CacheableContentProvider
...
pub fn set_parent(instance: HSRDataContentProvider, value: parent) -> HSRDataContentProvider
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HSRDataContentProvider) -> Nil
...
pub fn get_attribute_changed_signal(instance: HSRDataContentProvider, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HSRDataContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HSRDataContentProvider) -> List(String)
...
pub fn wait_for_child(instance: HSRDataContentProvider, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HSRDataContentProvider, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HSRDataContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HSRDataContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HSRDataContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HSRDataContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HSRDataContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HSRDataContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HSRDataContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HSRDataContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HSRDataContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HSRDataContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HSRDataContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HSRDataContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: HSRDataContentProvider, _: CacheableContentProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}