...
import roblox/types.{
  type Actor, type Button, type Controller, type Instance, type Int64,
  type Object, type SecurityCapabilities, type SkateboardController,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: SkateboardController) -> Int64
