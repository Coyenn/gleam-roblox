...
import roblox/types.{type Actor, type Button, type Controller, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SkateboardController, type UniqueId}

/// Creates a new Roblox `SkateboardController` instance.
///
/// Roblox: `Instance.new("SkateboardController")`
@target(luau)
@luau.global("Instance.new(\"SkateboardController\")")
...
pub fn axis_changed(instance: SkateboardController) -> RBXScriptSignal(fn(String) -> Nil)

/// Connects to Roblox event `SkateboardController.AxisChanged`.
///
/// Fired when any input state of the skateboard controller is updated.
///
/// Roblox: `SkateboardController.AxisChanged`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/SkateboardController#AxisChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.AxisChanged:Connect(callback) end)")
pub fn on_axis_changed(instance: SkateboardController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn button_changed(instance: SkateboardController) -> RBXScriptSignal(fn(Button) -> Nil)

/// Connects to Roblox event `Controller.ButtonChanged`.
///
/// Fired when the pressed state of a bound button is changed. This event can be used in conjunction with Controller:GetButton() to see whether a bound button is being pressed down or not.
///
/// Roblox: `Controller.ButtonChanged`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/Controller#ButtonChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.ButtonChanged:Connect(callback) end)")
pub fn on_button_changed(instance: SkateboardController, callback: fn(Button) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: SkateboardController, value: parent) -> SkateboardController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SkateboardController) -> Nil
...
pub fn get_attribute_changed_signal(instance: SkateboardController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SkateboardController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SkateboardController) -> List(String)
...
pub fn wait_for_child(instance: SkateboardController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SkateboardController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SkateboardController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SkateboardController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SkateboardController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SkateboardController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SkateboardController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SkateboardController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SkateboardController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SkateboardController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SkateboardController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SkateboardController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SkateboardController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SkateboardController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SkateboardController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SkateboardController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SkateboardController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SkateboardController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SkateboardController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SkateboardController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Button, _: SkateboardController, _: Controller, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}