...
import roblox/types.{type Actor, type Instance, type NumberValue, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `NumberValue` instance.
///
/// Roblox: `Instance.new("NumberValue")`
@target(luau)
@luau.global("Instance.new(\"NumberValue\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NumberValue) -> RBXScriptSignal(fn(OptionDouble) -> Nil)
...
pub fn on_changed(instance: NumberValue, callback: fn(OptionDouble) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: NumberValue, value: parent) -> NumberValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NumberValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: NumberValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NumberValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NumberValue) -> List(String)
...
pub fn wait_for_child(instance: NumberValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NumberValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NumberValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NumberValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NumberValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NumberValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NumberValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NumberValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NumberValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NumberValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NumberValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NumberValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NumberValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NumberValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NumberValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NumberValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NumberValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NumberValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NumberValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}