...
import roblox/types.{type Actor, type BinaryString, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ServiceVisibilityService, type UniqueId}
...
pub fn set_parent(instance: ServiceVisibilityService, value: parent) -> ServiceVisibilityService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ServiceVisibilityService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ServiceVisibilityService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ServiceVisibilityService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ServiceVisibilityService) -> List(String)
...
pub fn wait_for_child(instance: ServiceVisibilityService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ServiceVisibilityService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ServiceVisibilityService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ServiceVisibilityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ServiceVisibilityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ServiceVisibilityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ServiceVisibilityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ServiceVisibilityService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ServiceVisibilityService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ServiceVisibilityService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ServiceVisibilityService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ServiceVisibilityService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ServiceVisibilityService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ServiceVisibilityService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BinaryString, _: ServiceVisibilityService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}