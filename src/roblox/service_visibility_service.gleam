...
import roblox/types.{
  ...
  type SecurityCapabilities, type ServiceVisibilityService, type UniqueId,
}
...
pub fn set_archivable(
  instance: ServiceVisibilityService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ServiceVisibilityService) -> Int64
