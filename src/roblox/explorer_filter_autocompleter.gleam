...
import roblox/types.{
  type Actor, type ExplorerFilterAutocompleter, type Instance, type Int64,
...
pub fn get_requires_outside_context(
  instance: ExplorerFilterAutocompleter,
) -> Bool
...
pub fn get_source_asset_id(instance: ExplorerFilterAutocompleter) -> Int64
