...
import roblox/types.{type Actor, type ContentId, type DataModelMesh, type FileMesh, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `FileMesh` instance.
///
/// Roblox: `Instance.new("FileMesh")`
@target(luau)
@luau.global("Instance.new(\"FileMesh\")")
pub fn new() -> FileMesh
...
pub fn set_parent(instance: FileMesh, value: parent) -> FileMesh
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FileMesh) -> Nil
...
pub fn get_attribute_changed_signal(instance: FileMesh, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FileMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FileMesh) -> List(String)
...
pub fn wait_for_child(instance: FileMesh, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FileMesh) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FileMesh, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FileMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FileMesh, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FileMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FileMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FileMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FileMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FileMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FileMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FileMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FileMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FileMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FileMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FileMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FileMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FileMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FileMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FileMesh, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: ContentId, _: FileMesh, _: DataModelMesh, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}