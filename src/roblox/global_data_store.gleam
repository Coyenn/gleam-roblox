...
import roblox/types.{type Actor, type DataStoreGetOptions, type DataStoreIncrementOptions, type DataStoreSetOptions, type GlobalDataStore, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn increment_async(instance: GlobalDataStore, key: String, delta: Int, user_ids: List(Int), options: DataStoreIncrementOptions) -> Dynamic
...
pub fn set_async(instance: GlobalDataStore, key: String, value: Dynamic, user_ids: List(Int), options: DataStoreSetOptions) -> Dynamic
...
pub fn get_attribute_changed_signal(instance: GlobalDataStore, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GlobalDataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: GlobalDataStore, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GlobalDataStore) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GlobalDataStore, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GlobalDataStore) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GlobalDataStore, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GlobalDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GlobalDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GlobalDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GlobalDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GlobalDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GlobalDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GlobalDataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GlobalDataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: GlobalDataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GlobalDataStore) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GlobalDataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GlobalDataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: GlobalDataStore, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreSetOptions, _: DataStoreIncrementOptions, _: DataStoreGetOptions, _: GlobalDataStore, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}