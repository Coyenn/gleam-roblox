...
import roblox/types.{type Actor, type Chat, type ChatCallbackType, type ChatColor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId}
