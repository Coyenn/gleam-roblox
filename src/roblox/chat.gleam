...
pub fn invoke_chat_callback(
  instance: Chat,
  callback_type: ChatCallbackType,
  callback_arguments: Dynamic,
) -> Dynamic
...
pub fn filter_string_for_broadcast(
  instance: Chat,
  string_to_filter: String,
  player_from: Player,
) -> String
...
pub fn chatted(
  instance: Chat,
) -> RBXScriptSignal(fn(Instance, String, ChatColor) -> Nil)
...
pub fn on_chatted(
  instance: Chat,
  callback: fn(Instance, String, ChatColor) -> Nil,
) -> RBXScriptConnection
