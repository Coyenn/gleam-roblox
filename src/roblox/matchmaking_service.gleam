...
import roblox/types.{
  type Actor, type Instance, type Int64, type MatchmakingService, type Object,
...
pub fn get_server_attribute(
  instance: MatchmakingService,
  name: String,
) -> Dynamic
...
pub fn initialize_server_attributes_for_studio(
  instance: MatchmakingService,
  server_attributes: Dynamic,
) -> Dynamic
...
pub fn get_source_asset_id(instance: MatchmakingService) -> Int64
