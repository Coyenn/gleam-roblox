...
import roblox/types.{
  ...
  type StarterCharacterScripts, type StarterPlayerScripts, type UniqueId,
}
...
pub fn get_source_asset_id(instance: StarterCharacterScripts) -> Int64
