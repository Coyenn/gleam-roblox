...
import roblox/types.{
  type Actor, type ContentId, type Instance, type Int64, type Object,
  type ScreenshotHud, type SecurityCapabilities, type UDim2, type UniqueId,
}
...
pub fn set_camera_button_icon(
  instance: ScreenshotHud,
  value: ContentId,
) -> ScreenshotHud
...
pub fn set_camera_button_position(
  instance: ScreenshotHud,
  value: UDim2,
) -> ScreenshotHud
...
pub fn set_close_button_position(
  instance: ScreenshotHud,
  value: UDim2,
) -> ScreenshotHud
...
pub fn set_close_when_screenshot_taken(
  instance: ScreenshotHud,
  value: Bool,
) -> ScreenshotHud
...
pub fn set_hide_core_gui_for_captures(
  instance: ScreenshotHud,
  value: Bool,
) -> ScreenshotHud
...
pub fn set_hide_player_gui_for_captures(
  instance: ScreenshotHud,
  value: Bool,
) -> ScreenshotHud
...
pub fn get_source_asset_id(instance: ScreenshotHud) -> Int64
