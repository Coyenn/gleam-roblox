...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Snap, type UniqueId}
...
pub fn set_parent(instance: Snap, value: parent) -> Snap
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Snap) -> Nil
...
pub fn get_attribute_changed_signal(instance: Snap, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Snap, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Snap) -> List(String)
...
pub fn wait_for_child(instance: Snap, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Snap) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Snap, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Snap) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Snap, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Snap) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Snap, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Snap) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Snap, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Snap) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Snap, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Snap) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Snap, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Snap) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Snap, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Snap) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Snap, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Snap, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Snap) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Snap, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: Snap, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}