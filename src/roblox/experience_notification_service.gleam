...
import roblox/types.{
  type Actor, type ExperienceNotificationService, type Instance, type Int64,
...
pub fn opt_in_prompt_closed(
  instance: ExperienceNotificationService,
...
pub fn on_opt_in_prompt_closed(
  instance: ExperienceNotificationService,
  callback: fn() -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: ExperienceNotificationService) -> Int64
