...
import roblox/types.{type Actor, type ExperienceNotificationService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn opt_in_prompt_closed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `ExperienceNotificationService.OptInPromptClosed`.
///
/// Fires when the local player closes the prompt.
///
/// Roblox: `ExperienceNotificationService.OptInPromptClosed`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/ExperienceNotificationService#OptInPromptClosed
@target(luau)
@luau.global("(function(instance, callback) return instance.OptInPromptClosed:Connect(callback) end)")
pub fn on_opt_in_prompt_closed(instance: ExperienceNotificationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ExperienceNotificationService, value: parent) -> ExperienceNotificationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ExperienceNotificationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ExperienceNotificationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ExperienceNotificationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ExperienceNotificationService) -> List(String)
...
pub fn wait_for_child(instance: ExperienceNotificationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ExperienceNotificationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ExperienceNotificationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ExperienceNotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ExperienceNotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ExperienceNotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ExperienceNotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ExperienceNotificationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ExperienceNotificationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ExperienceNotificationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ExperienceNotificationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ExperienceNotificationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ExperienceNotificationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ExperienceNotificationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}