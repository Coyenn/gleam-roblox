...
import roblox/types.{type Actor, type HttpContentType, type HttpRbxApiService, type HttpRequestType, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ThrottlingPriority, type UniqueId}
...
pub fn set_parent(instance: HttpRbxApiService, value: parent) -> HttpRbxApiService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HttpRbxApiService) -> Nil
...
pub fn get_attribute_changed_signal(instance: HttpRbxApiService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HttpRbxApiService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HttpRbxApiService) -> List(String)
...
pub fn wait_for_child(instance: HttpRbxApiService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HttpRbxApiService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HttpRbxApiService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HttpRbxApiService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HttpRbxApiService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HttpRbxApiService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HttpRbxApiService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HttpRbxApiService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HttpRbxApiService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HttpRbxApiService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HttpRbxApiService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HttpRbxApiService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HttpRbxApiService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HttpRbxApiService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HttpRbxApiService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HttpRbxApiService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HttpRbxApiService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HttpRbxApiService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HttpRbxApiService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HttpRbxApiService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ThrottlingPriority, _: HttpContentType, _: HttpRequestType, _: HttpRbxApiService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}