...
import roblox/types.{type Actor, type BaseImportData, type FacsImportData, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `FacsImportData` as its Roblox ancestor `BaseImportData`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_base_import_data(instance: FacsImportData) -> BaseImportData

/// Treats `FacsImportData` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: FacsImportData) -> Instance

/// Treats `FacsImportData` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: FacsImportData) -> Object
...
pub fn status_removed(instance: FacsImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_removed(instance: FacsImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn status_reported(instance: FacsImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_reported(instance: FacsImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: FacsImportData, value: parent) -> FacsImportData
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FacsImportData) -> Nil
...
pub fn get_attribute_changed_signal(instance: FacsImportData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FacsImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FacsImportData) -> List(String)
...
pub fn wait_for_child(instance: FacsImportData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FacsImportData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FacsImportData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FacsImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FacsImportData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FacsImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FacsImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FacsImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FacsImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FacsImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FacsImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FacsImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FacsImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FacsImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FacsImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FacsImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FacsImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FacsImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FacsImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FacsImportData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FacsImportData, _: BaseImportData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}