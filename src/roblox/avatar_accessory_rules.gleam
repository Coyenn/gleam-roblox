...
import roblox/types.{type Actor, type AvatarAccessoryRules, type AvatarSettingsAccessoryLimitMethod, type AvatarSettingsAccessoryMode, type AvatarSettingsCustomAccessoryMode, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `AvatarAccessoryRules` instance.
///
/// Roblox: `Instance.new("AvatarAccessoryRules")`
@target(luau)
@luau.global("Instance.new(\"AvatarAccessoryRules\")")
pub fn new() -> AvatarAccessoryRules

/// Treats `AvatarAccessoryRules` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: AvatarAccessoryRules, value: parent) -> AvatarAccessoryRules
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AvatarAccessoryRules) -> Nil
...
pub fn get_attribute_changed_signal(instance: AvatarAccessoryRules, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AvatarAccessoryRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AvatarAccessoryRules) -> List(String)
...
pub fn wait_for_child(instance: AvatarAccessoryRules, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AvatarAccessoryRules, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AvatarAccessoryRules, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AvatarAccessoryRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AvatarAccessoryRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AvatarAccessoryRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AvatarAccessoryRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AvatarAccessoryRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AvatarAccessoryRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AvatarAccessoryRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AvatarAccessoryRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AvatarAccessoryRules, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AvatarSettingsAccessoryLimitMethod, _: Vector3, _: AvatarSettingsCustomAccessoryMode, _: AvatarSettingsAccessoryMode, _: AvatarAccessoryRules, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}