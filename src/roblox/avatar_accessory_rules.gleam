...
pub fn get_custom_accessory_mode(
  instance: AvatarAccessoryRules,
...
pub fn get_custom_front_accessory_enabled(
  instance: AvatarAccessoryRules,
) -> Bool
...
pub fn get_custom_shoulder_accessory_enabled(
  instance: AvatarAccessoryRules,
) -> Bool
...
pub fn get_custom_waist_accessory_enabled(
  instance: AvatarAccessoryRules,
) -> Bool
