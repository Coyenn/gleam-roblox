...
import roblox/types.{
  type Actor, type DataStoreListingPages, type Instance, type Int64, type Object,
...
pub fn set_archivable(
  instance: DataStoreListingPages,
  value: Bool,
...
pub fn get_source_asset_id(instance: DataStoreListingPages) -> Int64
