...
import roblox/types.{type Actor, type FillDirection, type HorizontalAlignment, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SortOrder, type UIBase, type UIComponent, type UIGridStyleLayout, type UILayout, type UniqueId, type Vector2, type VerticalAlignment}
...
pub fn set_parent(instance: UIGridStyleLayout, value: parent) -> UIGridStyleLayout
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIGridStyleLayout) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIGridStyleLayout, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIGridStyleLayout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIGridStyleLayout) -> List(String)
...
pub fn wait_for_child(instance: UIGridStyleLayout, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIGridStyleLayout, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIGridStyleLayout, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIGridStyleLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIGridStyleLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIGridStyleLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIGridStyleLayout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIGridStyleLayout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIGridStyleLayout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIGridStyleLayout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIGridStyleLayout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIGridStyleLayout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIGridStyleLayout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIGridStyleLayout, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VerticalAlignment, _: SortOrder, _: HorizontalAlignment, _: FillDirection, _: Vector2, _: UIGridStyleLayout, _: UILayout, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}