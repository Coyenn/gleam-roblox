...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type UserService}
...
pub fn get_user_infos_by_user_ids_async(instance: UserService, user_ids: List(Int)) -> List(Dynamic)
...
pub fn set_parent(instance: UserService, value: parent) -> UserService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UserService) -> Nil
...
pub fn get_attribute_changed_signal(instance: UserService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UserService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UserService) -> List(String)
...
pub fn wait_for_child(instance: UserService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UserService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UserService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UserService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UserService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UserService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UserService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UserService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UserService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UserService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UserService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UserService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UserService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}