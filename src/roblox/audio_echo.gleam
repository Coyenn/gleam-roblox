...
import roblox/types.{type Actor, type AudioEcho, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioEcho` instance.
///
/// Roblox: `Instance.new("AudioEcho")`
@target(luau)
@luau.global("Instance.new(\"AudioEcho\")")
pub fn new() -> AudioEcho
...
pub fn get_input_pins(instance: AudioEcho) -> List(String)
...
pub fn get_output_pins(instance: AudioEcho) -> List(String)
...
pub fn wiring_changed(instance: AudioEcho) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioEcho.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioEcho via a Wire.
///
/// Roblox: `AudioEcho.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioEcho, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioEcho, value: parent) -> AudioEcho
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioEcho) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioEcho, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioEcho, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioEcho) -> List(String)
...
pub fn wait_for_child(instance: AudioEcho, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioEcho) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioEcho, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioEcho) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioEcho, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioEcho) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioEcho, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioEcho) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioEcho, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioEcho) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioEcho, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioEcho) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioEcho, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioEcho) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioEcho, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioEcho) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioEcho, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioEcho, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioEcho) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioEcho, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioEcho, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}