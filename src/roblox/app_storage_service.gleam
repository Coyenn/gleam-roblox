...
import roblox/types.{
  type Actor, type AppStorageService, type Instance, type Int64,
  type LocalStorageService, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: AppStorageService) -> Int64
