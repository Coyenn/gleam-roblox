...
import roblox/types.{type Actor, type AppStorageService, type Instance, type LocalStorageService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: AppStorageService, value: parent) -> AppStorageService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AppStorageService) -> Nil
...
pub fn get_attribute_changed_signal(instance: AppStorageService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AppStorageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AppStorageService) -> List(String)
...
pub fn wait_for_child(instance: AppStorageService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AppStorageService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AppStorageService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AppStorageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AppStorageService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AppStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AppStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AppStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AppStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AppStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AppStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AppStorageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AppStorageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AppStorageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AppStorageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AppStorageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AppStorageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AppStorageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AppStorageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AppStorageService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AppStorageService, _: LocalStorageService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}