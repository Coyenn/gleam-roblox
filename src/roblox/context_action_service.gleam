...
import roblox/types.{
  type Actor, type ContextActionService, type Instance, type Int64, type KeyCode,
  type Object, type SecurityCapabilities, type UDim2, type UniqueId,
  type UserInputType,
}
...
pub fn bind_action(
  instance: ContextActionService,
  action_name: String,
  function_to_bind: Dynamic,
...
pub fn bind_activate(
  ...
  key_codes_for_activation: Dynamic,
) -> Nil
...
pub fn on_local_tool_unequipped(
  instance: ContextActionService,
  callback: fn(Instance) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: ContextActionService) -> Int64
