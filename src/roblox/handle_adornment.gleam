...
import roblox/types.{type Actor, type AdornCullingMode, type CFrame, type Color3, type GuiBase, type GuiBase3d, type HandleAdornment, type Instance, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn mouse_button1_down(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_down(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_up(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_up(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_enter(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_leave(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: HandleAdornment, value: parent) -> HandleAdornment
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HandleAdornment) -> Nil
...
pub fn get_attribute_changed_signal(instance: HandleAdornment, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HandleAdornment) -> List(String)
...
pub fn wait_for_child(instance: HandleAdornment, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HandleAdornment) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HandleAdornment, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HandleAdornment, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
