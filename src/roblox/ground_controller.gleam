...
import roblox/types.{type Actor, type ControllerBase, type GroundController, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `GroundController` instance.
///
/// Roblox: `Instance.new("GroundController")`
@target(luau)
@luau.global("Instance.new(\"GroundController\")")
pub fn new() -> GroundController
...
pub fn set_parent(instance: GroundController, value: parent) -> GroundController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GroundController) -> Nil
...
pub fn get_attribute_changed_signal(instance: GroundController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GroundController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GroundController) -> List(String)
...
pub fn wait_for_child(instance: GroundController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GroundController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GroundController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GroundController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GroundController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GroundController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GroundController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GroundController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GroundController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GroundController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GroundController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GroundController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GroundController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GroundController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GroundController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GroundController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GroundController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GroundController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GroundController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GroundController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GroundController, _: ControllerBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}