...
import roblox/types.{
  type Actor, type ControllerBase, type GroundController, type Instance,
...
pub fn set_acceleration_lean(
  instance: GroundController,
  value: Float,
) -> GroundController
...
pub fn set_balance_rigidity_enabled(
  instance: GroundController,
  value: Bool,
) -> GroundController
...
pub fn get_source_asset_id(instance: GroundController) -> Int64
