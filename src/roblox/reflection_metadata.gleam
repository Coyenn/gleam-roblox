...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type ReflectionMetadata, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ReflectionMetadata` instance.
///
/// Roblox: `Instance.new("ReflectionMetadata")`
@target(luau)
@luau.global("Instance.new(\"ReflectionMetadata\")")
pub fn new() -> ReflectionMetadata
...
pub fn set_parent(instance: ReflectionMetadata, value: parent) -> ReflectionMetadata
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ReflectionMetadata) -> Nil
...
pub fn get_attribute_changed_signal(instance: ReflectionMetadata, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ReflectionMetadata, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ReflectionMetadata) -> List(String)
...
pub fn wait_for_child(instance: ReflectionMetadata, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ReflectionMetadata) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ReflectionMetadata, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ReflectionMetadata) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ReflectionMetadata, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ReflectionMetadata) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ReflectionMetadata, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ReflectionMetadata) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ReflectionMetadata, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ReflectionMetadata) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ReflectionMetadata, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ReflectionMetadata) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ReflectionMetadata, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ReflectionMetadata) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ReflectionMetadata, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ReflectionMetadata) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ReflectionMetadata, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ReflectionMetadata, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ReflectionMetadata) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ReflectionMetadata, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ReflectionMetadata, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}