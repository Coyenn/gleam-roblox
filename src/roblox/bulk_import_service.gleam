...
import roblox/types.{
  type Actor, type BulkImportService, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: BulkImportService) -> Int64
