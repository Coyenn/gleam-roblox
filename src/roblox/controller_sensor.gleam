...
import roblox/types.{type Actor, type ControllerSensor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SensorBase, type SensorUpdateType, type UniqueId}
...
pub fn on_sensor_output_changed(instance: ControllerSensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_on_sensor_output_changed(instance: ControllerSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ControllerSensor, value: parent) -> ControllerSensor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ControllerSensor) -> Nil
...
pub fn get_attribute_changed_signal(instance: ControllerSensor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ControllerSensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ControllerSensor) -> List(String)
...
pub fn wait_for_child(instance: ControllerSensor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ControllerSensor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ControllerSensor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ControllerSensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ControllerSensor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ControllerSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ControllerSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ControllerSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ControllerSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ControllerSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ControllerSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ControllerSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ControllerSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ControllerSensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ControllerSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ControllerSensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ControllerSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ControllerSensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ControllerSensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ControllerSensor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SensorUpdateType, _: ControllerSensor, _: SensorBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}