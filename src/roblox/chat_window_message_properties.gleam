...
import roblox/types.{
  type Actor, type ChatWindowMessageProperties, type Color3, type Font,
...
pub fn get_prefix_text_properties(
  instance: ChatWindowMessageProperties,
) -> ChatWindowMessageProperties
...
pub fn set_prefix_text_properties(
  instance: ChatWindowMessageProperties,
...
pub fn get_source_asset_id(instance: ChatWindowMessageProperties) -> Int64
