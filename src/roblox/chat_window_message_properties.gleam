...
import roblox/types.{type Actor, type ChatWindowMessageProperties, type Color3, type Font, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextChatMessageProperties, type UniqueId}
...
pub fn set_parent(instance: ChatWindowMessageProperties, value: parent) -> ChatWindowMessageProperties
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ChatWindowMessageProperties) -> Nil
...
pub fn get_attribute_changed_signal(instance: ChatWindowMessageProperties, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ChatWindowMessageProperties, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ChatWindowMessageProperties) -> List(String)
...
pub fn wait_for_child(instance: ChatWindowMessageProperties, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ChatWindowMessageProperties, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ChatWindowMessageProperties, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ChatWindowMessageProperties, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ChatWindowMessageProperties, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ChatWindowMessageProperties, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ChatWindowMessageProperties, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ChatWindowMessageProperties, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ChatWindowMessageProperties, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ChatWindowMessageProperties, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ChatWindowMessageProperties) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ChatWindowMessageProperties, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: ChatWindowMessageProperties, _: Font, _: TextChatMessageProperties, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}