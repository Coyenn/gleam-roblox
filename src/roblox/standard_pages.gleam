...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type Pages,
  type SecurityCapabilities, type StandardPages, type UniqueId,
}
...
pub fn get_source_asset_id(instance: StandardPages) -> Int64
