...
import roblox/types.{
  type Actor, type FeatureRestrictionManager, type Instance, type Int64,
...
pub fn set_archivable(
  instance: FeatureRestrictionManager,
  value: Bool,
...
pub fn get_source_asset_id(instance: FeatureRestrictionManager) -> Int64
