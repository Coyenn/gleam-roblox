...
import roblox/types.{
  ...
  type ReflectionMetadataEnums, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataEnums,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataEnums) -> Int64
