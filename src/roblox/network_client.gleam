...
import roblox/types.{
  type Actor, type Instance, type Int64, type NetworkClient, type NetworkPeer,
...
) -> RBXScriptSignal(fn(String, Instance) -> Nil)
...
pub fn on_connection_accepted(
  instance: NetworkClient,
  callback: fn(String, Instance) -> Nil,
) -> RBXScriptConnection
...
pub fn connection_failed(
  instance: NetworkClient,
) -> RBXScriptSignal(fn(String, Int) -> Nil)
...
pub fn get_source_asset_id(instance: NetworkClient) -> Int64
