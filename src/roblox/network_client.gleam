...
import roblox/types.{type Actor, type Instance, type NetworkClient, type NetworkPeer, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn connection_accepted(instance: NetworkClient) -> RBXScriptSignal(fn(String, Instance) -> Nil)

/// Connects to Roblox event `NetworkClient.ConnectionAccepted`.
///
/// Fired when the client successfully connects to a server. Returns a string showing the server's IP and port, and the client's ClientReplicator.
///
/// Roblox: `NetworkClient.ConnectionAccepted`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/NetworkClient#ConnectionAccepted
@target(luau)
@luau.global("(function(instance, callback) return instance.ConnectionAccepted:Connect(callback) end)")
pub fn on_connection_accepted(instance: NetworkClient, callback: fn(String, Instance) -> Nil) -> RBXScriptConnection
...
pub fn connection_failed(instance: NetworkClient) -> RBXScriptSignal(fn(String, Int) -> Nil)

/// Connects to Roblox event `NetworkClient.ConnectionFailed`.
///
/// Fired if the client fails to connect to the server.
///
/// Roblox: `NetworkClient.ConnectionFailed`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/NetworkClient#ConnectionFailed
@target(luau)
@luau.global("(function(instance, callback) return instance.ConnectionFailed:Connect(callback) end)")
pub fn on_connection_failed(instance: NetworkClient, callback: fn(String, Int) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: NetworkClient, value: parent) -> NetworkClient
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NetworkClient) -> Nil
...
pub fn get_attribute_changed_signal(instance: NetworkClient, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NetworkClient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NetworkClient) -> List(String)
...
pub fn wait_for_child(instance: NetworkClient, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NetworkClient) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NetworkClient, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NetworkClient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NetworkClient, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NetworkClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NetworkClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NetworkClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NetworkClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NetworkClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NetworkClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NetworkClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NetworkClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NetworkClient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NetworkClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NetworkClient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NetworkClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NetworkClient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NetworkClient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: NetworkClient, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NetworkClient, _: NetworkPeer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}