...
import roblox/types.{type Actor, type CFrame, type CFrameValue, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `CFrameValue` instance.
///
/// Roblox: `Instance.new("CFrameValue")`
@target(luau)
@luau.global("Instance.new(\"CFrameValue\")")
pub fn new() -> CFrameValue
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CFrameValue) -> RBXScriptSignal(fn(CFrame) -> Nil)

/// Connects to Roblox event `CFrameValue.Changed`.
///
/// Fired whenever the CFrameValue.Value of the CFrameValue is changed.
///
/// Roblox: `CFrameValue.Changed`
...
pub fn on_changed(instance: CFrameValue, callback: fn(CFrame) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: CFrameValue, value: parent) -> CFrameValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CFrameValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: CFrameValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CFrameValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CFrameValue) -> List(String)
...
pub fn wait_for_child(instance: CFrameValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CFrameValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CFrameValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CFrameValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CFrameValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CFrameValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CFrameValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CFrameValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CFrameValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CFrameValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CFrameValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CFrameValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CFrameValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CFrameValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CFrameValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CFrameValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CFrameValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CFrameValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: CFrameValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}