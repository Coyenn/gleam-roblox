...
import roblox/types.{type Actor, type Instance, type MemStorageConnection, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `MemStorageConnection` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: MemStorageConnection) -> Instance

/// Treats `MemStorageConnection` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: MemStorageConnection) -> Object
...
pub fn set_parent(instance: MemStorageConnection, value: parent) -> MemStorageConnection
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MemStorageConnection) -> Nil
...
pub fn get_attribute_changed_signal(instance: MemStorageConnection, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MemStorageConnection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MemStorageConnection) -> List(String)
...
pub fn wait_for_child(instance: MemStorageConnection, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MemStorageConnection) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MemStorageConnection, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MemStorageConnection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MemStorageConnection, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MemStorageConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MemStorageConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MemStorageConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MemStorageConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MemStorageConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MemStorageConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MemStorageConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MemStorageConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MemStorageConnection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MemStorageConnection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MemStorageConnection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MemStorageConnection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MemStorageConnection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MemStorageConnection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MemStorageConnection, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MemStorageConnection, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}