...
import roblox/types.{type Actor, type AvatarCollisionRules, type AvatarSettingsCollisionMode, type AvatarSettingsHitAndTouchDetectionMode, type AvatarSettingsLegacyCollisionMode, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `AvatarCollisionRules` instance.
///
/// Roblox: `Instance.new("AvatarCollisionRules")`
@target(luau)
@luau.global("Instance.new(\"AvatarCollisionRules\")")
pub fn new() -> AvatarCollisionRules
...
pub fn set_parent(instance: AvatarCollisionRules, value: parent) -> AvatarCollisionRules
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AvatarCollisionRules) -> Nil
...
pub fn get_attribute_changed_signal(instance: AvatarCollisionRules, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AvatarCollisionRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AvatarCollisionRules) -> List(String)
...
pub fn wait_for_child(instance: AvatarCollisionRules, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AvatarCollisionRules, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AvatarCollisionRules, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AvatarCollisionRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AvatarCollisionRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AvatarCollisionRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AvatarCollisionRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AvatarCollisionRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AvatarCollisionRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AvatarCollisionRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AvatarCollisionRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AvatarCollisionRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AvatarCollisionRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AvatarCollisionRules, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: AvatarSettingsLegacyCollisionMode, _: AvatarSettingsHitAndTouchDetectionMode, _: AvatarSettingsCollisionMode, _: AvatarCollisionRules, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}