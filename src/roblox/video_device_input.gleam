...
import roblox/types.{
  ...
  type UniqueId, type VideoDeviceCaptureQuality, type VideoDeviceInput,
}
...
pub fn get_source_asset_id(instance: VideoDeviceInput) -> Int64
