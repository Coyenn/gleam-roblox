...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type VideoDeviceCaptureQuality, type VideoDeviceInput}

/// Creates a new Roblox `VideoDeviceInput` instance.
///
/// Roblox: `Instance.new("VideoDeviceInput")`
@target(luau)
@luau.global("Instance.new(\"VideoDeviceInput\")")
pub fn new() -> VideoDeviceInput
...
pub fn set_parent(instance: VideoDeviceInput, value: parent) -> VideoDeviceInput
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VideoDeviceInput) -> Nil
...
pub fn get_attribute_changed_signal(instance: VideoDeviceInput, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VideoDeviceInput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VideoDeviceInput) -> List(String)
...
pub fn wait_for_child(instance: VideoDeviceInput, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VideoDeviceInput) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VideoDeviceInput, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VideoDeviceInput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VideoDeviceInput, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VideoDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VideoDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VideoDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VideoDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VideoDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VideoDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VideoDeviceInput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VideoDeviceInput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VideoDeviceInput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VideoDeviceInput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VideoDeviceInput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VideoDeviceInput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VideoDeviceInput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VideoDeviceInput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VideoDeviceInput, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VideoDeviceCaptureQuality, _: VideoDeviceInput, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}