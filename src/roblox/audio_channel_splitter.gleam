...
import roblox/types.{type Actor, type AudioChannelLayout, type AudioChannelSplitter, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioChannelSplitter` instance.
///
/// Roblox: `Instance.new("AudioChannelSplitter")`
@target(luau)
@luau.global("Instance.new(\"AudioChannelSplitter\")")
pub fn new() -> AudioChannelSplitter
...
pub fn get_input_pins(instance: AudioChannelSplitter) -> List(String)
...
pub fn get_output_pins(instance: AudioChannelSplitter) -> List(String)
...
pub fn wiring_changed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioChannelSplitter.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioChannelSplitter via a Wire.
///
/// Roblox: `AudioChannelSplitter.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioChannelSplitter, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioChannelSplitter, value: parent) -> AudioChannelSplitter
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioChannelSplitter) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioChannelSplitter, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioChannelSplitter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioChannelSplitter) -> List(String)
...
pub fn wait_for_child(instance: AudioChannelSplitter, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioChannelSplitter, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioChannelSplitter, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioChannelSplitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioChannelSplitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioChannelSplitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioChannelSplitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioChannelSplitter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioChannelSplitter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioChannelSplitter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioChannelSplitter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioChannelSplitter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioChannelSplitter, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioChannelLayout, _: AudioChannelSplitter, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}