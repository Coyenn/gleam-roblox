...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type ScriptContext, type SecurityCapabilities, type UniqueId}
...
@target(luau)
@luau.event("Error")
pub fn error(instance: ScriptContext) -> RBXScriptSignal(fn(String, String, Instance) -> Nil)

/// Connects to Roblox event `ScriptContext.Error`.
///
/// Fired when an error occurs.
///
/// Roblox: `ScriptContext.Error`
...
pub fn on_error(instance: ScriptContext, callback: fn(String, String, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ScriptContext, value: parent) -> ScriptContext
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ScriptContext) -> Nil
...
pub fn get_attribute_changed_signal(instance: ScriptContext, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ScriptContext, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ScriptContext) -> List(String)
...
pub fn wait_for_child(instance: ScriptContext, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ScriptContext) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ScriptContext, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ScriptContext) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ScriptContext, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ScriptContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ScriptContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ScriptContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ScriptContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ScriptContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ScriptContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ScriptContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ScriptContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ScriptContext) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ScriptContext, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ScriptContext) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ScriptContext, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ScriptContext, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ScriptContext) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ScriptContext, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ScriptContext, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}