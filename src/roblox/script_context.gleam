...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptContext,
...
) -> RBXScriptSignal(fn(String, String, Instance) -> Nil)
...
pub fn on_error(
  instance: ScriptContext,
  callback: fn(String, String, Instance) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: ScriptContext) -> Int64
