...
import roblox/types.{
  ...
  type RolloutValidationService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RolloutValidationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: RolloutValidationService) -> Int64
