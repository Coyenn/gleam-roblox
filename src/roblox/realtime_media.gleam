...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type RealtimeMedia, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `RealtimeMedia` instance.
///
/// Roblox: `Instance.new("RealtimeMedia")`
@target(luau)
@luau.global("Instance.new(\"RealtimeMedia\")")
pub fn new() -> RealtimeMedia
...
pub fn get_input_pins(instance: RealtimeMedia) -> List(String)
...
pub fn get_output_pins(instance: RealtimeMedia) -> List(String)
...
pub fn on_message(instance: RealtimeMedia) -> RBXScriptSignal(fn(String, Bool) -> Nil)

/// Connects to Roblox event `RealtimeMedia.OnMessage`.
///
/// Roblox: `RealtimeMedia.OnMessage`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/RealtimeMedia#OnMessage
@target(luau)
@luau.global("(function(instance, callback) return instance.OnMessage:Connect(callback) end)")
pub fn on_on_message(instance: RealtimeMedia, callback: fn(String, Bool) -> Nil) -> RBXScriptConnection
...
pub fn wiring_changed(instance: RealtimeMedia) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `RealtimeMedia.WiringChanged`.
///
/// Roblox: `RealtimeMedia.WiringChanged`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/RealtimeMedia#WiringChanged
...
pub fn on_wiring_changed(instance: RealtimeMedia, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: RealtimeMedia, value: parent) -> RealtimeMedia
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RealtimeMedia) -> Nil
...
pub fn get_attribute_changed_signal(instance: RealtimeMedia, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RealtimeMedia, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RealtimeMedia) -> List(String)
...
pub fn wait_for_child(instance: RealtimeMedia, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RealtimeMedia) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RealtimeMedia, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RealtimeMedia) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RealtimeMedia, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RealtimeMedia) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RealtimeMedia, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RealtimeMedia) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RealtimeMedia, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RealtimeMedia) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RealtimeMedia, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RealtimeMedia) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RealtimeMedia, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RealtimeMedia) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RealtimeMedia, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RealtimeMedia) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RealtimeMedia, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RealtimeMedia, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RealtimeMedia) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RealtimeMedia, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: RealtimeMedia, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}