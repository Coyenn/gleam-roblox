...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type RealtimeMedia,
...
pub fn on_message(
  instance: RealtimeMedia,
) -> RBXScriptSignal(fn(String, Bool) -> Nil)
...
pub fn get_source_asset_id(instance: RealtimeMedia) -> Int64
