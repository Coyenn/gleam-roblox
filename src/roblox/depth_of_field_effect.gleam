...
import roblox/types.{
  type Actor, type DepthOfFieldEffect, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: DepthOfFieldEffect) -> Int64
