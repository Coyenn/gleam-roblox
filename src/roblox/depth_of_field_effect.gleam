...
import roblox/types.{type Actor, type DepthOfFieldEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DepthOfFieldEffect` instance.
///
/// Roblox: `Instance.new("DepthOfFieldEffect")`
@target(luau)
@luau.global("Instance.new(\"DepthOfFieldEffect\")")
...
pub fn set_parent(instance: DepthOfFieldEffect, value: parent) -> DepthOfFieldEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DepthOfFieldEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: DepthOfFieldEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DepthOfFieldEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DepthOfFieldEffect) -> List(String)
...
pub fn wait_for_child(instance: DepthOfFieldEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DepthOfFieldEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DepthOfFieldEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DepthOfFieldEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DepthOfFieldEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DepthOfFieldEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DepthOfFieldEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DepthOfFieldEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DepthOfFieldEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DepthOfFieldEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DepthOfFieldEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DepthOfFieldEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DepthOfFieldEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}