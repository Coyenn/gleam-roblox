...
import roblox/types.{type Actor, type BasePart, type Color3, type GuiBase, type GuiBase3d, type HandlesBase, type Instance, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type UniqueId}

/// Treats `HandlesBase` as its Roblox ancestor `PartAdornment`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_part_adornment(instance: HandlesBase) -> PartAdornment

/// Treats `HandlesBase` as its Roblox ancestor `GuiBase3d`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_gui_base3d(instance: HandlesBase) -> GuiBase3d

/// Treats `HandlesBase` as its Roblox ancestor `GuiBase`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_gui_base(instance: HandlesBase) -> GuiBase

/// Treats `HandlesBase` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: HandlesBase) -> Instance

/// Treats `HandlesBase` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: HandlesBase) -> Object
...
pub fn set_parent(instance: HandlesBase, value: parent) -> HandlesBase
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HandlesBase) -> Nil
...
pub fn get_attribute_changed_signal(instance: HandlesBase, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HandlesBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HandlesBase) -> List(String)
...
pub fn wait_for_child(instance: HandlesBase, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HandlesBase) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HandlesBase, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HandlesBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HandlesBase, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HandlesBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HandlesBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HandlesBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HandlesBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HandlesBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HandlesBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HandlesBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HandlesBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HandlesBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HandlesBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HandlesBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HandlesBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HandlesBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HandlesBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HandlesBase, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: BasePart, _: HandlesBase, _: PartAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}