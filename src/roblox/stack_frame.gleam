...
import roblox/types.{type Actor, type DebuggerFrameType, type DebuggerVariable, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StackFrame, type UniqueId}
...
pub fn set_parent(instance: StackFrame, value: parent) -> StackFrame
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StackFrame) -> Nil
...
pub fn get_attribute_changed_signal(instance: StackFrame, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StackFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StackFrame) -> List(String)
...
pub fn wait_for_child(instance: StackFrame, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StackFrame) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StackFrame, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StackFrame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StackFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StackFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StackFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StackFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StackFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StackFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StackFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StackFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StackFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StackFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StackFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StackFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StackFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StackFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StackFrame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StackFrame, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DebuggerVariable, _: DebuggerFrameType, _: StackFrame, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}