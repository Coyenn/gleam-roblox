...
import roblox/types.{type Actor, type BoolValue, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `BoolValue` instance.
///
/// Roblox: `Instance.new("BoolValue")`
@target(luau)
@luau.global("Instance.new(\"BoolValue\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BoolValue) -> RBXScriptSignal(fn(Bool) -> Nil)

/// Connects to Roblox event `BoolValue.Changed`.
///
/// Fires whenever the BoolValue.Value is changed.
///
/// Roblox: `BoolValue.Changed`
...
pub fn on_changed(instance: BoolValue, callback: fn(Bool) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BoolValue, value: parent) -> BoolValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BoolValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: BoolValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BoolValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BoolValue) -> List(String)
...
pub fn wait_for_child(instance: BoolValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BoolValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BoolValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BoolValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BoolValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BoolValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BoolValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BoolValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BoolValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BoolValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BoolValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BoolValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BoolValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BoolValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BoolValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BoolValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BoolValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BoolValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BoolValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}