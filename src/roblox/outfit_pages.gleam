...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type OutfitPages, type Pages, type SecurityCapabilities, type UniqueId}

/// Treats `OutfitPages` as its Roblox ancestor `Pages`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_pages(instance: OutfitPages) -> Pages

/// Treats `OutfitPages` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: OutfitPages) -> Instance

/// Treats `OutfitPages` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: OutfitPages) -> Object
...
pub fn set_parent(instance: OutfitPages, value: parent) -> OutfitPages
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: OutfitPages) -> Nil
...
pub fn get_attribute_changed_signal(instance: OutfitPages, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: OutfitPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: OutfitPages) -> List(String)
...
pub fn wait_for_child(instance: OutfitPages, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: OutfitPages) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: OutfitPages, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: OutfitPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: OutfitPages, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: OutfitPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: OutfitPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: OutfitPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: OutfitPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: OutfitPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: OutfitPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: OutfitPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: OutfitPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: OutfitPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: OutfitPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: OutfitPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: OutfitPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: OutfitPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: OutfitPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: OutfitPages, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: OutfitPages, _: Pages, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}