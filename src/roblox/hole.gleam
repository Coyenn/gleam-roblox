...
import roblox/types.{type Actor, type Feature, type Hole, type InOut, type Instance, type LeftRight, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TopBottom, type UniqueId}
...
pub fn set_parent(instance: Hole, value: parent) -> Hole
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Hole) -> Nil
...
pub fn get_attribute_changed_signal(instance: Hole, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Hole, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Hole) -> List(String)
...
pub fn wait_for_child(instance: Hole, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Hole) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Hole, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Hole) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Hole, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Hole) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Hole, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Hole) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Hole, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Hole) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Hole, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Hole) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Hole, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Hole) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Hole, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Hole) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Hole, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Hole, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Hole) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Hole, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TopBottom, _: LeftRight, _: InOut, _: NormalId, _: Hole, _: Feature, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}