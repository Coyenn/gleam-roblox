...
import roblox/types.{type Actor, type ApplyStrokeMode, type BorderStrokePosition, type Color3, type Instance, type LineJoinMode, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StrokeSizingMode, type UDim, type UIBase, type UIComponent, type UIStroke, type UniqueId}

/// Creates a new Roblox `UIStroke` instance.
///
/// Roblox: `Instance.new("UIStroke")`
@target(luau)
@luau.global("Instance.new(\"UIStroke\")")
pub fn new() -> UIStroke
...
pub fn set_parent(instance: UIStroke, value: parent) -> UIStroke
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIStroke) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIStroke, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIStroke, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIStroke) -> List(String)
...
pub fn wait_for_child(instance: UIStroke, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIStroke) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIStroke, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIStroke) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIStroke, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIStroke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIStroke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIStroke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIStroke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIStroke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIStroke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIStroke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIStroke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIStroke) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIStroke, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIStroke) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIStroke, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIStroke, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIStroke) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIStroke, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StrokeSizingMode, _: LineJoinMode, _: Color3, _: BorderStrokePosition, _: UDim, _: ApplyStrokeMode, _: UIStroke, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}