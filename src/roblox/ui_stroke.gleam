...
import roblox/types.{
  ...
  type Instance, type LineJoinMode, type Object, type OptionDouble,
  type OptionInt64, type SecurityCapabilities, type StrokeSizingMode, type UDim,
  type UIBase, type UIComponent, type UIStroke, type UniqueId,
}
...
pub fn set_border_stroke_position(
  instance: UIStroke,
...
pub fn set_stroke_sizing_mode(
  instance: UIStroke,
  value: StrokeSizingMode,
) -> UIStroke
