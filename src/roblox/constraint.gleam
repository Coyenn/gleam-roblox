...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Constraint, value: parent) -> Constraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Constraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: Constraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Constraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Constraint) -> List(String)
...
pub fn wait_for_child(instance: Constraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Constraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Constraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Constraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Constraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Constraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Constraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Constraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Constraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Constraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Constraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Constraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Constraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Constraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Constraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Constraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Constraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Constraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Constraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Constraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}