...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UGCValidationService, type UniqueId}

/// Treats `UGCValidationService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: UGCValidationService) -> Instance

/// Treats `UGCValidationService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: UGCValidationService) -> Object
...
pub fn set_parent(instance: UGCValidationService, value: parent) -> UGCValidationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UGCValidationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: UGCValidationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UGCValidationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UGCValidationService) -> List(String)
...
pub fn wait_for_child(instance: UGCValidationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UGCValidationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UGCValidationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UGCValidationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UGCValidationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UGCValidationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UGCValidationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UGCValidationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UGCValidationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UGCValidationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UGCValidationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UGCValidationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UGCValidationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UGCValidationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UGCValidationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UGCValidationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UGCValidationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UGCValidationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UGCValidationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UGCValidationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UGCValidationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}