...
import roblox/types.{
  type Actor, type CharacterAppearance, type Color3, type ContentId,
  type Instance, type Object, type SecurityCapabilities, type ShirtGraphic,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: ShirtGraphic) -> Int
