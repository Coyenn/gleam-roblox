...
import roblox/types.{type Actor, type CharacterAppearance, type Color3, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ShirtGraphic, type UniqueId}

/// Creates a new Roblox `ShirtGraphic` instance.
///
/// Roblox: `Instance.new("ShirtGraphic")`
@target(luau)
@luau.global("Instance.new(\"ShirtGraphic\")")
...
pub fn set_parent(instance: ShirtGraphic, value: parent) -> ShirtGraphic
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ShirtGraphic) -> Nil
...
pub fn get_attribute_changed_signal(instance: ShirtGraphic, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ShirtGraphic, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ShirtGraphic) -> List(String)
...
pub fn wait_for_child(instance: ShirtGraphic, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ShirtGraphic) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ShirtGraphic, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ShirtGraphic) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ShirtGraphic, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ShirtGraphic) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ShirtGraphic, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ShirtGraphic) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ShirtGraphic, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ShirtGraphic) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ShirtGraphic, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ShirtGraphic) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ShirtGraphic, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ShirtGraphic) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ShirtGraphic, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ShirtGraphic) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ShirtGraphic, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ShirtGraphic, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ShirtGraphic) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ShirtGraphic, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ContentId, _: Color3, _: ShirtGraphic, _: CharacterAppearance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}