...
import roblox/types.{type Actor, type DataStoreInfo, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: DataStoreInfo, value: parent) -> DataStoreInfo
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStoreInfo) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStoreInfo, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStoreInfo, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStoreInfo) -> List(String)
...
pub fn wait_for_child(instance: DataStoreInfo, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStoreInfo) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStoreInfo, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStoreInfo) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStoreInfo, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStoreInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStoreInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStoreInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStoreInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStoreInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStoreInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStoreInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStoreInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStoreInfo) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStoreInfo, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStoreInfo) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStoreInfo, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStoreInfo, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStoreInfo) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStoreInfo, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreInfo, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}