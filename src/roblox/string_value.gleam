...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StringValue, type UniqueId, type ValueBase}

/// Creates a new Roblox `StringValue` instance.
///
/// Roblox: `Instance.new("StringValue")`
@target(luau)
@luau.global("Instance.new(\"StringValue\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StringValue) -> RBXScriptSignal(fn(String) -> Nil)

/// Connects to Roblox event `StringValue.Changed`.
///
/// Fires whenever StringValue.Value is changed.
///
/// Roblox: `StringValue.Changed`
...
pub fn on_changed(instance: StringValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: StringValue, value: parent) -> StringValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StringValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: StringValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StringValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StringValue) -> List(String)
...
pub fn wait_for_child(instance: StringValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StringValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StringValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StringValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StringValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StringValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StringValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StringValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StringValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StringValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StringValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}