...
import roblox/types.{
  ...
  type HashAlgorithm, type Instance, type Object, type OptionDouble,
  type OptionInt, type OptionInt64, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_decompressed_buffer_size(
  instance: EncodingService,
  input: Buffer,
  algorithm: CompressionAlgorithm,
) -> OptionInt
