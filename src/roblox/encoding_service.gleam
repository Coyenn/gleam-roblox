...
import roblox/types.{type Actor, type Buffer, type CompressionAlgorithm, type EncodingService, type HashAlgorithm, type Instance, type Object, type OptionDouble, type OptionInt, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: EncodingService, value: parent) -> EncodingService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: EncodingService) -> Nil
...
pub fn get_attribute_changed_signal(instance: EncodingService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: EncodingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: EncodingService) -> List(String)
...
pub fn wait_for_child(instance: EncodingService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: EncodingService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: EncodingService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: EncodingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: EncodingService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: EncodingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: EncodingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: EncodingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: EncodingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: EncodingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: EncodingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: EncodingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: EncodingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: EncodingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: EncodingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: EncodingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: EncodingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: EncodingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: EncodingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: EncodingService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: OptionInt, _: Buffer, _: CompressionAlgorithm, _: HashAlgorithm, _: EncodingService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}