...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PackageService, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PackageService, value: parent) -> PackageService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PackageService) -> Nil
...
pub fn get_attribute_changed_signal(instance: PackageService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PackageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PackageService) -> List(String)
...
pub fn wait_for_child(instance: PackageService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PackageService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PackageService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PackageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PackageService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PackageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PackageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PackageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PackageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PackageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PackageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PackageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PackageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PackageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PackageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PackageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PackageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PackageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PackageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PackageService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PackageService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}