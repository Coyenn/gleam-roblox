...
import roblox/types.{type Actor, type ForceField, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ForceField` instance.
///
/// Roblox: `Instance.new("ForceField")`
@target(luau)
@luau.global("Instance.new(\"ForceField\")")
...
pub fn set_parent(instance: ForceField, value: parent) -> ForceField
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ForceField) -> Nil
...
pub fn get_attribute_changed_signal(instance: ForceField, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ForceField, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ForceField) -> List(String)
...
pub fn wait_for_child(instance: ForceField, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ForceField) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ForceField, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ForceField) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ForceField, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ForceField) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ForceField, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ForceField) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ForceField, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ForceField) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ForceField, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ForceField) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ForceField, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ForceField) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ForceField, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ForceField) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ForceField, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ForceField, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ForceField) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ForceField, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ForceField, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}