...
import roblox/types.{type Actor, type BindableEvent, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `BindableEvent` instance.
///
/// Roblox: `Instance.new("BindableEvent")`
@target(luau)
@luau.global("Instance.new(\"BindableEvent\")")
pub fn new() -> BindableEvent
...
@target(luau)
@luau.event("Event")
pub fn event(instance: BindableEvent) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `BindableEvent.Event`.
///
/// Fires when any script calls the Fire() method on the same BindableEvent instance.
///
/// Roblox: `BindableEvent.Event`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/BindableEvent#Event
@target(luau)
@luau.global("(function(instance, callback) return instance.Event:Connect(callback) end)")
pub fn on_event(instance: BindableEvent, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BindableEvent, value: parent) -> BindableEvent
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BindableEvent) -> Nil
...
pub fn get_attribute_changed_signal(instance: BindableEvent, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BindableEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BindableEvent) -> List(String)
...
pub fn wait_for_child(instance: BindableEvent, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BindableEvent) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BindableEvent, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BindableEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BindableEvent, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BindableEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BindableEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BindableEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BindableEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BindableEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BindableEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BindableEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BindableEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BindableEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BindableEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BindableEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BindableEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BindableEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BindableEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BindableEvent, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BindableEvent, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}