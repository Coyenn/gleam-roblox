...
import roblox/types.{type Actor, type AudioDeviceOutput, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioDeviceOutput` instance.
///
/// Roblox: `Instance.new("AudioDeviceOutput")`
@target(luau)
@luau.global("Instance.new(\"AudioDeviceOutput\")")
pub fn new() -> AudioDeviceOutput
...
pub fn get_input_pins(instance: AudioDeviceOutput) -> List(String)
...
pub fn get_output_pins(instance: AudioDeviceOutput) -> List(String)
...
pub fn wiring_changed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioDeviceOutput.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioDeviceOutput via a Wire.
///
/// Roblox: `AudioDeviceOutput.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioDeviceOutput, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioDeviceOutput, value: parent) -> AudioDeviceOutput
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioDeviceOutput) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioDeviceOutput, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioDeviceOutput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioDeviceOutput) -> List(String)
...
pub fn wait_for_child(instance: AudioDeviceOutput, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioDeviceOutput, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioDeviceOutput, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioDeviceOutput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioDeviceOutput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioDeviceOutput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioDeviceOutput, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioDeviceOutput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioDeviceOutput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioDeviceOutput, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioDeviceOutput, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioDeviceOutput) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioDeviceOutput, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: Player, _: AudioDeviceOutput, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}