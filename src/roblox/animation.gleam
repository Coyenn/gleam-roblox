...
import roblox/types.{type Actor, type Animation, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Animation` instance.
///
/// Roblox: `Instance.new("Animation")`
@target(luau)
@luau.global("Instance.new(\"Animation\")")
...
pub fn set_parent(instance: Animation, value: parent) -> Animation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Animation) -> Nil
...
pub fn get_attribute_changed_signal(instance: Animation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Animation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Animation) -> List(String)
...
pub fn wait_for_child(instance: Animation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Animation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Animation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Animation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Animation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Animation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Animation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Animation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Animation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Animation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Animation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Animation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Animation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Animation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Animation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Animation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Animation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Animation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Animation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Animation, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ContentId, _: Animation, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}