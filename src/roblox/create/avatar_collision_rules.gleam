...
import roblox/types.{
  type AvatarCollisionRules, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(AvatarCollisionRules)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(AvatarCollisionRules) {
  Property(fn(instance) {
    avatar_collision_rules.set_archivable(instance, value)
  })
}
...
) -> Property(AvatarCollisionRules) {
  Property(fn(instance) {
    avatar_collision_rules.set_capabilities(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(AvatarCollisionRules) {
  Property(fn(instance) {
    avatar_collision_rules.set_sandboxed(instance, value)
  })
}
