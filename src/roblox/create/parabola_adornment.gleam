...
import roblox/parabola_adornment
import roblox/types.{
  type Color3, type Instance, type PVInstance, type ParabolaAdornment,
...
pub fn node(
  properties: List(Property(ParabolaAdornment)),
  children: List(Node),
) -> Node {
