...
import roblox/types.{
  ...
  type SecurityCapabilities, type SortOrder, type StartCorner, type UDim2,
  type UIGridLayout, type VerticalAlignment,
}
import roblox/ui_grid_layout
...
pub fn node(
  properties: List(Property(UIGridLayout)),
  children: List(Node),
) -> Node {
...
pub fn fill_direction_max_cells(value: Int) -> Property(UIGridLayout) {
  Property(fn(instance) {
    ui_grid_layout.set_fill_direction_max_cells(instance, value)
  })
}
...
) -> Property(UIGridLayout) {
  Property(fn(instance) {
    ui_grid_layout.set_horizontal_alignment(instance, value)
  })
}
...
pub fn vertical_alignment(value: VerticalAlignment) -> Property(UIGridLayout) {
  Property(fn(instance) {
    ui_grid_layout.set_vertical_alignment(instance, value)
  })
}
