...
import roblox/types.{
  type BillboardGui, type Instance, type LocalizationTable,
  type SecurityCapabilities, type SelectionBehavior, type UDim2, type Vector2,
  type Vector3, type ZIndexBehavior,
}
...
pub fn node(
  properties: List(Property(BillboardGui)),
  children: List(Node),
) -> Node {
...
pub fn extents_offset_world_space(value: Vector3) -> Property(BillboardGui) {
  Property(fn(instance) {
    billboard_gui.set_extents_offset_world_space(instance, value)
  })
}
...
pub fn player_to_hide_from(value: Instance) -> Property(BillboardGui) {
  Property(fn(instance) {
    billboard_gui.set_player_to_hide_from(instance, value)
  })
}
...
pub fn studs_offset_world_space(value: Vector3) -> Property(BillboardGui) {
  Property(fn(instance) {
    billboard_gui.set_studs_offset_world_space(instance, value)
  })
}
...
) -> Property(BillboardGui) {
  Property(fn(instance) {
    billboard_gui.set_root_localization_table(instance, value)
  })
}
...
pub fn selection_behavior_down(
  ...
  Property(fn(instance) {
    billboard_gui.set_selection_behavior_down(instance, value)
  })
}
...
pub fn selection_behavior_left(
  ...
  Property(fn(instance) {
    billboard_gui.set_selection_behavior_left(instance, value)
  })
}
...
pub fn selection_behavior_right(
  ...
  Property(fn(instance) {
    billboard_gui.set_selection_behavior_right(instance, value)
  })
}
...
pub fn selection_behavior_up(
  ...
  Property(fn(instance) {
    billboard_gui.set_selection_behavior_up(instance, value)
  })
}
