...
import roblox/types.{type AdornCullingMode, type AdornShading, type BoxHandleAdornment, type CFrame, type Color3, type Instance, type PVInstance, type SecurityCapabilities, type Vector3}
