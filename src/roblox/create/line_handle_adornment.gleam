...
import roblox/line_handle_adornment
import roblox/types.{
  type AdornCullingMode, type CFrame, type Color3, type Instance,
  type LineHandleAdornment, type PVInstance, type SecurityCapabilities,
  type Vector3,
}
...
pub fn node(
  properties: List(Property(LineHandleAdornment)),
  children: List(Node),
) -> Node {
...
) -> Property(LineHandleAdornment) {
  Property(fn(instance) {
    line_handle_adornment.set_adorn_culling_mode(instance, value)
  })
}
...
pub fn always_on_top(value: Bool) -> Property(LineHandleAdornment) {
  Property(fn(instance) {
    line_handle_adornment.set_always_on_top(instance, value)
  })
}
...
pub fn size_relative_offset(value: Vector3) -> Property(LineHandleAdornment) {
  Property(fn(instance) {
    line_handle_adornment.set_size_relative_offset(instance, value)
  })
}
...
pub fn transparency(value: Float) -> Property(LineHandleAdornment) {
  Property(fn(instance) {
    line_handle_adornment.set_transparency(instance, value)
  })
}
...
pub fn archivable(value: Bool) -> Property(LineHandleAdornment) {
  Property(fn(instance) {
    line_handle_adornment.set_archivable(instance, value)
  })
}
...
pub fn capabilities(
  ...
  Property(fn(instance) {
    line_handle_adornment.set_capabilities(instance, value)
  })
}
