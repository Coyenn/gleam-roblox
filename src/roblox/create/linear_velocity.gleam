...
import roblox/linear_velocity
import roblox/types.{
  type ActuatorRelativeTo, type Attachment, type BrickColor, type ForceLimitMode,
  type Instance, type LinearVelocity, type SecurityCapabilities, type Vector2,
...
pub fn node(
  properties: List(Property(LinearVelocity)),
  children: List(Node),
) -> Node {
...
pub fn force_limit_mode(value: ForceLimitMode) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_force_limit_mode(instance, value)
  })
}
...
pub fn force_limits_enabled(value: Bool) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_force_limits_enabled(instance, value)
  })
}
...
pub fn max_planar_axes_force(value: Vector2) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_max_planar_axes_force(instance, value)
  })
}
...
pub fn primary_tangent_axis(value: Vector3) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_primary_tangent_axis(instance, value)
  })
}
...
pub fn reaction_force_enabled(value: Bool) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_reaction_force_enabled(instance, value)
  })
}
...
pub fn secondary_tangent_axis(value: Vector3) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_secondary_tangent_axis(instance, value)
  })
}
...
pub fn velocity_constraint_mode(
  value: VelocityConstraintMode,
) -> Property(LinearVelocity) {
  Property(fn(instance) {
    linear_velocity.set_velocity_constraint_mode(instance, value)
  })
}
