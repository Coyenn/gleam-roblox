...
import roblox/types.{
  type HumanoidController, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(HumanoidController)),
  children: List(Node),
) -> Node {
...
) -> Property(HumanoidController) {
  Property(fn(instance) {
    humanoid_controller.set_capabilities(instance, value)
  })
}
