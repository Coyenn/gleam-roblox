...
import roblox/reflection_metadata_callbacks
import roblox/types.{
  type Instance, type ReflectionMetadataCallbacks, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(ReflectionMetadataCallbacks)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(ReflectionMetadataCallbacks) {
  Property(fn(instance) {
    reflection_metadata_callbacks.set_archivable(instance, value)
  })
}
...
) -> Property(ReflectionMetadataCallbacks) {
  Property(fn(instance) {
    reflection_metadata_callbacks.set_capabilities(instance, value)
  })
}
...
pub fn name(value: String) -> Property(ReflectionMetadataCallbacks) {
  Property(fn(instance) {
    reflection_metadata_callbacks.set_name(instance, value)
  })
}
...
pub fn parent(value: Instance) -> Property(ReflectionMetadataCallbacks) {
  Property(fn(instance) {
    reflection_metadata_callbacks.set_parent(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(ReflectionMetadataCallbacks) {
  Property(fn(instance) {
    reflection_metadata_callbacks.set_sandboxed(instance, value)
  })
}
