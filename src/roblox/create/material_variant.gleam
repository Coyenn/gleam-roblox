...
import roblox/types.{type AlphaMode, type Color3, type Instance, type MaterialPattern, type MaterialVariant, type PhysicalProperties, type SecurityCapabilities}
