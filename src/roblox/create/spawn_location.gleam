...
import roblox/types.{type BrickColor, type CFrame, type Color3, type Instance, type Material, type PartType, type PhysicalProperties, type SecurityCapabilities, type SpawnLocation, type SurfaceType, type Vector3}
