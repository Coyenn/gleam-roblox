...
import roblox/relative_gui
import roblox/types.{
  type AutomaticSize, type BorderMode, type Color3, type GuiObject,
  type InputSink, type Instance, type LocalizationTable, type RelativeGui,
...
pub fn node(
  properties: List(Property(RelativeGui)),
  children: List(Node),
) -> Node {
...
pub fn background_transparency(value: Float) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_background_transparency(instance, value)
  })
}
...
pub fn next_selection_down(value: GuiObject) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_next_selection_down(instance, value)
  })
}
...
pub fn next_selection_left(value: GuiObject) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_next_selection_left(instance, value)
  })
}
...
pub fn next_selection_right(value: GuiObject) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_next_selection_right(instance, value)
  })
}
...
pub fn selection_image_object(value: GuiObject) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_selection_image_object(instance, value)
  })
}
...
) -> Property(RelativeGui) {
  Property(fn(instance) {
    relative_gui.set_root_localization_table(instance, value)
  })
}
...
pub fn selection_behavior_down(
  ...
  Property(fn(instance) {
    relative_gui.set_selection_behavior_down(instance, value)
  })
}
...
pub fn selection_behavior_left(
  ...
  Property(fn(instance) {
    relative_gui.set_selection_behavior_left(instance, value)
  })
}
...
pub fn selection_behavior_right(
  ...
  Property(fn(instance) {
    relative_gui.set_selection_behavior_right(instance, value)
  })
}
...
pub fn selection_behavior_up(
  ...
  Property(fn(instance) {
    relative_gui.set_selection_behavior_up(instance, value)
  })
}
