...
import roblox/types.{type AutomaticSize, type BorderMode, type Color3, type GuiObject, type InputSink, type Instance, type LocalizationTable, type RelativeGui, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type UDim2, type Vector2}
