...
import roblox/types.{
  type ColorGradingEffect, type Instance, type SecurityCapabilities,
...
pub fn node(
  properties: List(Property(ColorGradingEffect)),
  children: List(Node),
) -> Node {
...
pub fn tonemapper_preset(
  value: TonemapperPreset,
) -> Property(ColorGradingEffect) {
  Property(fn(instance) {
    color_grading_effect.set_tonemapper_preset(instance, value)
  })
}
...
pub fn capabilities(
  ...
  Property(fn(instance) {
    color_grading_effect.set_capabilities(instance, value)
  })
}
