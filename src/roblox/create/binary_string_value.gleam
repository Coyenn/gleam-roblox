...
import roblox/binary_string_value
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type BinaryStringValue, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(BinaryStringValue)),
  children: List(Node),
) -> Node {
...
) -> Property(BinaryStringValue) {
  Property(fn(instance) {
    binary_string_value.set_capabilities(instance, value)
  })
}
