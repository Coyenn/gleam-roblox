...
import roblox/types.{
  type AvatarAccessoryRules, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(AvatarAccessoryRules)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(AvatarAccessoryRules) {
  Property(fn(instance) {
    avatar_accessory_rules.set_archivable(instance, value)
  })
}
...
) -> Property(AvatarAccessoryRules) {
  Property(fn(instance) {
    avatar_accessory_rules.set_capabilities(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(AvatarAccessoryRules) {
  Property(fn(instance) {
    avatar_accessory_rules.set_sandboxed(instance, value)
  })
}
