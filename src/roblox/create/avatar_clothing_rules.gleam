...
import roblox/types.{
  type AvatarClothingRules, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(AvatarClothingRules)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(AvatarClothingRules) {
  Property(fn(instance) {
    avatar_clothing_rules.set_archivable(instance, value)
  })
}
...
) -> Property(AvatarClothingRules) {
  Property(fn(instance) {
    avatar_clothing_rules.set_capabilities(instance, value)
  })
}
