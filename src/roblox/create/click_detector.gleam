...
import roblox/click_detector
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type ClickDetector, type Content, type ContentId, type Instance,
...
pub fn node(
  properties: List(Property(ClickDetector)),
  children: List(Node),
) -> Node {
...
pub fn cursor_icon_content(value: Content) -> Property(ClickDetector) {
  Property(fn(instance) {
    click_detector.set_cursor_icon_content(instance, value)
  })
}
...
pub fn max_activation_distance(value: Float) -> Property(ClickDetector) {
  Property(fn(instance) {
    click_detector.set_max_activation_distance(instance, value)
  })
}
