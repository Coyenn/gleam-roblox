...
import roblox/types.{type ApplyStrokeMode, type BorderStrokePosition, type Color3, type Instance, type LineJoinMode, type SecurityCapabilities, type StrokeSizingMode, type UDim, type UIStroke}
