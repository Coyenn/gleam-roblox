...
import roblox/swim_controller
import roblox/types.{
  type Instance, type SecurityCapabilities, type SwimController,
}
...
pub fn node(
  properties: List(Property(SwimController)),
  children: List(Node),
) -> Node {
...
pub fn acceleration_time(value: Float) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_acceleration_time(instance, value)
  })
}
...
pub fn pitch_max_torque(value: Float) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_pitch_max_torque(instance, value)
  })
}
...
pub fn pitch_speed_factor(value: Float) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_pitch_speed_factor(instance, value)
  })
}
...
pub fn roll_speed_factor(value: Float) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_roll_speed_factor(instance, value)
  })
}
...
pub fn balance_rigidity_enabled(value: Bool) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_balance_rigidity_enabled(instance, value)
  })
}
...
pub fn move_speed_factor(value: Float) -> Property(SwimController) {
  Property(fn(instance) {
    swim_controller.set_move_speed_factor(instance, value)
  })
}
