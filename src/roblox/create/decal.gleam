...
import roblox/decal
import roblox/types.{
  type Color3, type Content, type ContentId, type Decal, type Instance,
  type NormalId, type SecurityCapabilities, type Vector2,
}
...
pub fn local_transparency_modifier(value: Float) -> Property(Decal) {
  Property(fn(instance) {
    decal.set_local_transparency_modifier(instance, value)
  })
}
