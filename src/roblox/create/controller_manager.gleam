...
import roblox/types.{type BasePart, type ControllerBase, type ControllerManager, type ControllerSensor, type Instance, type SecurityCapabilities, type Vector3}
