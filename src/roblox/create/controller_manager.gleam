...
import roblox/controller_manager
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type BasePart, type ControllerBase, type ControllerManager,
  type ControllerSensor, type Instance, type SecurityCapabilities, type Vector3,
}
...
pub fn node(
  properties: List(Property(ControllerManager)),
  children: List(Node),
) -> Node {
...
pub fn active_controller(value: ControllerBase) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_active_controller(instance, value)
  })
}
...
pub fn base_move_speed(value: Float) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_base_move_speed(instance, value)
  })
}
...
pub fn base_turn_speed(value: Float) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_base_turn_speed(instance, value)
  })
}
...
pub fn facing_direction(value: Vector3) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_facing_direction(instance, value)
  })
}
...
pub fn ground_sensor(value: ControllerSensor) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_ground_sensor(instance, value)
  })
}
...
pub fn moving_direction(value: Vector3) -> Property(ControllerManager) {
  Property(fn(instance) {
    controller_manager.set_moving_direction(instance, value)
  })
}
