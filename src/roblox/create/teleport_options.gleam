...
import roblox/teleport_options
import roblox/types.{
  type Instance, type SecurityCapabilities, type TeleportOptions,
}
...
pub fn node(
  properties: List(Property(TeleportOptions)),
  children: List(Node),
) -> Node {
...
pub fn reserved_server_access_code(value: String) -> Property(TeleportOptions) {
  Property(fn(instance) {
    teleport_options.set_reserved_server_access_code(instance, value)
  })
}
...
pub fn server_instance_id(value: String) -> Property(TeleportOptions) {
  Property(fn(instance) {
    teleport_options.set_server_instance_id(instance, value)
  })
}
...
pub fn should_reserve_server(value: Bool) -> Property(TeleportOptions) {
  Property(fn(instance) {
    teleport_options.set_should_reserve_server(instance, value)
  })
}
