...
import roblox/reflection_metadata_classes
import roblox/types.{
  type Instance, type ReflectionMetadataClasses, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(ReflectionMetadataClasses)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(ReflectionMetadataClasses) {
  Property(fn(instance) {
    reflection_metadata_classes.set_archivable(instance, value)
  })
}
...
) -> Property(ReflectionMetadataClasses) {
  Property(fn(instance) {
    reflection_metadata_classes.set_capabilities(instance, value)
  })
}
...
pub fn name(value: String) -> Property(ReflectionMetadataClasses) {
  Property(fn(instance) {
    reflection_metadata_classes.set_name(instance, value)
  })
}
...
pub fn parent(value: Instance) -> Property(ReflectionMetadataClasses) {
  Property(fn(instance) {
    reflection_metadata_classes.set_parent(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(ReflectionMetadataClasses) {
  Property(fn(instance) {
    reflection_metadata_classes.set_sandboxed(instance, value)
  })
}
