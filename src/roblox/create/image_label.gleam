...
import roblox/types.{
  ...
  type GuiObject, type ImageLabel, type InputSink, type Instance,
  type LocalizationTable, type Rect, type ResamplerMode, type ScaleType,
...
pub fn node(
  properties: List(Property(ImageLabel)),
  children: List(Node),
) -> Node {
...
pub fn background_transparency(value: Float) -> Property(ImageLabel) {
  Property(fn(instance) {
    image_label.set_background_transparency(instance, value)
  })
}
...
pub fn next_selection_right(value: GuiObject) -> Property(ImageLabel) {
  Property(fn(instance) {
    image_label.set_next_selection_right(instance, value)
  })
}
...
pub fn selection_image_object(value: GuiObject) -> Property(ImageLabel) {
  Property(fn(instance) {
    image_label.set_selection_image_object(instance, value)
  })
}
...
pub fn root_localization_table(
  ...
  Property(fn(instance) {
    image_label.set_root_localization_table(instance, value)
  })
}
...
pub fn selection_behavior_down(
  ...
  Property(fn(instance) {
    image_label.set_selection_behavior_down(instance, value)
  })
}
...
pub fn selection_behavior_left(
  ...
  Property(fn(instance) {
    image_label.set_selection_behavior_left(instance, value)
  })
}
...
pub fn selection_behavior_right(
  ...
  Property(fn(instance) {
    image_label.set_selection_behavior_right(instance, value)
  })
}
...
pub fn selection_behavior_up(value: SelectionBehavior) -> Property(ImageLabel) {
  Property(fn(instance) {
    image_label.set_selection_behavior_up(instance, value)
  })
}
