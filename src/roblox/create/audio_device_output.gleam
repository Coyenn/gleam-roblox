...
import roblox/types.{
  type AudioDeviceOutput, type Instance, type Player, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(AudioDeviceOutput)),
  children: List(Node),
) -> Node {
...
) -> Property(AudioDeviceOutput) {
  Property(fn(instance) {
    audio_device_output.set_capabilities(instance, value)
  })
}
