...
import roblox/types.{
  type AnimationConstraint, type Attachment, type BrickColor, type CFrame,
...
pub fn node(
  properties: List(Property(AnimationConstraint)),
  children: List(Node),
) -> Node {
...
pub fn is_kinematic(value: Bool) -> Property(AnimationConstraint) {
  Property(fn(instance) {
    animation_constraint.set_is_kinematic(instance, value)
  })
}
...
pub fn attachment0(value: Attachment) -> Property(AnimationConstraint) {
  Property(fn(instance) {
    animation_constraint.set_attachment0(instance, value)
  })
}
...
pub fn attachment1(value: Attachment) -> Property(AnimationConstraint) {
  Property(fn(instance) {
    animation_constraint.set_attachment1(instance, value)
  })
}
...
pub fn capabilities(
  ...
  Property(fn(instance) {
    animation_constraint.set_capabilities(instance, value)
  })
}
