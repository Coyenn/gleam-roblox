...
import roblox/types.{
  type FillDirection, type HorizontalAlignment, type Instance,
  type SecurityCapabilities, type SortOrder, type TableMajorAxis, type UDim2,
  type UITableLayout, type VerticalAlignment,
}
...
pub fn node(
  properties: List(Property(UITableLayout)),
  children: List(Node),
) -> Node {
...
pub fn fill_empty_space_columns(value: Bool) -> Property(UITableLayout) {
  Property(fn(instance) {
    ui_table_layout.set_fill_empty_space_columns(instance, value)
  })
}
...
pub fn fill_empty_space_rows(value: Bool) -> Property(UITableLayout) {
  Property(fn(instance) {
    ui_table_layout.set_fill_empty_space_rows(instance, value)
  })
}
...
) -> Property(UITableLayout) {
  Property(fn(instance) {
    ui_table_layout.set_horizontal_alignment(instance, value)
  })
}
...
pub fn vertical_alignment(value: VerticalAlignment) -> Property(UITableLayout) {
  Property(fn(instance) {
    ui_table_layout.set_vertical_alignment(instance, value)
  })
}
