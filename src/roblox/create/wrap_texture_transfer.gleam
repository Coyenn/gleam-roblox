...
import roblox/types.{
  type Content, type Instance, type SecurityCapabilities, type Vector2,
  type WrapTextureTransfer,
}
import roblox/wrap_texture_transfer
...
pub fn node(
  properties: List(Property(WrapTextureTransfer)),
  children: List(Node),
) -> Node {
...
pub fn reference_cage_mesh_content(
  value: Content,
) -> Property(WrapTextureTransfer) {
  Property(fn(instance) {
    wrap_texture_transfer.set_reference_cage_mesh_content(instance, value)
  })
}
...
pub fn uv_max_bound(value: Vector2) -> Property(WrapTextureTransfer) {
  Property(fn(instance) {
    wrap_texture_transfer.set_uv_max_bound(instance, value)
  })
}
...
pub fn uv_min_bound(value: Vector2) -> Property(WrapTextureTransfer) {
  Property(fn(instance) {
    wrap_texture_transfer.set_uv_min_bound(instance, value)
  })
}
...
pub fn archivable(value: Bool) -> Property(WrapTextureTransfer) {
  Property(fn(instance) {
    wrap_texture_transfer.set_archivable(instance, value)
  })
}
...
pub fn capabilities(
  ...
  Property(fn(instance) {
    wrap_texture_transfer.set_capabilities(instance, value)
  })
}
