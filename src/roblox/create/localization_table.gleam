...
import roblox/localization_table
import roblox/types.{
  type Instance, type LocalizationTable, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(LocalizationTable)),
  children: List(Node),
) -> Node {
...
pub fn source_locale_id(value: String) -> Property(LocalizationTable) {
  Property(fn(instance) {
    localization_table.set_source_locale_id(instance, value)
  })
}
