...
import roblox/dialog_choice
import roblox/types.{type DialogChoice, type Instance, type SecurityCapabilities}
...
pub fn node(
  properties: List(Property(DialogChoice)),
  children: List(Node),
) -> Node {
...
pub fn goodbye_choice_active(value: Bool) -> Property(DialogChoice) {
  Property(fn(instance) {
    dialog_choice.set_goodbye_choice_active(instance, value)
  })
}
