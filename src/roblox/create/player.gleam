...
import roblox/types.{type BrickColor, type CameraMode, type DevCameraOcclusionMode, type DevComputerCameraMovementMode, type DevComputerMovementMode, type DevTouchCameraMovementMode, type DevTouchMovementMode, type Instance, type Model, type OptionInt64, type Player, type SecurityCapabilities, type SpawnLocation, type Team}
...
pub fn can_load_character_appearance(value: Bool) -> Property(Player) {
  Property(fn(instance) { player.set_can_load_character_appearance(instance, value) })
}
...
@target(luau)
pub fn dev_camera_occlusion_mode(value: DevCameraOcclusionMode) -> Property(Player) {
  Property(fn(instance) { player.set_dev_camera_occlusion_mode(instance, value) })
}
...
@target(luau)
pub fn dev_computer_camera_mode(value: DevComputerCameraMovementMode) -> Property(Player) {
...
@target(luau)
pub fn dev_computer_movement_mode(value: DevComputerMovementMode) -> Property(Player) {
  Property(fn(instance) { player.set_dev_computer_movement_mode(instance, value) })
}
...
@target(luau)
pub fn dev_touch_camera_mode(value: DevTouchCameraMovementMode) -> Property(Player) {
...
@target(luau)
pub fn dev_touch_movement_mode(value: DevTouchMovementMode) -> Property(Player) {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: OptionInt64, _: BrickColor, _: Team, _: SpawnLocation, _: DevTouchMovementMode, _: DevTouchCameraMovementMode, _: DevComputerMovementMode, _: DevComputerCameraMovementMode, _: DevCameraOcclusionMode, _: Model, _: CameraMode, _: Player) -> Nil {
  Nil
}