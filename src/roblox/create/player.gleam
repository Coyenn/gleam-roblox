...
import roblox/types.{
  ...
  type Model, type Player, type SecurityCapabilities, type SpawnLocation,
  type Team,
}
...
pub fn character_appearance_id(value: Int) -> Property(Player) {
...
pub fn user_id(value: Int) -> Property(Player) {
