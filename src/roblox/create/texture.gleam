...
import roblox/types.{type Color3, type Content, type ContentId, type Instance, type NormalId, type SecurityCapabilities, type Texture, type Vector2}
...
pub fn local_transparency_modifier(value: Float) -> Property(Texture) {
  Property(fn(instance) { texture.set_local_transparency_modifier(instance, value) })
}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: NormalId, _: Vector2, _: Content, _: ContentId, _: Color3, _: Texture) -> Nil {
  Nil
}