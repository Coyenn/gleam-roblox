...
import roblox/types.{type AutomaticSize, type BorderMode, type Camera, type Color3, type GuiObject, type InputSink, type Instance, type LocalizationTable, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type UDim2, type Vector2, type Vector3, type ViewportFrame}
