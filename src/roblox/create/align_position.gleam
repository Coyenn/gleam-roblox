...
import roblox/types.{
  type ActuatorRelativeTo, type AlignPosition, type Attachment, type BrickColor,
  type ForceLimitMode, type Instance, type PositionAlignmentMode,
...
pub fn node(
  properties: List(Property(AlignPosition)),
  children: List(Node),
) -> Node {
...
pub fn apply_at_center_of_mass(value: Bool) -> Property(AlignPosition) {
  Property(fn(instance) {
    align_position.set_apply_at_center_of_mass(instance, value)
  })
}
...
pub fn force_relative_to(value: ActuatorRelativeTo) -> Property(AlignPosition) {
  Property(fn(instance) {
    align_position.set_force_relative_to(instance, value)
  })
}
...
pub fn reaction_force_enabled(value: Bool) -> Property(AlignPosition) {
  Property(fn(instance) {
    align_position.set_reaction_force_enabled(instance, value)
  })
}
