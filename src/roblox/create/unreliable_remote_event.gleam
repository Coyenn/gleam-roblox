...
import roblox/types.{
  type Instance, type SecurityCapabilities, type UnreliableRemoteEvent,
}
import roblox/unreliable_remote_event
...
pub fn node(
  properties: List(Property(UnreliableRemoteEvent)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(UnreliableRemoteEvent) {
  Property(fn(instance) {
    unreliable_remote_event.set_archivable(instance, value)
  })
}
...
) -> Property(UnreliableRemoteEvent) {
  Property(fn(instance) {
    unreliable_remote_event.set_capabilities(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(UnreliableRemoteEvent) {
  Property(fn(instance) {
    unreliable_remote_event.set_sandboxed(instance, value)
  })
}
