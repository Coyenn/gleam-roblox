...
import roblox/types.{
  ...
  type ItemLineAlignment, type SecurityCapabilities, type SortOrder, type UDim,
  type UIFlexAlignment, type UIListLayout, type VerticalAlignment,
}
...
pub fn node(
  properties: List(Property(UIListLayout)),
  children: List(Node),
) -> Node {
...
pub fn item_line_alignment(value: ItemLineAlignment) -> Property(UIListLayout) {
  Property(fn(instance) {
    ui_list_layout.set_item_line_alignment(instance, value)
  })
}
...
) -> Property(UIListLayout) {
  Property(fn(instance) {
    ui_list_layout.set_horizontal_alignment(instance, value)
  })
}
...
pub fn vertical_alignment(value: VerticalAlignment) -> Property(UIListLayout) {
  Property(fn(instance) {
    ui_list_layout.set_vertical_alignment(instance, value)
  })
}
