...
import roblox/types.{type Animation, type ContentId, type Instance, type SecurityCapabilities}
...
@target(luau)
pub fn node(properties: List(Property(Animation)), children: List(Node)) -> Node {
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: ContentId, _: Animation) -> Nil {
  Nil
}