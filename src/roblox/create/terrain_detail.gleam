...
import roblox/terrain_detail
import roblox/types.{
  type Color3, type Instance, type MaterialPattern, type SecurityCapabilities,
  type TerrainDetail, type TerrainFace,
}
...
pub fn node(
  properties: List(Property(TerrainDetail)),
  children: List(Node),
) -> Node {
...
pub fn emissive_strength(value: Float) -> Property(TerrainDetail) {
  Property(fn(instance) {
    terrain_detail.set_emissive_strength(instance, value)
  })
}
