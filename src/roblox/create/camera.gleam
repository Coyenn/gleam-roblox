...
import roblox/types.{type CFrame, type Camera, type CameraType, type FieldOfViewMode, type Instance, type SecurityCapabilities}
...
pub fn javascript_type_anchor(_: Instance, _: SecurityCapabilities, _: CFrame, _: FieldOfViewMode, _: CameraType, _: Camera) -> Nil {
  Nil
}