...
import roblox/types.{
  type DataStoreSetOptions, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(DataStoreSetOptions)),
  children: List(Node),
) -> Node {
...
pub fn archivable(value: Bool) -> Property(DataStoreSetOptions) {
  Property(fn(instance) {
    data_store_set_options.set_archivable(instance, value)
  })
}
...
) -> Property(DataStoreSetOptions) {
  Property(fn(instance) {
    data_store_set_options.set_capabilities(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(DataStoreSetOptions) {
  Property(fn(instance) {
    data_store_set_options.set_sandboxed(instance, value)
  })
}
