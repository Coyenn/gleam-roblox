...
import roblox/types.{
  type AlignOrientation, type AlignType, type Attachment, type BrickColor,
  type CFrame, type Instance, type OrientationAlignmentMode,
...
pub fn node(
  properties: List(Property(AlignOrientation)),
  children: List(Node),
) -> Node {
...
pub fn look_at_position(value: Vector3) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_look_at_position(instance, value)
  })
}
...
pub fn max_angular_velocity(value: Float) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_max_angular_velocity(instance, value)
  })
}
...
pub fn primary_axis_only(value: Bool) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_primary_axis_only(instance, value)
  })
}
...
pub fn reaction_torque_enabled(value: Bool) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_reaction_torque_enabled(instance, value)
  })
}
...
pub fn responsiveness(value: Float) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_responsiveness(instance, value)
  })
}
...
pub fn rigidity_enabled(value: Bool) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_rigidity_enabled(instance, value)
  })
}
...
pub fn secondary_axis(value: Vector3) -> Property(AlignOrientation) {
  Property(fn(instance) {
    align_orientation.set_secondary_axis(instance, value)
  })
}
