...
import roblox/hinge_constraint
import roblox/types.{
  type ActuatorType, type Attachment, type BrickColor, type HingeConstraint,
...
pub fn node(
  properties: List(Property(HingeConstraint)),
  children: List(Node),
) -> Node {
...
pub fn angular_responsiveness(value: Float) -> Property(HingeConstraint) {
  Property(fn(instance) {
    hinge_constraint.set_angular_responsiveness(instance, value)
  })
}
...
pub fn angular_velocity(value: Float) -> Property(HingeConstraint) {
  Property(fn(instance) {
    hinge_constraint.set_angular_velocity(instance, value)
  })
}
...
pub fn motor_max_acceleration(value: Float) -> Property(HingeConstraint) {
  Property(fn(instance) {
    hinge_constraint.set_motor_max_acceleration(instance, value)
  })
}
...
pub fn motor_max_torque(value: Float) -> Property(HingeConstraint) {
  Property(fn(instance) {
    hinge_constraint.set_motor_max_torque(instance, value)
  })
}
...
pub fn servo_max_torque(value: Float) -> Property(HingeConstraint) {
  Property(fn(instance) {
    hinge_constraint.set_servo_max_torque(instance, value)
  })
}
