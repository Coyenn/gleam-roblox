...
import roblox/animation_controller
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type AnimationController, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(AnimationController)),
  children: List(Node),
) -> Node {
...
pub fn capabilities(
  ...
  Property(fn(instance) {
    animation_controller.set_capabilities(instance, value)
  })
}
