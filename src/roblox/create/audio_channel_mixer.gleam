...
import roblox/audio_channel_mixer
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type AudioChannelLayout, type AudioChannelMixer, type Instance,
...
pub fn node(
  properties: List(Property(AudioChannelMixer)),
  children: List(Node),
) -> Node {
...
) -> Property(AudioChannelMixer) {
  Property(fn(instance) {
    audio_channel_mixer.set_capabilities(instance, value)
  })
}
