...
pub fn node(
  properties: List(Property(TextLabel)),
  children: List(Node),
) -> Node {
...
pub fn max_visible_graphemes(value: Int) -> Property(TextLabel) {
  Property(fn(instance) {
    text_label.set_max_visible_graphemes(instance, value)
  })
}
...
pub fn text_stroke_transparency(value: Float) -> Property(TextLabel) {
  Property(fn(instance) {
    text_label.set_text_stroke_transparency(instance, value)
  })
}
...
pub fn background_transparency(value: Float) -> Property(TextLabel) {
  Property(fn(instance) {
    text_label.set_background_transparency(instance, value)
  })
}
...
pub fn selection_image_object(value: GuiObject) -> Property(TextLabel) {
  Property(fn(instance) {
    text_label.set_selection_image_object(instance, value)
  })
}
...
pub fn root_localization_table(
  ...
  Property(fn(instance) {
    text_label.set_root_localization_table(instance, value)
  })
}
...
pub fn selection_behavior_down(
  ...
  Property(fn(instance) {
    text_label.set_selection_behavior_down(instance, value)
  })
}
...
pub fn selection_behavior_left(
  ...
  Property(fn(instance) {
    text_label.set_selection_behavior_left(instance, value)
  })
}
...
pub fn selection_behavior_right(
  ...
  Property(fn(instance) {
    text_label.set_selection_behavior_right(instance, value)
  })
}
...
pub fn selection_behavior_up(value: SelectionBehavior) -> Property(TextLabel) {
  Property(fn(instance) {
    text_label.set_selection_behavior_up(instance, value)
  })
}
