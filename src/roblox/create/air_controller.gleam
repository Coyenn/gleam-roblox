...
import roblox/air_controller
import roblox/create.{type Node, type Property, Node, Property, apply}
import roblox/types.{
  type AirController, type Instance, type SecurityCapabilities, type Vector3,
}
...
pub fn node(
  properties: List(Property(AirController)),
  children: List(Node),
) -> Node {
...
pub fn balance_max_torque(value: Float) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_balance_max_torque(instance, value)
  })
}
...
pub fn maintain_angular_momentum(value: Bool) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_maintain_angular_momentum(instance, value)
  })
}
...
pub fn maintain_linear_momentum(value: Bool) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_maintain_linear_momentum(instance, value)
  })
}
...
pub fn turn_speed_factor(value: Float) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_turn_speed_factor(instance, value)
  })
}
...
pub fn balance_rigidity_enabled(value: Bool) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_balance_rigidity_enabled(instance, value)
  })
}
...
pub fn move_speed_factor(value: Float) -> Property(AirController) {
  Property(fn(instance) {
    air_controller.set_move_speed_factor(instance, value)
  })
}
