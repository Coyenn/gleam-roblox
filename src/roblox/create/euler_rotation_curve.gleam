...
import roblox/types.{
  type EulerRotationCurve, type Instance, type RotationOrder,
...
pub fn node(
  properties: List(Property(EulerRotationCurve)),
  children: List(Node),
) -> Node {
...
pub fn rotation_order(value: RotationOrder) -> Property(EulerRotationCurve) {
  Property(fn(instance) {
    euler_rotation_curve.set_rotation_order(instance, value)
  })
}
...
) -> Property(EulerRotationCurve) {
  Property(fn(instance) {
    euler_rotation_curve.set_capabilities(instance, value)
  })
}
