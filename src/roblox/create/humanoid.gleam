...
import roblox/types.{
  type BasePart, type Humanoid, type HumanoidDisplayDistanceType,
  type HumanoidHealthDisplayType, type HumanoidRigType, type Instance,
  type NameOcclusion, type SecurityCapabilities, type Vector3,
}
...
pub fn node(
  properties: List(Property(Humanoid)),
  children: List(Node),
) -> Node {
...
pub fn automatic_scaling_enabled(value: Bool) -> Property(Humanoid) {
  Property(fn(instance) {
    humanoid.set_automatic_scaling_enabled(instance, value)
  })
}
...
pub fn health_display_distance(value: Float) -> Property(Humanoid) {
  Property(fn(instance) {
    humanoid.set_health_display_distance(instance, value)
  })
}
