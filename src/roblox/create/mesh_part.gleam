...
import roblox/types.{type BrickColor, type CFrame, type Color3, type Content, type ContentId, type Instance, type Material, type MeshPart, type PhysicalProperties, type SecurityCapabilities, type SurfaceType, type Vector3}
