...
import roblox/text_button
import roblox/types.{
  type AutomaticSize, type BorderMode, type ButtonStyle, type Color3, type Font,
  type GuiObject, type HapticEffect, type InputSink, type Instance,
  type LocalizationTable, type SecurityCapabilities, type SelectionBehavior,
  type SizeConstraint, type TextButton, type TextDirection, type TextTruncate,
  type TextXAlignment, type TextYAlignment, type UDim2, type Vector2,
}
...
pub fn node(
  properties: List(Property(TextButton)),
  children: List(Node),
) -> Node {
...
pub fn max_visible_graphemes(value: Int) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_max_visible_graphemes(instance, value)
  })
}
...
pub fn text_stroke_transparency(value: Float) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_text_stroke_transparency(instance, value)
  })
}
...
pub fn background_transparency(value: Float) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_background_transparency(instance, value)
  })
}
...
pub fn next_selection_right(value: GuiObject) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_next_selection_right(instance, value)
  })
}
...
pub fn selection_image_object(value: GuiObject) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_selection_image_object(instance, value)
  })
}
...
pub fn root_localization_table(
  ...
  Property(fn(instance) {
    text_button.set_root_localization_table(instance, value)
  })
}
...
pub fn selection_behavior_down(
  ...
  Property(fn(instance) {
    text_button.set_selection_behavior_down(instance, value)
  })
}
...
pub fn selection_behavior_left(
  ...
  Property(fn(instance) {
    text_button.set_selection_behavior_left(instance, value)
  })
}
...
pub fn selection_behavior_right(
  ...
  Property(fn(instance) {
    text_button.set_selection_behavior_right(instance, value)
  })
}
...
pub fn selection_behavior_up(value: SelectionBehavior) -> Property(TextButton) {
  Property(fn(instance) {
    text_button.set_selection_behavior_up(instance, value)
  })
}
