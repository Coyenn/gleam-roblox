...
import roblox/types.{
  type GuiButton, type InputBinding, type Instance, type KeyCode,
...
pub fn node(
  properties: List(Property(InputBinding)),
  children: List(Node),
) -> Node {
...
pub fn clamp_magnitude_to_one(value: Bool) -> Property(InputBinding) {
  Property(fn(instance) {
    input_binding.set_clamp_magnitude_to_one(instance, value)
  })
}
...
pub fn released_threshold(value: Float) -> Property(InputBinding) {
  Property(fn(instance) {
    input_binding.set_released_threshold(instance, value)
  })
}
...
pub fn secondary_modifier(value: KeyCode) -> Property(InputBinding) {
  Property(fn(instance) {
    input_binding.set_secondary_modifier(instance, value)
  })
}
