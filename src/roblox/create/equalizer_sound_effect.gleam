...
import roblox/types.{
  type EqualizerSoundEffect, type Instance, type SecurityCapabilities,
}
...
pub fn node(
  properties: List(Property(EqualizerSoundEffect)),
  children: List(Node),
) -> Node {
...
pub fn high_gain(value: Float) -> Property(EqualizerSoundEffect) {
  Property(fn(instance) {
    equalizer_sound_effect.set_high_gain(instance, value)
  })
}
...
pub fn archivable(value: Bool) -> Property(EqualizerSoundEffect) {
  Property(fn(instance) {
    equalizer_sound_effect.set_archivable(instance, value)
  })
}
...
) -> Property(EqualizerSoundEffect) {
  Property(fn(instance) {
    equalizer_sound_effect.set_capabilities(instance, value)
  })
}
...
pub fn sandboxed(value: Bool) -> Property(EqualizerSoundEffect) {
  Property(fn(instance) {
    equalizer_sound_effect.set_sandboxed(instance, value)
  })
}
