...
import roblox/types.{type Actor, type AnimationRigData, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `AnimationRigData` instance.
///
/// Roblox: `Instance.new("AnimationRigData")`
@target(luau)
@luau.global("Instance.new(\"AnimationRigData\")")
pub fn new() -> AnimationRigData

/// Treats `AnimationRigData` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: AnimationRigData, value: parent) -> AnimationRigData
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AnimationRigData) -> Nil
...
pub fn get_attribute_changed_signal(instance: AnimationRigData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AnimationRigData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AnimationRigData) -> List(String)
...
pub fn wait_for_child(instance: AnimationRigData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AnimationRigData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AnimationRigData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AnimationRigData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AnimationRigData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AnimationRigData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AnimationRigData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AnimationRigData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AnimationRigData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AnimationRigData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AnimationRigData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AnimationRigData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AnimationRigData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AnimationRigData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AnimationRigData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AnimationRigData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AnimationRigData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AnimationRigData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AnimationRigData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AnimationRigData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationRigData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}