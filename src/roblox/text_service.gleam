...
import roblox/types.{type Actor, type ContentId, type Font, type GetTextBoundsParams, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextFilterContext, type TextFilterResult, type TextFilterTranslatedResult, type TextService, type UniqueId, type Vector2}
...
pub fn filter_and_translate_string_async(instance: TextService, string_to_filter: String, from_user_id: OptionInt64, target_locales: List(String), text_context: TextFilterContext) -> TextFilterTranslatedResult
...
pub fn set_parent(instance: TextService, value: parent) -> TextService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TextService) -> Nil
...
pub fn get_attribute_changed_signal(instance: TextService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TextService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TextService) -> List(String)
...
pub fn wait_for_child(instance: TextService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TextService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TextService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TextService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TextService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TextService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TextService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TextService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TextService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TextService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TextService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TextService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TextService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TextService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TextService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TextService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TextService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TextService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TextService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TextService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Font, _: Vector2, _: GetTextBoundsParams, _: ContentId, _: TextFilterResult, _: TextFilterContext, _: TextFilterTranslatedResult, _: TextService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}