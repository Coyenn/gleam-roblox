...
import roblox/types.{
  type Actor, type Instance, type Int64, type KeyCode, type LocalizationTable,
  type Object, type Player, type ProximityPrompt,
...
pub fn get_source_asset_id(instance: ProximityPrompt) -> Int64
