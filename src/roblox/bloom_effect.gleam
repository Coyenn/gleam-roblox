...
import roblox/types.{type Actor, type BloomEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `BloomEffect` instance.
///
/// Roblox: `Instance.new("BloomEffect")`
@target(luau)
@luau.global("Instance.new(\"BloomEffect\")")
...
pub fn set_parent(instance: BloomEffect, value: parent) -> BloomEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BloomEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: BloomEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BloomEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BloomEffect) -> List(String)
...
pub fn wait_for_child(instance: BloomEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BloomEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BloomEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BloomEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BloomEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BloomEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BloomEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BloomEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BloomEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BloomEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BloomEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BloomEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BloomEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BloomEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BloomEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BloomEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BloomEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BloomEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BloomEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BloomEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BloomEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}