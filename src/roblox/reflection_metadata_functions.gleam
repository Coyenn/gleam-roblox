...
import roblox/types.{
  ...
  type ReflectionMetadataFunctions, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataFunctions,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataFunctions) -> Int64
