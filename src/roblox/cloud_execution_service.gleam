...
import roblox/types.{
  type Actor, type CloudExecutionService, type Instance, type Int64, type Object,
...
pub fn set_archivable(
  instance: CloudExecutionService,
  value: Bool,
...
pub fn get_source_asset_id(instance: CloudExecutionService) -> Int64
