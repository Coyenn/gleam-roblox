...
import roblox/types.{
  ...
  type ReflectionMetadataClass, type ReflectionMetadataItem,
  type SecurityCapabilities, type ServiceVisibility, type UniqueId,
}
...
pub fn get_source_asset_id(instance: ReflectionMetadataClass) -> Int64
