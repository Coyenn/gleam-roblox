...
import roblox/types.{type Actor, type DataStoreObjectVersionInfo, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: DataStoreObjectVersionInfo, value: parent) -> DataStoreObjectVersionInfo
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStoreObjectVersionInfo) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStoreObjectVersionInfo, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStoreObjectVersionInfo, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStoreObjectVersionInfo) -> List(String)
...
pub fn wait_for_child(instance: DataStoreObjectVersionInfo, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStoreObjectVersionInfo, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStoreObjectVersionInfo, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStoreObjectVersionInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStoreObjectVersionInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStoreObjectVersionInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStoreObjectVersionInfo, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStoreObjectVersionInfo, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStoreObjectVersionInfo, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStoreObjectVersionInfo, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStoreObjectVersionInfo) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStoreObjectVersionInfo, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreObjectVersionInfo, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}