...
import roblox/types.{
  type Actor, type ExplorerServiceVisibilityService, type Instance, type Int64,
...
pub fn get_service_visibility(
  instance: ExplorerServiceVisibilityService,
  service: Instance,
) -> Bool
...
pub fn get_source_asset_id(instance: ExplorerServiceVisibilityService) -> Int64
