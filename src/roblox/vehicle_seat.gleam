...
/// Creates a new Roblox `VehicleSeat` instance.
///
/// Roblox: `Instance.new("VehicleSeat")`
@target(luau)
@luau.global("Instance.new(\"VehicleSeat\")")
...
pub fn touch_ended(instance: VehicleSeat) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: VehicleSeat, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Touched")
pub fn touched(instance: VehicleSeat) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touched(instance: VehicleSeat, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: VehicleSeat, value: parent) -> VehicleSeat
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VehicleSeat) -> Nil
...
pub fn get_attribute_changed_signal(instance: VehicleSeat, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VehicleSeat, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VehicleSeat) -> List(String)
...
pub fn wait_for_child(instance: VehicleSeat, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VehicleSeat) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VehicleSeat, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VehicleSeat) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VehicleSeat, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VehicleSeat) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VehicleSeat, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VehicleSeat) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VehicleSeat, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VehicleSeat) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VehicleSeat, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VehicleSeat) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VehicleSeat, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VehicleSeat) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VehicleSeat, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VehicleSeat) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VehicleSeat, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VehicleSeat, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VehicleSeat) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VehicleSeat, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: BasePart, _: CollisionFidelity, _: RenderFidelity, _: Vector3, _: Player, _: NormalId, _: SurfaceType, _: Faces, _: Material, _: PhysicalProperties, _: Color3, _: BrickColor, _: Humanoid, _: VehicleSeat, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}