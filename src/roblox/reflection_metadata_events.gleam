...
import roblox/types.{
  ...
  type ReflectionMetadataEvents, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataEvents,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataEvents) -> Int64
