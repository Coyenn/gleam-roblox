...
import roblox/types.{type Actor, type ConnectivityService, type Instance, type NetworkStatus, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: ConnectivityService, value: parent) -> ConnectivityService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ConnectivityService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ConnectivityService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ConnectivityService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ConnectivityService) -> List(String)
...
pub fn wait_for_child(instance: ConnectivityService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ConnectivityService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ConnectivityService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ConnectivityService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ConnectivityService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ConnectivityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ConnectivityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ConnectivityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ConnectivityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ConnectivityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ConnectivityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ConnectivityService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ConnectivityService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ConnectivityService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ConnectivityService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ConnectivityService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ConnectivityService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ConnectivityService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ConnectivityService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ConnectivityService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NetworkStatus, _: ConnectivityService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}