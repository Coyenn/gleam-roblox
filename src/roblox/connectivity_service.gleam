...
import roblox/types.{
  type Actor, type ConnectivityService, type Instance, type Int64,
  type NetworkStatus, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: ConnectivityService) -> Int64
