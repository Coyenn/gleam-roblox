...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptChangeService,
...
pub fn get_source_asset_id(instance: ScriptChangeService) -> Int64
