...
import roblox/types.{type Actor, type Instance, type Message, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Message, value: parent) -> Message
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Message) -> Nil
...
pub fn get_attribute_changed_signal(instance: Message, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Message, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Message) -> List(String)
...
pub fn wait_for_child(instance: Message, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Message) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Message, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Message) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Message, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Message) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Message, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Message) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Message, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Message) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Message, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Message) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Message, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Message) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Message, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Message) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Message, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Message, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Message) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Message, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Message, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}