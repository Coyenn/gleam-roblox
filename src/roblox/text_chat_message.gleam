...
import roblox/types.{type Actor, type BubbleChatMessageProperties, type ChatWindowMessageProperties, type DateTime, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextChannel, type TextChatMessage, type TextChatMessageStatus, type TextSource, type UniqueId}
...
pub fn set_parent(instance: TextChatMessage, value: parent) -> TextChatMessage
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TextChatMessage) -> Nil
...
pub fn get_attribute_changed_signal(instance: TextChatMessage, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TextChatMessage, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TextChatMessage) -> List(String)
...
pub fn wait_for_child(instance: TextChatMessage, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TextChatMessage) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TextChatMessage, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TextChatMessage) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TextChatMessage, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TextChatMessage) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TextChatMessage, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TextChatMessage) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TextChatMessage, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TextChatMessage) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TextChatMessage, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TextChatMessage) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TextChatMessage, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TextChatMessage) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TextChatMessage, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TextChatMessage) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TextChatMessage, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TextChatMessage, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TextChatMessage) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TextChatMessage, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DateTime, _: TextSource, _: TextChannel, _: TextChatMessageStatus, _: ChatWindowMessageProperties, _: BubbleChatMessageProperties, _: TextChatMessage, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}