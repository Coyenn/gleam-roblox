...
import roblox/types.{type Actor, type FacialAnimationStreamingSubsessionStats, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `FacialAnimationStreamingSubsessionStats` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: FacialAnimationStreamingSubsessionStats) -> Instance
...
pub fn set_parent(instance: FacialAnimationStreamingSubsessionStats, value: parent) -> FacialAnimationStreamingSubsessionStats
...
pub fn get_source_asset_id(instance: FacialAnimationStreamingSubsessionStats) -> OptionInt64
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FacialAnimationStreamingSubsessionStats) -> Nil
...
pub fn get_attribute_changed_signal(instance: FacialAnimationStreamingSubsessionStats, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FacialAnimationStreamingSubsessionStats, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FacialAnimationStreamingSubsessionStats) -> List(String)
...
pub fn wait_for_child(instance: FacialAnimationStreamingSubsessionStats, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FacialAnimationStreamingSubsessionStats, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FacialAnimationStreamingSubsessionStats, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FacialAnimationStreamingSubsessionStats, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FacialAnimationStreamingSubsessionStats, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FacialAnimationStreamingSubsessionStats, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FacialAnimationStreamingSubsessionStats, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FacialAnimationStreamingSubsessionStats, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FacialAnimationStreamingSubsessionStats, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FacialAnimationStreamingSubsessionStats, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FacialAnimationStreamingSubsessionStats) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FacialAnimationStreamingSubsessionStats, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FacialAnimationStreamingSubsessionStats, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}