...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PluginDragEvent, type SecurityCapabilities, type UniqueId, type Vector2}
...
pub fn set_parent(instance: PluginDragEvent, value: parent) -> PluginDragEvent
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PluginDragEvent) -> Nil
...
pub fn get_attribute_changed_signal(instance: PluginDragEvent, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PluginDragEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PluginDragEvent) -> List(String)
...
pub fn wait_for_child(instance: PluginDragEvent, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PluginDragEvent) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PluginDragEvent, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PluginDragEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PluginDragEvent, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PluginDragEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PluginDragEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PluginDragEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PluginDragEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PluginDragEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PluginDragEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PluginDragEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PluginDragEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PluginDragEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PluginDragEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PluginDragEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PluginDragEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PluginDragEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PluginDragEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PluginDragEvent, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector2, _: PluginDragEvent, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}