...
import roblox/types.{
  type Actor, type DistortionSoundEffect, type Instance, type Int64, type Object,
...
pub fn set_level(
  instance: DistortionSoundEffect,
  value: Float,
...
pub fn get_source_asset_id(instance: DistortionSoundEffect) -> Int64
