...
import roblox/types.{type Actor, type DataStoreOptions, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DataStoreOptions` instance.
///
/// Roblox: `Instance.new("DataStoreOptions")`
@target(luau)
@luau.global("Instance.new(\"DataStoreOptions\")")
...
pub fn set_parent(instance: DataStoreOptions, value: parent) -> DataStoreOptions
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStoreOptions) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStoreOptions, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStoreOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStoreOptions) -> List(String)
...
pub fn wait_for_child(instance: DataStoreOptions, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStoreOptions) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStoreOptions, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStoreOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStoreOptions, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStoreOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStoreOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStoreOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStoreOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStoreOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStoreOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStoreOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStoreOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStoreOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStoreOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStoreOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStoreOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStoreOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStoreOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStoreOptions, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreOptions, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}