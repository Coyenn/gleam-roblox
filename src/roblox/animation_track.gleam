...
import roblox/types.{type Actor, type Animation, type AnimationPriority, type AnimationTrack, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn get_marker_reached_signal(instance: AnimationTrack, name: String) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_did_loop(instance: AnimationTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_ended(instance: AnimationTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn keyframe_reached(instance: AnimationTrack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_keyframe_reached(instance: AnimationTrack, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_stopped(instance: AnimationTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: AnimationTrack, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AnimationTrack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: AnimationTrack, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AnimationTrack) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AnimationTrack, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AnimationTrack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AnimationTrack, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AnimationTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AnimationTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AnimationTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AnimationTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AnimationTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AnimationTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AnimationTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AnimationTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: AnimationTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AnimationTrack) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AnimationTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AnimationTrack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: AnimationTrack, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationPriority, _: Animation, _: AnimationTrack, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}