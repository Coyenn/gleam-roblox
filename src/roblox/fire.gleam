...
import roblox/types.{type Actor, type Color3, type Fire, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Fire` instance.
///
/// Roblox: `Instance.new("Fire")`
@target(luau)
@luau.global("Instance.new(\"Fire\")")
pub fn new() -> Fire
...
pub fn set_parent(instance: Fire, value: parent) -> Fire
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Fire) -> Nil
...
pub fn get_attribute_changed_signal(instance: Fire, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Fire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Fire) -> List(String)
...
pub fn wait_for_child(instance: Fire, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Fire) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Fire, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Fire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Fire, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Fire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Fire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Fire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Fire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Fire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Fire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Fire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Fire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Fire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Fire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Fire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Fire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Fire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Fire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Fire, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Fire, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}