...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ReflectionService,
...
pub fn get_properties_of_class(
  instance: ReflectionService,
  class_name: String,
  filter: Dynamic,
) -> List(Dynamic)
...
pub fn get_source_asset_id(instance: ReflectionService) -> Int64
