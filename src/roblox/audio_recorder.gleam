...
import roblox/types.{
  type Actor, type AudioRecorder, type Content, type Instance, type Int64,
...
pub fn get_unrecordable_instances_async(
  instance: AudioRecorder,
) -> List(Instance)
...
pub fn get_source_asset_id(instance: AudioRecorder) -> Int64
