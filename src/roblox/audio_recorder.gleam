...
import roblox/types.{type Actor, type AudioRecorder, type Content, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioRecorder` instance.
///
/// Roblox: `Instance.new("AudioRecorder")`
@target(luau)
@luau.global("Instance.new(\"AudioRecorder\")")
...
pub fn get_input_pins(instance: AudioRecorder) -> List(String)
...
pub fn get_output_pins(instance: AudioRecorder) -> List(String)
...
pub fn wiring_changed(instance: AudioRecorder) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioRecorder.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioRecorder via a Wire.
///
/// Roblox: `AudioRecorder.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioRecorder, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioRecorder, value: parent) -> AudioRecorder
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioRecorder) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioRecorder, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioRecorder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioRecorder) -> List(String)
...
pub fn wait_for_child(instance: AudioRecorder, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioRecorder) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioRecorder, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioRecorder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioRecorder, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioRecorder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioRecorder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioRecorder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioRecorder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioRecorder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioRecorder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioRecorder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioRecorder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioRecorder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioRecorder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioRecorder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioRecorder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioRecorder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioRecorder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioRecorder, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: Content, _: AudioRecorder, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}