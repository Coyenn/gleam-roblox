...
import roblox/types.{
  type Actor, type BaseCoreGuiConfiguration, type Instance, type Int64,
  type Object, type PlayerListConfiguration, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: PlayerListConfiguration) -> Int64
