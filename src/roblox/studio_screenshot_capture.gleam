...
import roblox/types.{
  ...
  type SecurityCapabilities, type StudioCaptureBufferStatus,
  type StudioCaptureScreenshotFormat, type StudioScreenshotCapture,
  type UICaptureMode, type UniqueId, type Vector2,
}
