...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StudioCaptureBufferStatus, type StudioCaptureScreenshotFormat, type StudioScreenshotCapture, type UICaptureMode, type UniqueId, type Vector2}
...
pub fn set_parent(instance: StudioScreenshotCapture, value: parent) -> StudioScreenshotCapture
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StudioScreenshotCapture) -> Nil
...
pub fn get_attribute_changed_signal(instance: StudioScreenshotCapture, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StudioScreenshotCapture, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StudioScreenshotCapture) -> List(String)
...
pub fn wait_for_child(instance: StudioScreenshotCapture, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StudioScreenshotCapture, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StudioScreenshotCapture, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StudioScreenshotCapture, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StudioScreenshotCapture, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StudioScreenshotCapture, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StudioScreenshotCapture, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StudioScreenshotCapture, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StudioScreenshotCapture, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StudioScreenshotCapture, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StudioScreenshotCapture) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StudioScreenshotCapture, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UICaptureMode, _: Vector2, _: StudioCaptureBufferStatus, _: StudioCaptureScreenshotFormat, _: StudioScreenshotCapture, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}