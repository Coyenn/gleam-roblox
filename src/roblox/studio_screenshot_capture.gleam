...
import roblox/types.{
  ...
  type StudioCaptureBufferStatus, type StudioCaptureScreenshotFormat,
  type StudioScreenshotCapture, type UICaptureMode, type UniqueId, type Vector2,
}
...
pub fn get_buffer_format(
  instance: StudioScreenshotCapture,
...
pub fn get_source_asset_id(instance: StudioScreenshotCapture) -> Int64
