...
import roblox/types.{type Actor, type AudioGate, type Instance, type NumberRange, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioGate` instance.
///
/// Roblox: `Instance.new("AudioGate")`
@target(luau)
@luau.global("Instance.new(\"AudioGate\")")
...
pub fn get_input_pins(instance: AudioGate) -> List(String)
...
pub fn get_output_pins(instance: AudioGate) -> List(String)
...
pub fn wiring_changed(instance: AudioGate) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioGate.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioGate via a Wire.
///
/// Roblox: `AudioGate.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioGate, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioGate, value: parent) -> AudioGate
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioGate) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioGate, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioGate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioGate) -> List(String)
...
pub fn wait_for_child(instance: AudioGate, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioGate) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioGate, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioGate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioGate, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioGate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioGate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioGate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioGate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioGate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioGate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioGate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioGate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioGate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioGate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioGate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioGate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioGate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioGate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioGate, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: NumberRange, _: AudioGate, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}