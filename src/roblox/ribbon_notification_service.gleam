...
import roblox/types.{
  ...
  type RibbonNotificationService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RibbonNotificationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: RibbonNotificationService) -> Int64
