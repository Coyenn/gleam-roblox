...
import roblox/types.{
  type Actor, type Color3, type DraggerCoordinateSpace, type DraggerMovementMode,
  type DraggerService, type Instance, type Int64, type Object,
...
pub fn set_align_dragged_objects(
  instance: DraggerService,
  value: Bool,
) -> DraggerService
...
pub fn set_angle_snap_increment(
  instance: DraggerService,
  value: Float,
) -> DraggerService
...
pub fn get_dragger_coordinate_space(
  instance: DraggerService,
...
pub fn set_dragger_coordinate_space(
  instance: DraggerService,
  value: DraggerCoordinateSpace,
) -> DraggerService
...
pub fn get_dragger_movement_mode(
  instance: DraggerService,
) -> DraggerMovementMode
...
pub fn set_dragger_movement_mode(
  instance: DraggerService,
  value: DraggerMovementMode,
) -> DraggerService
...
pub fn set_geometry_snap_color(
  instance: DraggerService,
  value: Color3,
) -> DraggerService
...
pub fn set_hover_animate_frequency(
  instance: DraggerService,
  value: Float,
) -> DraggerService
...
pub fn set_linear_snap_enabled(
  instance: DraggerService,
  value: Bool,
) -> DraggerService
...
pub fn set_linear_snap_increment(
  instance: DraggerService,
  value: Float,
) -> DraggerService
...
pub fn set_show_pivot_indicator(
  instance: DraggerService,
  value: Bool,
) -> DraggerService
...
pub fn get_source_asset_id(instance: DraggerService) -> Int64
