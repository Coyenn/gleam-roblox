...
import roblox/types.{type Actor, type Color3, type DraggerCoordinateSpace, type DraggerMovementMode, type DraggerService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: DraggerService, value: parent) -> DraggerService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DraggerService) -> Nil
...
pub fn get_attribute_changed_signal(instance: DraggerService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DraggerService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DraggerService) -> List(String)
...
pub fn wait_for_child(instance: DraggerService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DraggerService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DraggerService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DraggerService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DraggerService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DraggerService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DraggerService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DraggerService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DraggerService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DraggerService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DraggerService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DraggerService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DraggerService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DraggerService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DraggerService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DraggerService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DraggerService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DraggerService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DraggerService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DraggerService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: DraggerMovementMode, _: DraggerCoordinateSpace, _: DraggerService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}