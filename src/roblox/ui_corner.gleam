...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UDim, type UIBase, type UIComponent, type UICorner, type UniqueId}

/// Creates a new Roblox `UICorner` instance.
///
/// Roblox: `Instance.new("UICorner")`
@target(luau)
@luau.global("Instance.new(\"UICorner\")")
pub fn new() -> UICorner
...
pub fn set_parent(instance: UICorner, value: parent) -> UICorner
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UICorner) -> Nil
...
pub fn get_attribute_changed_signal(instance: UICorner, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UICorner, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UICorner) -> List(String)
...
pub fn wait_for_child(instance: UICorner, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UICorner) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UICorner, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UICorner) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UICorner, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UICorner) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UICorner, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UICorner) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UICorner, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UICorner) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UICorner, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UICorner) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UICorner, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UICorner) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UICorner, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UICorner) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UICorner, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UICorner, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UICorner) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UICorner, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UDim, _: UICorner, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}