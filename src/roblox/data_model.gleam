...
import roblox/types.{
  ...
  type MatchmakingType, type Object, type OptionDouble, type OptionInt64,
  type RunService, type SecurityCapabilities, type ServiceProvider,
  type UniqueId, type Workspace,
}
...
pub fn graphics_quality_change_request(
  instance: DataModel,
...
pub fn on_graphics_quality_change_request(
  instance: DataModel,
...
pub fn server_lifecycle_changed(
  instance: DataModel,
...
pub fn on_server_lifecycle_changed(
  instance: DataModel,
