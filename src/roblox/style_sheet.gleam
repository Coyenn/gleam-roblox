...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt, type OptionInt64, type SecurityCapabilities, type StyleBase, type StyleRule, type StyleSheet, type UniqueId}

/// Creates a new Roblox `StyleSheet` instance.
///
/// Roblox: `Instance.new("StyleSheet")`
@target(luau)
@luau.global("Instance.new(\"StyleSheet\")")
...
pub fn style_rules_changed(instance: StyleSheet) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `StyleBase.StyleRulesChanged`.
///
/// Fires when one or more StyleRules is explicitly changed on the connected StyleSheet or StyleRule.
///
/// Roblox: `StyleBase.StyleRulesChanged`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/StyleBase#StyleRulesChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.StyleRulesChanged:Connect(callback) end)")
pub fn on_style_rules_changed(instance: StyleSheet, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: StyleSheet, value: parent) -> StyleSheet
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StyleSheet) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleSheet, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StyleSheet, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StyleSheet) -> List(String)
...
pub fn wait_for_child(instance: StyleSheet, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StyleSheet) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StyleSheet, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StyleSheet) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StyleSheet, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StyleSheet) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StyleSheet, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StyleSheet) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StyleSheet, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StyleSheet) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StyleSheet, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StyleSheet) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StyleSheet, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StyleSheet) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StyleSheet, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StyleSheet) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StyleSheet, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StyleSheet, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StyleSheet) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StyleSheet, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StyleRule, _: OptionInt, _: StyleSheet, _: StyleBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}