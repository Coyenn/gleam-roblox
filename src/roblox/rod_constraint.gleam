...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type RodConstraint, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `RodConstraint` instance.
///
/// Roblox: `Instance.new("RodConstraint")`
@target(luau)
@luau.global("Instance.new(\"RodConstraint\")")
...
pub fn set_parent(instance: RodConstraint, value: parent) -> RodConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RodConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: RodConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RodConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RodConstraint) -> List(String)
...
pub fn wait_for_child(instance: RodConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RodConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RodConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RodConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RodConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RodConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RodConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RodConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RodConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RodConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RodConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RodConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RodConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RodConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RodConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RodConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RodConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RodConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RodConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RodConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: RodConstraint, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}