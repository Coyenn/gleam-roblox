...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptDebuggerService,
...
pub fn set_archivable(
  instance: ScriptDebuggerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ScriptDebuggerService) -> Int64
