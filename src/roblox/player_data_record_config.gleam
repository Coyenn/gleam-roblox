...
import roblox/types.{
  ...
  type PlayerDataRecordConfig, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_default_value(
  instance: PlayerDataRecordConfig,
  key: String,
) -> Dynamic
...
pub fn get_source_asset_id(instance: PlayerDataRecordConfig) -> Int64
