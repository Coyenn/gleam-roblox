...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Constraint, type Instance, type LineForce, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `LineForce` instance.
///
/// Roblox: `Instance.new("LineForce")`
@target(luau)
@luau.global("Instance.new(\"LineForce\")")
pub fn new() -> LineForce
...
pub fn set_parent(instance: LineForce, value: parent) -> LineForce
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LineForce) -> Nil
...
pub fn get_attribute_changed_signal(instance: LineForce, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LineForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LineForce) -> List(String)
...
pub fn wait_for_child(instance: LineForce, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LineForce) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LineForce, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LineForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LineForce, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LineForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LineForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LineForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LineForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LineForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LineForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LineForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LineForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LineForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LineForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LineForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LineForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LineForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LineForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LineForce, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: LineForce, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}