...
import roblox/types.{
  type Actor, type AppLifecycleObserverService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: AppLifecycleObserverService,
  value: Bool,
...
pub fn get_source_asset_id(instance: AppLifecycleObserverService) -> Int64
