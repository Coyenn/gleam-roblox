...
import roblox/types.{
  type Actor, type ClientReplicator, type Instance, type Int64,
  type NetworkReplicator, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: ClientReplicator) -> Int64
