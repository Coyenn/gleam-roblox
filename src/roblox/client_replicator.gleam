...
import roblox/types.{type Actor, type ClientReplicator, type Instance, type NetworkReplicator, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: ClientReplicator, value: parent) -> ClientReplicator
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ClientReplicator) -> Nil
...
pub fn get_attribute_changed_signal(instance: ClientReplicator, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ClientReplicator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ClientReplicator) -> List(String)
...
pub fn wait_for_child(instance: ClientReplicator, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ClientReplicator) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ClientReplicator, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ClientReplicator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ClientReplicator, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ClientReplicator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ClientReplicator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ClientReplicator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ClientReplicator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ClientReplicator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ClientReplicator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ClientReplicator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ClientReplicator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ClientReplicator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ClientReplicator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ClientReplicator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ClientReplicator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ClientReplicator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ClientReplicator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ClientReplicator, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ClientReplicator, _: NetworkReplicator, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}