...
import roblox/types.{type Actor, type BuoyancySensor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SensorBase, type SensorUpdateType, type UniqueId}

/// Creates a new Roblox `BuoyancySensor` instance.
///
/// Roblox: `Instance.new("BuoyancySensor")`
@target(luau)
@luau.global("Instance.new(\"BuoyancySensor\")")
...
pub fn on_sensor_output_changed(instance: BuoyancySensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_on_sensor_output_changed(instance: BuoyancySensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BuoyancySensor, value: parent) -> BuoyancySensor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BuoyancySensor) -> Nil
...
pub fn get_attribute_changed_signal(instance: BuoyancySensor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BuoyancySensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BuoyancySensor) -> List(String)
...
pub fn wait_for_child(instance: BuoyancySensor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BuoyancySensor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BuoyancySensor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BuoyancySensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BuoyancySensor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BuoyancySensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BuoyancySensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BuoyancySensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BuoyancySensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BuoyancySensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BuoyancySensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BuoyancySensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BuoyancySensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BuoyancySensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BuoyancySensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BuoyancySensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BuoyancySensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BuoyancySensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BuoyancySensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BuoyancySensor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SensorUpdateType, _: BuoyancySensor, _: SensorBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}