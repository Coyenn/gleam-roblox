...
import roblox/types.{
  type Actor, type BuoyancySensor, type Instance, type Object, type OptionDouble,
  type OptionInt64, type SecurityCapabilities, type SensorBase,
  type SensorUpdateType, type UniqueId,
}
...
pub fn set_fully_submerged(
  instance: BuoyancySensor,
  value: Bool,
) -> BuoyancySensor
