...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TeleportOptions, type UniqueId}

/// Creates a new Roblox `TeleportOptions` instance.
///
/// Roblox: `Instance.new("TeleportOptions")`
@target(luau)
@luau.global("Instance.new(\"TeleportOptions\")")
pub fn new() -> TeleportOptions
...
pub fn set_parent(instance: TeleportOptions, value: parent) -> TeleportOptions
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TeleportOptions) -> Nil
...
pub fn get_attribute_changed_signal(instance: TeleportOptions, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TeleportOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TeleportOptions) -> List(String)
...
pub fn wait_for_child(instance: TeleportOptions, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TeleportOptions) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TeleportOptions, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TeleportOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TeleportOptions, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TeleportOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TeleportOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TeleportOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TeleportOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TeleportOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TeleportOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TeleportOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TeleportOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TeleportOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TeleportOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TeleportOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TeleportOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TeleportOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TeleportOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TeleportOptions, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TeleportOptions, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}