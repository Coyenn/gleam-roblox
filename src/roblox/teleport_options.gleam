...
import roblox/types.{
  ...
  type TeleportOptions, type UniqueId,
}
...
pub fn set_reserved_server_access_code(
  instance: TeleportOptions,
  value: String,
) -> TeleportOptions
...
pub fn set_should_reserve_server(
  instance: TeleportOptions,
  value: Bool,
) -> TeleportOptions
...
pub fn get_source_asset_id(instance: TeleportOptions) -> Int64
