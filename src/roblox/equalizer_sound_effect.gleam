...
import roblox/types.{
  type Actor, type EqualizerSoundEffect, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: EqualizerSoundEffect) -> Int64
