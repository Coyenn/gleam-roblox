...
import roblox/types.{type Actor, type ExplorerFilter, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ExplorerFilter` instance.
///
/// Roblox: `Instance.new("ExplorerFilter")`
@target(luau)
@luau.global("Instance.new(\"ExplorerFilter\")")
pub fn new() -> ExplorerFilter

/// Treats `ExplorerFilter` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: ExplorerFilter, value: parent) -> ExplorerFilter
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ExplorerFilter) -> Nil
...
pub fn get_attribute_changed_signal(instance: ExplorerFilter, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ExplorerFilter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ExplorerFilter) -> List(String)
...
pub fn wait_for_child(instance: ExplorerFilter, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ExplorerFilter) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ExplorerFilter, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ExplorerFilter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ExplorerFilter, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ExplorerFilter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ExplorerFilter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ExplorerFilter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ExplorerFilter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ExplorerFilter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ExplorerFilter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ExplorerFilter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ExplorerFilter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ExplorerFilter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ExplorerFilter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ExplorerFilter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ExplorerFilter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ExplorerFilter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ExplorerFilter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ExplorerFilter, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ExplorerFilter, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}