...
import roblox/types.{type Actor, type ActuatorType, type Attachment, type BrickColor, type Constraint, type HingeConstraint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `HingeConstraint` instance.
///
/// Roblox: `Instance.new("HingeConstraint")`
@target(luau)
@luau.global("Instance.new(\"HingeConstraint\")")
...
pub fn set_parent(instance: HingeConstraint, value: parent) -> HingeConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HingeConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: HingeConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HingeConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HingeConstraint) -> List(String)
...
pub fn wait_for_child(instance: HingeConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HingeConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HingeConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HingeConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HingeConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HingeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HingeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HingeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HingeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HingeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HingeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HingeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HingeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HingeConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HingeConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HingeConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HingeConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HingeConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HingeConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HingeConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: ActuatorType, _: HingeConstraint, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}