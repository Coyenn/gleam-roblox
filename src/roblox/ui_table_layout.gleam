...
import roblox/types.{
  ...
  type TableMajorAxis, type UDim2, type UIBase, type UIComponent,
  type UIGridStyleLayout, type UILayout, type UITableLayout, type UniqueId,
...
pub fn get_source_asset_id(instance: UITableLayout) -> Int64
