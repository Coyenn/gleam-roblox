...
import roblox/types.{
  ...
  type Object, type SecurityCapabilities, type SortOrder, type TableMajorAxis,
  type UDim2, type UIBase, type UIComponent, type UIGridStyleLayout,
  type UILayout, type UITableLayout, type UniqueId, type Vector2,
...
pub fn set_fill_empty_space_columns(
  instance: UITableLayout,
  value: Bool,
) -> UITableLayout
...
pub fn set_fill_empty_space_rows(
  instance: UITableLayout,
  value: Bool,
) -> UITableLayout
...
pub fn set_major_axis(
  instance: UITableLayout,
  value: TableMajorAxis,
) -> UITableLayout
