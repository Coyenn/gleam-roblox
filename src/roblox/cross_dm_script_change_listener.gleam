...
import roblox/types.{
  type Actor, type CrossDMScriptChangeListener, type Instance, type Int64,
...
pub fn set_archivable(
  instance: CrossDMScriptChangeListener,
  value: Bool,
...
pub fn get_source_asset_id(instance: CrossDMScriptChangeListener) -> Int64
