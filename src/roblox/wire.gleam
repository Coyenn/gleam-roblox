...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `Wire` instance.
///
/// Roblox: `Instance.new("Wire")`
@target(luau)
@luau.global("Instance.new(\"Wire\")")
pub fn new() -> Wire
...
pub fn set_parent(instance: Wire, value: parent) -> Wire
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Wire) -> Nil
...
pub fn get_attribute_changed_signal(instance: Wire, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Wire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Wire) -> List(String)
...
pub fn wait_for_child(instance: Wire, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Wire) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Wire, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Wire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Wire, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Wire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Wire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Wire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Wire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Wire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Wire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Wire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Wire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Wire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Wire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Wire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Wire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Wire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Wire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Wire, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}