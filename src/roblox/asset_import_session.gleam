...
import roblox/types.{
  type Actor, type AssetImportSession, type ImportSession, type Instance,
...
pub fn get_source_asset_id(instance: AssetImportSession) -> Int64
