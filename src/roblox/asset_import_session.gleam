...
import roblox/types.{type Actor, type AssetImportSession, type ImportSession, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn upload_complete(instance: AssetImportSession) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `ImportSession.UploadComplete`.
///
/// Roblox: `ImportSession.UploadComplete`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/ImportSession#UploadComplete
@target(luau)
@luau.global("(function(instance, callback) return instance.UploadComplete:Connect(callback) end)")
pub fn on_upload_complete(instance: AssetImportSession, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn upload_progress(instance: AssetImportSession) -> RBXScriptSignal(fn(Float) -> Nil)

/// Connects to Roblox event `ImportSession.UploadProgress`.
///
/// Roblox: `ImportSession.UploadProgress`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/ImportSession#UploadProgress
@target(luau)
@luau.global("(function(instance, callback) return instance.UploadProgress:Connect(callback) end)")
pub fn on_upload_progress(instance: AssetImportSession, callback: fn(Float) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AssetImportSession, value: parent) -> AssetImportSession
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AssetImportSession) -> Nil
...
pub fn get_attribute_changed_signal(instance: AssetImportSession, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AssetImportSession, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AssetImportSession) -> List(String)
...
pub fn wait_for_child(instance: AssetImportSession, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AssetImportSession) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AssetImportSession, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AssetImportSession) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AssetImportSession, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AssetImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AssetImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AssetImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AssetImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AssetImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AssetImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AssetImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AssetImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AssetImportSession) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AssetImportSession, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AssetImportSession) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AssetImportSession, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AssetImportSession, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AssetImportSession) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AssetImportSession, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AssetImportSession, _: ImportSession, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}