...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type PackageUIService,
...
pub fn get_source_asset_id(instance: PackageUIService) -> Int64
