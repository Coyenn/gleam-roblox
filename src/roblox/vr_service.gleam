...
import roblox/types.{
  ...
  type SecurityCapabilities, type UniqueId, type UserCFrame,
  type VRControllerModelMode, type VRLaserPointerMode, type VRScaling,
  type VRService, type VRSessionState, type VRTouchpad, type VRTouchpadMode,
}
...
pub fn set_controller_models(
  instance: VRService,
  value: VRControllerModelMode,
) -> VRService
...
pub fn set_fade_out_view_on_collision(
  instance: VRService,
  value: Bool,
) -> VRService
...
pub fn set_gui_input_user_cframe(
  instance: VRService,
  value: UserCFrame,
) -> VRService
...
pub fn set_laser_pointer(
  instance: VRService,
  value: VRLaserPointerMode,
) -> VRService
...
pub fn navigation_requested(
  instance: VRService,
) -> RBXScriptSignal(fn(CFrame, UserCFrame) -> Nil)
...
pub fn on_navigation_requested(
  instance: VRService,
  callback: fn(CFrame, UserCFrame) -> Nil,
) -> RBXScriptConnection
...
pub fn touchpad_mode_changed(
  instance: VRService,
) -> RBXScriptSignal(fn(VRTouchpad, VRTouchpadMode) -> Nil)
...
pub fn on_touchpad_mode_changed(
  instance: VRService,
  callback: fn(VRTouchpad, VRTouchpadMode) -> Nil,
) -> RBXScriptConnection
...
pub fn user_cframe_changed(
  instance: VRService,
) -> RBXScriptSignal(fn(UserCFrame, CFrame) -> Nil)
...
pub fn on_user_cframe_changed(
  instance: VRService,
  callback: fn(UserCFrame, CFrame) -> Nil,
) -> RBXScriptConnection
...
pub fn user_cframe_enabled(
  instance: VRService,
) -> RBXScriptSignal(fn(UserCFrame, Bool) -> Nil)
...
pub fn on_user_cframe_enabled(
  instance: VRService,
  callback: fn(UserCFrame, Bool) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: VRService) -> Int64
