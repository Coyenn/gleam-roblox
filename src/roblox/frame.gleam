...
import roblox/types.{type Actor, type AutomaticSize, type BorderMode, type Color3, type EasingDirection, type EasingStyle, type Frame, type FrameStyle, type GuiBase, type GuiBase2d, type GuiObject, type GuiState, type InputObject, type InputSink, type Instance, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type Rect, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type SwipeDirection, type UDim2, type UniqueId, type UserInputState, type Vector2}

/// Creates a new Roblox `Frame` instance.
///
/// Roblox: `Instance.new("Frame")`
@target(luau)
@luau.global("Instance.new(\"Frame\")")
pub fn new() -> Frame
...
pub fn tween_position(instance: Frame, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size(instance: Frame, end_size: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size_and_position(instance: Frame, end_size: UDim2, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn input_began(instance: Frame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_began(instance: Frame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_changed(instance: Frame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_changed(instance: Frame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_ended(instance: Frame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_ended(instance: Frame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: Frame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_enter(instance: Frame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: Frame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_leave(instance: Frame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_moved(instance: Frame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_moved(instance: Frame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_backward(instance: Frame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_backward(instance: Frame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_forward(instance: Frame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_forward(instance: Frame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn selection_gained(instance: Frame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_selection_gained(instance: Frame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn selection_lost(instance: Frame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_selection_lost(instance: Frame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn touch_long_press(instance: Frame) -> RBXScriptSignal(fn(List(Vector2), UserInputState) -> Nil)
...
pub fn on_touch_long_press(instance: Frame, callback: fn(List(Vector2), UserInputState) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchPan")
pub fn touch_pan(instance: Frame) -> RBXScriptSignal(fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil)
...
pub fn on_touch_pan(instance: Frame, callback: fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_pinch(instance: Frame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_pinch(instance: Frame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_rotate(instance: Frame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_rotate(instance: Frame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_swipe(instance: Frame) -> RBXScriptSignal(fn(SwipeDirection, Int) -> Nil)
...
pub fn on_touch_swipe(instance: Frame, callback: fn(SwipeDirection, Int) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchTap")
pub fn touch_tap(instance: Frame) -> RBXScriptSignal(fn(List(Vector2)) -> Nil)
...
pub fn on_touch_tap(instance: Frame, callback: fn(List(Vector2)) -> Nil) -> RBXScriptConnection
...
pub fn selection_changed(instance: Frame) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: Frame, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Frame, value: parent) -> Frame
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Frame) -> Nil
...
pub fn get_attribute_changed_signal(instance: Frame, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Frame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Frame) -> List(String)
...
pub fn wait_for_child(instance: Frame, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Frame) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Frame, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Frame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Frame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Frame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Frame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Frame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Frame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Frame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Frame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Frame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Frame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Frame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Frame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Frame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Frame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Frame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Frame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Frame, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: SwipeDirection, _: UserInputState, _: InputObject, _: UDim2, _: EasingDirection, _: EasingStyle, _: SizeConstraint, _: InputSink, _: GuiState, _: BorderMode, _: Color3, _: AutomaticSize, _: FrameStyle, _: Frame, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}