...
import roblox/types.{
  type Actor, type BreakReason, type Instance, type Object, type OptionDouble,
  type OptionInt64, type ScriptDebugger, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn encountered_break(
  instance: ScriptDebugger,
) -> RBXScriptSignal(fn(Int, BreakReason) -> Nil)
...
pub fn on_encountered_break(
  instance: ScriptDebugger,
  callback: fn(Int, BreakReason) -> Nil,
) -> RBXScriptConnection
