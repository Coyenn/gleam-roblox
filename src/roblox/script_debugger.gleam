...
import roblox/types.{
  type Actor, type BreakReason, type Instance, type Int64, type Object,
  type ScriptDebugger, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: ScriptDebugger) -> Int64
