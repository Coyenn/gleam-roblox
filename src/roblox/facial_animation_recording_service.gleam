...
import roblox/types.{
  type Actor, type FacialAnimationRecordingService, type Instance, type Int64,
...
pub fn get_biometric_data_consent(
  instance: FacialAnimationRecordingService,
) -> Bool
...
pub fn get_source_asset_id(instance: FacialAnimationRecordingService) -> Int64
