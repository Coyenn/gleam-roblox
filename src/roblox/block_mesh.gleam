...
import roblox/types.{type Actor, type BevelMesh, type BlockMesh, type DataModelMesh, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `BlockMesh` instance.
///
/// Roblox: `Instance.new("BlockMesh")`
@target(luau)
@luau.global("Instance.new(\"BlockMesh\")")
...
pub fn set_parent(instance: BlockMesh, value: parent) -> BlockMesh
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BlockMesh) -> Nil
...
pub fn get_attribute_changed_signal(instance: BlockMesh, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BlockMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BlockMesh) -> List(String)
...
pub fn wait_for_child(instance: BlockMesh, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BlockMesh) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BlockMesh, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BlockMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BlockMesh, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BlockMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BlockMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BlockMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BlockMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BlockMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BlockMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BlockMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BlockMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BlockMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BlockMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BlockMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BlockMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BlockMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BlockMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BlockMesh, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: BlockMesh, _: BevelMesh, _: DataModelMesh, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}