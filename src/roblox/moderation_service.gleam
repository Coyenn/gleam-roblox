...
import roblox/types.{
  type Actor, type Content, type Instance, type Int64, type ModerationService,
...
pub fn bind_reviewable_content_event_processor(
...
pub fn create_reviewable_content_key(
  instance: ModerationService,
  content: Content,
) -> String
...
pub fn internal_request_reviewable_content_review_async(
  instance: ModerationService,
  config: Dynamic,
) -> Nil
...
pub fn get_source_asset_id(instance: ModerationService) -> Int64
