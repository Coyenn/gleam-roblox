...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WebSocketClient, type WebSocketState}
...
@target(luau)
@luau.event("Closed")
pub fn closed(instance: WebSocketClient) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `WebSocketClient.Closed`.
///
/// Roblox: `WebSocketClient.Closed`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/WebSocketClient#Closed
...
pub fn on_closed(instance: WebSocketClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn message_received(instance: WebSocketClient) -> RBXScriptSignal(fn(String) -> Nil)

/// Connects to Roblox event `WebSocketClient.MessageReceived`.
///
/// Roblox: `WebSocketClient.MessageReceived`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/WebSocketClient#MessageReceived
...
pub fn on_message_received(instance: WebSocketClient, callback: fn(String) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Opened")
pub fn opened(instance: WebSocketClient) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `WebSocketClient.Opened`.
///
/// Roblox: `WebSocketClient.Opened`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/WebSocketClient#Opened
...
pub fn on_opened(instance: WebSocketClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: WebSocketClient, value: parent) -> WebSocketClient
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WebSocketClient) -> Nil
...
pub fn get_attribute_changed_signal(instance: WebSocketClient, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WebSocketClient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WebSocketClient) -> List(String)
...
pub fn wait_for_child(instance: WebSocketClient, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WebSocketClient) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WebSocketClient, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WebSocketClient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WebSocketClient, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WebSocketClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WebSocketClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WebSocketClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WebSocketClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WebSocketClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WebSocketClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WebSocketClient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WebSocketClient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WebSocketClient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WebSocketClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WebSocketClient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WebSocketClient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WebSocketClient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WebSocketClient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WebSocketClient, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: WebSocketState, _: WebSocketClient, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}