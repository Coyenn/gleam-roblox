...
import roblox/types.{type Actor, type Annotation, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3, type WorkspaceAnnotation}

/// Creates a new Roblox `WorkspaceAnnotation` instance.
///
/// Roblox: `Instance.new("WorkspaceAnnotation")`
@target(luau)
@luau.global("Instance.new(\"WorkspaceAnnotation\")")
...
pub fn set_parent(instance: WorkspaceAnnotation, value: parent) -> WorkspaceAnnotation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WorkspaceAnnotation) -> Nil
...
pub fn get_attribute_changed_signal(instance: WorkspaceAnnotation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WorkspaceAnnotation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WorkspaceAnnotation) -> List(String)
...
pub fn wait_for_child(instance: WorkspaceAnnotation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WorkspaceAnnotation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WorkspaceAnnotation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WorkspaceAnnotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WorkspaceAnnotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WorkspaceAnnotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WorkspaceAnnotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WorkspaceAnnotation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WorkspaceAnnotation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WorkspaceAnnotation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WorkspaceAnnotation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WorkspaceAnnotation, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Vector3, _: PVInstance, _: WorkspaceAnnotation, _: Annotation, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}