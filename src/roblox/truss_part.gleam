...
import roblox/types.{
  ...
  type Material, type NormalId, type Object, type PVInstance,
  type PhysicalProperties, type Player, type RenderFidelity,
  type SecurityCapabilities, type Style, type SurfaceType, type TrussPart,
...
pub fn get_source_asset_id(instance: TrussPart) -> Int64
