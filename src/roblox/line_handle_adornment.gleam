...
import roblox/types.{type Actor, type AdornCullingMode, type CFrame, type Color3, type GuiBase, type GuiBase3d, type HandleAdornment, type Instance, type LineHandleAdornment, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `LineHandleAdornment` instance.
///
/// Roblox: `Instance.new("LineHandleAdornment")`
@target(luau)
@luau.global("Instance.new(\"LineHandleAdornment\")")
pub fn new() -> LineHandleAdornment
...
pub fn mouse_button1_down(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_down(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_up(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_up(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_enter(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_leave(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: LineHandleAdornment, value: parent) -> LineHandleAdornment
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LineHandleAdornment) -> Nil
...
pub fn get_attribute_changed_signal(instance: LineHandleAdornment, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LineHandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LineHandleAdornment) -> List(String)
...
pub fn wait_for_child(instance: LineHandleAdornment, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LineHandleAdornment) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LineHandleAdornment, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LineHandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LineHandleAdornment, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LineHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LineHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LineHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LineHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LineHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LineHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LineHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LineHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LineHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LineHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LineHandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LineHandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LineHandleAdornment, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: PVInstance, _: Vector3, _: CFrame, _: AdornCullingMode, _: LineHandleAdornment, _: HandleAdornment, _: PVAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}