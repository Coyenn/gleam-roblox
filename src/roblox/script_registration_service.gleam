...
import roblox/types.{
  ...
  type ScriptRegistrationService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ScriptRegistrationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ScriptRegistrationService) -> Int64
