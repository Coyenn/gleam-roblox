...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type TextChannel, type TextChatMessage, type UniqueId}

/// Creates a new Roblox `TextChannel` instance.
///
/// Roblox: `Instance.new("TextChannel")`
@target(luau)
@luau.global("Instance.new(\"TextChannel\")")
...
pub fn message_received(instance: TextChannel) -> RBXScriptSignal(fn(TextChatMessage) -> Nil)

/// Connects to Roblox event `TextChannel.MessageReceived`.
///
/// Fires when TextChannel:DisplaySystemMessage() is invoked on the client, or when the client receives a valid TextChannel:SendAsync() response from the server.
///
/// Roblox: `TextChannel.MessageReceived`
...
pub fn on_message_received(instance: TextChannel, callback: fn(TextChatMessage) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: TextChannel, value: parent) -> TextChannel
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TextChannel) -> Nil
...
pub fn get_attribute_changed_signal(instance: TextChannel, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TextChannel, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TextChannel) -> List(String)
...
pub fn wait_for_child(instance: TextChannel, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TextChannel) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TextChannel, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TextChannel) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TextChannel, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TextChannel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TextChannel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TextChannel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TextChannel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TextChannel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TextChannel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TextChannel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TextChannel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TextChannel) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TextChannel, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TextChannel) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TextChannel, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TextChannel, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TextChannel) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TextChannel, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TextChatMessage, _: Player, _: TextChannel, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}