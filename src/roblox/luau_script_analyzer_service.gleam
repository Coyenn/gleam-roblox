...
import roblox/types.{
  type Actor, type Instance, type Int64, type LuauScriptAnalyzerService,
...
pub fn set_archivable(
  instance: LuauScriptAnalyzerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: LuauScriptAnalyzerService) -> Int64
