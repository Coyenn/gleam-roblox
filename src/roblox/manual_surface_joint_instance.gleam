...
import roblox/types.{
  ...
  type ManualSurfaceJointInstance, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn set_c0(
  instance: ManualSurfaceJointInstance,
  value: CFrame,
...
pub fn get_source_asset_id(instance: ManualSurfaceJointInstance) -> Int
