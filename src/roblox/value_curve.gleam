...
import roblox/types.{type Actor, type Instance, type KeyInterpolationMode, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueCurve, type ValueCurveKey}

/// Creates a new Roblox `ValueCurve` instance.
///
/// Roblox: `Instance.new("ValueCurve")`
@target(luau)
@luau.global("Instance.new(\"ValueCurve\")")
pub fn new() -> ValueCurve
...
pub fn get_key_indices_at_time(instance: ValueCurve, time: Float) -> List(Int)
...
@target(luau)
@luau.method("GetKeys")
pub fn get_keys(instance: ValueCurve) -> List(ValueCurveKey)
...
@target(luau)
@luau.method("SetKeys")
pub fn set_keys(instance: ValueCurve, keys: List(ValueCurveKey)) -> Int
...
pub fn set_parent(instance: ValueCurve, value: parent) -> ValueCurve
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ValueCurve) -> Nil
...
pub fn get_attribute_changed_signal(instance: ValueCurve, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ValueCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ValueCurve) -> List(String)
...
pub fn wait_for_child(instance: ValueCurve, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ValueCurve) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ValueCurve, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ValueCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ValueCurve, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ValueCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ValueCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ValueCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ValueCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ValueCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ValueCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ValueCurve, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ValueCurveKey, _: KeyInterpolationMode, _: ValueCurve, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}