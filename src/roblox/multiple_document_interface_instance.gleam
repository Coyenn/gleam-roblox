...
import roblox/types.{
  type Actor, type DataModelSession, type Instance, type Int64,
  type MultipleDocumentInterfaceInstance, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_focused_data_model_session(
  instance: MultipleDocumentInterfaceInstance,
) -> DataModelSession
...
pub fn get_source_asset_id(instance: MultipleDocumentInterfaceInstance) -> Int64
