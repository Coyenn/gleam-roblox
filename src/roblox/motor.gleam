...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type Motor, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Motor` instance.
///
/// Roblox: `Instance.new("Motor")`
@target(luau)
@luau.global("Instance.new(\"Motor\")")
pub fn new() -> Motor
...
pub fn set_parent(instance: Motor, value: parent) -> Motor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Motor) -> Nil
...
pub fn get_attribute_changed_signal(instance: Motor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Motor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Motor) -> List(String)
...
pub fn wait_for_child(instance: Motor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Motor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Motor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Motor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Motor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Motor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Motor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Motor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Motor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Motor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Motor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Motor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Motor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Motor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Motor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Motor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Motor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Motor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Motor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Motor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: Motor, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}