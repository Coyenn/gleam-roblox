...
import roblox/types.{type Actor, type Hint, type Instance, type Message, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Hint, value: parent) -> Hint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Hint) -> Nil
...
pub fn get_attribute_changed_signal(instance: Hint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Hint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Hint) -> List(String)
...
pub fn wait_for_child(instance: Hint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Hint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Hint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Hint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Hint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Hint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Hint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Hint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Hint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Hint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Hint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Hint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Hint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Hint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Hint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Hint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Hint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Hint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Hint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Hint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Hint, _: Message, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}