...
import roblox/types.{
  type Actor, type BasePart, type ControllerBase, type ControllerManager,
  type ControllerSensor, type Instance, type Object, type SecurityCapabilities,
...
pub fn set_climb_sensor(
  instance: ControllerManager,
  value: ControllerSensor,
) -> ControllerManager
...
pub fn get_source_asset_id(instance: ControllerManager) -> Int
