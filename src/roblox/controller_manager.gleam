...
import roblox/types.{type Actor, type BasePart, type ControllerBase, type ControllerManager, type ControllerSensor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `ControllerManager` instance.
///
/// Roblox: `Instance.new("ControllerManager")`
@target(luau)
@luau.global("Instance.new(\"ControllerManager\")")
...
pub fn set_parent(instance: ControllerManager, value: parent) -> ControllerManager
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ControllerManager) -> Nil
...
pub fn get_attribute_changed_signal(instance: ControllerManager, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ControllerManager, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ControllerManager) -> List(String)
...
pub fn wait_for_child(instance: ControllerManager, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ControllerManager) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ControllerManager, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ControllerManager) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ControllerManager, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ControllerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ControllerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ControllerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ControllerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ControllerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ControllerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ControllerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ControllerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ControllerManager) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ControllerManager, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ControllerManager) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ControllerManager, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ControllerManager, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ControllerManager) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ControllerManager, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: BasePart, _: ControllerSensor, _: ControllerBase, _: ControllerManager, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}