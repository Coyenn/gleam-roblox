...
import roblox/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Instance, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type SecurityCapabilities, type SelectionSphere, type UniqueId}

/// Creates a new Roblox `SelectionSphere` instance.
///
/// Roblox: `Instance.new("SelectionSphere")`
@target(luau)
@luau.global("Instance.new(\"SelectionSphere\")")
...
pub fn set_parent(instance: SelectionSphere, value: parent) -> SelectionSphere
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SelectionSphere) -> Nil
...
pub fn get_attribute_changed_signal(instance: SelectionSphere, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SelectionSphere, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SelectionSphere) -> List(String)
...
pub fn wait_for_child(instance: SelectionSphere, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SelectionSphere) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SelectionSphere, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SelectionSphere) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SelectionSphere, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SelectionSphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SelectionSphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SelectionSphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SelectionSphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SelectionSphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SelectionSphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SelectionSphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SelectionSphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SelectionSphere) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SelectionSphere, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SelectionSphere) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SelectionSphere, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SelectionSphere, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SelectionSphere) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SelectionSphere, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: PVInstance, _: SelectionSphere, _: PVAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}