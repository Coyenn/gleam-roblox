...
import roblox/types.{type Actor, type BillboardGui, type GuiBase, type GuiBase2d, type GuiObject, type Instance, type LayerCollector, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type Rect, type SecurityCapabilities, type SelectionBehavior, type UDim2, type UniqueId, type Vector2, type Vector3, type ZIndexBehavior}
...
pub fn selection_changed(instance: BillboardGui) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: BillboardGui, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: BillboardGui, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BillboardGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: BillboardGui, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BillboardGui) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BillboardGui, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BillboardGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BillboardGui, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BillboardGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BillboardGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BillboardGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BillboardGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BillboardGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BillboardGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BillboardGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BillboardGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: BillboardGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BillboardGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BillboardGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BillboardGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: BillboardGui, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: ZIndexBehavior, _: Vector3, _: UDim2, _: BillboardGui, _: LayerCollector, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}