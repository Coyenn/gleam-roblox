...
import roblox/types.{type Actor, type BasePart, type Color3, type GuiBase, type GuiBase3d, type Humanoid, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SelectionLasso, type SelectionPartLasso, type UniqueId}
...
pub fn set_parent(instance: SelectionPartLasso, value: parent) -> SelectionPartLasso
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SelectionPartLasso) -> Nil
...
pub fn get_attribute_changed_signal(instance: SelectionPartLasso, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SelectionPartLasso, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SelectionPartLasso) -> List(String)
...
pub fn wait_for_child(instance: SelectionPartLasso, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SelectionPartLasso) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SelectionPartLasso, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SelectionPartLasso) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SelectionPartLasso, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SelectionPartLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SelectionPartLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SelectionPartLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SelectionPartLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SelectionPartLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SelectionPartLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SelectionPartLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SelectionPartLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SelectionPartLasso) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SelectionPartLasso, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SelectionPartLasso) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SelectionPartLasso, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SelectionPartLasso, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SelectionPartLasso) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SelectionPartLasso, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Humanoid, _: BasePart, _: SelectionPartLasso, _: SelectionLasso, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}