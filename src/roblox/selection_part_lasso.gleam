...
import roblox/types.{
  ...
  type Humanoid, type Instance, type Int64, type Object,
  type SecurityCapabilities, type SelectionLasso, type SelectionPartLasso,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: SelectionPartLasso) -> Int64
