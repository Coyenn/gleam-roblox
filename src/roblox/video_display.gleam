...
pub fn wiring_changed(instance: VideoDisplay) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)
...
pub fn on_wiring_changed(instance: VideoDisplay, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn tween_position(instance: VideoDisplay, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size(instance: VideoDisplay, end_size: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size_and_position(instance: VideoDisplay, end_size: UDim2, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn input_began(instance: VideoDisplay) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_began(instance: VideoDisplay, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_changed(instance: VideoDisplay) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_changed(instance: VideoDisplay, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_ended(instance: VideoDisplay) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_ended(instance: VideoDisplay, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: VideoDisplay) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_enter(instance: VideoDisplay, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: VideoDisplay) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_leave(instance: VideoDisplay, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_moved(instance: VideoDisplay) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_moved(instance: VideoDisplay, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_backward(instance: VideoDisplay) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_backward(instance: VideoDisplay, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_forward(instance: VideoDisplay) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_forward(instance: VideoDisplay, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_selection_gained(instance: VideoDisplay, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_selection_lost(instance: VideoDisplay, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn touch_long_press(instance: VideoDisplay) -> RBXScriptSignal(fn(List(Vector2), UserInputState) -> Nil)
...
pub fn on_touch_long_press(instance: VideoDisplay, callback: fn(List(Vector2), UserInputState) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchPan")
pub fn touch_pan(instance: VideoDisplay) -> RBXScriptSignal(fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil)
...
pub fn on_touch_pan(instance: VideoDisplay, callback: fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_pinch(instance: VideoDisplay) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_pinch(instance: VideoDisplay, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_rotate(instance: VideoDisplay) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_rotate(instance: VideoDisplay, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_swipe(instance: VideoDisplay) -> RBXScriptSignal(fn(SwipeDirection, Int) -> Nil)
...
pub fn on_touch_swipe(instance: VideoDisplay, callback: fn(SwipeDirection, Int) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchTap")
pub fn touch_tap(instance: VideoDisplay) -> RBXScriptSignal(fn(List(Vector2)) -> Nil)
...
pub fn on_touch_tap(instance: VideoDisplay, callback: fn(List(Vector2)) -> Nil) -> RBXScriptConnection
...
pub fn selection_changed(instance: VideoDisplay) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: VideoDisplay, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: VideoDisplay, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VideoDisplay, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: VideoDisplay, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VideoDisplay) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VideoDisplay, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VideoDisplay) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VideoDisplay, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VideoDisplay) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VideoDisplay, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VideoDisplay) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VideoDisplay, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VideoDisplay) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VideoDisplay, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VideoDisplay) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VideoDisplay, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: VideoDisplay, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VideoDisplay) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VideoDisplay, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VideoDisplay, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: VideoDisplay, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: SwipeDirection, _: UserInputState, _: InputObject, _: UDim2, _: EasingDirection, _: EasingStyle, _: SizeConstraint, _: InputSink, _: GuiState, _: BorderMode, _: Color3, _: AutomaticSize, _: Wire, _: ScaleType, _: ResamplerMode, _: VideoDisplay, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}