...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StyleDerive, type StyleSheet, type UniqueId}

/// Creates a new Roblox `StyleDerive` instance.
///
/// Roblox: `Instance.new("StyleDerive")`
@target(luau)
@luau.global("Instance.new(\"StyleDerive\")")
pub fn new() -> StyleDerive
...
pub fn set_parent(instance: StyleDerive, value: parent) -> StyleDerive
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StyleDerive) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleDerive, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StyleDerive, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StyleDerive) -> List(String)
...
pub fn wait_for_child(instance: StyleDerive, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StyleDerive) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StyleDerive, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StyleDerive) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StyleDerive, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StyleDerive) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StyleDerive, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StyleDerive) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StyleDerive, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StyleDerive) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StyleDerive, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StyleDerive) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StyleDerive, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StyleDerive) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StyleDerive, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StyleDerive) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StyleDerive, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StyleDerive, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StyleDerive) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StyleDerive, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StyleSheet, _: StyleDerive, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}