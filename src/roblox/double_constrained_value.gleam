...
import roblox/types.{type Actor, type DoubleConstrainedValue, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(OptionDouble) -> Nil)
...
pub fn on_changed(instance: DoubleConstrainedValue, callback: fn(OptionDouble) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: DoubleConstrainedValue, value: parent) -> DoubleConstrainedValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DoubleConstrainedValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: DoubleConstrainedValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DoubleConstrainedValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DoubleConstrainedValue) -> List(String)
...
pub fn wait_for_child(instance: DoubleConstrainedValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DoubleConstrainedValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DoubleConstrainedValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DoubleConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DoubleConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DoubleConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DoubleConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DoubleConstrainedValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DoubleConstrainedValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DoubleConstrainedValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DoubleConstrainedValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DoubleConstrainedValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}