...
import roblox/types.{
  type Actor, type DebuggerLuaResponse, type DebuggerStatus, type Instance,
...
pub fn get_source_asset_id(instance: DebuggerLuaResponse) -> Int64
