...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type RunningAverageItemInt,
...
pub fn set_archivable(
  instance: RunningAverageItemInt,
  value: Bool,
...
pub fn get_source_asset_id(instance: RunningAverageItemInt) -> Int64
