...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type RunningAverageItemInt, type SecurityCapabilities, type StatsItem, type UniqueId}

/// Treats `RunningAverageItemInt` as its Roblox ancestor `StatsItem`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_stats_item(instance: RunningAverageItemInt) -> StatsItem

/// Treats `RunningAverageItemInt` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: RunningAverageItemInt) -> Instance

/// Treats `RunningAverageItemInt` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: RunningAverageItemInt) -> Object
...
pub fn set_parent(instance: RunningAverageItemInt, value: parent) -> RunningAverageItemInt
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RunningAverageItemInt) -> Nil
...
pub fn get_attribute_changed_signal(instance: RunningAverageItemInt, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RunningAverageItemInt, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RunningAverageItemInt) -> List(String)
...
pub fn wait_for_child(instance: RunningAverageItemInt, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RunningAverageItemInt, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RunningAverageItemInt, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RunningAverageItemInt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RunningAverageItemInt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RunningAverageItemInt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RunningAverageItemInt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RunningAverageItemInt) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RunningAverageItemInt, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RunningAverageItemInt) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RunningAverageItemInt, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RunningAverageItemInt, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RunningAverageItemInt) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RunningAverageItemInt, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RunningAverageItemInt, _: StatsItem, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}