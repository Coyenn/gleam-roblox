...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PlaybackState, type SecurityCapabilities, type TweenBase, type UniqueId}
...
pub fn completed(instance: TweenBase) -> RBXScriptSignal(fn(PlaybackState) -> Nil)
...
pub fn on_completed(instance: TweenBase, callback: fn(PlaybackState) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: TweenBase, value: parent) -> TweenBase
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TweenBase) -> Nil
...
pub fn get_attribute_changed_signal(instance: TweenBase, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TweenBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TweenBase) -> List(String)
...
pub fn wait_for_child(instance: TweenBase, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TweenBase) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TweenBase, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TweenBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TweenBase, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TweenBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TweenBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TweenBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TweenBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TweenBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TweenBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TweenBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TweenBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TweenBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TweenBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TweenBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TweenBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TweenBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TweenBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TweenBase, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PlaybackState, _: TweenBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}