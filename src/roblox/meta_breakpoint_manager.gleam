...
import roblox/types.{
  type Actor, type Instance, type Int64, type MetaBreakpointManager, type Object,
...
pub fn set_archivable(
  instance: MetaBreakpointManager,
  value: Bool,
...
pub fn get_source_asset_id(instance: MetaBreakpointManager) -> Int64
