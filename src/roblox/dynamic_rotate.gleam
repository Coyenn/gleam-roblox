...
import roblox/types.{type Actor, type BasePart, type CFrame, type DynamicRotate, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: DynamicRotate, value: parent) -> DynamicRotate
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DynamicRotate) -> Nil
...
pub fn get_attribute_changed_signal(instance: DynamicRotate, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DynamicRotate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DynamicRotate) -> List(String)
...
pub fn wait_for_child(instance: DynamicRotate, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DynamicRotate) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DynamicRotate, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DynamicRotate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DynamicRotate, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DynamicRotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DynamicRotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DynamicRotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DynamicRotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DynamicRotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DynamicRotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DynamicRotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DynamicRotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DynamicRotate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DynamicRotate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DynamicRotate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DynamicRotate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DynamicRotate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DynamicRotate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DynamicRotate, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: DynamicRotate, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}