...
import roblox/types.{type Actor, type ImportSession, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn upload_complete(instance: ImportSession) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_upload_complete(instance: ImportSession, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn upload_progress(instance: ImportSession) -> RBXScriptSignal(fn(Float) -> Nil)
...
pub fn on_upload_progress(instance: ImportSession, callback: fn(Float) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ImportSession, value: parent) -> ImportSession
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ImportSession) -> Nil
...
pub fn get_attribute_changed_signal(instance: ImportSession, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ImportSession, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ImportSession) -> List(String)
...
pub fn wait_for_child(instance: ImportSession, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ImportSession) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ImportSession, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ImportSession) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ImportSession, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ImportSession) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ImportSession, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ImportSession) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ImportSession, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ImportSession) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ImportSession, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ImportSession, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ImportSession) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ImportSession, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ImportSession, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}