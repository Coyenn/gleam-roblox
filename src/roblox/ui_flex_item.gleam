...
import roblox/types.{type Actor, type Instance, type ItemLineAlignment, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UIBase, type UIComponent, type UIFlexItem, type UIFlexMode, type UniqueId}

/// Creates a new Roblox `UIFlexItem` instance.
///
/// Roblox: `Instance.new("UIFlexItem")`
@target(luau)
@luau.global("Instance.new(\"UIFlexItem\")")
pub fn new() -> UIFlexItem
...
pub fn set_parent(instance: UIFlexItem, value: parent) -> UIFlexItem
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIFlexItem) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIFlexItem, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIFlexItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIFlexItem) -> List(String)
...
pub fn wait_for_child(instance: UIFlexItem, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIFlexItem) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIFlexItem, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIFlexItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIFlexItem, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIFlexItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIFlexItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIFlexItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIFlexItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIFlexItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIFlexItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIFlexItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIFlexItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIFlexItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIFlexItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIFlexItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIFlexItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIFlexItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIFlexItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIFlexItem, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ItemLineAlignment, _: UIFlexMode, _: UIFlexItem, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}