...
import roblox/types.{
  type Actor, type Instance, type Int64, type ItemLineAlignment, type Object,
  type SecurityCapabilities, type UIBase, type UIComponent, type UIFlexItem,
  type UIFlexMode, type UniqueId,
}
...
pub fn get_source_asset_id(instance: UIFlexItem) -> Int64
