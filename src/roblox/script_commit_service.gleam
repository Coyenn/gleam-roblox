...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptCommitService,
...
pub fn get_source_asset_id(instance: ScriptCommitService) -> Int64
