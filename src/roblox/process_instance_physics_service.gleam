...
import roblox/types.{
  ...
  type ProcessInstancePhysicsService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ProcessInstancePhysicsService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ProcessInstancePhysicsService) -> Int64
