...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type ProcessInstancePhysicsService, type SecurityCapabilities, type UniqueId}

/// Treats `ProcessInstancePhysicsService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: ProcessInstancePhysicsService) -> Instance

/// Treats `ProcessInstancePhysicsService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: ProcessInstancePhysicsService) -> Object
...
pub fn set_parent(instance: ProcessInstancePhysicsService, value: parent) -> ProcessInstancePhysicsService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ProcessInstancePhysicsService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ProcessInstancePhysicsService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ProcessInstancePhysicsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ProcessInstancePhysicsService) -> List(String)
...
pub fn wait_for_child(instance: ProcessInstancePhysicsService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ProcessInstancePhysicsService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ProcessInstancePhysicsService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ProcessInstancePhysicsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ProcessInstancePhysicsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ProcessInstancePhysicsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ProcessInstancePhysicsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ProcessInstancePhysicsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ProcessInstancePhysicsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ProcessInstancePhysicsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ProcessInstancePhysicsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ProcessInstancePhysicsService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ProcessInstancePhysicsService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}