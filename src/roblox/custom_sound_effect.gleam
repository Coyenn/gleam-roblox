...
import roblox/types.{
  type Actor, type CustomSoundEffect, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: CustomSoundEffect) -> Int64
