...
import roblox/types.{
  ...
  type MeshPartDetailLevel, type Object, type OptionDouble, type OptionInt64,
  type QualityLevel, type RenderSettings, type SecurityCapabilities,
  type UniqueId, type ViewMode,
}
...
pub fn set_eager_bulk_execution(
  instance: RenderSettings,
  value: Bool,
) -> RenderSettings
...
pub fn set_export_merge_by_material(
  instance: RenderSettings,
  value: Bool,
) -> RenderSettings
...
pub fn set_frame_rate_manager(
  instance: RenderSettings,
  value: FramerateManagerMode,
) -> RenderSettings
...
pub fn get_mesh_part_detail_level(
  instance: RenderSettings,
) -> MeshPartDetailLevel
...
pub fn set_mesh_part_detail_level(
  instance: RenderSettings,
  value: MeshPartDetailLevel,
) -> RenderSettings
...
pub fn set_render_csg_triangles_debug(
  instance: RenderSettings,
  value: Bool,
) -> RenderSettings
...
pub fn set_show_bounding_boxes(
  instance: RenderSettings,
  value: Bool,
) -> RenderSettings
