...
import roblox/types.{type Actor, type FramerateManagerMode, type GraphicsMode, type Instance, type MeshPartDetailLevel, type Object, type OptionDouble, type OptionInt64, type QualityLevel, type RenderSettings, type SecurityCapabilities, type UniqueId, type ViewMode}
