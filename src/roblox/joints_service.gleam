...
import roblox/types.{
  type Actor, type Instance, type Int64, type JointsService, type Object,
...
pub fn set_join_after_move_instance(
  instance: JointsService,
...
pub fn set_join_after_move_target(
  instance: JointsService,
  join_target: Instance,
) -> Nil
...
pub fn get_source_asset_id(instance: JointsService) -> Int64
