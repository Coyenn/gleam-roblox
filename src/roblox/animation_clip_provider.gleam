...
import roblox/types.{
  type Actor, type AnimationClip, type AnimationClipProvider, type ClipEvaluator,
...
pub fn register_active_animation_clip(
  instance: AnimationClipProvider,
...
pub fn get_animation_clip_async(
  instance: AnimationClipProvider,
  asset_id: ContentId,
) -> AnimationClip
...
pub fn get_clip_evaluator_async(
  instance: AnimationClipProvider,
  asset_id: ContentId,
) -> ClipEvaluator
...
pub fn get_source_asset_id(instance: AnimationClipProvider) -> Int64
