...
import roblox/types.{
  type Actor, type ExperienceStateRecordingService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: ExperienceStateRecordingService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ExperienceStateRecordingService) -> Int64
