...
import roblox/types.{type Actor, type ExperienceStateRecordingService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `ExperienceStateRecordingService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: ExperienceStateRecordingService) -> Instance

/// Treats `ExperienceStateRecordingService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: ExperienceStateRecordingService) -> Object
...
pub fn set_parent(instance: ExperienceStateRecordingService, value: parent) -> ExperienceStateRecordingService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ExperienceStateRecordingService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ExperienceStateRecordingService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ExperienceStateRecordingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ExperienceStateRecordingService) -> List(String)
...
pub fn wait_for_child(instance: ExperienceStateRecordingService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ExperienceStateRecordingService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ExperienceStateRecordingService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ExperienceStateRecordingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ExperienceStateRecordingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ExperienceStateRecordingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ExperienceStateRecordingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ExperienceStateRecordingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ExperienceStateRecordingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ExperienceStateRecordingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ExperienceStateRecordingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ExperienceStateRecordingService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ExperienceStateRecordingService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}