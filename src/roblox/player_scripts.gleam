...
import roblox/types.{type Actor, type ComputerCameraMovementMode, type ComputerMovementMode, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerScripts, type SecurityCapabilities, type TouchCameraMovementMode, type TouchMovementMode, type UniqueId}
...
pub fn set_parent(instance: PlayerScripts, value: parent) -> PlayerScripts
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlayerScripts) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlayerScripts, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlayerScripts, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlayerScripts) -> List(String)
...
pub fn wait_for_child(instance: PlayerScripts, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlayerScripts) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlayerScripts, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlayerScripts) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlayerScripts, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlayerScripts) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlayerScripts, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlayerScripts) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlayerScripts, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlayerScripts) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlayerScripts, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlayerScripts) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlayerScripts, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlayerScripts) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlayerScripts, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlayerScripts) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlayerScripts, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlayerScripts, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlayerScripts) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PlayerScripts, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TouchMovementMode, _: TouchCameraMovementMode, _: ComputerMovementMode, _: ComputerCameraMovementMode, _: PlayerScripts, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}