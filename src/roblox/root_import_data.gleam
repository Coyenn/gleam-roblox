...
import roblox/types.{type Actor, type BaseImportData, type Instance, type MeshScaleUnit, type NormalId, type Object, type OptionDouble, type OptionInt64, type PhysicalConstraintType, type RestPose, type RigScale, type RigType, type RootImportData, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_import_name(instance: RootImportData, value: String) -> RootImportData
...
pub fn set_should_import(instance: RootImportData, value: Bool) -> RootImportData
...
pub fn status_removed(instance: RootImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_removed(instance: RootImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn status_reported(instance: RootImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_reported(instance: RootImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_capabilities(instance: RootImportData, value: SecurityCapabilities) -> RootImportData
...
pub fn find_first_ancestor(instance: RootImportData, name: String) -> Option(Instance)
...
pub fn find_first_ancestor_of_class(instance: RootImportData, class_name: String) -> Option(Instance)
...
pub fn find_first_ancestor_which_is_a(instance: RootImportData, class_name: String) -> Option(Instance)
...
pub fn find_first_child(instance: RootImportData, name: String, recursive: Bool) -> Option(Instance)
...
pub fn find_first_child_of_class(instance: RootImportData, class_name: String) -> Option(Instance)
...
pub fn find_first_child_which_is_a(instance: RootImportData, class_name: String, recursive: Bool) -> Option(Instance)
...
pub fn find_first_descendant(instance: RootImportData, name: String) -> Option(Instance)
...
pub fn get_attribute_changed_signal(instance: RootImportData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RootImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn query_descendants(instance: RootImportData, selector: String) -> List(Instance)
...
pub fn reset_property_to_default(instance: RootImportData, property: String) -> Nil
...
pub fn wait_for_child(instance: RootImportData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RootImportData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RootImportData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RootImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RootImportData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RootImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RootImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RootImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RootImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RootImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RootImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RootImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RootImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: RootImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RootImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RootImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RootImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: RootImportData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NormalId, _: MeshScaleUnit, _: RigType, _: RigScale, _: RestPose, _: PhysicalConstraintType, _: Vector3, _: RootImportData, _: BaseImportData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}