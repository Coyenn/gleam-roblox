...
import roblox/types.{type Actor, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UDim, type UDim2, type UIBase, type UIComponent, type UIShadow, type UniqueId}

/// Creates a new Roblox `UIShadow` instance.
///
/// Roblox: `Instance.new("UIShadow")`
@target(luau)
@luau.global("Instance.new(\"UIShadow\")")
pub fn new() -> UIShadow
...
pub fn set_parent(instance: UIShadow, value: parent) -> UIShadow
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIShadow) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIShadow, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIShadow, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIShadow) -> List(String)
...
pub fn wait_for_child(instance: UIShadow, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIShadow) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIShadow, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIShadow) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIShadow, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIShadow) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIShadow, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIShadow) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIShadow, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIShadow) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIShadow, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIShadow) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIShadow, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIShadow) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIShadow, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIShadow) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIShadow, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIShadow, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIShadow) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIShadow, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UDim2, _: Color3, _: UDim, _: UIShadow, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}