...
import roblox/types.{
  ...
  type SecurityCapabilities, type UDim, type UDim2, type UIBase,
  type UIComponent, type UIShadow, type UniqueId,
}
...
pub fn get_source_asset_id(instance: UIShadow) -> Int64
