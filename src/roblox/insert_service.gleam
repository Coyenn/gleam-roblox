...
import roblox/types.{type Actor, type CollisionFidelity, type ContentId, type InsertService, type Instance, type MeshPart, type Object, type OptionDouble, type OptionInt64, type RenderFidelity, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: InsertService, value: parent) -> InsertService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InsertService) -> Nil
...
pub fn get_attribute_changed_signal(instance: InsertService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InsertService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InsertService) -> List(String)
...
pub fn wait_for_child(instance: InsertService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InsertService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InsertService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InsertService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InsertService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InsertService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InsertService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InsertService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InsertService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InsertService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InsertService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InsertService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InsertService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InsertService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InsertService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InsertService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InsertService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InsertService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InsertService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InsertService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MeshPart, _: ContentId, _: CollisionFidelity, _: RenderFidelity, _: InsertService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}