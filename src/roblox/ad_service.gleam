...
import roblox/types.{type Actor, type AdFormat, type AdReward, type AdService, type GuiButton, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type ShowAdResult, type UniqueId}
...
pub fn set_parent(instance: AdService, value: parent) -> AdService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AdService) -> Nil
...
pub fn get_attribute_changed_signal(instance: AdService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AdService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AdService) -> List(String)
...
pub fn wait_for_child(instance: AdService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AdService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AdService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AdService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AdService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AdService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AdService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AdService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AdService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AdService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AdService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AdService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ShowAdResult, _: Player, _: AdReward, _: AdFormat, _: GuiButton, _: AdService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}