...
pub fn register_disclosure_button(
  instance: AdService,
  disclosure_button: GuiButton,
  ad_integration_placement_id: String,
) -> Nil
...
pub fn unregister_ad_opportunity(
  instance: AdService,
  instance_: Instance,
) -> Nil
...
pub fn get_ad_availability_now_async(
  instance: AdService,
  ad_format: AdFormat,
) -> Dynamic
...
pub fn get_campaign_eligibility_async(
  instance: AdService,
  campaign_id: String,
  player: Player,
) -> Dynamic
...
pub fn show_rewarded_video_ad_async(
  instance: AdService,
  player: Player,
  reward: AdReward,
  placement_id: Option(Int),
