...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StyleLink, type StyleSheet, type UniqueId}

/// Creates a new Roblox `StyleLink` instance.
///
/// Roblox: `Instance.new("StyleLink")`
@target(luau)
@luau.global("Instance.new(\"StyleLink\")")
pub fn new() -> StyleLink
...
pub fn set_parent(instance: StyleLink, value: parent) -> StyleLink
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StyleLink) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleLink, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StyleLink, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StyleLink) -> List(String)
...
pub fn wait_for_child(instance: StyleLink, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StyleLink) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StyleLink, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StyleLink) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StyleLink, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StyleLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StyleLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StyleLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StyleLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StyleLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StyleLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StyleLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StyleLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StyleLink) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StyleLink, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StyleLink) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StyleLink, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StyleLink, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StyleLink) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StyleLink, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StyleSheet, _: StyleLink, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}