...
import roblox/types.{
  type Actor, type FlyweightService, type Instance, type Int64,
  type NonReplicatedCSGDictionaryService, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: NonReplicatedCSGDictionaryService) -> Int64
