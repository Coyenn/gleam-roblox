...
import roblox/types.{type Actor, type FlyweightService, type Instance, type NonReplicatedCSGDictionaryService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `NonReplicatedCSGDictionaryService` as its Roblox ancestor `FlyweightService`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_flyweight_service(instance: NonReplicatedCSGDictionaryService) -> FlyweightService
...
pub fn set_parent(instance: NonReplicatedCSGDictionaryService, value: parent) -> NonReplicatedCSGDictionaryService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NonReplicatedCSGDictionaryService) -> Nil
...
pub fn get_attribute_changed_signal(instance: NonReplicatedCSGDictionaryService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NonReplicatedCSGDictionaryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NonReplicatedCSGDictionaryService) -> List(String)
...
pub fn wait_for_child(instance: NonReplicatedCSGDictionaryService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NonReplicatedCSGDictionaryService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NonReplicatedCSGDictionaryService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NonReplicatedCSGDictionaryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NonReplicatedCSGDictionaryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NonReplicatedCSGDictionaryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NonReplicatedCSGDictionaryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NonReplicatedCSGDictionaryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NonReplicatedCSGDictionaryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NonReplicatedCSGDictionaryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NonReplicatedCSGDictionaryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: NonReplicatedCSGDictionaryService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NonReplicatedCSGDictionaryService, _: FlyweightService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}