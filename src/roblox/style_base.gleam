...
pub fn style_rules_changed(instance: StyleBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_style_rules_changed(instance: StyleBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: StyleBase, value: parent) -> StyleBase
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StyleBase) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleBase, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StyleBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StyleBase) -> List(String)
...
pub fn wait_for_child(instance: StyleBase, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StyleBase) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StyleBase, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StyleBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StyleBase, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StyleBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StyleBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StyleBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StyleBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StyleBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StyleBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StyleBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StyleBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StyleBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StyleBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StyleBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StyleBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StyleBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StyleBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StyleBase, callback: fn(String) -> Nil) -> RBXScriptConnection
