...
import roblox/types.{type Actor, type BasePart, type CFrame, type Glue, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: Glue, value: parent) -> Glue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Glue) -> Nil
...
pub fn get_attribute_changed_signal(instance: Glue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Glue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Glue) -> List(String)
...
pub fn wait_for_child(instance: Glue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Glue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Glue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Glue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Glue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Glue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Glue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Glue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Glue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Glue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Glue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Glue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Glue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Glue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Glue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Glue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Glue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Glue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Glue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Glue, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: Vector3, _: Glue, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}