...
import roblox/types.{type Actor, type Clouds, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Clouds` instance.
///
/// Roblox: `Instance.new("Clouds")`
@target(luau)
@luau.global("Instance.new(\"Clouds\")")
pub fn new() -> Clouds
...
pub fn set_parent(instance: Clouds, value: parent) -> Clouds
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Clouds) -> Nil
...
pub fn get_attribute_changed_signal(instance: Clouds, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Clouds, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Clouds) -> List(String)
...
pub fn wait_for_child(instance: Clouds, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Clouds) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Clouds, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Clouds) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Clouds, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Clouds) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Clouds, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Clouds) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Clouds, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Clouds) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Clouds, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Clouds) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Clouds, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Clouds) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Clouds, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Clouds) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Clouds, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Clouds, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Clouds) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Clouds, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Clouds, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}