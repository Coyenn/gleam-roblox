...
import roblox/types.{
  type Actor, type HiddenSurfaceRemovalAsset, type Instance, type Int64,
...
pub fn set_archivable(
  instance: HiddenSurfaceRemovalAsset,
  value: Bool,
...
pub fn get_source_asset_id(instance: HiddenSurfaceRemovalAsset) -> Int64
