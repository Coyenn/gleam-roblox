...
import roblox/types.{
  ...
  type ProximityPrompt, type ProximityPromptInputType,
  type ProximityPromptService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_enabled(
  instance: ProximityPromptService,
  value: Bool,
...
pub fn set_max_indicators_visible(
  instance: ProximityPromptService,
  value: Int,
) -> ProximityPromptService
...
pub fn set_max_prompts_visible(
  instance: ProximityPromptService,
  value: Int,
) -> ProximityPromptService
...
pub fn indicator_hidden(
  instance: ProximityPromptService,
) -> RBXScriptSignal(fn(ProximityPrompt) -> Nil)
...
pub fn on_indicator_hidden(
  instance: ProximityPromptService,
  callback: fn(ProximityPrompt) -> Nil,
) -> RBXScriptConnection
...
pub fn prompt_button_hold_began(
  instance: ProximityPromptService,
) -> RBXScriptSignal(fn(ProximityPrompt, Player) -> Nil)
...
pub fn on_prompt_button_hold_began(
  instance: ProximityPromptService,
  callback: fn(ProximityPrompt, Player) -> Nil,
) -> RBXScriptConnection
...
pub fn prompt_shown(
  instance: ProximityPromptService,
) -> RBXScriptSignal(fn(ProximityPrompt, ProximityPromptInputType) -> Nil)
...
pub fn on_prompt_shown(
  instance: ProximityPromptService,
  callback: fn(ProximityPrompt, ProximityPromptInputType) -> Nil,
) -> RBXScriptConnection
...
pub fn on_prompt_trigger_ended(
  instance: ProximityPromptService,
  callback: fn(ProximityPrompt, Player) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: ProximityPromptService) -> Int64
