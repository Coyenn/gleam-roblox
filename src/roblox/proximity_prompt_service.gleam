...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type ProximityPrompt, type ProximityPromptInputType, type ProximityPromptService, type SecurityCapabilities, type UniqueId}
...
pub fn indicator_hidden(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt) -> Nil)

/// Connects to Roblox event `ProximityPromptService.IndicatorHidden`.
///
/// Roblox: `ProximityPromptService.IndicatorHidden`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/ProximityPromptService#IndicatorHidden
...
pub fn on_indicator_hidden(instance: ProximityPromptService, callback: fn(ProximityPrompt) -> Nil) -> RBXScriptConnection
...
pub fn indicator_shown(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt) -> Nil)

/// Connects to Roblox event `ProximityPromptService.IndicatorShown`.
///
/// Roblox: `ProximityPromptService.IndicatorShown`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/ProximityPromptService#IndicatorShown
...
pub fn on_indicator_shown(instance: ProximityPromptService, callback: fn(ProximityPrompt) -> Nil) -> RBXScriptConnection
...
pub fn prompt_button_hold_began(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt, Player) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptButtonHoldBegan`.
///
/// Triggers when the player begins holding down the KeyboardKeyCode key/button on a prompt with a non-zero HoldDuration.
///
/// Roblox: `ProximityPromptService.PromptButtonHoldBegan`
...
pub fn on_prompt_button_hold_began(instance: ProximityPromptService, callback: fn(ProximityPrompt, Player) -> Nil) -> RBXScriptConnection
...
pub fn prompt_button_hold_ended(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt, Player) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptButtonHoldEnded`.
///
/// Triggers when the player stops holding down the KeyboardKeyCode key/button on a prompt with a non-zero HoldDuration.
///
/// Roblox: `ProximityPromptService.PromptButtonHoldEnded`
...
pub fn on_prompt_button_hold_ended(instance: ProximityPromptService, callback: fn(ProximityPrompt, Player) -> Nil) -> RBXScriptConnection
...
pub fn prompt_hidden(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptHidden`.
///
/// Triggers client-side when a prompt becomes hidden.
///
/// Roblox: `ProximityPromptService.PromptHidden`
...
pub fn on_prompt_hidden(instance: ProximityPromptService, callback: fn(ProximityPrompt) -> Nil) -> RBXScriptConnection
...
pub fn prompt_shown(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt, ProximityPromptInputType) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptShown`.
///
/// Triggers client-side when a prompt becomes visible.
///
/// Roblox: `ProximityPromptService.PromptShown`
...
pub fn on_prompt_shown(instance: ProximityPromptService, callback: fn(ProximityPrompt, ProximityPromptInputType) -> Nil) -> RBXScriptConnection
...
pub fn prompt_trigger_ended(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt, Player) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptTriggerEnded`.
///
/// Triggers when the player stops holding down the KeyboardKeyCode key/button while triggering a prompt.
///
/// Roblox: `ProximityPromptService.PromptTriggerEnded`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/ProximityPromptService#PromptTriggerEnded
@target(luau)
@luau.global("(function(instance, callback) return instance.PromptTriggerEnded:Connect(callback) end)")
pub fn on_prompt_trigger_ended(instance: ProximityPromptService, callback: fn(ProximityPrompt, Player) -> Nil) -> RBXScriptConnection
...
pub fn prompt_triggered(instance: ProximityPromptService) -> RBXScriptSignal(fn(ProximityPrompt, Player) -> Nil)

/// Connects to Roblox event `ProximityPromptService.PromptTriggered`.
///
/// Triggers when the user interacts with this prompt.
///
/// Roblox: `ProximityPromptService.PromptTriggered`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/ProximityPromptService#PromptTriggered
@target(luau)
@luau.global("(function(instance, callback) return instance.PromptTriggered:Connect(callback) end)")
pub fn on_prompt_triggered(instance: ProximityPromptService, callback: fn(ProximityPrompt, Player) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ProximityPromptService, value: parent) -> ProximityPromptService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ProximityPromptService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ProximityPromptService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ProximityPromptService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ProximityPromptService) -> List(String)
...
pub fn wait_for_child(instance: ProximityPromptService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ProximityPromptService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ProximityPromptService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ProximityPromptService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ProximityPromptService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ProximityPromptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ProximityPromptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ProximityPromptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ProximityPromptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ProximityPromptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ProximityPromptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ProximityPromptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ProximityPromptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ProximityPromptService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ProximityPromptService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ProximityPromptService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ProximityPromptService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ProximityPromptService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ProximityPromptService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ProximityPromptService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ProximityPrompt, _: Player, _: ProximityPromptInputType, _: ProximityPromptService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}