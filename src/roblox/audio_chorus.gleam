...
import roblox/types.{type Actor, type AudioChorus, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioChorus` instance.
///
/// Roblox: `Instance.new("AudioChorus")`
@target(luau)
@luau.global("Instance.new(\"AudioChorus\")")
pub fn new() -> AudioChorus
...
pub fn get_input_pins(instance: AudioChorus) -> List(String)
...
pub fn get_output_pins(instance: AudioChorus) -> List(String)
...
pub fn wiring_changed(instance: AudioChorus) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioChorus.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioChorus via a Wire.
///
/// Roblox: `AudioChorus.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioChorus, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioChorus, value: parent) -> AudioChorus
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioChorus) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioChorus, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioChorus, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioChorus) -> List(String)
...
pub fn wait_for_child(instance: AudioChorus, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioChorus) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioChorus, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioChorus) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioChorus, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioChorus) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioChorus, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioChorus) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioChorus, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioChorus) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioChorus, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioChorus) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioChorus, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioChorus) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioChorus, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioChorus) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioChorus, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioChorus, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioChorus) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioChorus, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioChorus, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}