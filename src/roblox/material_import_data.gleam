...
import roblox/types.{
  ...
  type MaterialImportData, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_diffuse_file_path(
  instance: MaterialImportData,
  value: String,
) -> MaterialImportData
...
pub fn set_metalness_file_path(
  instance: MaterialImportData,
  value: String,
) -> MaterialImportData
...
pub fn set_roughness_file_path(
  instance: MaterialImportData,
  value: String,
) -> MaterialImportData
...
pub fn get_source_asset_id(instance: MaterialImportData) -> Int64
