...
import roblox/types.{type Actor, type BaseImportData, type Instance, type MaterialImportData, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn status_removed(instance: MaterialImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_removed(instance: MaterialImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn status_reported(instance: MaterialImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_reported(instance: MaterialImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: MaterialImportData, value: parent) -> MaterialImportData
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MaterialImportData) -> Nil
...
pub fn get_attribute_changed_signal(instance: MaterialImportData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MaterialImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MaterialImportData) -> List(String)
...
pub fn wait_for_child(instance: MaterialImportData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MaterialImportData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MaterialImportData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MaterialImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MaterialImportData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MaterialImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MaterialImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MaterialImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MaterialImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MaterialImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MaterialImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MaterialImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MaterialImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MaterialImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MaterialImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MaterialImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MaterialImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MaterialImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MaterialImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MaterialImportData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MaterialImportData, _: BaseImportData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}