...
import roblox/types.{type Actor, type AnimationClip, type AnimationPriority, type Instance, type KeyframeSequence, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `KeyframeSequence` instance.
///
/// Roblox: `Instance.new("KeyframeSequence")`
@target(luau)
@luau.global("Instance.new(\"KeyframeSequence\")")
...
pub fn set_parent(instance: KeyframeSequence, value: parent) -> KeyframeSequence
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: KeyframeSequence) -> Nil
...
pub fn get_attribute_changed_signal(instance: KeyframeSequence, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: KeyframeSequence, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: KeyframeSequence) -> List(String)
...
pub fn wait_for_child(instance: KeyframeSequence, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: KeyframeSequence) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: KeyframeSequence, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: KeyframeSequence) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: KeyframeSequence, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: KeyframeSequence) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: KeyframeSequence, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: KeyframeSequence) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: KeyframeSequence, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: KeyframeSequence) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: KeyframeSequence, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: KeyframeSequence) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: KeyframeSequence, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: KeyframeSequence) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: KeyframeSequence, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: KeyframeSequence) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: KeyframeSequence, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: KeyframeSequence, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: KeyframeSequence) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: KeyframeSequence, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationPriority, _: KeyframeSequence, _: AnimationClip, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}