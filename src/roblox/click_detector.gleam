...
import roblox/types.{type Actor, type ClickDetector, type Content, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ClickDetector` instance.
///
/// Roblox: `Instance.new("ClickDetector")`
@target(luau)
@luau.global("Instance.new(\"ClickDetector\")")
pub fn new() -> ClickDetector
...
pub fn mouse_click(instance: ClickDetector) -> RBXScriptSignal(fn(Player) -> Nil)
...
pub fn on_mouse_click(instance: ClickDetector, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn mouse_hover_enter(instance: ClickDetector) -> RBXScriptSignal(fn(Player) -> Nil)
...
pub fn on_mouse_hover_enter(instance: ClickDetector, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn mouse_hover_leave(instance: ClickDetector) -> RBXScriptSignal(fn(Player) -> Nil)
...
pub fn on_mouse_hover_leave(instance: ClickDetector, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn right_mouse_click(instance: ClickDetector) -> RBXScriptSignal(fn(Player) -> Nil)
...
pub fn on_right_mouse_click(instance: ClickDetector, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ClickDetector, value: parent) -> ClickDetector
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ClickDetector) -> Nil
...
pub fn get_attribute_changed_signal(instance: ClickDetector, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ClickDetector, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ClickDetector) -> List(String)
...
pub fn wait_for_child(instance: ClickDetector, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ClickDetector) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ClickDetector, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ClickDetector) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ClickDetector, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ClickDetector) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ClickDetector, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ClickDetector) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ClickDetector, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ClickDetector) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ClickDetector, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ClickDetector) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ClickDetector, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ClickDetector) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ClickDetector, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ClickDetector) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ClickDetector, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ClickDetector, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ClickDetector) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ClickDetector, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: Content, _: ContentId, _: ClickDetector, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}