...
import roblox/types.{
  ...
  type OmniRecommendationsService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: OmniRecommendationsService,
  value: Bool,
...
pub fn get_source_asset_id(instance: OmniRecommendationsService) -> Int64
