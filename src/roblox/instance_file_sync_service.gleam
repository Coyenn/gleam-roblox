...
import roblox/types.{
  type Actor, type Instance, type InstanceFileSyncService, type Int64,
...
pub fn set_archivable(
  instance: InstanceFileSyncService,
  value: Bool,
...
pub fn get_source_asset_id(instance: InstanceFileSyncService) -> Int64
