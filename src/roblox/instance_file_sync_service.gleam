...
import roblox/types.{type Actor, type Instance, type InstanceFileSyncService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `InstanceFileSyncService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: InstanceFileSyncService) -> Instance

/// Treats `InstanceFileSyncService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: InstanceFileSyncService) -> Object
...
pub fn set_parent(instance: InstanceFileSyncService, value: parent) -> InstanceFileSyncService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InstanceFileSyncService) -> Nil
...
pub fn get_attribute_changed_signal(instance: InstanceFileSyncService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InstanceFileSyncService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InstanceFileSyncService) -> List(String)
...
pub fn wait_for_child(instance: InstanceFileSyncService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InstanceFileSyncService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InstanceFileSyncService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InstanceFileSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InstanceFileSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InstanceFileSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InstanceFileSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InstanceFileSyncService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InstanceFileSyncService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InstanceFileSyncService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InstanceFileSyncService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InstanceFileSyncService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InstanceFileSyncService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InstanceFileSyncService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: InstanceFileSyncService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}