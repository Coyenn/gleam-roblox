...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type OptionSharedTable,
...
pub fn get_source_asset_id(instance: SharedTableRegistry) -> Int64
