...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type OptionSharedTable, type SecurityCapabilities, type SharedTable, type SharedTableRegistry, type UniqueId}
...
pub fn set_parent(instance: SharedTableRegistry, value: parent) -> SharedTableRegistry
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SharedTableRegistry) -> Nil
...
pub fn get_attribute_changed_signal(instance: SharedTableRegistry, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SharedTableRegistry, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SharedTableRegistry) -> List(String)
...
pub fn wait_for_child(instance: SharedTableRegistry, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SharedTableRegistry) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SharedTableRegistry, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SharedTableRegistry) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SharedTableRegistry, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SharedTableRegistry) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SharedTableRegistry, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SharedTableRegistry) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SharedTableRegistry, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SharedTableRegistry) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SharedTableRegistry, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SharedTableRegistry) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SharedTableRegistry, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SharedTableRegistry) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SharedTableRegistry, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SharedTableRegistry) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SharedTableRegistry, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SharedTableRegistry, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SharedTableRegistry) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SharedTableRegistry, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: OptionSharedTable, _: SharedTable, _: SharedTableRegistry, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}