...
import roblox/types.{
  type Actor, type CFrame, type FluidForceSensor, type Instance, type Int64,
  type Object, type SecurityCapabilities, type SensorBase, type SensorUpdateType,
...
pub fn on_sensor_output_changed(
  instance: FluidForceSensor,
...
pub fn on_on_sensor_output_changed(
  instance: FluidForceSensor,
  callback: fn() -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: FluidForceSensor) -> Int64
