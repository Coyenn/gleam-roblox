...
import roblox/types.{
  type Actor, type GuiBase, type GuiBase2d, type GuiMain, type GuiObject,
  type Instance, type LayerCollector, type LocalizationTable, type Object,
  type Rect, type SafeAreaCompatibility, type ScreenGui, type ScreenInsets,
...
pub fn get_source_asset_id(instance: GuiMain) -> Int
