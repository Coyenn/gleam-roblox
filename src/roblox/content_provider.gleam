...
import roblox/types.{type Actor, type AssetFetchStatus, type ContentId, type ContentProvider, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn get_asset_fetch_status_changed_signal(instance: ContentProvider, content_id: ContentId) -> RBXScriptSignal(fn(AssetFetchStatus) -> Nil)
...
pub fn preload_async(instance: ContentProvider, content_id_list: List(ContentId), callback_function: fn(ContentId, AssetFetchStatus) -> Nil) -> Nil
...
pub fn asset_fetch_failed(instance: ContentProvider) -> RBXScriptSignal(fn(ContentId) -> Nil)

/// Connects to Roblox event `ContentProvider.AssetFetchFailed`.
///
/// Roblox: `ContentProvider.AssetFetchFailed`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/ContentProvider#AssetFetchFailed
@target(luau)
@luau.global("(function(instance, callback) return instance.AssetFetchFailed:Connect(callback) end)")
pub fn on_asset_fetch_failed(instance: ContentProvider, callback: fn(ContentId) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ContentProvider, value: parent) -> ContentProvider
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ContentProvider) -> Nil
...
pub fn get_attribute_changed_signal(instance: ContentProvider, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ContentProvider) -> List(String)
...
pub fn wait_for_child(instance: ContentProvider, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ContentProvider) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ContentProvider, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ContentId, _: AssetFetchStatus, _: ContentProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}