...
import roblox/types.{
  type Actor, type AssetFetchStatus, type ContentId, type ContentProvider,
...
pub fn get_asset_fetch_status_changed_signal(
  instance: ContentProvider,
  content_id: ContentId,
...
pub fn register_default_encryption_key(
  instance: ContentProvider,
...
pub fn register_default_session_key(
  instance: ContentProvider,
  session_key: String,
) -> Nil
...
pub fn register_session_encrypted_asset(
  instance: ContentProvider,
  content_id: ContentId,
  session_key: String,
) -> Nil
...
pub fn unregister_encrypted_asset(
  instance: ContentProvider,
  asset_id: ContentId,
) -> Nil
...
pub fn preload_async(
  instance: ContentProvider,
  content_id_list: List(ContentId),
  callback_function: fn(ContentId, AssetFetchStatus) -> Nil,
) -> Nil
...
pub fn get_source_asset_id(instance: ContentProvider) -> Int64
