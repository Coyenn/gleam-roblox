...
import roblox/types.{
  type Actor, type DeveloperMemoryTag, type Instance, type Int64, type Object,
  type SecurityCapabilities, type Stats, type UniqueId,
}
...
pub fn get_source_asset_id(instance: Stats) -> Int64
