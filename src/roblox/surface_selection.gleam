...
import roblox/types.{type Actor, type BasePart, type Color3, type GuiBase, type GuiBase3d, type Instance, type NormalId, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type SurfaceSelection, type UniqueId}

/// Creates a new Roblox `SurfaceSelection` instance.
///
/// Roblox: `Instance.new("SurfaceSelection")`
@target(luau)
@luau.global("Instance.new(\"SurfaceSelection\")")
...
pub fn set_parent(instance: SurfaceSelection, value: parent) -> SurfaceSelection
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SurfaceSelection) -> Nil
...
pub fn get_attribute_changed_signal(instance: SurfaceSelection, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SurfaceSelection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SurfaceSelection) -> List(String)
...
pub fn wait_for_child(instance: SurfaceSelection, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SurfaceSelection) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SurfaceSelection, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SurfaceSelection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SurfaceSelection, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SurfaceSelection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SurfaceSelection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SurfaceSelection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SurfaceSelection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SurfaceSelection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SurfaceSelection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SurfaceSelection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SurfaceSelection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SurfaceSelection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SurfaceSelection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SurfaceSelection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SurfaceSelection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SurfaceSelection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SurfaceSelection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SurfaceSelection, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: BasePart, _: NormalId, _: SurfaceSelection, _: PartAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}