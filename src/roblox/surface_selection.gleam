...
import roblox/types.{
  ...
  type SecurityCapabilities, type SurfaceSelection, type UniqueId,
}
...
pub fn set_target_surface(
  instance: SurfaceSelection,
  value: NormalId,
) -> SurfaceSelection
...
pub fn get_source_asset_id(instance: SurfaceSelection) -> Int64
