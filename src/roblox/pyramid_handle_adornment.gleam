...
import roblox/types.{
  ...
  type Object, type PVAdornment, type PVInstance, type PyramidHandleAdornment,
...
pub fn set_height(
  instance: PyramidHandleAdornment,
  value: Float,
...
pub fn get_source_asset_id(instance: PyramidHandleAdornment) -> Int64
