...
import roblox/types.{
  ...
  type Player, type RenderFidelity, type SecurityCapabilities,
  type SpawnLocation, type SurfaceType, type UniqueId, type Vector3,
}
...
pub fn set_allow_team_change_on_touch(
...
pub fn get_source_asset_id(instance: SpawnLocation) -> Int64
