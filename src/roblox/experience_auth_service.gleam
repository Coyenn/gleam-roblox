...
import roblox/types.{
  type Actor, type ExperienceAuthService, type Instance, type Int64, type Object,
...
pub fn set_archivable(
  instance: ExperienceAuthService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ExperienceAuthService) -> Int64
