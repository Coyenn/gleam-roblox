...
import roblox/types.{type Actor, type BaseWrap, type CFrame, type Content, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WrapTarget}

/// Creates a new Roblox `WrapTarget` instance.
///
/// Roblox: `Instance.new("WrapTarget")`
@target(luau)
@luau.global("Instance.new(\"WrapTarget\")")
...
pub fn set_parent(instance: WrapTarget, value: parent) -> WrapTarget
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WrapTarget) -> Nil
...
pub fn get_attribute_changed_signal(instance: WrapTarget, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WrapTarget, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WrapTarget) -> List(String)
...
pub fn wait_for_child(instance: WrapTarget, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WrapTarget) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WrapTarget, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WrapTarget) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WrapTarget, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WrapTarget) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WrapTarget, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WrapTarget) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WrapTarget, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WrapTarget) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WrapTarget, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WrapTarget) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WrapTarget, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WrapTarget) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WrapTarget, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WrapTarget) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WrapTarget, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WrapTarget, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WrapTarget) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WrapTarget, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: ContentId, _: Content, _: WrapTarget, _: BaseWrap, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}