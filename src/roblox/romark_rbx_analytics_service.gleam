...
import roblox/types.{
  ...
  type RomarkRbxAnalyticsService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RomarkRbxAnalyticsService,
  value: Bool,
...
pub fn get_source_asset_id(instance: RomarkRbxAnalyticsService) -> Int64
