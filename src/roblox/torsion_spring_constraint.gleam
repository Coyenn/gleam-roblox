...
import roblox/types.{
  ...
  type Int64, type Object, type SecurityCapabilities,
  type TorsionSpringConstraint, type UniqueId,
}
...
pub fn set_coils(
  instance: TorsionSpringConstraint,
  value: Float,
...
pub fn get_source_asset_id(instance: TorsionSpringConstraint) -> Int64
