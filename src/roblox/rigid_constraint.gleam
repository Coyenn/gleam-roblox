...
import roblox/types.{
  ...
  type Int64, type Object, type RigidConstraint, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: RigidConstraint) -> Int64
