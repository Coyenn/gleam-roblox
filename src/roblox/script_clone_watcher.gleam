...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptCloneWatcher,
...
pub fn get_source_asset_id(instance: ScriptCloneWatcher) -> Int64
