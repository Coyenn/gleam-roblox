...
import roblox/types.{type Actor, type Color3, type Instance, type Light, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SurfaceLight, type UniqueId}

/// Creates a new Roblox `SurfaceLight` instance.
///
/// Roblox: `Instance.new("SurfaceLight")`
@target(luau)
@luau.global("Instance.new(\"SurfaceLight\")")
pub fn new() -> SurfaceLight
...
pub fn set_parent(instance: SurfaceLight, value: parent) -> SurfaceLight
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SurfaceLight) -> Nil
...
pub fn get_attribute_changed_signal(instance: SurfaceLight, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SurfaceLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SurfaceLight) -> List(String)
...
pub fn wait_for_child(instance: SurfaceLight, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SurfaceLight) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SurfaceLight, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SurfaceLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SurfaceLight, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SurfaceLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SurfaceLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SurfaceLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SurfaceLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SurfaceLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SurfaceLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SurfaceLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SurfaceLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SurfaceLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SurfaceLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SurfaceLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SurfaceLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SurfaceLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SurfaceLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SurfaceLight, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: NormalId, _: SurfaceLight, _: Light, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}