...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type PhysicsService,
...
pub fn collision_group_set_collidable(
  instance: PhysicsService,
  name1: String,
  name2: String,
  collidable: Bool,
) -> Nil
...
pub fn collision_groups_are_collidable(
  instance: PhysicsService,
  name1: String,
  name2: String,
) -> Bool
...
pub fn get_registered_collision_groups(
  instance: PhysicsService,
) -> List(Dynamic)
...
pub fn is_collision_group_registered(
  instance: PhysicsService,
  name: String,
) -> Bool
...
pub fn get_source_asset_id(instance: PhysicsService) -> Int64
