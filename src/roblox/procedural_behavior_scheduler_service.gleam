...
import roblox/types.{
  type Actor, type Instance, type Object,
  type ProceduralBehaviorSchedulerService, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn set_archivable(
  instance: ProceduralBehaviorSchedulerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ProceduralBehaviorSchedulerService) -> Int
