...
import roblox/types.{
  type Actor, type Instance, type Int64, type MLModelDeliveryService,
...
pub fn set_archivable(
  instance: MLModelDeliveryService,
  value: Bool,
...
pub fn get_source_asset_id(instance: MLModelDeliveryService) -> Int64
