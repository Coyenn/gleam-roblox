...
import roblox/types.{
  ...
  type ReflectionMetadataClasses, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataClasses,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataClasses) -> Int64
