...
import roblox/types.{type Actor, type DeviceIdService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `DeviceIdService` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: DeviceIdService, value: parent) -> DeviceIdService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DeviceIdService) -> Nil
...
pub fn get_attribute_changed_signal(instance: DeviceIdService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DeviceIdService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DeviceIdService) -> List(String)
...
pub fn wait_for_child(instance: DeviceIdService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DeviceIdService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DeviceIdService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DeviceIdService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DeviceIdService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DeviceIdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DeviceIdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DeviceIdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DeviceIdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DeviceIdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DeviceIdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DeviceIdService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DeviceIdService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DeviceIdService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DeviceIdService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DeviceIdService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DeviceIdService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DeviceIdService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DeviceIdService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DeviceIdService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DeviceIdService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}