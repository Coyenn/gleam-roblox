...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type VisualizationModeCategory}

/// Creates a new Roblox `VisualizationModeCategory` instance.
///
/// Roblox: `Instance.new("VisualizationModeCategory")`
@target(luau)
@luau.global("Instance.new(\"VisualizationModeCategory\")")
pub fn new() -> VisualizationModeCategory
...
pub fn set_parent(instance: VisualizationModeCategory, value: parent) -> VisualizationModeCategory
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VisualizationModeCategory) -> Nil
...
pub fn get_attribute_changed_signal(instance: VisualizationModeCategory, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VisualizationModeCategory, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VisualizationModeCategory) -> List(String)
...
pub fn wait_for_child(instance: VisualizationModeCategory, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VisualizationModeCategory, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VisualizationModeCategory, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VisualizationModeCategory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VisualizationModeCategory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VisualizationModeCategory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VisualizationModeCategory, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VisualizationModeCategory) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VisualizationModeCategory, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VisualizationModeCategory) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VisualizationModeCategory, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VisualizationModeCategory, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VisualizationModeCategory) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VisualizationModeCategory, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VisualizationModeCategory, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}