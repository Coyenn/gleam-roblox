...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type RTAnimationTracker,
  type SecurityCapabilities, type TrackerError, type TrackerMode,
  type TrackerPromptEvent, type TrackerType, type UniqueId,
}
...
pub fn set_enable_fallback_audio_input(
  instance: RTAnimationTracker,
  value: Bool,
) -> RTAnimationTracker
...
pub fn tracker_error(
  instance: RTAnimationTracker,
) -> RBXScriptSignal(fn(TrackerError, String) -> Nil)
...
pub fn on_tracker_error(
  instance: RTAnimationTracker,
  callback: fn(TrackerError, String) -> Nil,
) -> RBXScriptConnection
...
pub fn tracker_prompt(
  instance: RTAnimationTracker,
) -> RBXScriptSignal(fn(TrackerPromptEvent) -> Nil)
...
pub fn on_tracker_prompt(
  instance: RTAnimationTracker,
  callback: fn(TrackerPromptEvent) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: RTAnimationTracker) -> Int64
