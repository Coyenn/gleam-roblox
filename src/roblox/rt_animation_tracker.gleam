...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type RTAnimationTracker, type SecurityCapabilities, type TrackerError, type TrackerMode, type TrackerPromptEvent, type TrackerType, type UniqueId}

/// Creates a new Roblox `RTAnimationTracker` instance.
///
/// Roblox: `Instance.new("RTAnimationTracker")`
@target(luau)
@luau.global("Instance.new(\"RTAnimationTracker\")")
pub fn new() -> RTAnimationTracker
...
pub fn tracker_error(instance: RTAnimationTracker) -> RBXScriptSignal(fn(TrackerError, String) -> Nil)

/// Connects to Roblox event `RTAnimationTracker.TrackerError`.
///
/// Roblox: `RTAnimationTracker.TrackerError`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/RTAnimationTracker#TrackerError
@target(luau)
@luau.global("(function(instance, callback) return instance.TrackerError:Connect(callback) end)")
pub fn on_tracker_error(instance: RTAnimationTracker, callback: fn(TrackerError, String) -> Nil) -> RBXScriptConnection
...
pub fn tracker_prompt(instance: RTAnimationTracker) -> RBXScriptSignal(fn(TrackerPromptEvent) -> Nil)

/// Connects to Roblox event `RTAnimationTracker.TrackerPrompt`.
///
/// Roblox: `RTAnimationTracker.TrackerPrompt`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/RTAnimationTracker#TrackerPrompt
@target(luau)
@luau.global("(function(instance, callback) return instance.TrackerPrompt:Connect(callback) end)")
pub fn on_tracker_prompt(instance: RTAnimationTracker, callback: fn(TrackerPromptEvent) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: RTAnimationTracker, value: parent) -> RTAnimationTracker
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RTAnimationTracker) -> Nil
...
pub fn get_attribute_changed_signal(instance: RTAnimationTracker, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RTAnimationTracker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RTAnimationTracker) -> List(String)
...
pub fn wait_for_child(instance: RTAnimationTracker, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RTAnimationTracker) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RTAnimationTracker, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RTAnimationTracker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RTAnimationTracker, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RTAnimationTracker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RTAnimationTracker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RTAnimationTracker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RTAnimationTracker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RTAnimationTracker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RTAnimationTracker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RTAnimationTracker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RTAnimationTracker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RTAnimationTracker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RTAnimationTracker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RTAnimationTracker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RTAnimationTracker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RTAnimationTracker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RTAnimationTracker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RTAnimationTracker, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TrackerPromptEvent, _: TrackerError, _: TrackerType, _: TrackerMode, _: RTAnimationTracker, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}