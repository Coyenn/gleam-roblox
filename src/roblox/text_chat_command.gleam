...
import roblox/types.{
  ...
  type TextChatCommand, type TextSource, type UniqueId,
}
...
pub fn set_autocomplete_visible(
...
pub fn triggered(
  instance: TextChatCommand,
) -> RBXScriptSignal(fn(TextSource, String) -> Nil)
...
pub fn on_triggered(
  instance: TextChatCommand,
  callback: fn(TextSource, String) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: TextChatCommand) -> Int64
