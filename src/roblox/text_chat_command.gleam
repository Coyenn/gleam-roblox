...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextChatCommand, type TextSource, type UniqueId}

/// Creates a new Roblox `TextChatCommand` instance.
///
/// Roblox: `Instance.new("TextChatCommand")`
@target(luau)
@luau.global("Instance.new(\"TextChatCommand\")")
pub fn new() -> TextChatCommand
...
pub fn triggered(instance: TextChatCommand) -> RBXScriptSignal(fn(TextSource, String) -> Nil)

/// Connects to Roblox event `TextChatCommand.Triggered`.
///
/// An event that developers can bind to execute commands.
///
/// Roblox: `TextChatCommand.Triggered`
...
pub fn on_triggered(instance: TextChatCommand, callback: fn(TextSource, String) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: TextChatCommand, value: parent) -> TextChatCommand
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TextChatCommand) -> Nil
...
pub fn get_attribute_changed_signal(instance: TextChatCommand, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TextChatCommand, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TextChatCommand) -> List(String)
...
pub fn wait_for_child(instance: TextChatCommand, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TextChatCommand) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TextChatCommand, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TextChatCommand) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TextChatCommand, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TextChatCommand) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TextChatCommand, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TextChatCommand) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TextChatCommand, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TextChatCommand) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TextChatCommand, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TextChatCommand) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TextChatCommand, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TextChatCommand) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TextChatCommand, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TextChatCommand) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TextChatCommand, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TextChatCommand, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TextChatCommand) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TextChatCommand, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TextSource, _: TextChatCommand, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}