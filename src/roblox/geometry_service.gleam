...
import roblox/types.{type Actor, type BasePart, type CFrame, type GeometryService, type Instance, type MeshPart, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SolidPrimitiveType, type UniqueId}
...
pub fn sweep_part_async(instance: GeometryService, part: BasePart, cframes: List(CFrame), options: Dynamic) -> MeshPart
...
pub fn set_parent(instance: GeometryService, value: parent) -> GeometryService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GeometryService) -> Nil
...
pub fn get_attribute_changed_signal(instance: GeometryService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GeometryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GeometryService) -> List(String)
...
pub fn wait_for_child(instance: GeometryService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GeometryService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GeometryService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GeometryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GeometryService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GeometryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GeometryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GeometryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GeometryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GeometryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GeometryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GeometryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GeometryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GeometryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GeometryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GeometryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GeometryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GeometryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GeometryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GeometryService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MeshPart, _: BasePart, _: CFrame, _: SolidPrimitiveType, _: GeometryService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}