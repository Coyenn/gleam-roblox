...
import roblox/types.{
  ...
  type MeshPart, type Object, type OptionDouble, type OptionInt64,
  type SecurityCapabilities, type SolidPrimitiveType, type UniqueId,
}
...
pub fn calculate_constraints_to_preserve(
...
pub fn create_solid_primitive(
  instance: GeometryService,
  type_: SolidPrimitiveType,
  options: Dynamic,
) -> MeshPart
...
pub fn generate_fragment_sites(
  instance: GeometryService,
  part: BasePart,
  options: Dynamic,
) -> List(Dynamic)
