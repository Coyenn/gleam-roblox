...
import roblox/types.{type Actor, type CustomLog, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `CustomLog` instance.
///
/// Roblox: `Instance.new("CustomLog")`
@target(luau)
@luau.global("Instance.new(\"CustomLog\")")
pub fn new() -> CustomLog
...
pub fn set_parent(instance: CustomLog, value: parent) -> CustomLog
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CustomLog) -> Nil
...
pub fn get_attribute_changed_signal(instance: CustomLog, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CustomLog, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CustomLog) -> List(String)
...
pub fn wait_for_child(instance: CustomLog, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CustomLog) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CustomLog, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CustomLog) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CustomLog, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CustomLog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CustomLog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CustomLog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CustomLog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CustomLog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CustomLog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CustomLog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CustomLog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CustomLog) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CustomLog, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CustomLog) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CustomLog, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CustomLog, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CustomLog) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CustomLog, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CustomLog, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}