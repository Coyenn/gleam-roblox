...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type RuntimeScriptService, type SecurityCapabilities, type UniqueId}

/// Treats `RuntimeScriptService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: RuntimeScriptService) -> Instance

/// Treats `RuntimeScriptService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: RuntimeScriptService) -> Object
...
pub fn set_parent(instance: RuntimeScriptService, value: parent) -> RuntimeScriptService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RuntimeScriptService) -> Nil
...
pub fn get_attribute_changed_signal(instance: RuntimeScriptService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RuntimeScriptService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RuntimeScriptService) -> List(String)
...
pub fn wait_for_child(instance: RuntimeScriptService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RuntimeScriptService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RuntimeScriptService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RuntimeScriptService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RuntimeScriptService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RuntimeScriptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RuntimeScriptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RuntimeScriptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RuntimeScriptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RuntimeScriptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RuntimeScriptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RuntimeScriptService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RuntimeScriptService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RuntimeScriptService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RuntimeScriptService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RuntimeScriptService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RuntimeScriptService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RuntimeScriptService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RuntimeScriptService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RuntimeScriptService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RuntimeScriptService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}