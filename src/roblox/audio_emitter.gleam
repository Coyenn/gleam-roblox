...
import roblox/types.{
  type Actor, type AudioEmitter, type AudioListener, type BinaryString,
...
pub fn set_acoustic_simulation_enabled(
...
pub fn set_audio_interaction_group(
  instance: AudioEmitter,
  value: String,
) -> AudioEmitter
...
pub fn get_source_asset_id(instance: AudioEmitter) -> Int64
