...
/// Creates a new Roblox `AudioEmitter` instance.
///
/// Roblox: `Instance.new("AudioEmitter")`
@target(luau)
@luau.global("Instance.new(\"AudioEmitter\")")
...
pub fn get_input_pins(instance: AudioEmitter) -> List(String)
...
pub fn get_output_pins(instance: AudioEmitter) -> List(String)
...
pub fn wiring_changed(instance: AudioEmitter) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioEmitter.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioEmitter via a Wire.
///
/// Roblox: `AudioEmitter.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioEmitter, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioEmitter, value: parent) -> AudioEmitter
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioEmitter) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioEmitter, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioEmitter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioEmitter) -> List(String)
...
pub fn wait_for_child(instance: AudioEmitter, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioEmitter) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioEmitter, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioEmitter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioEmitter, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioEmitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioEmitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioEmitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioEmitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioEmitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioEmitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioEmitter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioEmitter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioEmitter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioEmitter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioEmitter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioEmitter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioEmitter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioEmitter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioEmitter, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioListener, _: BinaryString, _: AudioEmitter, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}