...
import roblox/types.{
  ...
  type SmoothVoxelsUpgraderService, type UniqueId,
}
...
pub fn set_archivable(
  instance: SmoothVoxelsUpgraderService,
  value: Bool,
...
pub fn get_source_asset_id(instance: SmoothVoxelsUpgraderService) -> Int64
