...
import roblox/types.{
  ...
  type PlatformCloudStorageService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PlatformCloudStorageService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PlatformCloudStorageService) -> Int64
