...
import roblox/types.{type Actor, type BinaryString, type BinaryStringValue, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `BinaryStringValue` instance.
///
/// Roblox: `Instance.new("BinaryStringValue")`
@target(luau)
@luau.global("Instance.new(\"BinaryStringValue\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BinaryStringValue) -> RBXScriptSignal(fn(BinaryString) -> Nil)

/// Connects to Roblox event `BinaryStringValue.Changed`.
///
/// Fires if the BinaryStringValue's value is changed.
///
/// Roblox: `BinaryStringValue.Changed`
...
pub fn on_changed(instance: BinaryStringValue, callback: fn(BinaryString) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BinaryStringValue, value: parent) -> BinaryStringValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BinaryStringValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: BinaryStringValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BinaryStringValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BinaryStringValue) -> List(String)
...
pub fn wait_for_child(instance: BinaryStringValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BinaryStringValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BinaryStringValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BinaryStringValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BinaryStringValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BinaryStringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BinaryStringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BinaryStringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BinaryStringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BinaryStringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BinaryStringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BinaryStringValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BinaryStringValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BinaryStringValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BinaryStringValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BinaryStringValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BinaryStringValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BinaryStringValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BinaryString, _: BinaryStringValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}