...
import roblox/types.{
  type Actor, type BinaryString, type BinaryStringValue, type Instance,
...
) -> RBXScriptSignal(fn(BinaryString) -> Nil)
...
pub fn get_source_asset_id(instance: BinaryStringValue) -> Int64
