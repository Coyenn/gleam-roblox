...
import roblox/types.{type Actor, type AssetSoundEffect, type CustomSoundEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SoundEffect, type UniqueId}
...
pub fn set_parent(instance: AssetSoundEffect, value: parent) -> AssetSoundEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AssetSoundEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: AssetSoundEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AssetSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AssetSoundEffect) -> List(String)
...
pub fn wait_for_child(instance: AssetSoundEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AssetSoundEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AssetSoundEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AssetSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AssetSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AssetSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AssetSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AssetSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AssetSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AssetSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AssetSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AssetSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AssetSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AssetSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AssetSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AssetSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AssetSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AssetSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AssetSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AssetSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AssetSoundEffect, _: CustomSoundEffect, _: SoundEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}