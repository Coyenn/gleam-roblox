...
import roblox/types.{type Actor, type BodyMover, type BodyPosition, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn on_reached_target(instance: BodyPosition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: BodyPosition, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BodyPosition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: BodyPosition, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BodyPosition) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BodyPosition, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BodyPosition) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BodyPosition, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BodyPosition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BodyPosition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BodyPosition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BodyPosition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BodyPosition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BodyPosition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BodyPosition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BodyPosition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: BodyPosition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BodyPosition) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BodyPosition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BodyPosition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: BodyPosition, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: BodyPosition, _: BodyMover, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}