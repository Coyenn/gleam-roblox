...
import roblox/types.{
  type Actor, type Instance, type Object, type RunningAverageItemDouble,
  type SecurityCapabilities, type StatsItem, type UniqueId,
}
...
pub fn set_archivable(
  instance: RunningAverageItemDouble,
  value: Bool,
...
pub fn get_source_asset_id(instance: RunningAverageItemDouble) -> Int
