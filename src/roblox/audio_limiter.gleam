...
import roblox/types.{type Actor, type AudioLimiter, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioLimiter` instance.
///
/// Roblox: `Instance.new("AudioLimiter")`
@target(luau)
@luau.global("Instance.new(\"AudioLimiter\")")
pub fn new() -> AudioLimiter
...
pub fn get_input_pins(instance: AudioLimiter) -> List(String)
...
pub fn get_output_pins(instance: AudioLimiter) -> List(String)
...
pub fn wiring_changed(instance: AudioLimiter) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioLimiter.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioLimiter via a Wire.
///
/// Roblox: `AudioLimiter.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioLimiter, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioLimiter, value: parent) -> AudioLimiter
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioLimiter) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioLimiter, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioLimiter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioLimiter) -> List(String)
...
pub fn wait_for_child(instance: AudioLimiter, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioLimiter) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioLimiter, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioLimiter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioLimiter, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioLimiter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioLimiter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioLimiter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioLimiter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioLimiter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioLimiter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioLimiter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioLimiter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioLimiter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioLimiter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioLimiter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioLimiter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioLimiter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioLimiter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioLimiter, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioLimiter, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}