...
import roblox/types.{type Actor, type Feature, type InOut, type Instance, type LeftRight, type MotorFeature, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TopBottom, type UniqueId}
...
pub fn set_parent(instance: MotorFeature, value: parent) -> MotorFeature
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MotorFeature) -> Nil
...
pub fn get_attribute_changed_signal(instance: MotorFeature, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MotorFeature, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MotorFeature) -> List(String)
...
pub fn wait_for_child(instance: MotorFeature, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MotorFeature) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MotorFeature, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MotorFeature) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MotorFeature, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MotorFeature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MotorFeature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MotorFeature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MotorFeature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MotorFeature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MotorFeature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MotorFeature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MotorFeature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MotorFeature) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MotorFeature, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MotorFeature) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MotorFeature, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MotorFeature, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MotorFeature) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MotorFeature, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TopBottom, _: LeftRight, _: InOut, _: NormalId, _: MotorFeature, _: Feature, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}