...
import roblox/types.{
  type Actor, type Instance, type Int64, type MetaBreakpointContext, type Object,
...
pub fn set_archivable(
  instance: MetaBreakpointContext,
  value: Bool,
...
pub fn get_source_asset_id(instance: MetaBreakpointContext) -> Int64
