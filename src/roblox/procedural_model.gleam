...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type Model, type ModelLevelOfDetail, type ModelStreamingMode, type ModuleScript, type Object, type OptionDouble, type OptionInt64, type PVInstance, type Player, type ProceduralModel, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `ProceduralModel` instance.
///
/// Roblox: `Instance.new("ProceduralModel")`
@target(luau)
@luau.global("Instance.new(\"ProceduralModel\")")
...
pub fn set_parent(instance: ProceduralModel, value: parent) -> ProceduralModel
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ProceduralModel) -> Nil
...
pub fn get_attribute_changed_signal(instance: ProceduralModel, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ProceduralModel, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ProceduralModel) -> List(String)
...
pub fn wait_for_child(instance: ProceduralModel, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ProceduralModel) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ProceduralModel, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ProceduralModel) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ProceduralModel, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ProceduralModel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ProceduralModel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ProceduralModel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ProceduralModel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ProceduralModel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ProceduralModel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ProceduralModel) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ProceduralModel, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ProceduralModel) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ProceduralModel, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ProceduralModel) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ProceduralModel, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ProceduralModel, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ProceduralModel) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ProceduralModel, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: Vector3, _: Player, _: BasePart, _: ModelStreamingMode, _: ModelLevelOfDetail, _: ModuleScript, _: ProceduralModel, _: Model, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}