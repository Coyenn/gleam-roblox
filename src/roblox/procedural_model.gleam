...
import roblox/types.{
  type Actor, type BasePart, type CFrame, type Instance, type Int64, type Model,
  type ModelLevelOfDetail, type ModelStreamingMode, type ModuleScript,
  type Object, type PVInstance, type Player, type ProceduralModel,
...
pub fn get_source_asset_id(instance: ProceduralModel) -> Int64
