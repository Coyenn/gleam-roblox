...
import roblox/types.{
  type Actor, type DebuggablePluginWatcher, type Instance, type Int64,
...
pub fn set_archivable(
  instance: DebuggablePluginWatcher,
  value: Bool,
...
pub fn get_source_asset_id(instance: DebuggablePluginWatcher) -> Int64
