...
import roblox/types.{type Actor, type BasePart, type CFrame, type DynamicRotate, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type RotateP, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: RotateP, value: parent) -> RotateP
...
pub fn get_source_asset_id(instance: RotateP) -> OptionInt64
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RotateP) -> Nil
...
pub fn get_attribute_changed_signal(instance: RotateP, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RotateP, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RotateP) -> List(String)
...
pub fn wait_for_child(instance: RotateP, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RotateP) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RotateP, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RotateP) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RotateP, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RotateP) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RotateP, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RotateP) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RotateP, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RotateP) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RotateP, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RotateP) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RotateP, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RotateP) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RotateP, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RotateP) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RotateP, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RotateP, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RotateP) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RotateP, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: RotateP, _: DynamicRotate, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}