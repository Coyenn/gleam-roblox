...
import roblox/types.{
  type Actor, type Instance, type Object, type ReflectionMetadataYieldFunctions,
...
pub fn set_archivable(
  instance: ReflectionMetadataYieldFunctions,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataYieldFunctions) -> Int
