...
import roblox/types.{
  ...
  type MaterialPattern, type Object, type OptionDouble, type OptionInt64,
  type SecurityCapabilities, type TerrainDetail, type TerrainFace, type UniqueId,
}
