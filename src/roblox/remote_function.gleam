...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type RemoteFunction, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `RemoteFunction` instance.
///
/// Roblox: `Instance.new("RemoteFunction")`
@target(luau)
@luau.global("Instance.new(\"RemoteFunction\")")
pub fn new() -> RemoteFunction
...
pub fn set_parent(instance: RemoteFunction, value: parent) -> RemoteFunction
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RemoteFunction) -> Nil
...
pub fn get_attribute_changed_signal(instance: RemoteFunction, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RemoteFunction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RemoteFunction) -> List(String)
...
pub fn wait_for_child(instance: RemoteFunction, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RemoteFunction) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RemoteFunction, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RemoteFunction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RemoteFunction, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RemoteFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RemoteFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RemoteFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RemoteFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RemoteFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RemoteFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RemoteFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RemoteFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RemoteFunction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RemoteFunction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RemoteFunction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RemoteFunction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RemoteFunction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RemoteFunction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RemoteFunction, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: RemoteFunction, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}