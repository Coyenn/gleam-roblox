...
/// Creates a new Roblox `Part` instance.
///
/// Roblox: `Instance.new("Part")`
@target(luau)
@luau.global("Instance.new(\"Part\")")
pub fn new() -> Part
...
@target(luau)
@luau.method("Resize")
pub fn resize(instance: Part, normal_id: NormalId, delta_amount: Int) -> Bool
...
pub fn touch_ended(instance: Part) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: Part, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Part, value: parent) -> Part
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Part) -> Nil
...
pub fn get_attribute_changed_signal(instance: Part, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Part, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Part) -> List(String)
...
pub fn wait_for_child(instance: Part, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Part) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Part, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Part) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Part, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Part) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Part, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Part) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Part, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Part) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Part, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Part) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Part, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Part) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Part, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Part) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Part, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Part, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Part) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Part, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: BasePart, _: CollisionFidelity, _: RenderFidelity, _: Vector3, _: Player, _: NormalId, _: SurfaceType, _: Faces, _: Material, _: PhysicalProperties, _: Color3, _: BrickColor, _: PartType, _: Part, _: FormFactorPart, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}