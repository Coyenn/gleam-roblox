...
import roblox/types.{
  type Actor, type DialogChoice, type Instance, type Int64, type Object,
...
pub fn set_goodbye_choice_active(
  instance: DialogChoice,
  value: Bool,
) -> DialogChoice
...
pub fn get_source_asset_id(instance: DialogChoice) -> Int64
