...
import roblox/types.{type Actor, type DialogChoice, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DialogChoice` instance.
///
/// Roblox: `Instance.new("DialogChoice")`
@target(luau)
@luau.global("Instance.new(\"DialogChoice\")")
pub fn new() -> DialogChoice
...
pub fn set_parent(instance: DialogChoice, value: parent) -> DialogChoice
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DialogChoice) -> Nil
...
pub fn get_attribute_changed_signal(instance: DialogChoice, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DialogChoice, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DialogChoice) -> List(String)
...
pub fn wait_for_child(instance: DialogChoice, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DialogChoice) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DialogChoice, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DialogChoice) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DialogChoice, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DialogChoice) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DialogChoice, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DialogChoice) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DialogChoice, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DialogChoice) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DialogChoice, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DialogChoice) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DialogChoice, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DialogChoice) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DialogChoice, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DialogChoice) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DialogChoice, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DialogChoice, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DialogChoice) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DialogChoice, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DialogChoice, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}