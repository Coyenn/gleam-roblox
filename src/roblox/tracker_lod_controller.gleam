...
import roblox/types.{
  ...
  type TrackerExtrapolationFlagMode, type TrackerLodController,
  type TrackerLodFlagMode, type TrackerLodValueMode, type UniqueId,
}
...
pub fn set_audio_mode(
  instance: TrackerLodController,
  value: TrackerLodFlagMode,
...
pub fn get_video_extrapolation_mode(
  instance: TrackerLodController,
...
pub fn set_video_extrapolation_mode(
  instance: TrackerLodController,
  value: TrackerExtrapolationFlagMode,
) -> TrackerLodController
...
pub fn set_video_lod_mode(
  instance: TrackerLodController,
  value: TrackerLodValueMode,
) -> TrackerLodController
...
pub fn get_source_asset_id(instance: TrackerLodController) -> Int64
