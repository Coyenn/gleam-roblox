...
import roblox/types.{
  type Actor, type BrickColor, type BrickColorValue, type Instance, type Int64,
...
pub fn changed(
  instance: BrickColorValue,
) -> RBXScriptSignal(fn(BrickColor) -> Nil)
...
pub fn get_source_asset_id(instance: BrickColorValue) -> Int64
