...
import roblox/types.{type Actor, type BrickColor, type BrickColorValue, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `BrickColorValue` instance.
///
/// Roblox: `Instance.new("BrickColorValue")`
@target(luau)
@luau.global("Instance.new(\"BrickColorValue\")")
pub fn new() -> BrickColorValue
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BrickColorValue) -> RBXScriptSignal(fn(BrickColor) -> Nil)

/// Connects to Roblox event `BrickColorValue.Changed`.
///
/// Fired whenever the BrickColorValue.Value of the BrickColorValue is changed.
///
/// Roblox: `BrickColorValue.Changed`
...
pub fn on_changed(instance: BrickColorValue, callback: fn(BrickColor) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BrickColorValue, value: parent) -> BrickColorValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BrickColorValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: BrickColorValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BrickColorValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BrickColorValue) -> List(String)
...
pub fn wait_for_child(instance: BrickColorValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BrickColorValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BrickColorValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BrickColorValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BrickColorValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BrickColorValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BrickColorValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BrickColorValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BrickColorValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BrickColorValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BrickColorValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BrickColorValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BrickColorValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BrickColorValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BrickColorValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BrickColorValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BrickColorValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BrickColorValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: BrickColorValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}