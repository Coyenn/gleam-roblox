...
import roblox/types.{
  ...
  type StudioDeviceSimulatorService, type UniqueId,
}
...
pub fn set_archivable(
  instance: StudioDeviceSimulatorService,
  value: Bool,
...
pub fn get_source_asset_id(instance: StudioDeviceSimulatorService) -> Int64
