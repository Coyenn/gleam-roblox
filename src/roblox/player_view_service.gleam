...
import roblox/types.{
  type Actor, type CFrame, type Instance, type Int64, type Object, type Player,
  type PlayerViewService, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_device_camera_cframe(
  instance: PlayerViewService,
  player: Player,
) -> CFrame
...
pub fn get_source_asset_id(instance: PlayerViewService) -> Int64
