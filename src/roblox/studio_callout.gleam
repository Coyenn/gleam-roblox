...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StudioCallout, type UniqueId, type Vector2}

/// Creates a new Roblox `StudioCallout` instance.
///
/// Roblox: `Instance.new("StudioCallout")`
@target(luau)
@luau.global("Instance.new(\"StudioCallout\")")
pub fn new() -> StudioCallout
...
pub fn set_parent(instance: StudioCallout, value: parent) -> StudioCallout
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StudioCallout) -> Nil
...
pub fn get_attribute_changed_signal(instance: StudioCallout, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StudioCallout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StudioCallout) -> List(String)
...
pub fn wait_for_child(instance: StudioCallout, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StudioCallout) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StudioCallout, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StudioCallout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StudioCallout, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StudioCallout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StudioCallout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StudioCallout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StudioCallout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StudioCallout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StudioCallout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StudioCallout) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StudioCallout, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StudioCallout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StudioCallout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StudioCallout) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StudioCallout, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StudioCallout, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StudioCallout) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StudioCallout, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector2, _: StudioCallout, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}