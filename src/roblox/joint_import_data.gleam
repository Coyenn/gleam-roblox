...
import roblox/types.{type Actor, type BaseImportData, type Instance, type JointImportData, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `JointImportData` as its Roblox ancestor `BaseImportData`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_base_import_data(instance: JointImportData) -> BaseImportData

/// Treats `JointImportData` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: JointImportData) -> Instance

/// Treats `JointImportData` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: JointImportData) -> Object
...
pub fn status_removed(instance: JointImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_removed(instance: JointImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn status_reported(instance: JointImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_reported(instance: JointImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: JointImportData, value: parent) -> JointImportData
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: JointImportData) -> Nil
...
pub fn get_attribute_changed_signal(instance: JointImportData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: JointImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: JointImportData) -> List(String)
...
pub fn wait_for_child(instance: JointImportData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: JointImportData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: JointImportData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: JointImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: JointImportData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: JointImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: JointImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: JointImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: JointImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: JointImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: JointImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: JointImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: JointImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: JointImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: JointImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: JointImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: JointImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: JointImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: JointImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: JointImportData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: JointImportData, _: BaseImportData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}