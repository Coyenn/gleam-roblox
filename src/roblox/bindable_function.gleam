...
import roblox/types.{type Actor, type BindableFunction, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `BindableFunction` instance.
///
/// Roblox: `Instance.new("BindableFunction")`
@target(luau)
@luau.global("Instance.new(\"BindableFunction\")")
pub fn new() -> BindableFunction
...
pub fn set_parent(instance: BindableFunction, value: parent) -> BindableFunction
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BindableFunction) -> Nil
...
pub fn get_attribute_changed_signal(instance: BindableFunction, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BindableFunction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BindableFunction) -> List(String)
...
pub fn wait_for_child(instance: BindableFunction, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BindableFunction) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BindableFunction, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BindableFunction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BindableFunction, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BindableFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BindableFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BindableFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BindableFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BindableFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BindableFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BindableFunction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BindableFunction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BindableFunction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BindableFunction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BindableFunction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BindableFunction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BindableFunction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BindableFunction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BindableFunction, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BindableFunction, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}