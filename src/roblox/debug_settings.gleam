...
import roblox/types.{
  type Actor, type DebugSettings, type Instance, type Int64, type Object,
  type SecurityCapabilities, type TickCountSampleMethod, type UniqueId,
}
...
pub fn get_tick_count_precise_override(
  instance: DebugSettings,
...
pub fn get_source_asset_id(instance: DebugSettings) -> Int64
