...
import roblox/types.{
  type Actor, type Instance, type Object, type OptionDouble, type OptionInt,
  type OptionInt64, type SecurityCapabilities, type StyleBase, type StyleRule,
  type UniqueId,
}
...
pub fn set_default_property_transition(
  instance: StyleRule,
  transition_params: Dynamic,
) -> Nil
