...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt, type OptionInt64, type SecurityCapabilities, type StyleBase, type StyleRule, type UniqueId}

/// Creates a new Roblox `StyleRule` instance.
///
/// Roblox: `Instance.new("StyleRule")`
@target(luau)
@luau.global("Instance.new(\"StyleRule\")")
...
pub fn style_rules_changed(instance: StyleRule) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_style_rules_changed(instance: StyleRule, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: StyleRule, value: parent) -> StyleRule
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StyleRule) -> Nil
...
pub fn get_attribute_changed_signal(instance: StyleRule, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StyleRule, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StyleRule) -> List(String)
...
pub fn wait_for_child(instance: StyleRule, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StyleRule) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StyleRule, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StyleRule) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StyleRule, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StyleRule) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StyleRule, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StyleRule) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StyleRule, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StyleRule) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StyleRule, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StyleRule) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StyleRule, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StyleRule) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StyleRule, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StyleRule) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StyleRule, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StyleRule, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StyleRule) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StyleRule, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StyleRule, _: OptionInt, _: StyleBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}