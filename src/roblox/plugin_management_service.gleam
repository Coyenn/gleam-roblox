...
import roblox/types.{
  ...
  type PluginManagementService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PluginManagementService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PluginManagementService) -> Int64
