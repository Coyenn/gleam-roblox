...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PluginAction, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PluginAction` instance.
///
/// Roblox: `Instance.new("PluginAction")`
@target(luau)
@luau.global("Instance.new(\"PluginAction\")")
pub fn new() -> PluginAction
...
pub fn set_parent(instance: PluginAction, value: parent) -> PluginAction
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PluginAction) -> Nil
...
pub fn get_attribute_changed_signal(instance: PluginAction, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PluginAction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PluginAction) -> List(String)
...
pub fn wait_for_child(instance: PluginAction, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PluginAction) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PluginAction, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PluginAction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PluginAction, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PluginAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PluginAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PluginAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PluginAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PluginAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PluginAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PluginAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PluginAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PluginAction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PluginAction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PluginAction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PluginAction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PluginAction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PluginAction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PluginAction, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PluginAction, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}