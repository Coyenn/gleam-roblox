...
import roblox/types.{type Actor, type Backpack, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Backpack` instance.
///
/// Roblox: `Instance.new("Backpack")`
@target(luau)
@luau.global("Instance.new(\"Backpack\")")
pub fn new() -> Backpack

/// Treats `Backpack` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: Backpack, value: parent) -> Backpack
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Backpack) -> Nil
...
pub fn get_attribute_changed_signal(instance: Backpack, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Backpack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Backpack) -> List(String)
...
pub fn wait_for_child(instance: Backpack, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Backpack) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Backpack, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Backpack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Backpack, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Backpack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Backpack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Backpack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Backpack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Backpack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Backpack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Backpack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Backpack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Backpack) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Backpack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Backpack) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Backpack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Backpack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Backpack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Backpack, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Backpack, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}