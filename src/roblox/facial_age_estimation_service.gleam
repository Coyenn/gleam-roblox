...
import roblox/types.{type Actor, type FacialAgeEstimationService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `FacialAgeEstimationService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: FacialAgeEstimationService) -> Instance

/// Treats `FacialAgeEstimationService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: FacialAgeEstimationService) -> Object
...
pub fn set_parent(instance: FacialAgeEstimationService, value: parent) -> FacialAgeEstimationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FacialAgeEstimationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: FacialAgeEstimationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FacialAgeEstimationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FacialAgeEstimationService) -> List(String)
...
pub fn wait_for_child(instance: FacialAgeEstimationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FacialAgeEstimationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FacialAgeEstimationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FacialAgeEstimationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FacialAgeEstimationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FacialAgeEstimationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FacialAgeEstimationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FacialAgeEstimationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FacialAgeEstimationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FacialAgeEstimationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FacialAgeEstimationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FacialAgeEstimationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FacialAgeEstimationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}