...
import roblox/types.{
  type Actor, type FacialAgeEstimationService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: FacialAgeEstimationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: FacialAgeEstimationService) -> Int64
