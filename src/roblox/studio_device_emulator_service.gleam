...
import roblox/types.{
  ...
  type StudioDeviceEmulatorService, type UniqueId, type Vector2,
}
...
pub fn get_has_multi_touch_started(
  instance: StudioDeviceEmulatorService,
) -> Bool
...
pub fn get_is_multi_touch_emulation_on(
  instance: StudioDeviceEmulatorService,
) -> Bool
...
pub fn get_source_asset_id(instance: StudioDeviceEmulatorService) -> Int64
