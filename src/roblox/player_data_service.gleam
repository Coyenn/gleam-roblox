...
import roblox/types.{
  ...
  type PlayerDataLoadFailureBehavior, type PlayerDataRecordConfig,
  type PlayerDataService, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_load_failure_behavior(
  instance: PlayerDataService,
...
pub fn set_load_failure_behavior(
  instance: PlayerDataService,
  value: PlayerDataLoadFailureBehavior,
) -> PlayerDataService
...
pub fn get_source_asset_id(instance: PlayerDataService) -> Int64
