...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerDataLoadFailureBehavior, type PlayerDataRecordConfig, type PlayerDataService, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PlayerDataService, value: parent) -> PlayerDataService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlayerDataService) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlayerDataService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlayerDataService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlayerDataService) -> List(String)
...
pub fn wait_for_child(instance: PlayerDataService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlayerDataService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlayerDataService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlayerDataService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlayerDataService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlayerDataService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlayerDataService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlayerDataService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlayerDataService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlayerDataService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlayerDataService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlayerDataService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlayerDataService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlayerDataService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlayerDataService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlayerDataService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlayerDataService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlayerDataService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlayerDataService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PlayerDataService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PlayerDataRecordConfig, _: PlayerDataLoadFailureBehavior, _: PlayerDataService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}