...
import roblox/types.{
  type Actor, type BasePlayerGui, type CoreGuiType, type Instance, type Int64,
  type Object, type ScreenOrientation, type SecurityCapabilities,
  type StarterGui, type StyleSheet, type UniqueId,
}
...
pub fn get_studio_insert_widget_layer_collector_auto_link_style_sheet(
  instance: StarterGui,
) -> StyleSheet
...
pub fn get_core_gui_enabled(
  instance: StarterGui,
  core_gui_type: CoreGuiType,
) -> Bool
...
pub fn get_gui_objects_at_position(
  instance: StarterGui,
  x: Int,
  y: Int,
) -> List(Instance)
...
pub fn get_source_asset_id(instance: StarterGui) -> Int64
