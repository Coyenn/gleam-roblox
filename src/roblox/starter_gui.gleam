...
import roblox/types.{
  type Actor, type BasePlayerGui, type CoreGuiType, type Instance, type Object,
  type ScreenOrientation, type SecurityCapabilities, type StarterGui,
...
pub fn get_source_asset_id(instance: StarterGui) -> Int
