...
import roblox/types.{
  ...
  type ReflectionMetadataProperties, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: ReflectionMetadataProperties,
  value: Bool,
...
pub fn get_source_asset_id(instance: ReflectionMetadataProperties) -> Int64
