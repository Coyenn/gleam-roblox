...
import roblox/types.{
  type Actor, type ControllerBase, type Instance, type Int64, type Object,
  type SecurityCapabilities, type SwimController, type UniqueId,
}
...
pub fn get_source_asset_id(instance: SwimController) -> Int64
