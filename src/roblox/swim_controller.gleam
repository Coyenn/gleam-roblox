...
import roblox/types.{type Actor, type ControllerBase, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SwimController, type UniqueId}

/// Creates a new Roblox `SwimController` instance.
///
/// Roblox: `Instance.new("SwimController")`
@target(luau)
@luau.global("Instance.new(\"SwimController\")")
...
pub fn set_parent(instance: SwimController, value: parent) -> SwimController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SwimController) -> Nil
...
pub fn get_attribute_changed_signal(instance: SwimController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SwimController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SwimController) -> List(String)
...
pub fn wait_for_child(instance: SwimController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SwimController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SwimController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SwimController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SwimController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SwimController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SwimController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SwimController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SwimController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SwimController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SwimController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SwimController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SwimController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SwimController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SwimController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SwimController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SwimController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SwimController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SwimController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SwimController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SwimController, _: ControllerBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}