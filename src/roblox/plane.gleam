...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type Plane, type PlaneConstraint, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Plane, value: parent) -> Plane
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Plane) -> Nil
...
pub fn get_attribute_changed_signal(instance: Plane, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Plane, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Plane) -> List(String)
...
pub fn wait_for_child(instance: Plane, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Plane) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Plane, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Plane) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Plane, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Plane) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Plane, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Plane) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Plane, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Plane) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Plane, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Plane) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Plane, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Plane) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Plane, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Plane) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Plane, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Plane, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Plane) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Plane, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: Plane, _: PlaneConstraint, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}