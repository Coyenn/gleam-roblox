...
import roblox/types.{type Actor, type ILegacyStudioBridge, type Instance, type LegacyStudioBridge, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `LegacyStudioBridge` as its Roblox ancestor `ILegacyStudioBridge`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_i_legacy_studio_bridge(instance: LegacyStudioBridge) -> ILegacyStudioBridge
...
pub fn set_parent(instance: LegacyStudioBridge, value: parent) -> LegacyStudioBridge
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LegacyStudioBridge) -> Nil
...
pub fn get_attribute_changed_signal(instance: LegacyStudioBridge, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LegacyStudioBridge, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LegacyStudioBridge) -> List(String)
...
pub fn wait_for_child(instance: LegacyStudioBridge, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LegacyStudioBridge, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LegacyStudioBridge, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LegacyStudioBridge, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LegacyStudioBridge, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LegacyStudioBridge, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LegacyStudioBridge, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LegacyStudioBridge) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LegacyStudioBridge, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LegacyStudioBridge) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LegacyStudioBridge, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LegacyStudioBridge, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LegacyStudioBridge) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LegacyStudioBridge, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: LegacyStudioBridge, _: ILegacyStudioBridge, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}