...
import roblox/types.{
  type Actor, type ILegacyStudioBridge, type Instance, type Int64,
  type LegacyStudioBridge, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: LegacyStudioBridge) -> Int64
