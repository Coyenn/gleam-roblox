...
import roblox/types.{type Actor, type Color3, type Instance, type Light, type Object, type OptionDouble, type OptionInt64, type PointLight, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PointLight` instance.
///
/// Roblox: `Instance.new("PointLight")`
@target(luau)
@luau.global("Instance.new(\"PointLight\")")
...
pub fn set_parent(instance: PointLight, value: parent) -> PointLight
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PointLight) -> Nil
...
pub fn get_attribute_changed_signal(instance: PointLight, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PointLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PointLight) -> List(String)
...
pub fn wait_for_child(instance: PointLight, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PointLight) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PointLight, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PointLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PointLight, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PointLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PointLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PointLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PointLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PointLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PointLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PointLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PointLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PointLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PointLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PointLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PointLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PointLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PointLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PointLight, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: PointLight, _: Light, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}