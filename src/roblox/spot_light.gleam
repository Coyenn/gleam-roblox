...
import roblox/types.{type Actor, type Color3, type Instance, type Light, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SpotLight, type UniqueId}

/// Creates a new Roblox `SpotLight` instance.
///
/// Roblox: `Instance.new("SpotLight")`
@target(luau)
@luau.global("Instance.new(\"SpotLight\")")
...
pub fn set_parent(instance: SpotLight, value: parent) -> SpotLight
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SpotLight) -> Nil
...
pub fn get_attribute_changed_signal(instance: SpotLight, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SpotLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SpotLight) -> List(String)
...
pub fn wait_for_child(instance: SpotLight, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SpotLight) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SpotLight, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SpotLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SpotLight, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SpotLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SpotLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SpotLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SpotLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SpotLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SpotLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SpotLight) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SpotLight, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SpotLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SpotLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SpotLight) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SpotLight, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SpotLight, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SpotLight) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SpotLight, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: NormalId, _: SpotLight, _: Light, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}