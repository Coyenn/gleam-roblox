...
import roblox/types.{
  type Actor, type Color3, type Instance, type Int64, type Light, type NormalId,
  type Object, type SecurityCapabilities, type SpotLight, type UniqueId,
}
...
pub fn get_source_asset_id(instance: SpotLight) -> Int64
