...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UIBase, type UIComponent, type UIConstraint, type UITextSizeConstraint, type UniqueId}

/// Creates a new Roblox `UITextSizeConstraint` instance.
///
/// Roblox: `Instance.new("UITextSizeConstraint")`
@target(luau)
@luau.global("Instance.new(\"UITextSizeConstraint\")")
...
pub fn set_parent(instance: UITextSizeConstraint, value: parent) -> UITextSizeConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UITextSizeConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: UITextSizeConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UITextSizeConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UITextSizeConstraint) -> List(String)
...
pub fn wait_for_child(instance: UITextSizeConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UITextSizeConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UITextSizeConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UITextSizeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UITextSizeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UITextSizeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UITextSizeConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UITextSizeConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UITextSizeConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UITextSizeConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UITextSizeConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UITextSizeConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UITextSizeConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UITextSizeConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UITextSizeConstraint, _: UIConstraint, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}