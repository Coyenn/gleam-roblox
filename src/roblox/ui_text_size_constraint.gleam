...
import roblox/types.{
  ...
  type UIComponent, type UIConstraint, type UITextSizeConstraint, type UniqueId,
}
...
pub fn set_max_text_size(
  instance: UITextSizeConstraint,
  value: Int,
