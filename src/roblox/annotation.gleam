...
import roblox/types.{type Actor, type Annotation, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Annotation` instance.
///
/// Roblox: `Instance.new("Annotation")`
@target(luau)
@luau.global("Instance.new(\"Annotation\")")
...
pub fn set_parent(instance: Annotation, value: parent) -> Annotation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Annotation) -> Nil
...
pub fn get_attribute_changed_signal(instance: Annotation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Annotation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Annotation) -> List(String)
...
pub fn wait_for_child(instance: Annotation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Annotation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Annotation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Annotation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Annotation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Annotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Annotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Annotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Annotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Annotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Annotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Annotation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Annotation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Annotation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Annotation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Annotation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Annotation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Annotation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Annotation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Annotation, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Annotation, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}