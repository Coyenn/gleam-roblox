...
import roblox/types.{
  ...
  type PlayerHydrationService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PlayerHydrationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PlayerHydrationService) -> Int64
