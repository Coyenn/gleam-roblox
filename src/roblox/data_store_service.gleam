...
pub fn get_request_budget_for_request_type(
  instance: DataStoreService,
  request_type: DataStoreRequestType,
) -> Int
...
pub fn set_rate_limit_for_request_type(
  instance: DataStoreService,
  request_type: DataStoreRequestType,
  base_limit: Int,
