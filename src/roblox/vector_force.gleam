...
import roblox/types.{type Actor, type ActuatorRelativeTo, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3, type VectorForce}

/// Creates a new Roblox `VectorForce` instance.
///
/// Roblox: `Instance.new("VectorForce")`
@target(luau)
@luau.global("Instance.new(\"VectorForce\")")
...
pub fn set_parent(instance: VectorForce, value: parent) -> VectorForce
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VectorForce) -> Nil
...
pub fn get_attribute_changed_signal(instance: VectorForce, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VectorForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VectorForce) -> List(String)
...
pub fn wait_for_child(instance: VectorForce, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VectorForce) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VectorForce, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VectorForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VectorForce, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VectorForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VectorForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VectorForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VectorForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VectorForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VectorForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VectorForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VectorForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VectorForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VectorForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VectorForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VectorForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VectorForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VectorForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VectorForce, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: ActuatorRelativeTo, _: Vector3, _: VectorForce, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}