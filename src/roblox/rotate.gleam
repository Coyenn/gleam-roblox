...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type Rotate, type SecurityCapabilities, type UniqueId}

/// Treats `Rotate` as its Roblox ancestor `JointInstance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_joint_instance(instance: Rotate) -> JointInstance

/// Treats `Rotate` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: Rotate) -> Instance

/// Treats `Rotate` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: Rotate) -> Object
...
pub fn set_parent(instance: Rotate, value: parent) -> Rotate
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Rotate) -> Nil
...
pub fn get_attribute_changed_signal(instance: Rotate, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Rotate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Rotate) -> List(String)
...
pub fn wait_for_child(instance: Rotate, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Rotate) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Rotate, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Rotate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Rotate, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Rotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Rotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Rotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Rotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Rotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Rotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Rotate) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Rotate, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Rotate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Rotate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Rotate) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Rotate, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Rotate, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Rotate) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Rotate, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: Rotate, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}