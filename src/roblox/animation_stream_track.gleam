...
import roblox/types.{type Actor, type AnimationPriority, type AnimationStreamTrack, type FACSDataLod, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TrackerStreamAnimation, type UniqueId}
...
pub fn set_parent(instance: AnimationStreamTrack, value: parent) -> AnimationStreamTrack
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AnimationStreamTrack) -> Nil
...
pub fn get_attribute_changed_signal(instance: AnimationStreamTrack, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AnimationStreamTrack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AnimationStreamTrack) -> List(String)
...
pub fn wait_for_child(instance: AnimationStreamTrack, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AnimationStreamTrack, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AnimationStreamTrack, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AnimationStreamTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AnimationStreamTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AnimationStreamTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AnimationStreamTrack, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AnimationStreamTrack) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AnimationStreamTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AnimationStreamTrack) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AnimationStreamTrack, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AnimationStreamTrack, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AnimationStreamTrack) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AnimationStreamTrack, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationPriority, _: FACSDataLod, _: TrackerStreamAnimation, _: AnimationStreamTrack, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}