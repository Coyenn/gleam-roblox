...
import roblox/types.{
  type Actor, type AnimationPriority, type AnimationStreamTrack,
  type FACSDataLod, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: AnimationStreamTrack) -> Int64
