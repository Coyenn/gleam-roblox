...
import roblox/types.{type Actor, type Axis, type Dragger, type Instance, type Object, type OptionDouble, type OptionInt64, type Ray, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Dragger` instance.
///
/// Roblox: `Instance.new("Dragger")`
@target(luau)
@luau.global("Instance.new(\"Dragger\")")
pub fn new() -> Dragger
...
pub fn set_parent(instance: Dragger, value: parent) -> Dragger
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Dragger) -> Nil
...
pub fn get_attribute_changed_signal(instance: Dragger, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Dragger, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Dragger) -> List(String)
...
pub fn wait_for_child(instance: Dragger, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Dragger) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Dragger, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Dragger) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Dragger, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Dragger) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Dragger, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Dragger) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Dragger, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Dragger) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Dragger, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Dragger) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Dragger, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Dragger) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Dragger, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Dragger) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Dragger, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Dragger, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Dragger) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Dragger, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Ray, _: Vector3, _: Axis, _: Dragger, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}