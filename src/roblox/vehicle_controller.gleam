...
import roblox/types.{type Actor, type Button, type Controller, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type VehicleController}

/// Creates a new Roblox `VehicleController` instance.
///
/// Roblox: `Instance.new("VehicleController")`
@target(luau)
@luau.global("Instance.new(\"VehicleController\")")
...
pub fn button_changed(instance: VehicleController) -> RBXScriptSignal(fn(Button) -> Nil)
...
pub fn on_button_changed(instance: VehicleController, callback: fn(Button) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: VehicleController, value: parent) -> VehicleController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VehicleController) -> Nil
...
pub fn get_attribute_changed_signal(instance: VehicleController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VehicleController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VehicleController) -> List(String)
...
pub fn wait_for_child(instance: VehicleController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VehicleController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VehicleController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VehicleController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VehicleController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VehicleController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VehicleController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VehicleController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VehicleController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VehicleController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VehicleController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VehicleController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VehicleController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VehicleController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VehicleController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VehicleController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VehicleController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VehicleController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VehicleController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VehicleController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Button, _: VehicleController, _: Controller, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}