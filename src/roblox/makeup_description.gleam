...
import roblox/types.{type Actor, type Instance, type MakeupDescription, type MakeupType, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `MakeupDescription` instance.
///
/// Roblox: `Instance.new("MakeupDescription")`
@target(luau)
@luau.global("Instance.new(\"MakeupDescription\")")
pub fn new() -> MakeupDescription
...
pub fn set_parent(instance: MakeupDescription, value: parent) -> MakeupDescription
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MakeupDescription) -> Nil
...
pub fn get_attribute_changed_signal(instance: MakeupDescription, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MakeupDescription, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MakeupDescription) -> List(String)
...
pub fn wait_for_child(instance: MakeupDescription, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MakeupDescription) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MakeupDescription, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MakeupDescription) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MakeupDescription, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MakeupDescription) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MakeupDescription, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MakeupDescription) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MakeupDescription, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MakeupDescription) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MakeupDescription, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MakeupDescription) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MakeupDescription, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MakeupDescription) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MakeupDescription, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MakeupDescription) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MakeupDescription, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MakeupDescription, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MakeupDescription) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MakeupDescription, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MakeupType, _: MakeupDescription, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}