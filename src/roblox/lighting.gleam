...
import roblox/types.{type Actor, type Color3, type Instance, type Lighting, type LightingStyle, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Technology, type UniqueId, type Vector3}
...
pub fn on_lighting_changed(instance: Lighting, callback: fn(Bool) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: Lighting, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Lighting, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: Lighting, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Lighting) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Lighting, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Lighting) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Lighting, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_child_added(instance: Lighting, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_child_removed(instance: Lighting, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Lighting) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Lighting, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Lighting) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Lighting, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: Lighting, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Lighting) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Lighting, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Lighting, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: Lighting, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: Technology, _: Color3, _: LightingStyle, _: Lighting, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}