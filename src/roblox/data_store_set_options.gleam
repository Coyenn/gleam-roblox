...
import roblox/types.{type Actor, type DataStoreSetOptions, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DataStoreSetOptions` instance.
///
/// Roblox: `Instance.new("DataStoreSetOptions")`
@target(luau)
@luau.global("Instance.new(\"DataStoreSetOptions\")")
pub fn new() -> DataStoreSetOptions
...
pub fn set_parent(instance: DataStoreSetOptions, value: parent) -> DataStoreSetOptions
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStoreSetOptions) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStoreSetOptions, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStoreSetOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStoreSetOptions) -> List(String)
...
pub fn wait_for_child(instance: DataStoreSetOptions, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStoreSetOptions, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStoreSetOptions, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStoreSetOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStoreSetOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStoreSetOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStoreSetOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStoreSetOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStoreSetOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStoreSetOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStoreSetOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStoreSetOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStoreSetOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStoreSetOptions, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreSetOptions, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}