...
import roblox/types.{
  ...
  type MeshImportData, type Object, type SecurityCapabilities, type UniqueId,
  type Vector3,
}
...
pub fn set_cage_mesh_intersected_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_cage_non_manifold_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_cage_overlapping_vertices_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_cage_uv_mis_matched_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_ignore_vertex_colors(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_irrelevant_cage_modified_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn set_mesh_hole_detected_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn get_no_outer_cage_far_extended_from_mesh(
  instance: MeshImportData,
) -> Bool
...
pub fn get_outer_cage_far_extended_from_mesh_preview(
  instance: MeshImportData,
) -> Bool
...
pub fn set_outer_cage_far_extended_from_mesh_preview(
  instance: MeshImportData,
  value: Bool,
) -> MeshImportData
...
pub fn get_source_asset_id(instance: MeshImportData) -> Int64
