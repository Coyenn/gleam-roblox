...
pub fn set_print_join_size_breakdown(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
...
pub fn set_print_physics_errors(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
...
pub fn set_print_stream_instance_quota(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
...
pub fn set_randomize_join_instance_order(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
...
pub fn set_render_streamed_regions(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
...
pub fn set_show_active_animation_asset(
  instance: NetworkSettings,
  value: Bool,
) -> NetworkSettings
