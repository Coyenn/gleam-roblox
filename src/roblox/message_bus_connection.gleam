...
import roblox/types.{
  type Actor, type Instance, type Int64, type MessageBusConnection, type Object,
...
pub fn get_source_asset_id(instance: MessageBusConnection) -> Int64
