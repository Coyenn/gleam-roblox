...
import roblox/types.{
  ...
  type Instance, type Material, type NegateOperation, type NormalId, type Object,
  type OptionDouble, type OptionInt64, type PVInstance, type PartOperation,
