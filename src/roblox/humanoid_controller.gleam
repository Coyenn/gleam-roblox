...
import roblox/types.{type Actor, type Button, type Controller, type HumanoidController, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `HumanoidController` instance.
///
/// Roblox: `Instance.new("HumanoidController")`
@target(luau)
@luau.global("Instance.new(\"HumanoidController\")")
...
pub fn button_changed(instance: HumanoidController) -> RBXScriptSignal(fn(Button) -> Nil)
...
pub fn on_button_changed(instance: HumanoidController, callback: fn(Button) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: HumanoidController, value: parent) -> HumanoidController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HumanoidController) -> Nil
...
pub fn get_attribute_changed_signal(instance: HumanoidController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HumanoidController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HumanoidController) -> List(String)
...
pub fn wait_for_child(instance: HumanoidController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HumanoidController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HumanoidController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HumanoidController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HumanoidController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HumanoidController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HumanoidController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HumanoidController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HumanoidController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HumanoidController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HumanoidController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HumanoidController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HumanoidController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HumanoidController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HumanoidController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HumanoidController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HumanoidController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HumanoidController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HumanoidController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HumanoidController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Button, _: HumanoidController, _: Controller, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}