...
import roblox/types.{
  ...
  type UIComponent, type UIConstraint, type UISizeConstraint, type UniqueId,
  type Vector2,
}
...
pub fn get_source_asset_id(instance: UISizeConstraint) -> Int
