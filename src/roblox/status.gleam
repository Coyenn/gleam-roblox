...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type Model, type ModelLevelOfDetail, type ModelStreamingMode, type Object, type OptionDouble, type OptionInt64, type PVInstance, type Player, type SecurityCapabilities, type Status, type UniqueId, type Vector3}
...
pub fn set_parent(instance: Status, value: parent) -> Status
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Status) -> Nil
...
pub fn get_attribute_changed_signal(instance: Status, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Status, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Status) -> List(String)
...
pub fn wait_for_child(instance: Status, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Status) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Status, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Status) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Status, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Status) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Status, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Status) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Status, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Status) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Status, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Status) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Status, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Status) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Status, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Status) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Status, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Status, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Status) -> RBXScriptSignal(fn(String) -> Nil)
