...
import roblox/types.{type Actor, type Feature, type InOut, type Instance, type LeftRight, type NormalId, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TopBottom, type UniqueId}
...
pub fn set_parent(instance: Feature, value: parent) -> Feature
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Feature) -> Nil
...
pub fn get_attribute_changed_signal(instance: Feature, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Feature, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Feature) -> List(String)
...
pub fn wait_for_child(instance: Feature, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Feature) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Feature, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Feature) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Feature, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Feature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Feature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Feature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Feature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Feature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Feature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Feature) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Feature, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Feature) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Feature, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Feature) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Feature, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Feature, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Feature) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Feature, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TopBottom, _: LeftRight, _: InOut, _: NormalId, _: Feature, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}