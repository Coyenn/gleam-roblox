...
import roblox/types.{type Actor, type AutomaticSize, type BorderMode, type Color3, type Content, type ContentId, type EasingDirection, type EasingStyle, type GuiBase, type GuiBase2d, type GuiObject, type GuiState, type InputObject, type InputSink, type Instance, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type Rect, type RollOffMode, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type SwipeDirection, type UDim2, type UniqueId, type UserInputState, type Vector2, type VideoFrame, type VideoSampleSize}
...
pub fn on_did_loop(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_ended(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_loaded(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_paused(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_played(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn tween_position(instance: VideoFrame, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size(instance: VideoFrame, end_size: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size_and_position(instance: VideoFrame, end_size: UDim2, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn input_began(instance: VideoFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_began(instance: VideoFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_changed(instance: VideoFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_changed(instance: VideoFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_ended(instance: VideoFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_ended(instance: VideoFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_enter(instance: VideoFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_leave(instance: VideoFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_moved(instance: VideoFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_backward(instance: VideoFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_backward(instance: VideoFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_forward(instance: VideoFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_forward(instance: VideoFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_selection_gained(instance: VideoFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_selection_lost(instance: VideoFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn touch_long_press(instance: VideoFrame) -> RBXScriptSignal(fn(List(Vector2), UserInputState) -> Nil)
...
pub fn on_touch_long_press(instance: VideoFrame, callback: fn(List(Vector2), UserInputState) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchPan")
pub fn touch_pan(instance: VideoFrame) -> RBXScriptSignal(fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil)
...
pub fn on_touch_pan(instance: VideoFrame, callback: fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_pinch(instance: VideoFrame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_pinch(instance: VideoFrame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_rotate(instance: VideoFrame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_rotate(instance: VideoFrame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_swipe(instance: VideoFrame) -> RBXScriptSignal(fn(SwipeDirection, Int) -> Nil)
...
pub fn on_touch_swipe(instance: VideoFrame, callback: fn(SwipeDirection, Int) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchTap")
pub fn touch_tap(instance: VideoFrame) -> RBXScriptSignal(fn(List(Vector2)) -> Nil)
...
pub fn on_touch_tap(instance: VideoFrame, callback: fn(List(Vector2)) -> Nil) -> RBXScriptConnection
...
pub fn selection_changed(instance: VideoFrame) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: VideoFrame, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: VideoFrame, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VideoFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: VideoFrame, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VideoFrame) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VideoFrame, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VideoFrame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_child_added(instance: VideoFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VideoFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VideoFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VideoFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VideoFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VideoFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VideoFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: VideoFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VideoFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VideoFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VideoFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: VideoFrame, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: SwipeDirection, _: UserInputState, _: InputObject, _: UDim2, _: EasingDirection, _: EasingStyle, _: SizeConstraint, _: InputSink, _: GuiState, _: BorderMode, _: Color3, _: AutomaticSize, _: Content, _: ContentId, _: RollOffMode, _: VideoSampleSize, _: VideoFrame, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}