...
import roblox/types.{type Actor, type IncrementalPatchBuilder, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: IncrementalPatchBuilder, value: parent) -> IncrementalPatchBuilder
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: IncrementalPatchBuilder) -> Nil
...
pub fn get_attribute_changed_signal(instance: IncrementalPatchBuilder, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: IncrementalPatchBuilder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: IncrementalPatchBuilder) -> List(String)
...
pub fn wait_for_child(instance: IncrementalPatchBuilder, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: IncrementalPatchBuilder, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: IncrementalPatchBuilder, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: IncrementalPatchBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: IncrementalPatchBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: IncrementalPatchBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: IncrementalPatchBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: IncrementalPatchBuilder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: IncrementalPatchBuilder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: IncrementalPatchBuilder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: IncrementalPatchBuilder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: IncrementalPatchBuilder, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: IncrementalPatchBuilder, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}