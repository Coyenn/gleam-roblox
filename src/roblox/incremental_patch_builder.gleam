...
pub fn set_add_paths_to_bundle(
...
pub fn get_use_file_level_compression_instead_of_chunk(
  instance: IncrementalPatchBuilder,
) -> Bool
...
pub fn set_use_file_level_compression_instead_of_chunk(
  instance: IncrementalPatchBuilder,
  value: Bool,
) -> IncrementalPatchBuilder
