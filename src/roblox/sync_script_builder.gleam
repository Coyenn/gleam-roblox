...
import roblox/types.{type Actor, type CompileTarget, type Instance, type Object, type OptionDouble, type OptionInt64, type ScriptBuilder, type SecurityCapabilities, type SyncScriptBuilder, type UniqueId}
...
pub fn set_parent(instance: SyncScriptBuilder, value: parent) -> SyncScriptBuilder
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SyncScriptBuilder) -> Nil
...
pub fn get_attribute_changed_signal(instance: SyncScriptBuilder, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SyncScriptBuilder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SyncScriptBuilder) -> List(String)
...
pub fn wait_for_child(instance: SyncScriptBuilder, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SyncScriptBuilder, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SyncScriptBuilder, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SyncScriptBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SyncScriptBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SyncScriptBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SyncScriptBuilder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SyncScriptBuilder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SyncScriptBuilder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SyncScriptBuilder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SyncScriptBuilder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SyncScriptBuilder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SyncScriptBuilder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SyncScriptBuilder, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CompileTarget, _: SyncScriptBuilder, _: ScriptBuilder, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}