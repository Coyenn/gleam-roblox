...
import roblox/types.{
  type Actor, type CompileTarget, type Instance, type Int64, type Object,
  type ScriptBuilder, type SecurityCapabilities, type SyncScriptBuilder,
  type UniqueId,
}
...
pub fn set_compile_target(
  instance: SyncScriptBuilder,
  value: CompileTarget,
) -> SyncScriptBuilder
...
pub fn get_source_asset_id(instance: SyncScriptBuilder) -> Int64
