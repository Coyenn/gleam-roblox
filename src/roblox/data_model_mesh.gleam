...
import roblox/types.{type Actor, type DataModelMesh, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: DataModelMesh, value: parent) -> DataModelMesh
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataModelMesh) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataModelMesh, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataModelMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataModelMesh) -> List(String)
...
pub fn wait_for_child(instance: DataModelMesh, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataModelMesh) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataModelMesh, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataModelMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataModelMesh, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataModelMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataModelMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataModelMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataModelMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataModelMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataModelMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataModelMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataModelMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataModelMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataModelMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataModelMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataModelMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataModelMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataModelMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataModelMesh, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: DataModelMesh, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}