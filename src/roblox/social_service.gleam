...
import roblox/types.{type Actor, type Instance, type InviteState, type Object, type OptionDouble, type OptionInt64, type Player, type RsvpStatus, type SecurityCapabilities, type SelfViewPosition, type SocialService, type UniqueId}
...
pub fn call_invite_state_changed(instance: SocialService) -> RBXScriptSignal(fn(Instance, InviteState) -> Nil)
...
pub fn on_call_invite_state_changed(instance: SocialService, callback: fn(Instance, InviteState) -> Nil) -> RBXScriptConnection
...
pub fn game_invite_prompt_closed(instance: SocialService) -> RBXScriptSignal(fn(Instance, List(Dynamic)) -> Nil)
...
pub fn on_game_invite_prompt_closed(instance: SocialService, callback: fn(Instance, List(Dynamic)) -> Nil) -> RBXScriptConnection
...
pub fn phone_book_prompt_closed(instance: SocialService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_phone_book_prompt_closed(instance: SocialService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn share_sheet_closed(instance: SocialService) -> RBXScriptSignal(fn(Player) -> Nil)
...
pub fn on_share_sheet_closed(instance: SocialService, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: SocialService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SocialService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: SocialService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SocialService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SocialService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SocialService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SocialService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SocialService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SocialService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SocialService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SocialService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SocialService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SocialService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SocialService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SocialService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: SocialService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SocialService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SocialService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SocialService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: SocialService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: InviteState, _: RsvpStatus, _: SelfViewPosition, _: SocialService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}