...
/// Creates a new Roblox `PartOperation` instance.
///
/// Roblox: `Instance.new("PartOperation")`
@target(luau)
@luau.global("Instance.new(\"PartOperation\")")
pub fn new() -> PartOperation
...
pub fn touch_ended(instance: PartOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: PartOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Touched")
pub fn touched(instance: PartOperation) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touched(instance: PartOperation, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: PartOperation, value: parent) -> PartOperation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PartOperation) -> Nil
...
pub fn get_attribute_changed_signal(instance: PartOperation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PartOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PartOperation) -> List(String)
...
pub fn wait_for_child(instance: PartOperation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PartOperation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PartOperation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PartOperation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PartOperation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PartOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PartOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PartOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PartOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PartOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PartOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PartOperation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PartOperation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PartOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PartOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PartOperation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PartOperation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PartOperation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PartOperation) -> RBXScriptSignal(fn(String) -> Nil)
