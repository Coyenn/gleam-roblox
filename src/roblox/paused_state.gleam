...
import roblox/types.{
  type Actor, type DebuggerPauseReason, type Instance, type Int64, type Object,
  type PausedState, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: PausedState) -> Int64
