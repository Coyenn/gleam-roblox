...
import roblox/types.{type Actor, type Breakpoint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Breakpoint` instance.
///
/// Roblox: `Instance.new("Breakpoint")`
@target(luau)
@luau.global("Instance.new(\"Breakpoint\")")
...
pub fn set_parent(instance: Breakpoint, value: parent) -> Breakpoint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Breakpoint) -> Nil
...
pub fn get_attribute_changed_signal(instance: Breakpoint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Breakpoint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Breakpoint) -> List(String)
...
pub fn wait_for_child(instance: Breakpoint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Breakpoint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Breakpoint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Breakpoint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Breakpoint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Breakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Breakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Breakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Breakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Breakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Breakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Breakpoint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Breakpoint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Breakpoint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Breakpoint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Breakpoint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Breakpoint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Breakpoint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Breakpoint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Breakpoint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Breakpoint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}