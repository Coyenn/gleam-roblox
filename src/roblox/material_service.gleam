...
import roblox/types.{
  type Actor, type Instance, type Int64, type Material, type MaterialService,
  type MaterialVariant, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_base_material_override(
...
pub fn set_base_material_override(
  instance: MaterialService,
  material: Material,
  name: String,
) -> Nil
...
pub fn get_source_asset_id(instance: MaterialService) -> Int64
