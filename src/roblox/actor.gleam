...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type Model, type ModelLevelOfDetail, type ModelStreamingMode, type Object, type OptionDouble, type OptionInt64, type PVInstance, type Player, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Actor` instance.
///
/// Roblox: `Instance.new("Actor")`
@target(luau)
@luau.global("Instance.new(\"Actor\")")
pub fn new() -> Actor
...
pub fn set_parent(instance: Actor, value: parent) -> Actor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Actor) -> Nil
...
pub fn get_attribute_changed_signal(instance: Actor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Actor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Actor) -> List(String)
...
pub fn wait_for_child(instance: Actor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Actor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Actor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Actor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Actor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Actor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Actor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Actor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Actor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Actor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Actor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Actor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Actor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Actor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Actor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Actor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Actor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Actor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Actor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Actor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: Vector3, _: Player, _: BasePart, _: ModelStreamingMode, _: ModelLevelOfDetail, _: Model, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}