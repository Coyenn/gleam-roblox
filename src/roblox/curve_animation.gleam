...
import roblox/types.{type Actor, type AnimationClip, type AnimationPriority, type CurveAnimation, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `CurveAnimation` instance.
///
/// Roblox: `Instance.new("CurveAnimation")`
@target(luau)
@luau.global("Instance.new(\"CurveAnimation\")")
...
pub fn set_parent(instance: CurveAnimation, value: parent) -> CurveAnimation
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CurveAnimation) -> Nil
...
pub fn get_attribute_changed_signal(instance: CurveAnimation, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CurveAnimation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CurveAnimation) -> List(String)
...
pub fn wait_for_child(instance: CurveAnimation, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CurveAnimation) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CurveAnimation, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CurveAnimation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CurveAnimation, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CurveAnimation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CurveAnimation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CurveAnimation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CurveAnimation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CurveAnimation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CurveAnimation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CurveAnimation) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CurveAnimation, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CurveAnimation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CurveAnimation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CurveAnimation) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CurveAnimation, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CurveAnimation, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CurveAnimation) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CurveAnimation, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationPriority, _: CurveAnimation, _: AnimationClip, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}