...
import roblox/types.{
  type Actor, type AnimationClip, type AnimationPriority, type CurveAnimation,
...
pub fn get_source_asset_id(instance: CurveAnimation) -> Int64
