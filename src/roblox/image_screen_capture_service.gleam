...
import roblox/types.{
  type Actor, type ImageScreenCaptureService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: ImageScreenCaptureService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ImageScreenCaptureService) -> Int64
