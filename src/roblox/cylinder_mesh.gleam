...
import roblox/types.{type Actor, type BevelMesh, type CylinderMesh, type DataModelMesh, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Treats `CylinderMesh` as its Roblox ancestor `BevelMesh`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_bevel_mesh(instance: CylinderMesh) -> BevelMesh

/// Treats `CylinderMesh` as its Roblox ancestor `DataModelMesh`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_data_model_mesh(instance: CylinderMesh) -> DataModelMesh

/// Treats `CylinderMesh` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: CylinderMesh) -> Instance

/// Treats `CylinderMesh` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: CylinderMesh) -> Object
...
pub fn set_parent(instance: CylinderMesh, value: parent) -> CylinderMesh
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CylinderMesh) -> Nil
...
pub fn get_attribute_changed_signal(instance: CylinderMesh, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CylinderMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CylinderMesh) -> List(String)
...
pub fn wait_for_child(instance: CylinderMesh, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CylinderMesh) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CylinderMesh, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CylinderMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CylinderMesh, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CylinderMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CylinderMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CylinderMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CylinderMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CylinderMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CylinderMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CylinderMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CylinderMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CylinderMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CylinderMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CylinderMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CylinderMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CylinderMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CylinderMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CylinderMesh, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: CylinderMesh, _: BevelMesh, _: DataModelMesh, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}