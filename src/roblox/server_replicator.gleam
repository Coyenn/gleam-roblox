...
import roblox/types.{
  type Actor, type Instance, type Int64, type NetworkReplicator, type Object,
  type SecurityCapabilities, type ServerReplicator, type UniqueId,
}
...
pub fn get_source_asset_id(instance: ServerReplicator) -> Int64
