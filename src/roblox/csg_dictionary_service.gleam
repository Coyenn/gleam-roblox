...
import roblox/types.{
  type Actor, type CSGDictionaryService, type FlyweightService, type Instance,
...
pub fn get_source_asset_id(instance: CSGDictionaryService) -> Int64
