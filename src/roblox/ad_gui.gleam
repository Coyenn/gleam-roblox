...
import roblox/types.{type Actor, type AdGui, type AdShape, type AdUnitStatus, type ContentId, type GuiBase, type GuiBase2d, type GuiObject, type Instance, type LayerCollector, type LocalizationTable, type NormalId, type Object, type OptionDouble, type OptionInt64, type Rect, type SecurityCapabilities, type SelectionBehavior, type SurfaceGuiBase, type UniqueId, type Vector2, type ZIndexBehavior}

/// Creates a new Roblox `AdGui` instance.
///
/// Roblox: `Instance.new("AdGui")`
@target(luau)
@luau.global("Instance.new(\"AdGui\")")
pub fn new() -> AdGui
...
pub fn selection_changed(instance: AdGui) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: AdGui, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AdGui, value: parent) -> AdGui
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AdGui) -> Nil
...
pub fn get_attribute_changed_signal(instance: AdGui, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AdGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AdGui) -> List(String)
...
pub fn wait_for_child(instance: AdGui, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AdGui) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AdGui, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AdGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AdGui, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AdGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AdGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AdGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AdGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AdGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AdGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AdGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AdGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AdGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AdGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AdGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AdGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AdGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AdGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AdGui, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: ZIndexBehavior, _: NormalId, _: AdUnitStatus, _: ContentId, _: AdShape, _: AdGui, _: SurfaceGuiBase, _: LayerCollector, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}