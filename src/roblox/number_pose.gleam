...
import roblox/types.{type Actor, type Instance, type NumberPose, type Object, type OptionDouble, type OptionInt64, type PoseBase, type PoseEasingDirection, type PoseEasingStyle, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `NumberPose` instance.
///
/// Roblox: `Instance.new("NumberPose")`
@target(luau)
@luau.global("Instance.new(\"NumberPose\")")
...
pub fn set_parent(instance: NumberPose, value: parent) -> NumberPose
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NumberPose) -> Nil
...
pub fn get_attribute_changed_signal(instance: NumberPose, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NumberPose, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NumberPose) -> List(String)
...
pub fn wait_for_child(instance: NumberPose, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NumberPose) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NumberPose, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NumberPose) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NumberPose, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NumberPose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NumberPose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NumberPose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NumberPose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NumberPose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NumberPose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NumberPose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NumberPose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NumberPose) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NumberPose, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NumberPose) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NumberPose, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NumberPose, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NumberPose) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: NumberPose, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PoseEasingStyle, _: PoseEasingDirection, _: NumberPose, _: PoseBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}