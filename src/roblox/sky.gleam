...
import roblox/types.{type Actor, type Content, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Sky, type UniqueId, type Vector3}

/// Creates a new Roblox `Sky` instance.
///
/// Roblox: `Instance.new("Sky")`
@target(luau)
@luau.global("Instance.new(\"Sky\")")
pub fn new() -> Sky
...
pub fn set_parent(instance: Sky, value: parent) -> Sky
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Sky) -> Nil
...
pub fn get_attribute_changed_signal(instance: Sky, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Sky, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Sky) -> List(String)
...
pub fn wait_for_child(instance: Sky, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Sky) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Sky, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Sky) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Sky, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Sky) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Sky, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Sky) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Sky, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Sky) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Sky, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Sky) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Sky, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Sky) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Sky, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Sky) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Sky, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Sky, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Sky) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Sky, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ContentId, _: Content, _: Vector3, _: Sky, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}