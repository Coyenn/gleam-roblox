...
import roblox/types.{
  type Actor, type Content, type ContentId, type Instance, type Int64,
  type Object, type SecurityCapabilities, type Sky, type UniqueId, type Vector3,
}
...
pub fn get_source_asset_id(instance: Sky) -> Int64
