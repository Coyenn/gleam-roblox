...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptEditorService,
...
pub fn get_source_asset_id(instance: ScriptEditorService) -> Int64
