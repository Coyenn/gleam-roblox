...
import roblox/types.{type Actor, type AudioCompressor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioCompressor` instance.
///
/// Roblox: `Instance.new("AudioCompressor")`
@target(luau)
@luau.global("Instance.new(\"AudioCompressor\")")
pub fn new() -> AudioCompressor
...
pub fn get_input_pins(instance: AudioCompressor) -> List(String)
...
pub fn get_output_pins(instance: AudioCompressor) -> List(String)
...
pub fn wiring_changed(instance: AudioCompressor) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioCompressor.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioCompressor via a Wire.
///
/// Roblox: `AudioCompressor.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioCompressor, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioCompressor, value: parent) -> AudioCompressor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioCompressor) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioCompressor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioCompressor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioCompressor) -> List(String)
...
pub fn wait_for_child(instance: AudioCompressor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioCompressor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioCompressor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioCompressor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioCompressor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioCompressor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioCompressor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioCompressor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioCompressor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioCompressor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioCompressor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioCompressor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioCompressor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioCompressor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioCompressor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioCompressor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioCompressor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioCompressor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioCompressor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioCompressor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioCompressor, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}