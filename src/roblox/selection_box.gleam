...
import roblox/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Instance, type InstanceAdornment, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SelectionBox, type UniqueId}

/// Creates a new Roblox `SelectionBox` instance.
///
/// Roblox: `Instance.new("SelectionBox")`
@target(luau)
@luau.global("Instance.new(\"SelectionBox\")")
...
pub fn set_parent(instance: SelectionBox, value: parent) -> SelectionBox
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SelectionBox) -> Nil
...
pub fn get_attribute_changed_signal(instance: SelectionBox, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SelectionBox, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SelectionBox) -> List(String)
...
pub fn wait_for_child(instance: SelectionBox, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SelectionBox) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SelectionBox, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SelectionBox) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SelectionBox, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SelectionBox) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SelectionBox, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SelectionBox) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SelectionBox, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SelectionBox) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SelectionBox, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SelectionBox) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SelectionBox, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SelectionBox) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SelectionBox, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SelectionBox) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SelectionBox, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SelectionBox, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SelectionBox) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SelectionBox, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: SelectionBox, _: InstanceAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}