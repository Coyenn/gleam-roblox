...
import roblox/types.{type Actor, type BaseScript, type CoreScript, type Instance, type LuaSourceContainer, type Object, type OptionDouble, type OptionInt64, type RunContext, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: CoreScript, value: parent) -> CoreScript
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CoreScript) -> Nil
...
pub fn get_attribute_changed_signal(instance: CoreScript, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CoreScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CoreScript) -> List(String)
...
pub fn wait_for_child(instance: CoreScript, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CoreScript) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CoreScript, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CoreScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CoreScript, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CoreScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CoreScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CoreScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CoreScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CoreScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CoreScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CoreScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CoreScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CoreScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CoreScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CoreScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CoreScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CoreScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CoreScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CoreScript, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RunContext, _: CoreScript, _: BaseScript, _: LuaSourceContainer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}