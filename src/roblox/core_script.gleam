...
import roblox/types.{
  type Actor, type BaseScript, type CoreScript, type Instance, type Int64,
  type LuaSourceContainer, type Object, type RunContext,
...
pub fn get_source_asset_id(instance: CoreScript) -> Int64
