...
import roblox/types.{type Actor, type Dialog, type DialogBehaviorType, type DialogPurpose, type DialogTone, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Dialog` instance.
///
/// Roblox: `Instance.new("Dialog")`
@target(luau)
@luau.global("Instance.new(\"Dialog\")")
pub fn new() -> Dialog
...
pub fn dialog_choice_selected(instance: Dialog) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)

/// Connects to Roblox event `Dialog.DialogChoiceSelected`.
///
/// Fired when a player chooses something to say, through a Dialog instance.
///
/// Roblox: `Dialog.DialogChoiceSelected`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/Dialog#DialogChoiceSelected
@target(luau)
@luau.global("(function(instance, callback) return instance.DialogChoiceSelected:Connect(callback) end)")
pub fn on_dialog_choice_selected(instance: Dialog, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Dialog, value: parent) -> Dialog
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Dialog) -> Nil
...
pub fn get_attribute_changed_signal(instance: Dialog, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Dialog, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Dialog) -> List(String)
...
pub fn wait_for_child(instance: Dialog, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Dialog) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Dialog, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Dialog) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Dialog, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Dialog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Dialog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Dialog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Dialog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Dialog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Dialog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Dialog) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Dialog, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Dialog) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Dialog, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Dialog) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Dialog, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Dialog, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Dialog) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Dialog, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: DialogTone, _: DialogPurpose, _: DialogBehaviorType, _: Dialog, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}