...
import roblox/types.{
  type Actor, type Dialog, type DialogBehaviorType, type DialogPurpose,
  type DialogTone, type Instance, type Int64, type Object,
...
pub fn on_dialog_choice_selected(
  instance: Dialog,
...
pub fn get_source_asset_id(instance: Dialog) -> Int64
