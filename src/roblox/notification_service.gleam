...
import roblox/types.{
  type Actor, type ConnectionState, type Instance, type Int64,
  type NotificationService, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn roblox17s_connection_changed(
  instance: NotificationService,
) -> RBXScriptSignal(fn(String, ConnectionState, String) -> Nil)
...
pub fn on_roblox17s_connection_changed(
  instance: NotificationService,
  callback: fn(String, ConnectionState, String) -> Nil,
) -> RBXScriptConnection
...
pub fn roblox17s_event_received(
  instance: NotificationService,
...
pub fn on_roblox17s_event_received(
  instance: NotificationService,
...
pub fn get_source_asset_id(instance: NotificationService) -> Int64
