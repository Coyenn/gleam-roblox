...
import roblox/types.{type Actor, type ConnectionState, type Instance, type NotificationService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn roblox17s_connection_changed(instance: NotificationService) -> RBXScriptSignal(fn(String, ConnectionState, String) -> Nil)

/// Connects to Roblox event `NotificationService.Roblox17sConnectionChanged`.
///
/// Roblox: `NotificationService.Roblox17sConnectionChanged`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/NotificationService#Roblox17sConnectionChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.Roblox17sConnectionChanged:Connect(callback) end)")
pub fn on_roblox17s_connection_changed(instance: NotificationService, callback: fn(String, ConnectionState, String) -> Nil) -> RBXScriptConnection
...
pub fn roblox17s_event_received(instance: NotificationService) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `NotificationService.Roblox17sEventReceived`.
///
/// Roblox: `NotificationService.Roblox17sEventReceived`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/NotificationService#Roblox17sEventReceived
@target(luau)
@luau.global("(function(instance, callback) return instance.Roblox17sEventReceived:Connect(callback) end)")
pub fn on_roblox17s_event_received(instance: NotificationService, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: NotificationService, value: parent) -> NotificationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: NotificationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: NotificationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: NotificationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: NotificationService) -> List(String)
...
pub fn wait_for_child(instance: NotificationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: NotificationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: NotificationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: NotificationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: NotificationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: NotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: NotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: NotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: NotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: NotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: NotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: NotificationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: NotificationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: NotificationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: NotificationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: NotificationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: NotificationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: NotificationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: NotificationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: NotificationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ConnectionState, _: NotificationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}