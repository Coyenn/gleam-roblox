...
import roblox/types.{type Actor, type AudioAnalyzer, type AudioWindowSize, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioAnalyzer` instance.
///
/// Roblox: `Instance.new("AudioAnalyzer")`
@target(luau)
@luau.global("Instance.new(\"AudioAnalyzer\")")
pub fn new() -> AudioAnalyzer
...
pub fn get_input_pins(instance: AudioAnalyzer) -> List(String)
...
pub fn get_output_pins(instance: AudioAnalyzer) -> List(String)
...
pub fn wiring_changed(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioAnalyzer.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioAnalyzer via a Wire.
///
/// Roblox: `AudioAnalyzer.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioAnalyzer, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioAnalyzer, value: parent) -> AudioAnalyzer
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioAnalyzer) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioAnalyzer, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioAnalyzer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioAnalyzer) -> List(String)
...
pub fn wait_for_child(instance: AudioAnalyzer, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioAnalyzer, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioAnalyzer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioAnalyzer, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioAnalyzer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioAnalyzer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioAnalyzer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioAnalyzer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioAnalyzer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioAnalyzer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioAnalyzer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioAnalyzer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioAnalyzer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioAnalyzer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioAnalyzer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioAnalyzer, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioWindowSize, _: AudioAnalyzer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}