...
import roblox/types.{
  type Actor, type GenericChallengeService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: GenericChallengeService,
  value: Bool,
...
pub fn get_source_asset_id(instance: GenericChallengeService) -> Int64
