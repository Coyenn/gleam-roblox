...
import roblox/types.{type Actor, type GenericChallengeService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `GenericChallengeService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: GenericChallengeService) -> Instance

/// Treats `GenericChallengeService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: GenericChallengeService) -> Object
...
pub fn set_parent(instance: GenericChallengeService, value: parent) -> GenericChallengeService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GenericChallengeService) -> Nil
...
pub fn get_attribute_changed_signal(instance: GenericChallengeService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GenericChallengeService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GenericChallengeService) -> List(String)
...
pub fn wait_for_child(instance: GenericChallengeService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GenericChallengeService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GenericChallengeService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GenericChallengeService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GenericChallengeService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GenericChallengeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GenericChallengeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GenericChallengeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GenericChallengeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GenericChallengeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GenericChallengeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GenericChallengeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GenericChallengeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GenericChallengeService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GenericChallengeService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GenericChallengeService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GenericChallengeService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GenericChallengeService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GenericChallengeService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GenericChallengeService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GenericChallengeService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}