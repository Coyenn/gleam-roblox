...
import roblox/types.{type Actor, type ChatInputBarConfiguration, type Color3, type Font, type Instance, type KeyCode, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextBox, type TextChannel, type TextChatConfigurations, type UniqueId, type Vector2}
...
pub fn set_parent(instance: ChatInputBarConfiguration, value: parent) -> ChatInputBarConfiguration
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ChatInputBarConfiguration) -> Nil
...
pub fn get_attribute_changed_signal(instance: ChatInputBarConfiguration, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ChatInputBarConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ChatInputBarConfiguration) -> List(String)
...
pub fn wait_for_child(instance: ChatInputBarConfiguration, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ChatInputBarConfiguration, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ChatInputBarConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ChatInputBarConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ChatInputBarConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ChatInputBarConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ChatInputBarConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ChatInputBarConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ChatInputBarConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ChatInputBarConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ChatInputBarConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ChatInputBarConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: TextBox, _: TextChannel, _: KeyCode, _: Font, _: Vector2, _: ChatInputBarConfiguration, _: TextChatConfigurations, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}