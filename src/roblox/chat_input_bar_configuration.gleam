...
pub fn get_absolute_position_write(
  instance: ChatInputBarConfiguration,
) -> Vector2
...
pub fn set_autocomplete_enabled(
  instance: ChatInputBarConfiguration,
  value: Bool,
...
pub fn get_target_text_channel(
  instance: ChatInputBarConfiguration,
) -> TextChannel
...
pub fn set_target_text_channel(
  instance: ChatInputBarConfiguration,
  value: TextChannel,
) -> ChatInputBarConfiguration
