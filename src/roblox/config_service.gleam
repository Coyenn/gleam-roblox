...
import roblox/types.{
  type Actor, type ConfigService, type ConfigSnapshot, type Instance, type Int64,
...
pub fn get_config_for_player_async(
  instance: ConfigService,
  player: Player,
) -> ConfigSnapshot
...
pub fn get_source_asset_id(instance: ConfigService) -> Int64
