...
import roblox/types.{
  type Actor, type FaceAnimatorService, type Instance, type Int64, type Object,
  type SecurityCapabilities, type TrackerFaceTrackingStatus, type UniqueId,
}
...
pub fn get_face_tracking_status_enum(
  instance: FaceAnimatorService,
...
pub fn get_source_asset_id(instance: FaceAnimatorService) -> Int64
