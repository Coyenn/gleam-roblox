...
import roblox/types.{type AccessModifierType, type AccessoryType, type ActionOnAutoResumeSync, type ActionOnStopSync, type ActionType, type ActivePayerStatus, type ActuatorRelativeTo, type ActuatorType, type AdAvailabilityResult, type AdEventType, type AdFormat, type AdShape, type AdTeleportMethod, type AdUIEventType, type AdUIType, type AdUnitStatus, type AdornCullingMode, type AdornShading, type AlignType, type AlphaMode, type AnalyticsCustomFieldKeys, type AnalyticsEconomyAction, type AnalyticsEconomyFlowType, type AnalyticsEconomyTransactionType, type AnalyticsLogLevel, type AnalyticsProgressionStatus, type AnalyticsProgressionType, type AnimationClipFromVideoStatus, type AnimationNodeBlend2DInputMode, type AnimationNodeInterruptible, type AnimationNodePhaseSync, type AnimationNodePlayMode, type AnimationNodeTransitionType, type AnimationNodeType, type AnimationNodeWaitFor, type AnimationPriority, type AnimatorRetargetingMode, type AnnotationChannelContentPreference, type AnnotationEditingMode, type AnnotationPlaceContentPreference, type AnnotationRequestStatus, type AnnotationRequestType, type AntiAliasing, type AppLifecycleManagerState, type AppShellActionType, type AppShellFeature, type AppUpdateStatus, type ApplyStrokeMode, type AspectType, type AssetCreatorType, type AssetFetchStatus, type AssetRepresentation, type AssetType, type AssetTypeVerification, type AudioApiRollout, type AudioCaptureMode, type AudioChannelLayout, type AudioFilterType, type AudioSimulationFidelity, type AudioSubType, type AudioWindowSize, type AuthorityMode, type AutoIndentRule, type AutomaticSize, type AvatarAssetType, type AvatarChatServiceFeature, type AvatarContextMenuOption, type AvatarGenerationError, type AvatarItemType, type AvatarPromptResult, type AvatarSettingsAccessoryLimitMethod, type AvatarSettingsAccessoryMode, type AvatarSettingsAnimationClipsMode, type AvatarSettingsAnimationPacksMode, type AvatarSettingsAppearanceMode, type AvatarSettingsBuildMode, type AvatarSettingsCharacterControllerMode, type AvatarSettingsClothingMode, type AvatarSettingsCollisionMode, type AvatarSettingsCustomAccessoryMode, type AvatarSettingsCustomBodyType, type AvatarSettingsCustomClothingMode, type AvatarSettingsHitAndTouchDetectionMode, type AvatarSettingsJumpMode, type AvatarSettingsLegacyCollisionMode, type AvatarSettingsScaleMode, type AvatarThumbnailCustomizationType, type AvatarUnificationMode, type Axis, type BenefitType, type BinType, type BodyPart, type BodyPartR15, type BorderMode, type BorderStrokePosition, type BreakReason, type BreakpointRemoveReason, type BulkMoveMode, type BundleType, type Button, type ButtonStyle, type CageType, type CameraMode, type CameraNavigationModel, type CameraPanMode, type CameraSpeedAdjustBinding, type CameraType, type CanCollaborateError, type CaptureGalleryPermission, type CaptureType, type CatalogCategoryFilter, type CatalogSortAggregation, type CatalogSortType, type CellBlock, type CellMaterial, type CellOrientation, type CenterDialogType, type CharacterControlMode, type ChatCallbackType, type ChatColor, type ChatMode, type ChatPrivacyMode, type ChatRestrictionStatus, type ChatStyle, type ChatVersion, type ClientAnimatorThrottlingMode, type CloseReason, type CollaboratorStatus, type CollisionFidelity, type CommandPermission, type CompileTarget, type CompletionAcceptanceBehavior, type CompletionItemKind, type CompletionItemTag, type CompletionTriggerKind, type CompositeValueCurveType, type CompressionAlgorithm, type ComputerCameraMovementMode, type ComputerMovementMode, type ConfigSnapshotErrorState, type ConnectionError, type ConnectionState, type ContentSourceType, type ContextActionPriority, type ContextActionResult, type ControlMode, type CoreGuiType, type CreateAssetResult, type CreateContentResult, type CreateOutfitFailure, type CreatorType, type CreatorTypeFilter, type CurrencyType, type CustomCameraMode, type DataModelExtractorFileType, type DataStoreRequestType, type DebugBreakModeType, type DebuggerEndReason, type DebuggerExceptionBreakMode, type DebuggerFrameType, type DebuggerPauseReason, type DebuggerResumeType, type DebuggerStatus, type DefaultScriptSyncFileType, type DevCameraOcclusionMode, type DevComputerCameraMovementMode, type DevComputerMovementMode, type DevTouchCameraMovementMode, type DevTouchMovementMode, type DeveloperMemoryTag, type DeviceFeatureType, type DeviceForm, type DeviceLevel, type DeviceSimulatorScalingMode, type DeviceType, type DialogBehaviorType, type DialogPurpose, type DialogTone, type DigitsRigDescriptionSide, type DiscountType, type DisplayScalingMode, type DisplaySize, type DomainType, type DominantAxis, type DraftStatusCode, type DragDetectorDragStyle, type DragDetectorPermissionPolicy, type DragDetectorResponseStyle, type DraggerCoordinateSpace, type DraggerMovementMode, type DraggingScrollBar, type EasingDirection, type EasingStyle, type EditableStatus, type ElasticBehavior, type EngagementLevel, type EngineFolder, type EnviromentalPhysicsThrottle, type ExperienceActivationStatus, type ExperienceAuthScope, type ExperienceEventStatus, type ExperienceStateCaptureSelectionMode, type ExperienceStateRecordingLoadMode, type ExperienceStateRecordingLoadSourceType, type ExperienceStateRecordingPlaybackMode, type ExplosionType, type ExternalEditorMode, type FACSDataLod, type FacialAgeEstimationResultType, type FacialAnimationStreamingState, type FacsActionUnit, type FeatureRestrictionAbuseVector, type FieldOfViewMode, type FillDirection, type FilterErrorType, type FilterResult, type FilterType, type FinishRecordingOperation, type FluidFidelity, type FluidForces, type Font, type FontSize, type FontStyle, type FontWeight, type ForceLimitMode, type FormFactor, type FrameStyle, type FramerateManagerMode, type FriendRequestEvent, type FriendStatus, type FunctionalTestResult, type GameAvatarType, type GamepadType, type GearGenreSetting, type GearType, type Genre, type GraphicsMode, type GraphicsOptimizationMode, type GroupMembershipStatus, type GuiState, type GuiType, type HandlesStyle, type HapticEffectType, type HashAlgorithm, type HighlightDepthMode, type HorizontalAlignment, type HoverAnimateSpeed, type HttpCachePolicy, type HttpCompression, type HttpContentType, type HttpError, type HttpRequestType, type HumanoidCollisionType, type HumanoidDisplayDistanceType, type HumanoidHealthDisplayType, type HumanoidRigType, type HumanoidStateType, type IKCollisionsMode, type IKControlConstraintSupport, type IKControlType, type IXPLoadingStatus, type ImageAlphaType, type ImageCombineType, type InOut, type InfoType, type InitialDockState, type InputActionType, type InputSink, type InputType, type InstanceFileSyncStatus, type IntermediateMeshGenerationResult, type InterpolationThrottlingMode, type InviteState, type ItemLineAlignment, type JoinSource, type JointCreationMode, type KeyCode, type KeyInterpolationMode, type KeywordFilterType, type Language, type LeftRight, type LexemeType, type LightingStyle, type Limb, type LineJoinMode, type ListDisplayMode, type ListenerLocation, type ListenerType, type LiveEditingAtomicUpdateResponse, type LiveEditingBroadcastMessageType, type LoadCharacterLayeredClothing, type LoadDynamicHeads, type LocationType, type LuauTypeCheckMode, type MakeupType, type MarketplaceBulkPurchasePromptStatus, type MarketplaceItemPurchaseStatus, type MarketplaceProductType, type MarkupKind, type MatchmakingType, type Material, type MaterialPattern, type MembershipType, type MeshPartDetailLevel, type MeshPartHeadsAndAccessories, type MeshScaleUnit, type MeshType, type MessageType, type ModelLevelOfDetail, type ModelStreamingBehavior, type ModelStreamingMode, type ModerationResultCategory, type ModerationResultLabel, type ModerationStatus, type ModifierKey, type MouseBehavior, type MoveState, type MuteState, type NameOcclusion, type NegateOperationHiddenHistory, type NetworkOwnership, type NetworkStatus, type NoiseType, type NormalId, type NotificationButtonType, type OperationType, type OrientationAlignmentMode, type OutfitSource, type OutfitType, type OutputLayoutMode, type OverrideMouseIconBehavior, type PackagePermission, type PartType, type ParticleEmitterShape, type ParticleEmitterShapeInOut, type ParticleEmitterShapeStyle, type ParticleFlipbookLayout, type ParticleFlipbookMode, type ParticleFlipbookTextureCompatible, type ParticleOrientation, type PathStatus, type PathWaypointAction, type PathfindingUseImprovedSearch, type PeoplePageLayout, type PerformanceOverlayMode, type PermissionLevelShown, type PhysicalConstraintType, type PhysicsSimulationRate, type PhysicsSteppingMethod, type PlaceContentPreference, type PlacePublishType, type Platform, type PlaybackState, type PlayerActions, type PlayerCharacterDestroyBehavior, type PlayerChatType, type PlayerDataErrorState, type PlayerDataLoadFailureBehavior, type PlayerExitReason, type PlayerPlatformActivationStatus, type PlayerPlatformSpenderStatus, type PluginConnectionTargetType, type PoseEasingDirection, type PoseEasingStyle, type PositionAlignmentMode, type PredictionMode, type PredictionStatus, type PreferredInput, type PreferredTextSize, type PrefetchDownloadStatus, type PrimalPhysicsSolver, type PrimitiveType, type PrivilegeType, type ProductLocationRestriction, type ProductPurchaseChannel, type ProductPurchaseDecision, type PromptCreateAssetResult, type PromptCreateAvatarResult, type PromptExperienceDetailsResult, type PromptLinkSharingResult, type PromptPublishAssetResult, type PropertyStatus, type ProximityPromptExclusivity, type ProximityPromptInputType, type ProximityPromptStyle, type PurchaseOption, type QualityLevel, type R15CollisionType, type RaycastFilterType, type ReadCapturesFromGalleryResult, type ReceiptDecision, type ReceiptType, type RecommendationActionType, type RecommendationDepartureIntent, type RecommendationImpressionType, type RecommendationItemContentType, type RecommendationItemVisibility, type RecommendationPreferenceTargetType, type RecommendationPreferenceType, type RejectCharacterDeletions, type RenderFidelity, type RenderPriority, type RenderingCacheOptimizationMode, type RenderingTestComparisonMethod, type ReplicateInstanceDestroySetting, type ResamplerMode, type ReservedHighlightId, type RestPose, type RestPoseModel, type ReturnKeyType, type ReverbType, type ReviewableContentState, type RibbonTool, type RigLabel, type RigScale, type RigType, type RollOffMode, type RolloutState, type RotationOrder, type RotationType, type RsvpStatus, type RtlTextSupport, type RunContext, type RunState, type RuntimeUndoBehavior, type SafeAreaCompatibility, type SalesTypeFilter, type SandboxedInstanceMode, type SaveAvatarThumbnailCustomizationFailure, type SaveFilter, type SavedQualitySetting, type ScaleType, type ScopeCheckResult, type ScreenInsets, type ScreenOrientation, type ScreenshotCaptureResult, type ScriptStoppedReason, type ScriptVariableScope, type ScrollBarInset, type ScrollingDirection, type SecurityCapability, type SelectionBehavior, type SelectionRenderMode, type SelfViewPosition, type SensorMode, type SensorUpdateType, type ServerLiveEditingMode, type ServiceVisibility, type Severity, type ShowAdResult, type SignalBehavior, type SizeConstraint, type SolidPrimitiveType, type SolverConvergenceMetricType, type SolverConvergenceVisualizationMode, type SortDirection, type SortOrder, type SpecialKey, type StartCorner, type StateObjectFieldType, type Status, type StepFrequency, type StreamOutBehavior, type StreamingIntegrityMode, type StreamingPauseMode, type StrokeSizingMode, type StudioCaptureBufferStatus, type StudioCaptureScreenshotFormat, type StudioCloseMode, type StudioDataModelType, type StudioPlaceUpdateFailureReason, type StudioScriptEditorColorCategories, type StudioScriptEditorColorPresets, type StudioStyleGuideColor, type StudioStyleGuideModifier, type Style, type SubscriptionExpirationReason, type SubscriptionPaymentStatus, type SubscriptionPeriod, type SubscriptionState, type SurfaceConstraint, type SurfaceGuiShape, type SurfaceGuiSizingMode, type SurfaceType, type SwipeDirection, type SystemThemeValue, type TableMajorAxis, type TagReplicability, type TeamCreateErrorState, type Technology, type TelemetryBackend, type TelemetryStandardizedField, type TeleportMethod, type TeleportResult, type TeleportState, type TeleportType, type TerrainAcquisitionMethod, type TerrainFace, type TerrainLiquidMergeOperation, type TerrainSolidMergeOperation, type TextChatMessageStatus, type TextDirection, type TextFilterContext, type TextInputType, type TextTruncate, type TextXAlignment, type TextYAlignment, type TextureMode, type TextureQueryType, type ThreadPoolConfig, type ThrottlingPriority, type ThumbnailSize, type ThumbnailType, type TickCountSampleMethod, type TonemapperPreset, type TopBottom, type TouchCameraMovementMode, type TouchMovementMode, type TrackerError, type TrackerExtrapolationFlagMode, type TrackerFaceTrackingStatus, type TrackerLodFlagMode, type TrackerLodValueMode, type TrackerMode, type TrackerPromptEvent, type TrackerType, type TriStateBoolean, type TweenStatus, type UICaptureMode, type UIDragDetectorBoundingBehavior, type UIDragDetectorDragRelativity, type UIDragDetectorDragSpace, type UIDragDetectorDragStyle, type UIDragDetectorResponseStyle, type UIDragSpeedAxisMapping, type UIFlexAlignment, type UIFlexMode, type UITheme, type UiMessageType, type UpdateState, type UploadCaptureResult, type UsageContext, type UserCFrame, type UserInputState, type UserInputType, type VRComfortSetting, type VRControllerModelMode, type VRDeviceType, type VRLaserPointerMode, type VRSafetyBubbleMode, type VRScaling, type VRSessionState, type VRTouchpad, type VRTouchpadMode, type VelocityConstraintMode, type VerticalAlignment, type VerticalScrollBarPosition, type VibrationMotor, type VideoCaptureResult, type VideoCaptureStartedResult, type VideoDeviceCaptureQuality, type VideoError, type VideoSampleSize, type ViewMode, type VirtualCursorMode, type VirtualInputMode, type VoiceChatDistanceAttenuationType, type VoiceChatState, type VoiceClientLeaveReasons, type VoiceControlPath, type VoiceRccReconnectReason, type VolumetricAudio, type WaterDirection, type WaterForce, type WebSocketState, type WebStreamClientState, type WebStreamClientType, type WeldConstraintPreserve, type WhenUserFirstPlayed, type WhisperChatPrivacyMode, type WrapLayerAutoSkin, type WrapLayerDebugMode, type WrapTargetDebugMode, type ZIndexBehavior}
...
pub fn analytics_economy_transaction_type() -> RobloxEnum(AnalyticsEconomyTransactionType)
...
pub fn animation_clip_from_video_status() -> RobloxEnum(AnimationClipFromVideoStatus)
...
pub fn animation_node_blend2_d_input_mode() -> RobloxEnum(AnimationNodeBlend2DInputMode)
...
pub fn animation_node_transition_type() -> RobloxEnum(AnimationNodeTransitionType)
...
pub fn annotation_channel_content_preference() -> RobloxEnum(AnnotationChannelContentPreference)
...
pub fn annotation_place_content_preference() -> RobloxEnum(AnnotationPlaceContentPreference)
...
pub fn avatar_settings_accessory_limit_method() -> RobloxEnum(AvatarSettingsAccessoryLimitMethod)
...
pub fn avatar_settings_accessory_mode() -> RobloxEnum(AvatarSettingsAccessoryMode)
...
pub fn avatar_settings_animation_clips_mode() -> RobloxEnum(AvatarSettingsAnimationClipsMode)
...
pub fn avatar_settings_animation_packs_mode() -> RobloxEnum(AvatarSettingsAnimationPacksMode)
...
pub fn avatar_settings_appearance_mode() -> RobloxEnum(AvatarSettingsAppearanceMode)
...
pub fn avatar_settings_character_controller_mode() -> RobloxEnum(AvatarSettingsCharacterControllerMode)
...
pub fn avatar_settings_collision_mode() -> RobloxEnum(AvatarSettingsCollisionMode)
...
pub fn avatar_settings_custom_accessory_mode() -> RobloxEnum(AvatarSettingsCustomAccessoryMode)
...
pub fn avatar_settings_custom_body_type() -> RobloxEnum(AvatarSettingsCustomBodyType)
...
pub fn avatar_settings_custom_clothing_mode() -> RobloxEnum(AvatarSettingsCustomClothingMode)
...
pub fn avatar_settings_hit_and_touch_detection_mode() -> RobloxEnum(AvatarSettingsHitAndTouchDetectionMode)
...
pub fn avatar_settings_legacy_collision_mode() -> RobloxEnum(AvatarSettingsLegacyCollisionMode)
...
pub fn avatar_thumbnail_customization_type() -> RobloxEnum(AvatarThumbnailCustomizationType)
...
pub fn client_animator_throttling_mode() -> RobloxEnum(ClientAnimatorThrottlingMode)
...
pub fn completion_acceptance_behavior() -> RobloxEnum(CompletionAcceptanceBehavior)
...
pub fn data_model_extractor_file_type() -> RobloxEnum(DataModelExtractorFileType)
...
pub fn dev_computer_camera_movement_mode() -> RobloxEnum(DevComputerCameraMovementMode)
...
pub fn dev_touch_camera_movement_mode() -> RobloxEnum(DevTouchCameraMovementMode)
...
pub fn drag_detector_permission_policy() -> RobloxEnum(DragDetectorPermissionPolicy)
...
pub fn enviromental_physics_throttle() -> RobloxEnum(EnviromentalPhysicsThrottle)
...
pub fn experience_state_capture_selection_mode() -> RobloxEnum(ExperienceStateCaptureSelectionMode)
...
pub fn experience_state_recording_load_mode() -> RobloxEnum(ExperienceStateRecordingLoadMode)
...
pub fn experience_state_recording_load_source_type() -> RobloxEnum(ExperienceStateRecordingLoadSourceType)
...
pub fn experience_state_recording_playback_mode() -> RobloxEnum(ExperienceStateRecordingPlaybackMode)
...
pub fn facial_age_estimation_result_type() -> RobloxEnum(FacialAgeEstimationResultType)
...
pub fn facial_animation_streaming_state() -> RobloxEnum(FacialAnimationStreamingState)
...
pub fn feature_restriction_abuse_vector() -> RobloxEnum(FeatureRestrictionAbuseVector)
...
pub fn humanoid_display_distance_type() -> RobloxEnum(HumanoidDisplayDistanceType)
...
pub fn intermediate_mesh_generation_result() -> RobloxEnum(IntermediateMeshGenerationResult)
...
pub fn interpolation_throttling_mode() -> RobloxEnum(InterpolationThrottlingMode)
...
pub fn live_editing_atomic_update_response() -> RobloxEnum(LiveEditingAtomicUpdateResponse)
...
pub fn live_editing_broadcast_message_type() -> RobloxEnum(LiveEditingBroadcastMessageType)
...
pub fn load_character_layered_clothing() -> RobloxEnum(LoadCharacterLayeredClothing)
...
pub fn marketplace_bulk_purchase_prompt_status() -> RobloxEnum(MarketplaceBulkPurchasePromptStatus)
...
pub fn marketplace_item_purchase_status() -> RobloxEnum(MarketplaceItemPurchaseStatus)
...
pub fn mesh_part_heads_and_accessories() -> RobloxEnum(MeshPartHeadsAndAccessories)
...
pub fn negate_operation_hidden_history() -> RobloxEnum(NegateOperationHiddenHistory)
...
pub fn particle_flipbook_texture_compatible() -> RobloxEnum(ParticleFlipbookTextureCompatible)
...
pub fn pathfinding_use_improved_search() -> RobloxEnum(PathfindingUseImprovedSearch)
...
pub fn player_character_destroy_behavior() -> RobloxEnum(PlayerCharacterDestroyBehavior)
...
pub fn player_data_load_failure_behavior() -> RobloxEnum(PlayerDataLoadFailureBehavior)
...
pub fn player_platform_activation_status() -> RobloxEnum(PlayerPlatformActivationStatus)
...
pub fn player_platform_spender_status() -> RobloxEnum(PlayerPlatformSpenderStatus)
...
pub fn prompt_experience_details_result() -> RobloxEnum(PromptExperienceDetailsResult)
...
pub fn read_captures_from_gallery_result() -> RobloxEnum(ReadCapturesFromGalleryResult)
...
pub fn recommendation_departure_intent() -> RobloxEnum(RecommendationDepartureIntent)
...
pub fn recommendation_impression_type() -> RobloxEnum(RecommendationImpressionType)
...
pub fn recommendation_item_content_type() -> RobloxEnum(RecommendationItemContentType)
...
pub fn recommendation_item_visibility() -> RobloxEnum(RecommendationItemVisibility)
...
pub fn recommendation_preference_target_type() -> RobloxEnum(RecommendationPreferenceTargetType)
...
pub fn recommendation_preference_type() -> RobloxEnum(RecommendationPreferenceType)
...
pub fn rendering_cache_optimization_mode() -> RobloxEnum(RenderingCacheOptimizationMode)
...
pub fn rendering_test_comparison_method() -> RobloxEnum(RenderingTestComparisonMethod)
...
pub fn replicate_instance_destroy_setting() -> RobloxEnum(ReplicateInstanceDestroySetting)
...
pub fn save_avatar_thumbnail_customization_failure() -> RobloxEnum(SaveAvatarThumbnailCustomizationFailure)
...
pub fn solver_convergence_metric_type() -> RobloxEnum(SolverConvergenceMetricType)
...
pub fn solver_convergence_visualization_mode() -> RobloxEnum(SolverConvergenceVisualizationMode)
...
pub fn studio_capture_screenshot_format() -> RobloxEnum(StudioCaptureScreenshotFormat)
...
pub fn studio_place_update_failure_reason() -> RobloxEnum(StudioPlaceUpdateFailureReason)
...
pub fn studio_script_editor_color_categories() -> RobloxEnum(StudioScriptEditorColorCategories)
...
pub fn studio_script_editor_color_presets() -> RobloxEnum(StudioScriptEditorColorPresets)
...
pub fn subscription_expiration_reason() -> RobloxEnum(SubscriptionExpirationReason)
...
pub fn terrain_liquid_merge_operation() -> RobloxEnum(TerrainLiquidMergeOperation)
...
pub fn tracker_extrapolation_flag_mode() -> RobloxEnum(TrackerExtrapolationFlagMode)
...
pub fn uidrag_detector_bounding_behavior() -> RobloxEnum(UIDragDetectorBoundingBehavior)
...
pub fn uidrag_detector_drag_relativity() -> RobloxEnum(UIDragDetectorDragRelativity)
...
pub fn uidrag_detector_response_style() -> RobloxEnum(UIDragDetectorResponseStyle)
...
pub fn voice_chat_distance_attenuation_type() -> RobloxEnum(VoiceChatDistanceAttenuationType)
...
pub fn javascript_type_anchor(_: AccessModifierType, _: AccessoryType, _: ActionOnAutoResumeSync, _: ActionOnStopSync, _: ActionType, _: ActivePayerStatus, _: ActuatorRelativeTo, _: ActuatorType, _: AdAvailabilityResult, _: AdEventType, _: AdFormat, _: AdShape, _: AdTeleportMethod, _: AdUIEventType, _: AdUIType, _: AdUnitStatus, _: AdornCullingMode, _: AdornShading, _: AlignType, _: AlphaMode, _: AnalyticsCustomFieldKeys, _: AnalyticsEconomyAction, _: AnalyticsEconomyFlowType, _: AnalyticsEconomyTransactionType, _: AnalyticsLogLevel, _: AnalyticsProgressionStatus, _: AnalyticsProgressionType, _: AnimationClipFromVideoStatus, _: AnimationNodeBlend2DInputMode, _: AnimationNodeInterruptible, _: AnimationNodePhaseSync, _: AnimationNodePlayMode, _: AnimationNodeTransitionType, _: AnimationNodeType, _: AnimationNodeWaitFor, _: AnimationPriority, _: AnimatorRetargetingMode, _: AnnotationChannelContentPreference, _: AnnotationEditingMode, _: AnnotationPlaceContentPreference, _: AnnotationRequestStatus, _: AnnotationRequestType, _: AntiAliasing, _: AppLifecycleManagerState, _: AppShellActionType, _: AppShellFeature, _: AppUpdateStatus, _: ApplyStrokeMode, _: AspectType, _: AssetCreatorType, _: AssetFetchStatus, _: AssetRepresentation, _: AssetType, _: AssetTypeVerification, _: AudioApiRollout, _: AudioCaptureMode, _: AudioChannelLayout, _: AudioFilterType, _: AudioSimulationFidelity, _: AudioSubType, _: AudioWindowSize, _: AuthorityMode, _: AutoIndentRule, _: AutomaticSize, _: AvatarAssetType, _: AvatarChatServiceFeature, _: AvatarContextMenuOption, _: AvatarGenerationError, _: AvatarItemType, _: AvatarPromptResult, _: AvatarSettingsAccessoryLimitMethod, _: AvatarSettingsAccessoryMode, _: AvatarSettingsAnimationClipsMode, _: AvatarSettingsAnimationPacksMode, _: AvatarSettingsAppearanceMode, _: AvatarSettingsBuildMode, _: AvatarSettingsCharacterControllerMode, _: AvatarSettingsClothingMode, _: AvatarSettingsCollisionMode, _: AvatarSettingsCustomAccessoryMode, _: AvatarSettingsCustomBodyType, _: AvatarSettingsCustomClothingMode, _: AvatarSettingsHitAndTouchDetectionMode, _: AvatarSettingsJumpMode, _: AvatarSettingsLegacyCollisionMode, _: AvatarSettingsScaleMode, _: AvatarThumbnailCustomizationType, _: AvatarUnificationMode, _: Axis, _: BenefitType, _: BinType, _: BodyPart, _: BodyPartR15, _: BorderMode, _: BorderStrokePosition, _: BreakReason, _: BreakpointRemoveReason, _: BulkMoveMode, _: BundleType, _: Button, _: ButtonStyle, _: CageType, _: CameraMode, _: CameraNavigationModel, _: CameraPanMode, _: CameraSpeedAdjustBinding, _: CameraType, _: CanCollaborateError, _: CaptureGalleryPermission, _: CaptureType, _: CatalogCategoryFilter, _: CatalogSortAggregation, _: CatalogSortType, _: CellBlock, _: CellMaterial, _: CellOrientation, _: CenterDialogType, _: CharacterControlMode, _: ChatCallbackType, _: ChatColor, _: ChatMode, _: ChatPrivacyMode, _: ChatRestrictionStatus, _: ChatStyle, _: ChatVersion, _: ClientAnimatorThrottlingMode, _: CloseReason, _: CollaboratorStatus, _: CollisionFidelity, _: CommandPermission, _: CompileTarget, _: CompletionAcceptanceBehavior, _: CompletionItemKind, _: CompletionItemTag, _: CompletionTriggerKind, _: CompositeValueCurveType, _: CompressionAlgorithm, _: ComputerCameraMovementMode, _: ComputerMovementMode, _: ConfigSnapshotErrorState, _: ConnectionError, _: ConnectionState, _: ContentSourceType, _: ContextActionPriority, _: ContextActionResult, _: ControlMode, _: CoreGuiType, _: CreateAssetResult, _: CreateContentResult, _: CreateOutfitFailure, _: CreatorType, _: CreatorTypeFilter, _: CurrencyType, _: CustomCameraMode, _: DataModelExtractorFileType, _: DataStoreRequestType, _: DebugBreakModeType, _: DebuggerEndReason, _: DebuggerExceptionBreakMode, _: DebuggerFrameType, _: DebuggerPauseReason, _: DebuggerResumeType, _: DebuggerStatus, _: DefaultScriptSyncFileType, _: DevCameraOcclusionMode, _: DevComputerCameraMovementMode, _: DevComputerMovementMode, _: DevTouchCameraMovementMode, _: DevTouchMovementMode, _: DeveloperMemoryTag, _: DeviceFeatureType, _: DeviceForm, _: DeviceLevel, _: DeviceSimulatorScalingMode, _: DeviceType, _: DialogBehaviorType, _: DialogPurpose, _: DialogTone, _: DigitsRigDescriptionSide, _: DiscountType, _: DisplayScalingMode, _: DisplaySize, _: DomainType, _: DominantAxis, _: DraftStatusCode, _: DragDetectorDragStyle, _: DragDetectorPermissionPolicy, _: DragDetectorResponseStyle, _: DraggerCoordinateSpace, _: DraggerMovementMode, _: DraggingScrollBar, _: EasingDirection, _: EasingStyle, _: EditableStatus, _: ElasticBehavior, _: EngagementLevel, _: EngineFolder, _: EnviromentalPhysicsThrottle, _: ExperienceActivationStatus, _: ExperienceAuthScope, _: ExperienceEventStatus, _: ExperienceStateCaptureSelectionMode, _: ExperienceStateRecordingLoadMode, _: ExperienceStateRecordingLoadSourceType, _: ExperienceStateRecordingPlaybackMode, _: ExplosionType, _: ExternalEditorMode, _: FACSDataLod, _: FacialAgeEstimationResultType, _: FacialAnimationStreamingState, _: FacsActionUnit, _: FeatureRestrictionAbuseVector, _: FieldOfViewMode, _: FillDirection, _: FilterErrorType, _: FilterResult, _: FilterType, _: FinishRecordingOperation, _: FluidFidelity, _: FluidForces, _: Font, _: FontSize, _: FontStyle, _: FontWeight, _: ForceLimitMode, _: FormFactor, _: FrameStyle, _: FramerateManagerMode, _: FriendRequestEvent, _: FriendStatus, _: FunctionalTestResult, _: GameAvatarType, _: GamepadType, _: GearGenreSetting, _: GearType, _: Genre, _: GraphicsMode, _: GraphicsOptimizationMode, _: GroupMembershipStatus, _: GuiState, _: GuiType, _: HandlesStyle, _: HapticEffectType, _: HashAlgorithm, _: HighlightDepthMode, _: HorizontalAlignment, _: HoverAnimateSpeed, _: HttpCachePolicy, _: HttpCompression, _: HttpContentType, _: HttpError, _: HttpRequestType, _: HumanoidCollisionType, _: HumanoidDisplayDistanceType, _: HumanoidHealthDisplayType, _: HumanoidRigType, _: HumanoidStateType, _: IKCollisionsMode, _: IKControlConstraintSupport, _: IKControlType, _: IXPLoadingStatus, _: ImageAlphaType, _: ImageCombineType, _: InOut, _: InfoType, _: InitialDockState, _: InputActionType, _: InputSink, _: InputType, _: InstanceFileSyncStatus, _: IntermediateMeshGenerationResult, _: InterpolationThrottlingMode, _: InviteState, _: ItemLineAlignment, _: JoinSource, _: JointCreationMode, _: KeyCode, _: KeyInterpolationMode, _: KeywordFilterType, _: Language, _: LeftRight, _: LexemeType, _: LightingStyle, _: Limb, _: LineJoinMode, _: ListDisplayMode, _: ListenerLocation, _: ListenerType, _: LiveEditingAtomicUpdateResponse, _: LiveEditingBroadcastMessageType, _: LoadCharacterLayeredClothing, _: LoadDynamicHeads, _: LocationType, _: LuauTypeCheckMode, _: MakeupType, _: MarketplaceBulkPurchasePromptStatus, _: MarketplaceItemPurchaseStatus, _: MarketplaceProductType, _: MarkupKind, _: MatchmakingType, _: Material, _: MaterialPattern, _: MembershipType, _: MeshPartDetailLevel, _: MeshPartHeadsAndAccessories, _: MeshScaleUnit, _: MeshType, _: MessageType, _: ModelLevelOfDetail, _: ModelStreamingBehavior, _: ModelStreamingMode, _: ModerationResultCategory, _: ModerationResultLabel, _: ModerationStatus, _: ModifierKey, _: MouseBehavior, _: MoveState, _: MuteState, _: NameOcclusion, _: NegateOperationHiddenHistory, _: NetworkOwnership, _: NetworkStatus, _: NoiseType, _: NormalId, _: NotificationButtonType, _: OperationType, _: OrientationAlignmentMode, _: OutfitSource, _: OutfitType, _: OutputLayoutMode, _: OverrideMouseIconBehavior, _: PackagePermission, _: PartType, _: ParticleEmitterShape, _: ParticleEmitterShapeInOut, _: ParticleEmitterShapeStyle, _: ParticleFlipbookLayout, _: ParticleFlipbookMode, _: ParticleFlipbookTextureCompatible, _: ParticleOrientation, _: PathStatus, _: PathWaypointAction, _: PathfindingUseImprovedSearch, _: PeoplePageLayout, _: PerformanceOverlayMode, _: PermissionLevelShown, _: PhysicalConstraintType, _: PhysicsSimulationRate, _: PhysicsSteppingMethod, _: PlaceContentPreference, _: PlacePublishType, _: Platform, _: PlaybackState, _: PlayerActions, _: PlayerCharacterDestroyBehavior, _: PlayerChatType, _: PlayerDataErrorState, _: PlayerDataLoadFailureBehavior, _: PlayerExitReason, _: PlayerPlatformActivationStatus, _: PlayerPlatformSpenderStatus, _: PluginConnectionTargetType, _: PoseEasingDirection, _: PoseEasingStyle, _: PositionAlignmentMode, _: PredictionMode, _: PredictionStatus, _: PreferredInput, _: PreferredTextSize, _: PrefetchDownloadStatus, _: PrimalPhysicsSolver, _: PrimitiveType, _: PrivilegeType, _: ProductLocationRestriction, _: ProductPurchaseChannel, _: ProductPurchaseDecision, _: PromptCreateAssetResult, _: PromptCreateAvatarResult, _: PromptExperienceDetailsResult, _: PromptLinkSharingResult, _: PromptPublishAssetResult, _: PropertyStatus, _: ProximityPromptExclusivity, _: ProximityPromptInputType, _: ProximityPromptStyle, _: PurchaseOption, _: QualityLevel, _: R15CollisionType, _: RaycastFilterType, _: ReadCapturesFromGalleryResult, _: ReceiptDecision, _: ReceiptType, _: RecommendationActionType, _: RecommendationDepartureIntent, _: RecommendationImpressionType, _: RecommendationItemContentType, _: RecommendationItemVisibility, _: RecommendationPreferenceTargetType, _: RecommendationPreferenceType, _: RejectCharacterDeletions, _: RenderFidelity, _: RenderPriority, _: RenderingCacheOptimizationMode, _: RenderingTestComparisonMethod, _: ReplicateInstanceDestroySetting, _: ResamplerMode, _: ReservedHighlightId, _: RestPose, _: RestPoseModel, _: ReturnKeyType, _: ReverbType, _: ReviewableContentState, _: RibbonTool, _: RigLabel, _: RigScale, _: RigType, _: RollOffMode, _: RolloutState, _: RotationOrder, _: RotationType, _: RsvpStatus, _: RtlTextSupport, _: RunContext, _: RunState, _: RuntimeUndoBehavior, _: SafeAreaCompatibility, _: SalesTypeFilter, _: SandboxedInstanceMode, _: SaveAvatarThumbnailCustomizationFailure, _: SaveFilter, _: SavedQualitySetting, _: ScaleType, _: ScopeCheckResult, _: ScreenInsets, _: ScreenOrientation, _: ScreenshotCaptureResult, _: ScriptStoppedReason, _: ScriptVariableScope, _: ScrollBarInset, _: ScrollingDirection, _: SecurityCapability, _: SelectionBehavior, _: SelectionRenderMode, _: SelfViewPosition, _: SensorMode, _: SensorUpdateType, _: ServerLiveEditingMode, _: ServiceVisibility, _: Severity, _: ShowAdResult, _: SignalBehavior, _: SizeConstraint, _: SolidPrimitiveType, _: SolverConvergenceMetricType, _: SolverConvergenceVisualizationMode, _: SortDirection, _: SortOrder, _: SpecialKey, _: StartCorner, _: StateObjectFieldType, _: Status, _: StepFrequency, _: StreamOutBehavior, _: StreamingIntegrityMode, _: StreamingPauseMode, _: StrokeSizingMode, _: StudioCaptureBufferStatus, _: StudioCaptureScreenshotFormat, _: StudioCloseMode, _: StudioDataModelType, _: StudioPlaceUpdateFailureReason, _: StudioScriptEditorColorCategories, _: StudioScriptEditorColorPresets, _: StudioStyleGuideColor, _: StudioStyleGuideModifier, _: Style, _: SubscriptionExpirationReason, _: SubscriptionPaymentStatus, _: SubscriptionPeriod, _: SubscriptionState, _: SurfaceConstraint, _: SurfaceGuiShape, _: SurfaceGuiSizingMode, _: SurfaceType, _: SwipeDirection, _: SystemThemeValue, _: TableMajorAxis, _: TagReplicability, _: TeamCreateErrorState, _: Technology, _: TelemetryBackend, _: TelemetryStandardizedField, _: TeleportMethod, _: TeleportResult, _: TeleportState, _: TeleportType, _: TerrainAcquisitionMethod, _: TerrainFace, _: TerrainLiquidMergeOperation, _: TerrainSolidMergeOperation, _: TextChatMessageStatus, _: TextDirection, _: TextFilterContext, _: TextInputType, _: TextTruncate, _: TextXAlignment, _: TextYAlignment, _: TextureMode, _: TextureQueryType, _: ThreadPoolConfig, _: ThrottlingPriority, _: ThumbnailSize, _: ThumbnailType, _: TickCountSampleMethod, _: TonemapperPreset, _: TopBottom, _: TouchCameraMovementMode, _: TouchMovementMode, _: TrackerError, _: TrackerExtrapolationFlagMode, _: TrackerFaceTrackingStatus, _: TrackerLodFlagMode, _: TrackerLodValueMode, _: TrackerMode, _: TrackerPromptEvent, _: TrackerType, _: TriStateBoolean, _: TweenStatus, _: UICaptureMode, _: UIDragDetectorBoundingBehavior, _: UIDragDetectorDragRelativity, _: UIDragDetectorDragSpace, _: UIDragDetectorDragStyle, _: UIDragDetectorResponseStyle, _: UIDragSpeedAxisMapping, _: UIFlexAlignment, _: UIFlexMode, _: UITheme, _: UiMessageType, _: UpdateState, _: UploadCaptureResult, _: UsageContext, _: UserCFrame, _: UserInputState, _: UserInputType, _: VRComfortSetting, _: VRControllerModelMode, _: VRDeviceType, _: VRLaserPointerMode, _: VRSafetyBubbleMode, _: VRScaling, _: VRSessionState, _: VRTouchpad, _: VRTouchpadMode, _: VelocityConstraintMode, _: VerticalAlignment, _: VerticalScrollBarPosition, _: VibrationMotor, _: VideoCaptureResult, _: VideoCaptureStartedResult, _: VideoDeviceCaptureQuality, _: VideoError, _: VideoSampleSize, _: ViewMode, _: VirtualCursorMode, _: VirtualInputMode, _: VoiceChatDistanceAttenuationType, _: VoiceChatState, _: VoiceClientLeaveReasons, _: VoiceControlPath, _: VoiceRccReconnectReason, _: VolumetricAudio, _: WaterDirection, _: WaterForce, _: WebSocketState, _: WebStreamClientState, _: WebStreamClientType, _: WeldConstraintPreserve, _: WhenUserFirstPlayed, _: WhisperChatPrivacyMode, _: WrapLayerAutoSkin, _: WrapLayerDebugMode, _: WrapTargetDebugMode, _: ZIndexBehavior) -> Nil {
  Nil
}