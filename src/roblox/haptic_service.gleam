...
import roblox/types.{
  type Actor, type HapticService, type Instance, type Int64, type Object,
  type SecurityCapabilities, type UniqueId, type UserInputType,
  type VibrationMotor,
}
...
pub fn get_source_asset_id(instance: HapticService) -> Int64
