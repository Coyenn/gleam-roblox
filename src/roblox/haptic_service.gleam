...
import roblox/types.{type Actor, type HapticService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type UserInputType, type VibrationMotor}
...
pub fn set_parent(instance: HapticService, value: parent) -> HapticService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HapticService) -> Nil
...
pub fn get_attribute_changed_signal(instance: HapticService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HapticService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HapticService) -> List(String)
...
pub fn wait_for_child(instance: HapticService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HapticService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HapticService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HapticService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HapticService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HapticService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HapticService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HapticService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HapticService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HapticService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HapticService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HapticService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HapticService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HapticService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HapticService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HapticService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HapticService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HapticService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HapticService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HapticService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UserInputType, _: VibrationMotor, _: HapticService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}