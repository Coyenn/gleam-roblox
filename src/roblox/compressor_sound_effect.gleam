...
import roblox/types.{
  type Actor, type CompressorSoundEffect, type Instance, type Int64, type Object,
...
pub fn set_attack(
  instance: CompressorSoundEffect,
  value: Float,
...
pub fn get_source_asset_id(instance: CompressorSoundEffect) -> Int64
