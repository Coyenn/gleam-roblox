...
import roblox/types.{type Actor, type CompressorSoundEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SoundEffect, type UniqueId}

/// Creates a new Roblox `CompressorSoundEffect` instance.
///
/// Roblox: `Instance.new("CompressorSoundEffect")`
@target(luau)
@luau.global("Instance.new(\"CompressorSoundEffect\")")
...
pub fn set_parent(instance: CompressorSoundEffect, value: parent) -> CompressorSoundEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CompressorSoundEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: CompressorSoundEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CompressorSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CompressorSoundEffect) -> List(String)
...
pub fn wait_for_child(instance: CompressorSoundEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CompressorSoundEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CompressorSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CompressorSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CompressorSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CompressorSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CompressorSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CompressorSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CompressorSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CompressorSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CompressorSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CompressorSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CompressorSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CompressorSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CompressorSoundEffect, _: SoundEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}