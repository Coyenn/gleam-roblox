...
import roblox/types.{
  ...
  type PlayerEmulatorService, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_serialized_emulated_policy_info(
  instance: PlayerEmulatorService,
) -> BinaryString
...
pub fn get_source_asset_id(instance: PlayerEmulatorService) -> Int64
