...
import roblox/types.{type Actor, type BinaryString, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerEmulatorService, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PlayerEmulatorService, value: parent) -> PlayerEmulatorService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlayerEmulatorService) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlayerEmulatorService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlayerEmulatorService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlayerEmulatorService) -> List(String)
...
pub fn wait_for_child(instance: PlayerEmulatorService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlayerEmulatorService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlayerEmulatorService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlayerEmulatorService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlayerEmulatorService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlayerEmulatorService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlayerEmulatorService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlayerEmulatorService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlayerEmulatorService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlayerEmulatorService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlayerEmulatorService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlayerEmulatorService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlayerEmulatorService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PlayerEmulatorService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BinaryString, _: PlayerEmulatorService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}