...
import roblox/types.{
  type Actor, type CommerceService, type Instance, type Object,
...
pub fn prompt_commerce_product_purchase(
  instance: CommerceService,
  user: Player,
...
pub fn prompt_real_world_commerce_browser(
  instance: CommerceService,
  player: Player,
  url: String,
) -> Nil
...
pub fn get_commerce_product_info_async(
  instance: CommerceService,
  commerce_product_id: String,
) -> Dynamic
...
pub fn user_eligible_for_real_world_commerce_async(
  instance: CommerceService,
) -> Bool
...
pub fn prompt_commerce_product_purchase_finished(
  instance: CommerceService,
...
pub fn on_prompt_commerce_product_purchase_finished(
  instance: CommerceService,
