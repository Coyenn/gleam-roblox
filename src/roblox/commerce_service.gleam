...
import roblox/types.{type Actor, type CommerceService, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId}
...
pub fn prompt_commerce_product_purchase_finished(instance: CommerceService) -> RBXScriptSignal(fn(Player, String) -> Nil)

/// Connects to Roblox event `CommerceService.PromptCommerceProductPurchaseFinished`.
///
/// Fires when commerce purchase webview has closed - not an indicator that a purchase was successful.
///
/// Roblox: `CommerceService.PromptCommerceProductPurchaseFinished`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CommerceService#PromptCommerceProductPurchaseFinished
@target(luau)
@luau.global("(function(instance, callback) return instance.PromptCommerceProductPurchaseFinished:Connect(callback) end)")
pub fn on_prompt_commerce_product_purchase_finished(instance: CommerceService, callback: fn(Player, String) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: CommerceService, value: parent) -> CommerceService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CommerceService) -> Nil
...
pub fn get_attribute_changed_signal(instance: CommerceService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CommerceService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CommerceService) -> List(String)
...
pub fn wait_for_child(instance: CommerceService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CommerceService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CommerceService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CommerceService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CommerceService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CommerceService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CommerceService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CommerceService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CommerceService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CommerceService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CommerceService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CommerceService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CommerceService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CommerceService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CommerceService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CommerceService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CommerceService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CommerceService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CommerceService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CommerceService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: CommerceService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}