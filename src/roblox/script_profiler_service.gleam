...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type ScriptProfilerService,
...
pub fn set_archivable(
  instance: ScriptProfilerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ScriptProfilerService) -> Int64
