...
import roblox/types.{type Actor, type BodyGyro, type BodyMover, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: BodyGyro, value: parent) -> BodyGyro
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BodyGyro) -> Nil
...
pub fn get_attribute_changed_signal(instance: BodyGyro, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BodyGyro, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BodyGyro) -> List(String)
...
pub fn wait_for_child(instance: BodyGyro, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BodyGyro) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BodyGyro, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BodyGyro) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BodyGyro, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BodyGyro) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BodyGyro, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BodyGyro) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BodyGyro, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BodyGyro) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BodyGyro, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BodyGyro) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BodyGyro, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BodyGyro) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BodyGyro, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BodyGyro) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BodyGyro, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BodyGyro, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BodyGyro) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BodyGyro, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: CFrame, _: BodyGyro, _: BodyMover, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}