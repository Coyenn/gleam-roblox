...
import roblox/types.{type Actor, type AdPortal, type AdUnitStatus, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `AdPortal` instance.
///
/// Roblox: `Instance.new("AdPortal")`
@target(luau)
@luau.global("Instance.new(\"AdPortal\")")
pub fn new() -> AdPortal
...
pub fn set_parent(instance: AdPortal, value: parent) -> AdPortal
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AdPortal) -> Nil
...
pub fn get_attribute_changed_signal(instance: AdPortal, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AdPortal, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AdPortal) -> List(String)
...
pub fn wait_for_child(instance: AdPortal, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AdPortal) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AdPortal, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AdPortal) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AdPortal, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AdPortal) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AdPortal, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AdPortal) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AdPortal, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AdPortal) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AdPortal, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AdPortal) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AdPortal, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AdPortal) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AdPortal, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AdPortal) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AdPortal, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AdPortal, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AdPortal) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AdPortal, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AdUnitStatus, _: AdPortal, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}