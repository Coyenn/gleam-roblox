...
import roblox/types.{type Actor, type BasePart, type CFrame, type DynamicRotate, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type RotateV, type SecurityCapabilities, type UniqueId}

/// Treats `RotateV` as its Roblox ancestor `DynamicRotate`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_dynamic_rotate(instance: RotateV) -> DynamicRotate

/// Treats `RotateV` as its Roblox ancestor `JointInstance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_joint_instance(instance: RotateV) -> JointInstance

/// Treats `RotateV` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: RotateV) -> Instance

/// Treats `RotateV` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: RotateV) -> Object
...
pub fn set_parent(instance: RotateV, value: parent) -> RotateV
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RotateV) -> Nil
...
pub fn get_attribute_changed_signal(instance: RotateV, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RotateV, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RotateV) -> List(String)
...
pub fn wait_for_child(instance: RotateV, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RotateV) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RotateV, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RotateV) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RotateV, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RotateV) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RotateV, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RotateV) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RotateV, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RotateV) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RotateV, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RotateV) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RotateV, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RotateV) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RotateV, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RotateV) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RotateV, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RotateV, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RotateV) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RotateV, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: RotateV, _: DynamicRotate, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}