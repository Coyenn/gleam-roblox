...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type RemoteDebuggerServer,
...
pub fn get_source_asset_id(instance: RemoteDebuggerServer) -> Int64
