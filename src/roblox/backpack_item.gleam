...
import roblox/types.{
  ...
  type ModelStreamingMode, type Object, type PVInstance, type Player,
...
pub fn set_texture_content(
  instance: BackpackItem,
  value: Content,
) -> BackpackItem
...
pub fn get_source_asset_id(instance: BackpackItem) -> Int64
