...
import roblox/types.{type Actor, type DebuggerConnection, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: DebuggerConnection, value: parent) -> DebuggerConnection
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DebuggerConnection) -> Nil
...
pub fn get_attribute_changed_signal(instance: DebuggerConnection, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DebuggerConnection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DebuggerConnection) -> List(String)
...
pub fn wait_for_child(instance: DebuggerConnection, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DebuggerConnection) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DebuggerConnection, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DebuggerConnection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DebuggerConnection, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DebuggerConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DebuggerConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DebuggerConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DebuggerConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DebuggerConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DebuggerConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DebuggerConnection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DebuggerConnection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DebuggerConnection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DebuggerConnection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DebuggerConnection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DebuggerConnection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DebuggerConnection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DebuggerConnection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DebuggerConnection, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DebuggerConnection, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}