...
import roblox/types.{
  type Actor, type DebuggerConnection, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: DebuggerConnection) -> Int64
