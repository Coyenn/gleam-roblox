...
import roblox/types.{type Actor, type AudioSpeechToText, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioSpeechToText` instance.
///
/// Roblox: `Instance.new("AudioSpeechToText")`
@target(luau)
@luau.global("Instance.new(\"AudioSpeechToText\")")
pub fn new() -> AudioSpeechToText
...
/// Gets Roblox property `AudioSpeechToText.IsDictationEnabled`.
///
/// Roblox: `AudioSpeechToText.IsDictationEnabled`
/// ThreadSafety: ReadSafe
/// See: https://create.roblox.com/docs/reference/engine/classes/AudioSpeechToText#IsDictationEnabled
@target(luau)
@luau.property("IsDictationEnabled")
pub fn get_is_dictation_enabled(instance: AudioSpeechToText) -> Bool
...
pub fn wiring_changed(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioSpeechToText.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioSpeechToText via a Wire.
///
/// Roblox: `AudioSpeechToText.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioSpeechToText, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioSpeechToText, value: parent) -> AudioSpeechToText
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioSpeechToText) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioSpeechToText, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioSpeechToText, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioSpeechToText) -> List(String)
...
pub fn wait_for_child(instance: AudioSpeechToText, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioSpeechToText, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioSpeechToText) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioSpeechToText, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioSpeechToText, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioSpeechToText, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioSpeechToText, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioSpeechToText) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioSpeechToText, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioSpeechToText) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioSpeechToText, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioSpeechToText) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioSpeechToText, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioSpeechToText, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioSpeechToText) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioSpeechToText, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioSpeechToText, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}