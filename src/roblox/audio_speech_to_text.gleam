...
import roblox/types.{
  type Actor, type AudioSpeechToText, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: AudioSpeechToText) -> Int64
