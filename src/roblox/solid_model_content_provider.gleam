...
import roblox/types.{type Actor, type CacheableContentProvider, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SolidModelContentProvider, type UniqueId}

/// Treats `SolidModelContentProvider` as its Roblox ancestor `CacheableContentProvider`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_cacheable_content_provider(instance: SolidModelContentProvider) -> CacheableContentProvider
...
pub fn set_parent(instance: SolidModelContentProvider, value: parent) -> SolidModelContentProvider
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SolidModelContentProvider) -> Nil
...
pub fn get_attribute_changed_signal(instance: SolidModelContentProvider, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SolidModelContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SolidModelContentProvider) -> List(String)
...
pub fn wait_for_child(instance: SolidModelContentProvider, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SolidModelContentProvider, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SolidModelContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SolidModelContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SolidModelContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SolidModelContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SolidModelContentProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SolidModelContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SolidModelContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SolidModelContentProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SolidModelContentProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SolidModelContentProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SolidModelContentProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SolidModelContentProvider, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SolidModelContentProvider, _: CacheableContentProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}