...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Translator, type UniqueId}
...
pub fn set_parent(instance: Translator, value: parent) -> Translator
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Translator) -> Nil
...
pub fn get_attribute_changed_signal(instance: Translator, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Translator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Translator) -> List(String)
...
pub fn wait_for_child(instance: Translator, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Translator) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Translator, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Translator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Translator, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Translator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Translator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Translator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Translator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Translator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Translator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Translator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Translator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Translator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Translator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Translator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Translator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Translator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Translator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Translator, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Translator, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}