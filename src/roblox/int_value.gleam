...
import roblox/types.{type Actor, type Instance, type IntValue, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `IntValue` instance.
///
/// Roblox: `Instance.new("IntValue")`
@target(luau)
@luau.global("Instance.new(\"IntValue\")")
pub fn new() -> IntValue
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: IntValue) -> RBXScriptSignal(fn(OptionInt64) -> Nil)
...
pub fn on_changed(instance: IntValue, callback: fn(OptionInt64) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: IntValue, value: parent) -> IntValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: IntValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: IntValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: IntValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: IntValue) -> List(String)
...
pub fn wait_for_child(instance: IntValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: IntValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: IntValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: IntValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: IntValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: IntValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: IntValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: IntValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: IntValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: IntValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: IntValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: IntValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: IntValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: IntValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: IntValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: IntValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: IntValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: IntValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: IntValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}