...
import roblox/types.{
  ...
  type StudioScriptDebugEventListener, type UniqueId,
}
...
pub fn set_archivable(
  instance: StudioScriptDebugEventListener,
  value: Bool,
...
pub fn get_source_asset_id(instance: StudioScriptDebugEventListener) -> Int64
