...
import roblox/types.{type Actor, type BodyForce, type BodyMover, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: BodyForce, value: parent) -> BodyForce
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BodyForce) -> Nil
...
pub fn get_attribute_changed_signal(instance: BodyForce, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BodyForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BodyForce) -> List(String)
...
pub fn wait_for_child(instance: BodyForce, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BodyForce) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BodyForce, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BodyForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BodyForce, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BodyForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BodyForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BodyForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BodyForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BodyForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BodyForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BodyForce) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BodyForce, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BodyForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BodyForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BodyForce) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BodyForce, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BodyForce, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BodyForce) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BodyForce, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: BodyForce, _: BodyMover, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}