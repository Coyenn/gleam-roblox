...
import roblox/types.{type Actor, type BasePart, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WeldConstraint}

/// Creates a new Roblox `WeldConstraint` instance.
///
/// Roblox: `Instance.new("WeldConstraint")`
@target(luau)
@luau.global("Instance.new(\"WeldConstraint\")")
pub fn new() -> WeldConstraint
...
pub fn set_parent(instance: WeldConstraint, value: parent) -> WeldConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WeldConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: WeldConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WeldConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WeldConstraint) -> List(String)
...
pub fn wait_for_child(instance: WeldConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WeldConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WeldConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WeldConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WeldConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WeldConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WeldConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WeldConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WeldConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WeldConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WeldConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WeldConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WeldConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WeldConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WeldConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WeldConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WeldConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WeldConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WeldConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WeldConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: WeldConstraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}