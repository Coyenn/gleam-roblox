...
import roblox/types.{
  type Actor, type BasePart, type Instance, type Int64, type Object,
  type SecurityCapabilities, type UniqueId, type WeldConstraint,
}
...
pub fn get_source_asset_id(instance: WeldConstraint) -> Int64
