...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UDim, type UIBase, type UIComponent, type UIPadding, type UniqueId}

/// Creates a new Roblox `UIPadding` instance.
///
/// Roblox: `Instance.new("UIPadding")`
@target(luau)
@luau.global("Instance.new(\"UIPadding\")")
...
pub fn set_parent(instance: UIPadding, value: parent) -> UIPadding
...
pub fn get_source_asset_id(instance: UIPadding) -> OptionInt64
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIPadding) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIPadding, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIPadding, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIPadding) -> List(String)
...
pub fn wait_for_child(instance: UIPadding, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIPadding) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIPadding, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIPadding) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIPadding, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIPadding) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIPadding, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIPadding) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIPadding, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIPadding) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIPadding, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIPadding) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIPadding, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIPadding) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIPadding, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIPadding) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIPadding, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIPadding, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIPadding) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIPadding, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UDim, _: UIPadding, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}