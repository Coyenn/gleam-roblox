...
import roblox/types.{
  ...
  type RobloxReplicatedStorage, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RobloxReplicatedStorage,
  value: Bool,
...
pub fn get_source_asset_id(instance: RobloxReplicatedStorage) -> Int64
