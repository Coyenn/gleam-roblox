...
import roblox/types.{
  ...
  type Instance, type Material, type MaterialPattern, type MaterialVariant,
  type Object, type PhysicalProperties, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: MaterialVariant) -> Int
