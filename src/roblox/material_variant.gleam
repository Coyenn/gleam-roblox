...
import roblox/types.{type Actor, type AlphaMode, type Color3, type Content, type ContentId, type Instance, type Material, type MaterialPattern, type MaterialVariant, type Object, type OptionDouble, type OptionInt64, type PhysicalProperties, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `MaterialVariant` instance.
///
/// Roblox: `Instance.new("MaterialVariant")`
@target(luau)
@luau.global("Instance.new(\"MaterialVariant\")")
pub fn new() -> MaterialVariant
...
pub fn set_parent(instance: MaterialVariant, value: parent) -> MaterialVariant
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MaterialVariant) -> Nil
...
pub fn get_attribute_changed_signal(instance: MaterialVariant, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MaterialVariant, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MaterialVariant) -> List(String)
...
pub fn wait_for_child(instance: MaterialVariant, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MaterialVariant) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MaterialVariant, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MaterialVariant) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MaterialVariant, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MaterialVariant) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MaterialVariant, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MaterialVariant) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MaterialVariant, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MaterialVariant) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MaterialVariant, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MaterialVariant) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MaterialVariant, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MaterialVariant) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MaterialVariant, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MaterialVariant) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MaterialVariant, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MaterialVariant, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MaterialVariant) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MaterialVariant, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Content, _: ContentId, _: MaterialPattern, _: Color3, _: PhysicalProperties, _: Material, _: AlphaMode, _: MaterialVariant, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}