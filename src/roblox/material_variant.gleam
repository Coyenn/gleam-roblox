...
import roblox/types.{
  ...
  type Instance, type Int64, type Material, type MaterialPattern,
  type MaterialVariant, type Object, type PhysicalProperties,
...
pub fn get_source_asset_id(instance: MaterialVariant) -> Int64
