...
import roblox/types.{
  type Actor, type Instance, type Int64, type MemoryStoreHashMapPages,
  type Object, type Pages, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: MemoryStoreHashMapPages,
  value: Bool,
...
pub fn get_source_asset_id(instance: MemoryStoreHashMapPages) -> Int64
