...
import roblox/types.{
  ...
  type SensorBase, type SensorMode, type SensorUpdateType, type UniqueId,
  type Vector3,
}
...
pub fn set_hit_frame(
  instance: ControllerPartSensor,
  value: CFrame,
...
pub fn set_ladder_search_height(
  instance: ControllerPartSensor,
  value: Float,
) -> ControllerPartSensor
...
pub fn set_ladder_search_offset(
  instance: ControllerPartSensor,
  value: Float,
) -> ControllerPartSensor
