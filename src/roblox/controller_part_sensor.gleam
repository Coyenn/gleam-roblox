...
import roblox/types.{type Actor, type BasePart, type CFrame, type ControllerPartSensor, type ControllerSensor, type Instance, type Material, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SensorBase, type SensorMode, type SensorUpdateType, type UniqueId, type Vector3}

/// Creates a new Roblox `ControllerPartSensor` instance.
///
/// Roblox: `Instance.new("ControllerPartSensor")`
@target(luau)
@luau.global("Instance.new(\"ControllerPartSensor\")")
...
pub fn on_sensor_output_changed(instance: ControllerPartSensor) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `SensorBase.OnSensorOutputChanged`.
///
/// Roblox: `SensorBase.OnSensorOutputChanged`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/SensorBase#OnSensorOutputChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.OnSensorOutputChanged:Connect(callback) end)")
pub fn on_on_sensor_output_changed(instance: ControllerPartSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ControllerPartSensor, value: parent) -> ControllerPartSensor
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ControllerPartSensor) -> Nil
...
pub fn get_attribute_changed_signal(instance: ControllerPartSensor, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ControllerPartSensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ControllerPartSensor) -> List(String)
...
pub fn wait_for_child(instance: ControllerPartSensor, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ControllerPartSensor) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ControllerPartSensor, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ControllerPartSensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ControllerPartSensor, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ControllerPartSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ControllerPartSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ControllerPartSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ControllerPartSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ControllerPartSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ControllerPartSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ControllerPartSensor) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ControllerPartSensor, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ControllerPartSensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ControllerPartSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ControllerPartSensor) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ControllerPartSensor, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ControllerPartSensor, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ControllerPartSensor) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ControllerPartSensor, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SensorUpdateType, _: SensorMode, _: BasePart, _: Material, _: Vector3, _: CFrame, _: ControllerPartSensor, _: ControllerSensor, _: SensorBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}