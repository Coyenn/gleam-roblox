...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type VisualizationMode}

/// Creates a new Roblox `VisualizationMode` instance.
///
/// Roblox: `Instance.new("VisualizationMode")`
@target(luau)
@luau.global("Instance.new(\"VisualizationMode\")")
pub fn new() -> VisualizationMode
...
pub fn set_parent(instance: VisualizationMode, value: parent) -> VisualizationMode
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VisualizationMode) -> Nil
...
pub fn get_attribute_changed_signal(instance: VisualizationMode, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VisualizationMode, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VisualizationMode) -> List(String)
...
pub fn wait_for_child(instance: VisualizationMode, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VisualizationMode) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VisualizationMode, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VisualizationMode) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VisualizationMode, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VisualizationMode) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VisualizationMode, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VisualizationMode) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VisualizationMode, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VisualizationMode) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VisualizationMode, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VisualizationMode) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VisualizationMode, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VisualizationMode) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VisualizationMode, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VisualizationMode) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VisualizationMode, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VisualizationMode, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VisualizationMode) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VisualizationMode, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VisualizationMode, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}