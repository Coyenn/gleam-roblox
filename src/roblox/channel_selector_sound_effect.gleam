...
import roblox/types.{
  type Actor, type ChannelSelectorSoundEffect, type CustomSoundEffect,
  type Instance, type Object, type SecurityCapabilities, type SoundEffect,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: ChannelSelectorSoundEffect) -> Int
