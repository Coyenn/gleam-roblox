...
import roblox/types.{type Actor, type AssetFetchStatus, type Content, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector2, type VideoPlayer, type VideoSampleSize, type Wire}
...
pub fn on_did_end(instance: VideoPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_did_loop(instance: VideoPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn play_failed(instance: VideoPlayer) -> RBXScriptSignal(fn(AssetFetchStatus) -> Nil)
...
pub fn on_play_failed(instance: VideoPlayer, callback: fn(AssetFetchStatus) -> Nil) -> RBXScriptConnection
...
pub fn wiring_changed(instance: VideoPlayer) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)
...
pub fn on_wiring_changed(instance: VideoPlayer, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: VideoPlayer, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VideoPlayer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: VideoPlayer, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VideoPlayer) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VideoPlayer, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VideoPlayer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VideoPlayer, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VideoPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VideoPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VideoPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VideoPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VideoPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VideoPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VideoPlayer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VideoPlayer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: VideoPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VideoPlayer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VideoPlayer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VideoPlayer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: VideoPlayer, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AssetFetchStatus, _: Content, _: Vector2, _: VideoSampleSize, _: VideoPlayer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}