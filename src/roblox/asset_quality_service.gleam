...
import roblox/types.{
  type Actor, type AssetQualityService, type Instance, type Int64, type Object,
...
pub fn get_source_asset_id(instance: AssetQualityService) -> Int64
