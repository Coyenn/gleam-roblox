...
import roblox/types.{type Actor, type BasePart, type CFrame, type Content, type ContentId, type Instance, type Mouse, type NormalId, type Object, type OptionDouble, type OptionInt64, type Ray, type SecurityCapabilities, type UniqueId}
...
pub fn button1_down(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_button1_down(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn button1_up(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_button1_up(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn button2_down(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_button2_down(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn button2_up(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_button2_up(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Idle")
pub fn idle(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_idle(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Move")
pub fn move(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_move(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn wheel_backward(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_wheel_backward(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn wheel_forward(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_wheel_forward(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Mouse, value: parent) -> Mouse
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Mouse) -> Nil
...
pub fn get_attribute_changed_signal(instance: Mouse, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Mouse, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Mouse) -> List(String)
...
pub fn wait_for_child(instance: Mouse, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Mouse) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Mouse, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Mouse) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Mouse, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Mouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Mouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Mouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Mouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Mouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Mouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Mouse) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Mouse, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Mouse) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Mouse, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Mouse, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Mouse) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Mouse, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Ray, _: NormalId, _: BasePart, _: CFrame, _: Content, _: ContentId, _: Mouse, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}