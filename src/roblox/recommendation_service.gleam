...
import roblox/types.{
  ...
  type RecommendationActionType, type RecommendationImpressionType,
  type RecommendationPages, type RecommendationPreferenceTargetType,
  type RecommendationPreferenceType, type RecommendationService,
...
pub fn log_impression_event(
  instance: RecommendationService,
  impression_type: RecommendationImpressionType,
  item_id: String,
  tracing_id: String,
  impression_event_details: Dynamic,
) -> Nil
...
pub fn log_preference_event(
  instance: RecommendationService,
  preference_type: RecommendationPreferenceType,
  target_type: RecommendationPreferenceTargetType,
  target_id: String,
  tracing_id: String,
  item_id: String,
) -> Nil
...
pub fn generate_item_list_async(
  instance: RecommendationService,
  generate_recommendation_item_list_request: Dynamic,
) -> RecommendationPages
...
pub fn get_recommendation_item_async(
  instance: RecommendationService,
  item_id: String,
) -> Dynamic
...
pub fn register_item_async(
  instance: RecommendationService,
  player: Player,
  register_recommendation_items_request: Dynamic,
) -> Dynamic
...
pub fn update_item_async(
  instance: RecommendationService,
  update_recommendation_item_request: Dynamic,
) -> Nil
...
pub fn get_source_asset_id(instance: RecommendationService) -> Int64
