...
import roblox/types.{type Actor, type ActuatorRelativeTo, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Torque, type UniqueId, type Vector3}

/// Creates a new Roblox `Torque` instance.
///
/// Roblox: `Instance.new("Torque")`
@target(luau)
@luau.global("Instance.new(\"Torque\")")
pub fn new() -> Torque
...
pub fn set_parent(instance: Torque, value: parent) -> Torque
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Torque) -> Nil
...
pub fn get_attribute_changed_signal(instance: Torque, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Torque, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Torque) -> List(String)
...
pub fn wait_for_child(instance: Torque, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Torque) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Torque, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Torque) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Torque, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Torque) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Torque, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Torque) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Torque, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Torque) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Torque, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Torque) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Torque, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Torque) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Torque, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Torque) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Torque, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Torque, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Torque) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Torque, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: Vector3, _: ActuatorRelativeTo, _: Torque, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}