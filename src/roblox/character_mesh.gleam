...
import roblox/types.{type Actor, type BodyPart, type CharacterAppearance, type CharacterMesh, type Content, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `CharacterMesh` instance.
///
/// Roblox: `Instance.new("CharacterMesh")`
@target(luau)
@luau.global("Instance.new(\"CharacterMesh\")")
pub fn new() -> CharacterMesh
...
pub fn set_parent(instance: CharacterMesh, value: parent) -> CharacterMesh
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CharacterMesh) -> Nil
...
pub fn get_attribute_changed_signal(instance: CharacterMesh, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CharacterMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CharacterMesh) -> List(String)
...
pub fn wait_for_child(instance: CharacterMesh, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CharacterMesh) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CharacterMesh, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CharacterMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CharacterMesh, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CharacterMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CharacterMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CharacterMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CharacterMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CharacterMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CharacterMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CharacterMesh) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CharacterMesh, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CharacterMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CharacterMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CharacterMesh) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CharacterMesh, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CharacterMesh, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CharacterMesh) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CharacterMesh, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Content, _: BodyPart, _: CharacterMesh, _: CharacterAppearance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}