...
import roblox/types.{type Actor, type ChatRestrictionStatus, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ThirdPartyUserService, type UniqueId}
...
pub fn set_parent(instance: ThirdPartyUserService, value: parent) -> ThirdPartyUserService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ThirdPartyUserService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ThirdPartyUserService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ThirdPartyUserService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ThirdPartyUserService) -> List(String)
...
pub fn wait_for_child(instance: ThirdPartyUserService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ThirdPartyUserService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ThirdPartyUserService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ThirdPartyUserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ThirdPartyUserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ThirdPartyUserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ThirdPartyUserService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ThirdPartyUserService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ThirdPartyUserService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ThirdPartyUserService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ThirdPartyUserService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ThirdPartyUserService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ThirdPartyUserService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ThirdPartyUserService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ChatRestrictionStatus, _: ThirdPartyUserService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}