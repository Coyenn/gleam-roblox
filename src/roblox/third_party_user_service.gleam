...
import roblox/types.{
  type Actor, type ChatRestrictionStatus, type Instance, type Int64, type Object,
  type SecurityCapabilities, type ThirdPartyUserService, type UniqueId,
}
...
pub fn get_friend_communication_restriction_status(
  instance: ThirdPartyUserService,
...
pub fn get_voice_chat_restriction_status(
  instance: ThirdPartyUserService,
) -> ChatRestrictionStatus
...
pub fn get_source_asset_id(instance: ThirdPartyUserService) -> Int64
