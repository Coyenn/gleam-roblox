...
import roblox/types.{type Actor, type InputAction, type InputActionType, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `InputAction` instance.
///
/// Roblox: `Instance.new("InputAction")`
@target(luau)
@luau.global("Instance.new(\"InputAction\")")
...
@target(luau)
@luau.event("Pressed")
pub fn pressed(instance: InputAction) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `InputAction.Pressed`.
///
/// Fires only when the InputAction.Type is set to Bool on a state transition from false to true.
///
/// Roblox: `InputAction.Pressed`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/InputAction#Pressed
@target(luau)
@luau.global("(function(instance, callback) return instance.Pressed:Connect(callback) end)")
pub fn on_pressed(instance: InputAction, callback: fn() -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("Released")
pub fn released(instance: InputAction) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `InputAction.Released`.
///
/// Fires only when the InputAction.Type is set to Bool on a state transition from true to false.
///
/// Roblox: `InputAction.Released`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/InputAction#Released
@target(luau)
@luau.global("(function(instance, callback) return instance.Released:Connect(callback) end)")
pub fn on_released(instance: InputAction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn state_changed(instance: InputAction) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `InputAction.StateChanged`.
///
/// Fires for all InputActionType types whenever the state changes, except if the state attempts to transition to the same state.
///
/// Roblox: `InputAction.StateChanged`
...
pub fn on_state_changed(instance: InputAction, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: InputAction, value: parent) -> InputAction
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InputAction) -> Nil
...
pub fn get_attribute_changed_signal(instance: InputAction, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InputAction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InputAction) -> List(String)
...
pub fn wait_for_child(instance: InputAction, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InputAction) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InputAction, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InputAction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InputAction, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InputAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InputAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InputAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InputAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InputAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InputAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InputAction) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InputAction, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InputAction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InputAction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InputAction) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InputAction, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InputAction, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InputAction) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InputAction, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: InputActionType, _: InputAction, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}