...
import roblox/types.{
  ...
  type Object, type ReverbType, type RolloutState, type SecurityCapabilities,
  type SoundService, type UniqueId,
}
...
pub fn set_respect_filtering_enabled(
  instance: SoundService,
  value: Bool,
) -> SoundService
