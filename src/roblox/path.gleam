...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Path, type PathStatus, type SecurityCapabilities, type UniqueId, type Vector3}
...
@target(luau)
@luau.event("Blocked")
pub fn blocked(instance: Path) -> RBXScriptSignal(fn(Int) -> Nil)

/// Connects to Roblox event `Path.Blocked`.
///
/// Fires when the computed path becomes blocked.
///
/// Roblox: `Path.Blocked`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/Path#Blocked
@target(luau)
@luau.global("(function(instance, callback) return instance.Blocked:Connect(callback) end)")
pub fn on_blocked(instance: Path, callback: fn(Int) -> Nil) -> RBXScriptConnection
...
pub fn unblocked(instance: Path) -> RBXScriptSignal(fn(Int) -> Nil)

/// Connects to Roblox event `Path.Unblocked`.
///
/// Fires when a computed path that was blocked becomes unblocked.
///
/// Roblox: `Path.Unblocked`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/Path#Unblocked
@target(luau)
@luau.global("(function(instance, callback) return instance.Unblocked:Connect(callback) end)")
pub fn on_unblocked(instance: Path, callback: fn(Int) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Path, value: parent) -> Path
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Path) -> Nil
...
pub fn get_attribute_changed_signal(instance: Path, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Path, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Path) -> List(String)
...
pub fn wait_for_child(instance: Path, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Path) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Path, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Path) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Path, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Path) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Path, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Path) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Path, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Path) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Path, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Path) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Path, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Path) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Path, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Path) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Path, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Path, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Path) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Path, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: PathStatus, _: Path, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}