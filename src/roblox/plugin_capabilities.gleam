...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type PluginCapabilities,
...
pub fn get_source_asset_id(instance: PluginCapabilities) -> Int64
