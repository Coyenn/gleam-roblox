...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PluginCapabilities, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PluginCapabilities` instance.
///
/// Roblox: `Instance.new("PluginCapabilities")`
@target(luau)
@luau.global("Instance.new(\"PluginCapabilities\")")
pub fn new() -> PluginCapabilities
...
pub fn set_parent(instance: PluginCapabilities, value: parent) -> PluginCapabilities
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PluginCapabilities) -> Nil
...
pub fn get_attribute_changed_signal(instance: PluginCapabilities, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PluginCapabilities, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PluginCapabilities) -> List(String)
...
pub fn wait_for_child(instance: PluginCapabilities, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PluginCapabilities) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PluginCapabilities, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PluginCapabilities) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PluginCapabilities, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PluginCapabilities) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PluginCapabilities, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PluginCapabilities) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PluginCapabilities, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PluginCapabilities) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PluginCapabilities, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PluginCapabilities) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PluginCapabilities, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PluginCapabilities) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PluginCapabilities, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PluginCapabilities) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PluginCapabilities, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PluginCapabilities, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PluginCapabilities) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PluginCapabilities, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PluginCapabilities, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}