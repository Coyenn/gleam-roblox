...
import roblox/types.{type Actor, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Smoke, type UniqueId}

/// Creates a new Roblox `Smoke` instance.
///
/// Roblox: `Instance.new("Smoke")`
@target(luau)
@luau.global("Instance.new(\"Smoke\")")
pub fn new() -> Smoke
...
pub fn set_parent(instance: Smoke, value: parent) -> Smoke
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Smoke) -> Nil
...
pub fn get_attribute_changed_signal(instance: Smoke, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Smoke, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Smoke) -> List(String)
...
pub fn wait_for_child(instance: Smoke, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Smoke) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Smoke, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Smoke) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Smoke, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Smoke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Smoke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Smoke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Smoke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Smoke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Smoke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Smoke) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Smoke, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Smoke) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Smoke, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Smoke) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Smoke, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Smoke, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Smoke) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Smoke, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Smoke, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}