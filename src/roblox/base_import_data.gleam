...
import roblox/types.{type Actor, type BaseImportData, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn status_removed(instance: BaseImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_removed(instance: BaseImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn status_reported(instance: BaseImportData) -> RBXScriptSignal(fn(Dynamic) -> Nil)
...
pub fn on_status_reported(instance: BaseImportData, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BaseImportData, value: parent) -> BaseImportData
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BaseImportData) -> Nil
...
pub fn get_attribute_changed_signal(instance: BaseImportData, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BaseImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BaseImportData) -> List(String)
...
pub fn wait_for_child(instance: BaseImportData, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BaseImportData) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BaseImportData, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BaseImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BaseImportData, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BaseImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BaseImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BaseImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BaseImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BaseImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BaseImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BaseImportData) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BaseImportData, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BaseImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BaseImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BaseImportData) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BaseImportData, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BaseImportData, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BaseImportData) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BaseImportData, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BaseImportData, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}