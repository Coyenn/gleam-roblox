...
import roblox/types.{
  type Actor, type DataModelSession, type Instance, type Int64, type Object,
  type SecurityCapabilities, type StudioDataModelType, type UniqueId,
}
...
pub fn get_current_data_model_type(
...
pub fn get_source_asset_id(instance: DataModelSession) -> Int64
