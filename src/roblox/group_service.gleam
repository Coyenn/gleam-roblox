...
import roblox/types.{type Actor, type GroupMembershipStatus, type GroupService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StandardPages, type UniqueId}
...
pub fn set_parent(instance: GroupService, value: parent) -> GroupService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GroupService) -> Nil
...
pub fn get_attribute_changed_signal(instance: GroupService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GroupService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GroupService) -> List(String)
...
pub fn wait_for_child(instance: GroupService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GroupService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GroupService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GroupService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GroupService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GroupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GroupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GroupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GroupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GroupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GroupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GroupService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GroupService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GroupService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GroupService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GroupService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GroupService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GroupService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GroupService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GroupService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GroupMembershipStatus, _: StandardPages, _: GroupService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}