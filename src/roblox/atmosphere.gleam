...
import roblox/types.{type Actor, type Atmosphere, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Atmosphere` instance.
///
/// Roblox: `Instance.new("Atmosphere")`
@target(luau)
@luau.global("Instance.new(\"Atmosphere\")")
...
pub fn set_parent(instance: Atmosphere, value: parent) -> Atmosphere
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Atmosphere) -> Nil
...
pub fn get_attribute_changed_signal(instance: Atmosphere, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Atmosphere, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Atmosphere) -> List(String)
...
pub fn wait_for_child(instance: Atmosphere, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Atmosphere) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Atmosphere, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Atmosphere) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Atmosphere, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Atmosphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Atmosphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Atmosphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Atmosphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Atmosphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Atmosphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Atmosphere) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Atmosphere, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Atmosphere) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Atmosphere, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Atmosphere) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Atmosphere, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Atmosphere, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Atmosphere) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Atmosphere, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Atmosphere, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}