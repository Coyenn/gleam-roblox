...
import roblox/types.{type Actor, type BaseScript, type Instance, type LuaSourceContainer, type Object, type OptionDouble, type OptionInt64, type ProtectedString, type RunContext, type Script, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Script` instance.
///
/// Roblox: `Instance.new("Script")`
@target(luau)
@luau.global("Instance.new(\"Script\")")
pub fn new() -> Script
...
pub fn set_parent(instance: Script, value: parent) -> Script
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Script) -> Nil
...
pub fn get_attribute_changed_signal(instance: Script, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Script, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Script) -> List(String)
...
pub fn wait_for_child(instance: Script, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Script) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Script, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Script) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Script, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Script) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Script, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Script) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Script, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Script) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Script, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Script) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Script, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Script) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Script, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Script) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Script, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Script, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Script) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Script, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RunContext, _: ProtectedString, _: Script, _: BaseScript, _: LuaSourceContainer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}