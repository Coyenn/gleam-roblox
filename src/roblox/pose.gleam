...
import roblox/types.{type Actor, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type Pose, type PoseBase, type PoseEasingDirection, type PoseEasingStyle, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Pose` instance.
///
/// Roblox: `Instance.new("Pose")`
@target(luau)
@luau.global("Instance.new(\"Pose\")")
pub fn new() -> Pose
...
pub fn set_parent(instance: Pose, value: parent) -> Pose
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Pose) -> Nil
...
pub fn get_attribute_changed_signal(instance: Pose, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Pose, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Pose) -> List(String)
...
pub fn wait_for_child(instance: Pose, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Pose) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Pose, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Pose) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Pose, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Pose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Pose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Pose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Pose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Pose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Pose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Pose) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Pose, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Pose) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Pose, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Pose) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Pose, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Pose, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Pose) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Pose, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PoseEasingStyle, _: PoseEasingDirection, _: CFrame, _: Pose, _: PoseBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}