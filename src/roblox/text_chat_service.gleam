...
import roblox/types.{type Actor, type ChatVersion, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextChatMessage, type TextChatService, type UniqueId}
...
pub fn can_users_direct_chat_async(instance: TextChatService, requester_user_id: OptionInt64, user_ids: List(Int)) -> List(Dynamic)
...
pub fn bubble_displayed(instance: TextChatService) -> RBXScriptSignal(fn(Instance, TextChatMessage) -> Nil)

/// Connects to Roblox event `TextChatService.BubbleDisplayed`.
///
/// Fires when TextChatService:DisplayBubble() is called.
///
/// Roblox: `TextChatService.BubbleDisplayed`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/TextChatService#BubbleDisplayed
@target(luau)
@luau.global("(function(instance, callback) return instance.BubbleDisplayed:Connect(callback) end)")
pub fn on_bubble_displayed(instance: TextChatService, callback: fn(Instance, TextChatMessage) -> Nil) -> RBXScriptConnection
...
pub fn message_received(instance: TextChatService) -> RBXScriptSignal(fn(TextChatMessage) -> Nil)

/// Connects to Roblox event `TextChatService.MessageReceived`.
///
/// Fires when TextChannel:DisplaySystemMessage() is invoked on the client, or when the client receives a valid TextChannel:SendAsync() response from the server.
///
/// Roblox: `TextChatService.MessageReceived`
...
pub fn on_message_received(instance: TextChatService, callback: fn(TextChatMessage) -> Nil) -> RBXScriptConnection
...
pub fn sending_message(instance: TextChatService) -> RBXScriptSignal(fn(TextChatMessage) -> Nil)

/// Connects to Roblox event `TextChatService.SendingMessage`.
///
/// Fires when TextChannel:SendAsync() is called by the sending client.
///
/// Roblox: `TextChatService.SendingMessage`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/TextChatService#SendingMessage
@target(luau)
@luau.global("(function(instance, callback) return instance.SendingMessage:Connect(callback) end)")
pub fn on_sending_message(instance: TextChatService, callback: fn(TextChatMessage) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: TextChatService, value: parent) -> TextChatService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TextChatService) -> Nil
...
pub fn get_attribute_changed_signal(instance: TextChatService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TextChatService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TextChatService) -> List(String)
...
pub fn wait_for_child(instance: TextChatService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TextChatService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TextChatService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TextChatService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TextChatService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TextChatService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TextChatService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TextChatService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TextChatService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TextChatService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TextChatService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TextChatService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TextChatService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TextChatService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TextChatService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TextChatService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TextChatService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TextChatService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TextChatService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TextChatService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TextChatMessage, _: ChatVersion, _: TextChatService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}