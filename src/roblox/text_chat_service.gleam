...
pub fn display_bubble(
  instance: TextChatService,
  part_or_character: Instance,
  message: String,
) -> Nil
...
pub fn bubble_displayed(
  instance: TextChatService,
) -> RBXScriptSignal(fn(Instance, TextChatMessage) -> Nil)
...
pub fn on_bubble_displayed(
  instance: TextChatService,
  callback: fn(Instance, TextChatMessage) -> Nil,
) -> RBXScriptConnection
...
pub fn message_received(
  instance: TextChatService,
) -> RBXScriptSignal(fn(TextChatMessage) -> Nil)
...
pub fn on_message_received(
  instance: TextChatService,
  callback: fn(TextChatMessage) -> Nil,
) -> RBXScriptConnection
