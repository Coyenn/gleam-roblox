...
import roblox/types.{
  type Actor, type Instance, type InstanceExtensionsService, type Int64,
...
pub fn set_archivable(
  instance: InstanceExtensionsService,
  value: Bool,
...
pub fn get_source_asset_id(instance: InstanceExtensionsService) -> Int64
