...
import roblox/types.{type Actor, type Instance, type InstanceExtensionsService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `InstanceExtensionsService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: InstanceExtensionsService) -> Instance

/// Treats `InstanceExtensionsService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: InstanceExtensionsService) -> Object
...
pub fn set_parent(instance: InstanceExtensionsService, value: parent) -> InstanceExtensionsService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InstanceExtensionsService) -> Nil
...
pub fn get_attribute_changed_signal(instance: InstanceExtensionsService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InstanceExtensionsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InstanceExtensionsService) -> List(String)
...
pub fn wait_for_child(instance: InstanceExtensionsService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InstanceExtensionsService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InstanceExtensionsService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InstanceExtensionsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InstanceExtensionsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InstanceExtensionsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InstanceExtensionsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InstanceExtensionsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InstanceExtensionsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InstanceExtensionsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InstanceExtensionsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InstanceExtensionsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InstanceExtensionsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InstanceExtensionsService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: InstanceExtensionsService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}