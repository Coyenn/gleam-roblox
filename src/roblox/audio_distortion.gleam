...
import roblox/types.{type Actor, type AudioDistortion, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioDistortion` instance.
///
/// Roblox: `Instance.new("AudioDistortion")`
@target(luau)
@luau.global("Instance.new(\"AudioDistortion\")")
pub fn new() -> AudioDistortion
...
pub fn get_input_pins(instance: AudioDistortion) -> List(String)
...
pub fn get_output_pins(instance: AudioDistortion) -> List(String)
...
pub fn wiring_changed(instance: AudioDistortion) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioDistortion.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioDistortion via a Wire.
///
/// Roblox: `AudioDistortion.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioDistortion, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioDistortion, value: parent) -> AudioDistortion
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioDistortion) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioDistortion, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioDistortion, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioDistortion) -> List(String)
...
pub fn wait_for_child(instance: AudioDistortion, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioDistortion) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioDistortion, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioDistortion) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioDistortion, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioDistortion) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioDistortion, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioDistortion) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioDistortion, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioDistortion) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioDistortion, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioDistortion) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioDistortion, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioDistortion) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioDistortion, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioDistortion) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioDistortion, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioDistortion, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioDistortion) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioDistortion, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioDistortion, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}