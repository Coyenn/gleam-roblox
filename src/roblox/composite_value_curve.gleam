...
import roblox/types.{type Actor, type CompositeValueCurve, type CompositeValueCurveType, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `CompositeValueCurve` instance.
///
/// Roblox: `Instance.new("CompositeValueCurve")`
@target(luau)
@luau.global("Instance.new(\"CompositeValueCurve\")")
pub fn new() -> CompositeValueCurve
...
pub fn set_parent(instance: CompositeValueCurve, value: parent) -> CompositeValueCurve
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CompositeValueCurve) -> Nil
...
pub fn get_attribute_changed_signal(instance: CompositeValueCurve, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CompositeValueCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CompositeValueCurve) -> List(String)
...
pub fn wait_for_child(instance: CompositeValueCurve, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CompositeValueCurve) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CompositeValueCurve, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CompositeValueCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CompositeValueCurve, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CompositeValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CompositeValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CompositeValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CompositeValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CompositeValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CompositeValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CompositeValueCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CompositeValueCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CompositeValueCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CompositeValueCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CompositeValueCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CompositeValueCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CompositeValueCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CompositeValueCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CompositeValueCurve, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CompositeValueCurveType, _: CompositeValueCurve, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}