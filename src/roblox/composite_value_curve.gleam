...
import roblox/types.{
  type Actor, type CompositeValueCurve, type CompositeValueCurveType,
...
pub fn get_source_asset_id(instance: CompositeValueCurve) -> Int64
