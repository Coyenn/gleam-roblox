...
import roblox/types.{
  ...
  type RobloxPluginGuiService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RobloxPluginGuiService,
  value: Bool,
...
pub fn get_source_asset_id(instance: RobloxPluginGuiService) -> Int64
