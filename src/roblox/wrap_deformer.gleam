...
import roblox/types.{type Actor, type BaseWrap, type CFrame, type Content, type ContentId, type EditableMesh, type Instance, type Object, type OptionCoordinateFrame, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WrapDeformer}

/// Creates a new Roblox `WrapDeformer` instance.
///
/// Roblox: `Instance.new("WrapDeformer")`
@target(luau)
@luau.global("Instance.new(\"WrapDeformer\")")
...
pub fn set_parent(instance: WrapDeformer, value: parent) -> WrapDeformer
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WrapDeformer) -> Nil
...
pub fn get_attribute_changed_signal(instance: WrapDeformer, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WrapDeformer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WrapDeformer) -> List(String)
...
pub fn wait_for_child(instance: WrapDeformer, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WrapDeformer) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WrapDeformer, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WrapDeformer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WrapDeformer, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WrapDeformer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WrapDeformer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WrapDeformer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WrapDeformer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WrapDeformer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WrapDeformer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WrapDeformer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WrapDeformer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WrapDeformer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WrapDeformer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WrapDeformer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WrapDeformer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WrapDeformer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WrapDeformer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WrapDeformer, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: ContentId, _: Content, _: EditableMesh, _: OptionCoordinateFrame, _: WrapDeformer, _: BaseWrap, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}