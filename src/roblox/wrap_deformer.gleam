...
import roblox/types.{
  ...
  type EditableMesh, type Instance, type Int64, type Object,
  type OptionCoordinateFrame, type SecurityCapabilities, type UniqueId,
  type WrapDeformer,
}
...
pub fn get_deformed_cframe_async(
  instance: WrapDeformer,
  original_cframe: CFrame,
) -> CFrame
...
pub fn get_source_asset_id(instance: WrapDeformer) -> Int64
