...
import roblox/types.{
  ...
  type SlimAnimationDataEntity, type UniqueId,
}
...
pub fn set_archivable(
  instance: SlimAnimationDataEntity,
  value: Bool,
...
pub fn get_source_asset_id(instance: SlimAnimationDataEntity) -> Int64
