...
import roblox/types.{type Actor, type BaseRemoteEvent, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type RemoteEvent, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `RemoteEvent` instance.
///
/// Roblox: `Instance.new("RemoteEvent")`
@target(luau)
@luau.global("Instance.new(\"RemoteEvent\")")
...
pub fn on_client_event(instance: RemoteEvent) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `RemoteEvent.OnClientEvent`.
///
/// Fires from a LocalScript when either FireClient() or FireAllClients() is called on the same RemoteEvent instance from a Script.
///
/// Roblox: `RemoteEvent.OnClientEvent`
...
pub fn on_on_client_event(instance: RemoteEvent, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn on_server_event(instance: RemoteEvent) -> RBXScriptSignal(fn(Player, Dynamic) -> Nil)

/// Connects to Roblox event `RemoteEvent.OnServerEvent`.
///
/// Fires from a Script when FireServer() is called on the same RemoteEvent instance from a LocalScript.
///
/// Roblox: `RemoteEvent.OnServerEvent`
...
pub fn on_on_server_event(instance: RemoteEvent, callback: fn(Player, Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: RemoteEvent, value: parent) -> RemoteEvent
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RemoteEvent) -> Nil
...
pub fn get_attribute_changed_signal(instance: RemoteEvent, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RemoteEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RemoteEvent) -> List(String)
...
pub fn wait_for_child(instance: RemoteEvent, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RemoteEvent) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RemoteEvent, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RemoteEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RemoteEvent, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RemoteEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RemoteEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RemoteEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RemoteEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RemoteEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RemoteEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RemoteEvent, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: RemoteEvent, _: BaseRemoteEvent, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}