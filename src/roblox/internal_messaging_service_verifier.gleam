...
import roblox/types.{
  type Actor, type Instance, type Int64, type InternalMessagingServiceVerifier,
...
pub fn set_archivable(
  instance: InternalMessagingServiceVerifier,
  value: Bool,
...
pub fn get_source_asset_id(instance: InternalMessagingServiceVerifier) -> Int64
