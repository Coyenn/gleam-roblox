...
import roblox/types.{
  type Actor, type BasePart, type Color3, type ContentId, type FloorWire,
  type GuiBase, type GuiBase3d, type Instance, type Object, type OptionDouble,
  type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector2,
}
...
pub fn set_studs_between_textures(
  instance: FloorWire,
  value: Float,
) -> FloorWire
