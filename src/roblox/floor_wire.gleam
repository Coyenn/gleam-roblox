...
import roblox/types.{type Actor, type BasePart, type Color3, type ContentId, type FloorWire, type GuiBase, type GuiBase3d, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector2}
...
pub fn set_parent(instance: FloorWire, value: parent) -> FloorWire
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FloorWire) -> Nil
...
pub fn get_attribute_changed_signal(instance: FloorWire, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FloorWire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FloorWire) -> List(String)
...
pub fn wait_for_child(instance: FloorWire, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FloorWire) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FloorWire, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FloorWire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FloorWire, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FloorWire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FloorWire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FloorWire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FloorWire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FloorWire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FloorWire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FloorWire) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FloorWire, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FloorWire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FloorWire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FloorWire) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FloorWire, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FloorWire, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FloorWire) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FloorWire, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: BasePart, _: Vector2, _: ContentId, _: FloorWire, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}