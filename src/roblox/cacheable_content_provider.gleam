...
import roblox/types.{
  type Actor, type CacheableContentProvider, type Instance, type Int64,
...
pub fn set_archivable(
  instance: CacheableContentProvider,
  value: Bool,
...
pub fn get_source_asset_id(instance: CacheableContentProvider) -> Int64
