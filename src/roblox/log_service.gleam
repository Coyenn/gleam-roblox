...
import roblox/types.{
  type Actor, type Instance, type Int64, type LogService, type MessageType,
...
pub fn message_out(
  instance: LogService,
) -> RBXScriptSignal(fn(String, MessageType, Dynamic) -> Nil)
...
pub fn on_message_out(
  instance: LogService,
  callback: fn(String, MessageType, Dynamic) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: LogService) -> Int64
