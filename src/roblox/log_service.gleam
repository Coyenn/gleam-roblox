...
import roblox/types.{type Actor, type Instance, type LogService, type MessageType, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn message_out(instance: LogService) -> RBXScriptSignal(fn(String, MessageType, Dynamic) -> Nil)

/// Connects to Roblox event `LogService.MessageOut`.
///
/// Fires when the client outputs text.
///
/// Roblox: `LogService.MessageOut`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/LogService#MessageOut
@target(luau)
@luau.global("(function(instance, callback) return instance.MessageOut:Connect(callback) end)")
pub fn on_message_out(instance: LogService, callback: fn(String, MessageType, Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: LogService, value: parent) -> LogService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LogService) -> Nil
...
pub fn get_attribute_changed_signal(instance: LogService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LogService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LogService) -> List(String)
...
pub fn wait_for_child(instance: LogService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LogService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LogService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LogService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LogService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LogService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LogService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LogService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LogService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LogService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LogService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LogService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LogService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LogService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LogService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LogService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LogService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LogService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LogService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LogService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MessageType, _: LogService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}