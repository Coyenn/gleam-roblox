...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StylingService, type UniqueId}

/// Treats `StylingService` as its Roblox ancestor `Instance`.
@target(luau)
...
pub fn set_parent(instance: StylingService, value: parent) -> StylingService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StylingService) -> Nil
...
pub fn get_attribute_changed_signal(instance: StylingService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StylingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StylingService) -> List(String)
...
pub fn wait_for_child(instance: StylingService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StylingService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StylingService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StylingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StylingService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StylingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StylingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StylingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StylingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StylingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StylingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StylingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StylingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StylingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StylingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StylingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StylingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StylingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StylingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StylingService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: StylingService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}