...
import roblox/types.{type Actor, type Attachment, type BrickColor, type Constraint, type Instance, type Object, type OptionDouble, type OptionInt64, type PlaneConstraint, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PlaneConstraint` instance.
///
/// Roblox: `Instance.new("PlaneConstraint")`
@target(luau)
@luau.global("Instance.new(\"PlaneConstraint\")")
pub fn new() -> PlaneConstraint

/// Treats `PlaneConstraint` as its Roblox ancestor `Constraint`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_constraint(instance: PlaneConstraint) -> Constraint

/// Treats `PlaneConstraint` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: PlaneConstraint) -> Instance

/// Treats `PlaneConstraint` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: PlaneConstraint) -> Object
...
pub fn set_parent(instance: PlaneConstraint, value: parent) -> PlaneConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlaneConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlaneConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlaneConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlaneConstraint) -> List(String)
...
pub fn wait_for_child(instance: PlaneConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlaneConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlaneConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlaneConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlaneConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlaneConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlaneConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlaneConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlaneConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlaneConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlaneConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlaneConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlaneConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlaneConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlaneConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlaneConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlaneConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlaneConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlaneConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PlaneConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BrickColor, _: Attachment, _: PlaneConstraint, _: Constraint, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}