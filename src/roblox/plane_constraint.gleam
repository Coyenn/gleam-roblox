...
import roblox/types.{
  ...
  type Object, type PlaneConstraint, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: PlaneConstraint) -> Int
