...
import roblox/types.{type Actor, type Attachment, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Attachment` instance.
///
/// Roblox: `Instance.new("Attachment")`
@target(luau)
@luau.global("Instance.new(\"Attachment\")")
...
pub fn set_parent(instance: Attachment, value: parent) -> Attachment
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Attachment) -> Nil
...
pub fn get_attribute_changed_signal(instance: Attachment, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Attachment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Attachment) -> List(String)
...
pub fn wait_for_child(instance: Attachment, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Attachment) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Attachment, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Attachment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Attachment, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Attachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Attachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Attachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Attachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Attachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Attachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Attachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Attachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Attachment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Attachment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Attachment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Attachment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Attachment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Attachment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Attachment, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: CFrame, _: Attachment, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}