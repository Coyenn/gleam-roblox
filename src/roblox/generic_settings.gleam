...
import roblox/types.{
  type Actor, type GenericSettings, type Instance, type Int64, type Object,
  type SecurityCapabilities, type ServiceProvider, type UniqueId,
}
...
pub fn get_source_asset_id(instance: GenericSettings) -> Int64
