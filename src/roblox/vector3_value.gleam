...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase, type Vector3, type Vector3Value}

/// Creates a new Roblox `Vector3Value` instance.
///
/// Roblox: `Instance.new("Vector3Value")`
@target(luau)
@luau.global("Instance.new(\"Vector3Value\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Vector3Value) -> RBXScriptSignal(fn(Vector3) -> Nil)

/// Connects to Roblox event `Vector3Value.Changed`.
///
/// Fired whenever Vector3Value.Value is changed.
///
/// Roblox: `Vector3Value.Changed`
...
pub fn on_changed(instance: Vector3Value, callback: fn(Vector3) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Vector3Value, value: parent) -> Vector3Value
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Vector3Value) -> Nil
...
pub fn get_attribute_changed_signal(instance: Vector3Value, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Vector3Value, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Vector3Value) -> List(String)
...
pub fn wait_for_child(instance: Vector3Value, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Vector3Value) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Vector3Value, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Vector3Value) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Vector3Value, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Vector3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Vector3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Vector3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Vector3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Vector3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Vector3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Vector3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Vector3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Vector3Value) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Vector3Value, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Vector3Value) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Vector3Value, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Vector3Value, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: Vector3Value, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}