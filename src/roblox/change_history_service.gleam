...
import roblox/types.{type Actor, type ChangeHistoryService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `ChangeHistoryService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: ChangeHistoryService) -> Instance

/// Treats `ChangeHistoryService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: ChangeHistoryService) -> Object
...
pub fn set_parent(instance: ChangeHistoryService, value: parent) -> ChangeHistoryService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ChangeHistoryService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ChangeHistoryService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ChangeHistoryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ChangeHistoryService) -> List(String)
...
pub fn wait_for_child(instance: ChangeHistoryService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ChangeHistoryService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ChangeHistoryService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ChangeHistoryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ChangeHistoryService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ChangeHistoryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ChangeHistoryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ChangeHistoryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ChangeHistoryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ChangeHistoryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ChangeHistoryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ChangeHistoryService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ChangeHistoryService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ChangeHistoryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ChangeHistoryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ChangeHistoryService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ChangeHistoryService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ChangeHistoryService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ChangeHistoryService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ChangeHistoryService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ChangeHistoryService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}