...
import roblox/types.{
  ...
  type TextureGenerationPartGroup, type UniqueId,
}
...
pub fn set_archivable(
  instance: TextureGenerationPartGroup,
  value: Bool,
...
pub fn get_source_asset_id(instance: TextureGenerationPartGroup) -> Int64
