...
import roblox/types.{type Actor, type Instance, type KeyframeMarker, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `KeyframeMarker` instance.
///
/// Roblox: `Instance.new("KeyframeMarker")`
@target(luau)
@luau.global("Instance.new(\"KeyframeMarker\")")
pub fn new() -> KeyframeMarker
...
pub fn set_parent(instance: KeyframeMarker, value: parent) -> KeyframeMarker
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: KeyframeMarker) -> Nil
...
pub fn get_attribute_changed_signal(instance: KeyframeMarker, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: KeyframeMarker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: KeyframeMarker) -> List(String)
...
pub fn wait_for_child(instance: KeyframeMarker, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: KeyframeMarker) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: KeyframeMarker, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: KeyframeMarker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: KeyframeMarker, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: KeyframeMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: KeyframeMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: KeyframeMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: KeyframeMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: KeyframeMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: KeyframeMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: KeyframeMarker) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: KeyframeMarker, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: KeyframeMarker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: KeyframeMarker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: KeyframeMarker) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: KeyframeMarker, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: KeyframeMarker, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: KeyframeMarker) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: KeyframeMarker, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: KeyframeMarker, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}