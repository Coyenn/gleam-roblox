...
import roblox/types.{
  ...
  type StatsItem, type TotalCountTimeIntervalItem, type UniqueId,
}
...
pub fn set_archivable(
  instance: TotalCountTimeIntervalItem,
  value: Bool,
...
pub fn get_source_asset_id(instance: TotalCountTimeIntervalItem) -> Int64
