...
import roblox/types.{
  type Actor, type CoreScriptDebuggingManagerHelper, type Instance, type Int64,
...
pub fn set_archivable(
  instance: CoreScriptDebuggingManagerHelper,
  value: Bool,
...
pub fn get_source_asset_id(instance: CoreScriptDebuggingManagerHelper) -> Int64
