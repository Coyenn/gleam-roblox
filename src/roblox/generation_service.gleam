...
import roblox/types.{
  type Actor, type GenerationService, type Instance, type Int64, type MeshPart,
...
pub fn get_video_gen_triggers_async(
  instance: GenerationService,
  session_id: String,
...
pub fn load_generated_mesh_async(
  instance: GenerationService,
...
pub fn start_video_gen_session_async(
  instance: GenerationService,
  session_id: String,
  prompt: String,
  image_data: String,
  image_s3_reference: String,
  triggers: Dynamic,
) -> Bool
...
pub fn update_video_gen_session_prompt_async(
  instance: GenerationService,
  session_id: String,
  prompt: String,
  image_data: String,
...
pub fn update_video_gen_session_triggers_async(
  instance: GenerationService,
  session_id: String,
  triggers: Dynamic,
) -> Bool
...
pub fn get_source_asset_id(instance: GenerationService) -> Int64
