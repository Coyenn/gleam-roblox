...
import roblox/types.{type Actor, type GenerationService, type Instance, type MeshPart, type Object, type OptionDouble, type OptionFunction, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: GenerationService, value: parent) -> GenerationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GenerationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: GenerationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GenerationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GenerationService) -> List(String)
...
pub fn wait_for_child(instance: GenerationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GenerationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GenerationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GenerationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GenerationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GenerationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GenerationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GenerationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GenerationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GenerationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GenerationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GenerationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MeshPart, _: Player, _: OptionFunction, _: GenerationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}