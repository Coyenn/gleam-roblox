...
import roblox/types.{
  type Actor, type AnimationFromVideoCreatorService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: AnimationFromVideoCreatorService,
  value: Bool,
...
pub fn get_source_asset_id(instance: AnimationFromVideoCreatorService) -> Int64
