...
import roblox/types.{type Actor, type BadgeService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn check_user_badges_async(instance: BadgeService, user_id: OptionInt64, badge_ids: List(Int)) -> List(Dynamic)
...
pub fn set_parent(instance: BadgeService, value: parent) -> BadgeService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BadgeService) -> Nil
...
pub fn get_attribute_changed_signal(instance: BadgeService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BadgeService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BadgeService) -> List(String)
...
pub fn wait_for_child(instance: BadgeService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BadgeService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BadgeService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BadgeService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BadgeService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BadgeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BadgeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BadgeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BadgeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BadgeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BadgeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BadgeService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BadgeService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BadgeService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BadgeService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BadgeService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BadgeService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BadgeService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BadgeService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BadgeService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BadgeService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}