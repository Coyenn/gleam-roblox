...
import roblox/types.{
  type Actor, type AnimationImportData, type BaseImportData, type Instance,
...
pub fn get_source_asset_id(instance: AnimationImportData) -> Int64
