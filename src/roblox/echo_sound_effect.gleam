...
import roblox/types.{
  type Actor, type EchoSoundEffect, type Instance, type Int64, type Object,
  type SecurityCapabilities, type SoundEffect, type UniqueId,
}
...
pub fn get_source_asset_id(instance: EchoSoundEffect) -> Int64
