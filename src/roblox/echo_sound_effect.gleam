...
import roblox/types.{type Actor, type EchoSoundEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SoundEffect, type UniqueId}

/// Creates a new Roblox `EchoSoundEffect` instance.
///
/// Roblox: `Instance.new("EchoSoundEffect")`
@target(luau)
@luau.global("Instance.new(\"EchoSoundEffect\")")
...
pub fn set_parent(instance: EchoSoundEffect, value: parent) -> EchoSoundEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: EchoSoundEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: EchoSoundEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: EchoSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: EchoSoundEffect) -> List(String)
...
pub fn wait_for_child(instance: EchoSoundEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: EchoSoundEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: EchoSoundEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: EchoSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: EchoSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: EchoSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: EchoSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: EchoSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: EchoSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: EchoSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: EchoSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: EchoSoundEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: EchoSoundEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: EchoSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: EchoSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: EchoSoundEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: EchoSoundEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: EchoSoundEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: EchoSoundEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: EchoSoundEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: EchoSoundEffect, _: SoundEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}