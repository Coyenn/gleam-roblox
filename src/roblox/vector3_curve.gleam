...
import roblox/types.{type Actor, type FloatCurve, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3Curve}

/// Creates a new Roblox `Vector3Curve` instance.
///
/// Roblox: `Instance.new("Vector3Curve")`
@target(luau)
@luau.global("Instance.new(\"Vector3Curve\")")
pub fn new() -> Vector3Curve
...
pub fn set_parent(instance: Vector3Curve, value: parent) -> Vector3Curve
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Vector3Curve) -> Nil
...
pub fn get_attribute_changed_signal(instance: Vector3Curve, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Vector3Curve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Vector3Curve) -> List(String)
...
pub fn wait_for_child(instance: Vector3Curve, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Vector3Curve) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Vector3Curve, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Vector3Curve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Vector3Curve, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Vector3Curve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Vector3Curve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Vector3Curve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Vector3Curve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Vector3Curve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Vector3Curve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Vector3Curve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Vector3Curve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Vector3Curve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Vector3Curve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Vector3Curve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Vector3Curve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Vector3Curve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Vector3Curve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Vector3Curve, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FloatCurve, _: Vector3Curve, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}