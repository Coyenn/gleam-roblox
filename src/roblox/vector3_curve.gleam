...
import roblox/types.{
  type Actor, type FloatCurve, type Instance, type Int64, type Object,
  type SecurityCapabilities, type UniqueId, type Vector3Curve,
}
...
pub fn get_source_asset_id(instance: Vector3Curve) -> Int64
