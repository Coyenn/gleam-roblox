...
import roblox/types.{type Actor, type Color3, type Color3Value, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `Color3Value` instance.
///
/// Roblox: `Instance.new("Color3Value")`
@target(luau)
@luau.global("Instance.new(\"Color3Value\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Color3Value) -> RBXScriptSignal(fn(Color3) -> Nil)

/// Connects to Roblox event `Color3Value.Changed`.
///
/// Fired whenever the Color3Value.Value is changed.
///
/// Roblox: `Color3Value.Changed`
...
pub fn on_changed(instance: Color3Value, callback: fn(Color3) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Color3Value, value: parent) -> Color3Value
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Color3Value) -> Nil
...
pub fn get_attribute_changed_signal(instance: Color3Value, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Color3Value, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Color3Value) -> List(String)
...
pub fn wait_for_child(instance: Color3Value, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Color3Value) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Color3Value, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Color3Value) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Color3Value, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Color3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Color3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Color3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Color3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Color3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Color3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Color3Value) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Color3Value, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Color3Value) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Color3Value, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Color3Value) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Color3Value, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Color3Value, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Color3Value, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}