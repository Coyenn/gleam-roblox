...
import roblox/types.{
  type Actor, type Color3, type Color3Value, type Instance, type Int64,
...
pub fn on_changed(
  instance: Color3Value,
  callback: fn(Color3) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: Color3Value) -> Int64
