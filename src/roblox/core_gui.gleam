...
import roblox/types.{type Actor, type BasePlayerGui, type CoreGui, type GuiObject, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: CoreGui, value: parent) -> CoreGui
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CoreGui) -> Nil
...
pub fn get_attribute_changed_signal(instance: CoreGui, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CoreGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CoreGui) -> List(String)
...
pub fn wait_for_child(instance: CoreGui, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CoreGui) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CoreGui, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CoreGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CoreGui, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CoreGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CoreGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CoreGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CoreGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CoreGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CoreGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CoreGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CoreGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CoreGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CoreGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CoreGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CoreGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CoreGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CoreGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CoreGui, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: CoreGui, _: BasePlayerGui, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}