...
import roblox/types.{
  type Actor, type BasePart, type Instance, type Int64,
  type NoCollisionConstraint, type Object, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: NoCollisionConstraint) -> Int64
