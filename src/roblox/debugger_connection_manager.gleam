...
import roblox/types.{
  type Actor, type DebuggerConnectionManager, type Instance, type Int64,
...
pub fn set_archivable(
  instance: DebuggerConnectionManager,
  value: Bool,
...
pub fn get_source_asset_id(instance: DebuggerConnectionManager) -> Int64
