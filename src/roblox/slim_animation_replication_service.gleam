...
import roblox/types.{
  ...
  type SlimAnimationReplicationService, type UniqueId,
}
...
pub fn set_archivable(
  instance: SlimAnimationReplicationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: SlimAnimationReplicationService) -> Int64
