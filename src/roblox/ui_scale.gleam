...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UIBase, type UIComponent, type UIScale, type UniqueId}

/// Creates a new Roblox `UIScale` instance.
///
/// Roblox: `Instance.new("UIScale")`
@target(luau)
@luau.global("Instance.new(\"UIScale\")")
pub fn new() -> UIScale
...
pub fn set_parent(instance: UIScale, value: parent) -> UIScale
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIScale) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIScale, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIScale, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIScale) -> List(String)
...
pub fn wait_for_child(instance: UIScale, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIScale) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIScale, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIScale) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIScale, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIScale) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIScale, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIScale) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIScale, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIScale) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIScale, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIScale) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIScale, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIScale) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIScale, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIScale) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIScale, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIScale, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIScale) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIScale, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UIScale, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}