...
import roblox/types.{type Actor, type BanHistoryPages, type Instance, type Object, type OptionDouble, type OptionInt64, type Pages, type SecurityCapabilities, type UniqueId}

/// Treats `BanHistoryPages` as its Roblox ancestor `Pages`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_pages(instance: BanHistoryPages) -> Pages

/// Treats `BanHistoryPages` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: BanHistoryPages) -> Instance

/// Treats `BanHistoryPages` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: BanHistoryPages) -> Object
...
pub fn set_parent(instance: BanHistoryPages, value: parent) -> BanHistoryPages
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BanHistoryPages) -> Nil
...
pub fn get_attribute_changed_signal(instance: BanHistoryPages, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BanHistoryPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BanHistoryPages) -> List(String)
...
pub fn wait_for_child(instance: BanHistoryPages, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BanHistoryPages) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BanHistoryPages, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BanHistoryPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BanHistoryPages, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BanHistoryPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BanHistoryPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BanHistoryPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BanHistoryPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BanHistoryPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BanHistoryPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BanHistoryPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BanHistoryPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BanHistoryPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BanHistoryPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BanHistoryPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BanHistoryPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BanHistoryPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BanHistoryPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BanHistoryPages, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BanHistoryPages, _: Pages, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}