...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type StudioAttachment, type UniqueId, type Vector2}

/// Creates a new Roblox `StudioAttachment` instance.
///
/// Roblox: `Instance.new("StudioAttachment")`
@target(luau)
@luau.global("Instance.new(\"StudioAttachment\")")
pub fn new() -> StudioAttachment
...
pub fn set_parent(instance: StudioAttachment, value: parent) -> StudioAttachment
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: StudioAttachment) -> Nil
...
pub fn get_attribute_changed_signal(instance: StudioAttachment, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: StudioAttachment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: StudioAttachment) -> List(String)
...
pub fn wait_for_child(instance: StudioAttachment, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: StudioAttachment) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: StudioAttachment, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: StudioAttachment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: StudioAttachment, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: StudioAttachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: StudioAttachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: StudioAttachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: StudioAttachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: StudioAttachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: StudioAttachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: StudioAttachment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: StudioAttachment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: StudioAttachment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: StudioAttachment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: StudioAttachment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: StudioAttachment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: StudioAttachment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: StudioAttachment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: StudioAttachment, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector2, _: StudioAttachment, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}