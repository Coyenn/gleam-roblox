...
import roblox/types.{
  type Actor, type CloudLocalizationTable, type Instance, type Int64,
  type LocalizationTable, type Object, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: CloudLocalizationTable) -> Int64
