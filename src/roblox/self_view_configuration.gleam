...
import roblox/types.{type Actor, type BaseCoreGuiConfiguration, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SelfViewConfiguration, type UniqueId}

/// Treats `SelfViewConfiguration` as its Roblox ancestor `BaseCoreGuiConfiguration`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_base_core_gui_configuration(instance: SelfViewConfiguration) -> BaseCoreGuiConfiguration
...
pub fn set_parent(instance: SelfViewConfiguration, value: parent) -> SelfViewConfiguration
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SelfViewConfiguration) -> Nil
...
pub fn get_attribute_changed_signal(instance: SelfViewConfiguration, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SelfViewConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SelfViewConfiguration) -> List(String)
...
pub fn wait_for_child(instance: SelfViewConfiguration, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SelfViewConfiguration, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SelfViewConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SelfViewConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SelfViewConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SelfViewConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SelfViewConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SelfViewConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SelfViewConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SelfViewConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SelfViewConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SelfViewConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SelfViewConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SelfViewConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SelfViewConfiguration, _: BaseCoreGuiConfiguration, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}