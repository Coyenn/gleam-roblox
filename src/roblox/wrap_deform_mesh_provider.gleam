...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type WrapDeformMeshProvider}

/// Treats `WrapDeformMeshProvider` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: WrapDeformMeshProvider) -> Instance

/// Treats `WrapDeformMeshProvider` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: WrapDeformMeshProvider) -> Object
...
pub fn set_parent(instance: WrapDeformMeshProvider, value: parent) -> WrapDeformMeshProvider
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WrapDeformMeshProvider) -> Nil
...
pub fn get_attribute_changed_signal(instance: WrapDeformMeshProvider, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WrapDeformMeshProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WrapDeformMeshProvider) -> List(String)
...
pub fn wait_for_child(instance: WrapDeformMeshProvider, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WrapDeformMeshProvider, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WrapDeformMeshProvider, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WrapDeformMeshProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WrapDeformMeshProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WrapDeformMeshProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WrapDeformMeshProvider, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WrapDeformMeshProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WrapDeformMeshProvider, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WrapDeformMeshProvider, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WrapDeformMeshProvider) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WrapDeformMeshProvider, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: WrapDeformMeshProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}