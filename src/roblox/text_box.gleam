...
import roblox/types.{
  ...
  type Rect, type ReturnKeyType, type SecurityCapabilities,
  type SelectionBehavior, type SizeConstraint, type SwipeDirection, type TextBox,
  type TextDirection, type TextInputType, type TextTruncate, type TextXAlignment,
...
pub fn focus_lost(
  instance: TextBox,
) -> RBXScriptSignal(fn(Bool, InputObject) -> Nil)
...
pub fn on_focus_lost(
  instance: TextBox,
  callback: fn(Bool, InputObject) -> Nil,
) -> RBXScriptConnection
...
pub fn return_pressed_from_on_screen_keyboard(
  instance: TextBox,
...
pub fn on_return_pressed_from_on_screen_keyboard(
  instance: TextBox,
  callback: fn() -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: TextBox) -> Int64
