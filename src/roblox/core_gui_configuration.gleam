...
import roblox/types.{type Actor, type CapturesViewConfiguration, type CoreGuiConfiguration, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerListConfiguration, type SecurityCapabilities, type SelfViewConfiguration, type UniqueId}
...
pub fn set_parent(instance: CoreGuiConfiguration, value: parent) -> CoreGuiConfiguration
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CoreGuiConfiguration) -> Nil
...
pub fn get_attribute_changed_signal(instance: CoreGuiConfiguration, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CoreGuiConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CoreGuiConfiguration) -> List(String)
...
pub fn wait_for_child(instance: CoreGuiConfiguration, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CoreGuiConfiguration, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CoreGuiConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CoreGuiConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CoreGuiConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CoreGuiConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CoreGuiConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CoreGuiConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CoreGuiConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CoreGuiConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CoreGuiConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CoreGuiConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SelfViewConfiguration, _: PlayerListConfiguration, _: CapturesViewConfiguration, _: CoreGuiConfiguration, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}