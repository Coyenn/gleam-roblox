...
import roblox/types.{
  type Actor, type CapturesViewConfiguration, type CoreGuiConfiguration,
  type Instance, type Int64, type Object, type PlayerListConfiguration,
  type SecurityCapabilities, type SelfViewConfiguration, type UniqueId,
}
...
pub fn get_captures_view_configuration(
  instance: CoreGuiConfiguration,
...
pub fn set_captures_view_configuration(
  instance: CoreGuiConfiguration,
  value: CapturesViewConfiguration,
...
pub fn get_player_list_configuration(
  instance: CoreGuiConfiguration,
...
pub fn set_player_list_configuration(
  instance: CoreGuiConfiguration,
  value: PlayerListConfiguration,
) -> CoreGuiConfiguration
...
pub fn get_self_view_configuration(
  instance: CoreGuiConfiguration,
...
pub fn set_self_view_configuration(
  instance: CoreGuiConfiguration,
  value: SelfViewConfiguration,
) -> CoreGuiConfiguration
...
pub fn get_source_asset_id(instance: CoreGuiConfiguration) -> Int64
...
pub fn javascript_type_anchor(
  ...
  _: SelfViewConfiguration,
  _: PlayerListConfiguration,
  _: CapturesViewConfiguration,
