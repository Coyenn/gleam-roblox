...
import roblox/types.{type Actor, type AudioFader, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioFader` instance.
///
/// Roblox: `Instance.new("AudioFader")`
@target(luau)
@luau.global("Instance.new(\"AudioFader\")")
pub fn new() -> AudioFader
...
pub fn get_input_pins(instance: AudioFader) -> List(String)
...
pub fn get_output_pins(instance: AudioFader) -> List(String)
...
pub fn wiring_changed(instance: AudioFader) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioFader.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioFader via a Wire.
///
/// Roblox: `AudioFader.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioFader, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioFader, value: parent) -> AudioFader
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioFader) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioFader, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioFader, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioFader) -> List(String)
...
pub fn wait_for_child(instance: AudioFader, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioFader) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioFader, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioFader) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioFader, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioFader) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioFader, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioFader) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioFader, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioFader) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioFader, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioFader) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioFader, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioFader) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioFader, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioFader) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioFader, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioFader, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioFader) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioFader, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioFader, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}