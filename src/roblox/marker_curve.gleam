...
import roblox/types.{type Actor, type Instance, type MarkerCurve, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `MarkerCurve` instance.
///
/// Roblox: `Instance.new("MarkerCurve")`
@target(luau)
@luau.global("Instance.new(\"MarkerCurve\")")
pub fn new() -> MarkerCurve
...
pub fn set_parent(instance: MarkerCurve, value: parent) -> MarkerCurve
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MarkerCurve) -> Nil
...
pub fn get_attribute_changed_signal(instance: MarkerCurve, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MarkerCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MarkerCurve) -> List(String)
...
pub fn wait_for_child(instance: MarkerCurve, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MarkerCurve) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MarkerCurve, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MarkerCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MarkerCurve, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MarkerCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MarkerCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MarkerCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MarkerCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MarkerCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MarkerCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MarkerCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MarkerCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MarkerCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MarkerCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MarkerCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MarkerCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MarkerCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MarkerCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MarkerCurve, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MarkerCurve, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}