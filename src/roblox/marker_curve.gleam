...
import roblox/types.{
  type Actor, type Instance, type Int64, type MarkerCurve, type Object,
...
pub fn insert_marker_at_time(
  instance: MarkerCurve,
  time: Float,
  marker: String,
) -> List(Dynamic)
...
pub fn get_source_asset_id(instance: MarkerCurve) -> Int64
