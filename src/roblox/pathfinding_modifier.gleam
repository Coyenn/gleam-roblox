...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PathfindingModifier, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PathfindingModifier` instance.
///
/// Roblox: `Instance.new("PathfindingModifier")`
@target(luau)
@luau.global("Instance.new(\"PathfindingModifier\")")
pub fn new() -> PathfindingModifier
...
pub fn set_parent(instance: PathfindingModifier, value: parent) -> PathfindingModifier
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PathfindingModifier) -> Nil
...
pub fn get_attribute_changed_signal(instance: PathfindingModifier, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PathfindingModifier, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PathfindingModifier) -> List(String)
...
pub fn wait_for_child(instance: PathfindingModifier, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PathfindingModifier) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PathfindingModifier, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PathfindingModifier) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PathfindingModifier, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PathfindingModifier) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PathfindingModifier, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PathfindingModifier) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PathfindingModifier, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PathfindingModifier) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PathfindingModifier, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PathfindingModifier) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PathfindingModifier, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PathfindingModifier) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PathfindingModifier, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PathfindingModifier) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PathfindingModifier, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PathfindingModifier, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PathfindingModifier) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PathfindingModifier, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PathfindingModifier, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}