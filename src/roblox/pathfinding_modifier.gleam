...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type PathfindingModifier,
...
pub fn get_source_asset_id(instance: PathfindingModifier) -> Int64
