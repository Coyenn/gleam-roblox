...
import roblox/types.{type Actor, type GenericSettings, type GlobalSettings, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ServiceProvider, type UniqueId}
...
@target(luau)
@luau.event("Close")
pub fn close(instance: GlobalSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_close(instance: GlobalSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn service_added(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_service_added(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn service_removing(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_service_removing(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: GlobalSettings, value: parent) -> GlobalSettings
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GlobalSettings) -> Nil
...
pub fn get_attribute_changed_signal(instance: GlobalSettings, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GlobalSettings, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GlobalSettings) -> List(String)
...
pub fn wait_for_child(instance: GlobalSettings, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GlobalSettings, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GlobalSettings) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GlobalSettings, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GlobalSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GlobalSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GlobalSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GlobalSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GlobalSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GlobalSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GlobalSettings, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GlobalSettings) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GlobalSettings, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GlobalSettings, _: GenericSettings, _: ServiceProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}