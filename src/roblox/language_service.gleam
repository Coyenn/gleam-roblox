...
import roblox/types.{type Actor, type Instance, type LanguageService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: LanguageService, value: parent) -> LanguageService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LanguageService) -> Nil
...
pub fn get_attribute_changed_signal(instance: LanguageService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LanguageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LanguageService) -> List(String)
...
pub fn wait_for_child(instance: LanguageService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LanguageService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LanguageService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LanguageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LanguageService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LanguageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LanguageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LanguageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LanguageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LanguageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LanguageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LanguageService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LanguageService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LanguageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LanguageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LanguageService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LanguageService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LanguageService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LanguageService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LanguageService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: LanguageService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}