...
import roblox/types.{
  type Actor, type HeightmapImporterService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: HeightmapImporterService,
  value: Bool,
...
pub fn get_source_asset_id(instance: HeightmapImporterService) -> Int64
