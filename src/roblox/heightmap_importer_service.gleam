...
import roblox/types.{type Actor, type HeightmapImporterService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `HeightmapImporterService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: HeightmapImporterService) -> Instance

/// Treats `HeightmapImporterService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: HeightmapImporterService) -> Object
...
pub fn set_parent(instance: HeightmapImporterService, value: parent) -> HeightmapImporterService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HeightmapImporterService) -> Nil
...
pub fn get_attribute_changed_signal(instance: HeightmapImporterService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HeightmapImporterService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HeightmapImporterService) -> List(String)
...
pub fn wait_for_child(instance: HeightmapImporterService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HeightmapImporterService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HeightmapImporterService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HeightmapImporterService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HeightmapImporterService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HeightmapImporterService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HeightmapImporterService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HeightmapImporterService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HeightmapImporterService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HeightmapImporterService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HeightmapImporterService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HeightmapImporterService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HeightmapImporterService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HeightmapImporterService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HeightmapImporterService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HeightmapImporterService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HeightmapImporterService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HeightmapImporterService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HeightmapImporterService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HeightmapImporterService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: HeightmapImporterService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}