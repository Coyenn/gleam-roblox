...
import roblox/types.{type Actor, type AssetDeliveryProxy, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: AssetDeliveryProxy, value: parent) -> AssetDeliveryProxy
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AssetDeliveryProxy) -> Nil
...
pub fn get_attribute_changed_signal(instance: AssetDeliveryProxy, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AssetDeliveryProxy, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AssetDeliveryProxy) -> List(String)
...
pub fn wait_for_child(instance: AssetDeliveryProxy, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AssetDeliveryProxy, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AssetDeliveryProxy, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AssetDeliveryProxy, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AssetDeliveryProxy, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AssetDeliveryProxy, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AssetDeliveryProxy, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AssetDeliveryProxy, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AssetDeliveryProxy, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AssetDeliveryProxy, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AssetDeliveryProxy) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AssetDeliveryProxy, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AssetDeliveryProxy, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}