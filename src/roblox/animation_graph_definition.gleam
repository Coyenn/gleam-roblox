...
import roblox/types.{type Actor, type AnimationClip, type AnimationGraphDefinition, type AnimationPriority, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `AnimationGraphDefinition` instance.
///
/// Roblox: `Instance.new("AnimationGraphDefinition")`
@target(luau)
@luau.global("Instance.new(\"AnimationGraphDefinition\")")
pub fn new() -> AnimationGraphDefinition
...
pub fn set_parent(instance: AnimationGraphDefinition, value: parent) -> AnimationGraphDefinition
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AnimationGraphDefinition) -> Nil
...
pub fn get_attribute_changed_signal(instance: AnimationGraphDefinition, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AnimationGraphDefinition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AnimationGraphDefinition) -> List(String)
...
pub fn wait_for_child(instance: AnimationGraphDefinition, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AnimationGraphDefinition, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AnimationGraphDefinition, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AnimationGraphDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AnimationGraphDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AnimationGraphDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AnimationGraphDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AnimationGraphDefinition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AnimationGraphDefinition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AnimationGraphDefinition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AnimationGraphDefinition) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AnimationGraphDefinition, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationPriority, _: AnimationGraphDefinition, _: AnimationClip, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}