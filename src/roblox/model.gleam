...
/// Creates a new Roblox `Model` instance.
///
/// Roblox: `Instance.new("Model")`
@target(luau)
@luau.global("Instance.new(\"Model\")")
pub fn new() -> Model
...
pub fn set_parent(instance: Model, value: parent) -> Model
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Model) -> Nil
...
pub fn get_attribute_changed_signal(instance: Model, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Model, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Model) -> List(String)
...
pub fn wait_for_child(instance: Model, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Model) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Model, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Model) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Model, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Model) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Model, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Model) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Model, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Model) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Model, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Model) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Model, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Model) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Model, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Model) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Model, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Model, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Model) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Model, callback: fn(String) -> Nil) -> RBXScriptConnection
