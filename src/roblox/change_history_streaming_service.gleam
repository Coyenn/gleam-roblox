...
import roblox/types.{type Actor, type ChangeHistoryStreamingService, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `ChangeHistoryStreamingService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: ChangeHistoryStreamingService) -> Instance

/// Treats `ChangeHistoryStreamingService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: ChangeHistoryStreamingService) -> Object
...
pub fn set_parent(instance: ChangeHistoryStreamingService, value: parent) -> ChangeHistoryStreamingService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ChangeHistoryStreamingService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ChangeHistoryStreamingService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ChangeHistoryStreamingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ChangeHistoryStreamingService) -> List(String)
...
pub fn wait_for_child(instance: ChangeHistoryStreamingService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ChangeHistoryStreamingService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ChangeHistoryStreamingService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ChangeHistoryStreamingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ChangeHistoryStreamingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ChangeHistoryStreamingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ChangeHistoryStreamingService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ChangeHistoryStreamingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ChangeHistoryStreamingService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ChangeHistoryStreamingService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ChangeHistoryStreamingService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ChangeHistoryStreamingService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ChangeHistoryStreamingService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}