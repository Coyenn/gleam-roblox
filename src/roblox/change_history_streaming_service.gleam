...
import roblox/types.{
  type Actor, type ChangeHistoryStreamingService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: ChangeHistoryStreamingService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ChangeHistoryStreamingService) -> Int64
