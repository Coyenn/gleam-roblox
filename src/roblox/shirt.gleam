...
import roblox/types.{type Actor, type CharacterAppearance, type Clothing, type Color3, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Shirt, type UniqueId}

/// Creates a new Roblox `Shirt` instance.
///
/// Roblox: `Instance.new("Shirt")`
@target(luau)
@luau.global("Instance.new(\"Shirt\")")
pub fn new() -> Shirt
...
pub fn set_parent(instance: Shirt, value: parent) -> Shirt
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Shirt) -> Nil
...
pub fn get_attribute_changed_signal(instance: Shirt, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Shirt, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Shirt) -> List(String)
...
pub fn wait_for_child(instance: Shirt, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Shirt) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Shirt, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Shirt) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Shirt, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Shirt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Shirt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Shirt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Shirt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Shirt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Shirt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Shirt) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Shirt, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Shirt) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Shirt, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Shirt) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Shirt, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Shirt, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Shirt) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Shirt, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: ContentId, _: Shirt, _: Clothing, _: CharacterAppearance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}