...
import roblox/types.{
  ...
  type TextFilterResult, type TextFilterTranslatedResult, type UniqueId,
}
...
pub fn get_translation_for_locale(
  instance: TextFilterTranslatedResult,
  locale: String,
) -> TextFilterResult
...
pub fn get_source_asset_id(instance: TextFilterTranslatedResult) -> Int64
