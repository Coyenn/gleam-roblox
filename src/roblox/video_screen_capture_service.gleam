...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type VideoScreenCaptureService}

/// Treats `VideoScreenCaptureService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: VideoScreenCaptureService) -> Instance

/// Treats `VideoScreenCaptureService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: VideoScreenCaptureService) -> Object
...
pub fn set_parent(instance: VideoScreenCaptureService, value: parent) -> VideoScreenCaptureService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: VideoScreenCaptureService) -> Nil
...
pub fn get_attribute_changed_signal(instance: VideoScreenCaptureService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: VideoScreenCaptureService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: VideoScreenCaptureService) -> List(String)
...
pub fn wait_for_child(instance: VideoScreenCaptureService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: VideoScreenCaptureService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: VideoScreenCaptureService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: VideoScreenCaptureService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: VideoScreenCaptureService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: VideoScreenCaptureService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: VideoScreenCaptureService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: VideoScreenCaptureService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: VideoScreenCaptureService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: VideoScreenCaptureService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: VideoScreenCaptureService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: VideoScreenCaptureService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: VideoScreenCaptureService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}