...
import roblox/types.{type Actor, type CFrame, type Collaborator, type CollaboratorStatus, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: Collaborator, value: parent) -> Collaborator
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Collaborator) -> Nil
...
pub fn get_attribute_changed_signal(instance: Collaborator, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Collaborator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Collaborator) -> List(String)
...
pub fn wait_for_child(instance: Collaborator, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Collaborator) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Collaborator, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Collaborator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Collaborator, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Collaborator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Collaborator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Collaborator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Collaborator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Collaborator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Collaborator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Collaborator) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Collaborator, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Collaborator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Collaborator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Collaborator) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Collaborator, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Collaborator, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Collaborator) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Collaborator, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CollaboratorStatus, _: Color3, _: CFrame, _: Collaborator, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}