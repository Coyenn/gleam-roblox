...
import roblox/types.{type Actor, type DebuggerManager, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn debugger_added(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `DebuggerManager.DebuggerAdded`.
///
/// Roblox: `DebuggerManager.DebuggerAdded`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/DebuggerManager#DebuggerAdded
@target(luau)
@luau.global("(function(instance, callback) return instance.DebuggerAdded:Connect(callback) end)")
pub fn on_debugger_added(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn debugger_removed(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `DebuggerManager.DebuggerRemoved`.
///
/// Roblox: `DebuggerManager.DebuggerRemoved`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/DebuggerManager#DebuggerRemoved
@target(luau)
@luau.global("(function(instance, callback) return instance.DebuggerRemoved:Connect(callback) end)")
pub fn on_debugger_removed(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: DebuggerManager, value: parent) -> DebuggerManager
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DebuggerManager) -> Nil
...
pub fn get_attribute_changed_signal(instance: DebuggerManager, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DebuggerManager, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DebuggerManager) -> List(String)
...
pub fn wait_for_child(instance: DebuggerManager, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DebuggerManager, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DebuggerManager) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DebuggerManager, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DebuggerManager) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DebuggerManager, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DebuggerManager) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DebuggerManager, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DebuggerManager) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DebuggerManager, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DebuggerManager, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DebuggerManager) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DebuggerManager, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DebuggerManager, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}