...
import roblox/types.{
  type Actor, type DebuggerManager, type Instance, type Int64, type Object,
...
pub fn debugger_added(
  instance: DebuggerManager,
...
pub fn get_source_asset_id(instance: DebuggerManager) -> Int64
