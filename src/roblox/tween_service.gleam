...
import roblox/types.{type Actor, type EasingDirection, type EasingStyle, type Instance, type Object, type OptionDouble, type OptionFloat, type OptionInt64, type SecurityCapabilities, type Tween, type TweenInfo, type TweenService, type UniqueId}
...
pub fn set_parent(instance: TweenService, value: parent) -> TweenService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TweenService) -> Nil
...
pub fn get_attribute_changed_signal(instance: TweenService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TweenService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TweenService) -> List(String)
...
pub fn wait_for_child(instance: TweenService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TweenService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TweenService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TweenService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TweenService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TweenService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TweenService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TweenService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TweenService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TweenService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TweenService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TweenService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TweenService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TweenService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TweenService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TweenService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TweenService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TweenService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TweenService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TweenService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: OptionFloat, _: EasingStyle, _: EasingDirection, _: Tween, _: TweenInfo, _: TweenService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}