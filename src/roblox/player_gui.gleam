...
import roblox/types.{type Actor, type BasePlayerGui, type GuiObject, type Instance, type Object, type OptionDouble, type OptionInt64, type PlayerGui, type ScreenOrientation, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PlayerGui, value: parent) -> PlayerGui
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PlayerGui) -> Nil
...
pub fn get_attribute_changed_signal(instance: PlayerGui, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PlayerGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PlayerGui) -> List(String)
...
pub fn wait_for_child(instance: PlayerGui, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PlayerGui) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PlayerGui, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PlayerGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PlayerGui, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PlayerGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PlayerGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PlayerGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PlayerGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PlayerGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PlayerGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PlayerGui) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PlayerGui, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PlayerGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PlayerGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PlayerGui) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PlayerGui, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PlayerGui, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PlayerGui) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PlayerGui, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: ScreenOrientation, _: PlayerGui, _: BasePlayerGui, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}