...
import roblox/types.{type Actor, type AudioEmitter, type AudioListener, type BinaryString, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioListener` instance.
///
/// Roblox: `Instance.new("AudioListener")`
@target(luau)
@luau.global("Instance.new(\"AudioListener\")")
...
pub fn get_input_pins(instance: AudioListener) -> List(String)
...
pub fn get_output_pins(instance: AudioListener) -> List(String)
...
pub fn wiring_changed(instance: AudioListener) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioListener.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioListener via a Wire.
///
/// Roblox: `AudioListener.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioListener, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioListener, value: parent) -> AudioListener
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioListener) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioListener, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioListener, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioListener) -> List(String)
...
pub fn wait_for_child(instance: AudioListener, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioListener) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioListener, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioListener) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioListener, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioListener) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioListener, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioListener) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioListener, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioListener) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioListener, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioListener) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioListener, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioListener) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioListener, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioListener) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioListener, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioListener, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioListener) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioListener, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioEmitter, _: BinaryString, _: AudioListener, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}