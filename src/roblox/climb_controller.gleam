...
import roblox/types.{type Actor, type ClimbController, type ControllerBase, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ClimbController` instance.
///
/// Roblox: `Instance.new("ClimbController")`
@target(luau)
@luau.global("Instance.new(\"ClimbController\")")
...
pub fn set_parent(instance: ClimbController, value: parent) -> ClimbController
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ClimbController) -> Nil
...
pub fn get_attribute_changed_signal(instance: ClimbController, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ClimbController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ClimbController) -> List(String)
...
pub fn wait_for_child(instance: ClimbController, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ClimbController) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ClimbController, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ClimbController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ClimbController, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ClimbController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ClimbController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ClimbController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ClimbController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ClimbController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ClimbController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ClimbController) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ClimbController, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ClimbController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ClimbController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ClimbController) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ClimbController, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ClimbController, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ClimbController) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ClimbController, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ClimbController, _: ControllerBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}