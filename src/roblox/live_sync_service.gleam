...
import roblox/types.{type Actor, type Instance, type LiveSyncService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn sync_status_changed(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `LiveSyncService.SyncStatusChanged`.
///
/// Roblox: `LiveSyncService.SyncStatusChanged`
/// ThreadSafety: Unsafe
/// See: https://create.roblox.com/docs/reference/engine/classes/LiveSyncService#SyncStatusChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.SyncStatusChanged:Connect(callback) end)")
pub fn on_sync_status_changed(instance: LiveSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: LiveSyncService, value: parent) -> LiveSyncService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LiveSyncService) -> Nil
...
pub fn get_attribute_changed_signal(instance: LiveSyncService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LiveSyncService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LiveSyncService) -> List(String)
...
pub fn wait_for_child(instance: LiveSyncService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LiveSyncService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LiveSyncService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LiveSyncService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LiveSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LiveSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LiveSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LiveSyncService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LiveSyncService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LiveSyncService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LiveSyncService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LiveSyncService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LiveSyncService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LiveSyncService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LiveSyncService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LiveSyncService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: LiveSyncService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}