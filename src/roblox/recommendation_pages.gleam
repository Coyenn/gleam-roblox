...
import roblox/types.{
  ...
  type RecommendationPages, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: RecommendationPages) -> Int64
