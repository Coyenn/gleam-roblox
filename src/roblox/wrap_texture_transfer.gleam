...
import roblox/types.{
  type Actor, type Content, type Instance, type Object,
  type SecurityCapabilities, type UniqueId, type Vector2,
  type WrapTextureTransfer,
}
...
pub fn set_reference_cage_mesh_content(
  instance: WrapTextureTransfer,
  value: Content,
) -> WrapTextureTransfer
...
pub fn get_source_asset_id(instance: WrapTextureTransfer) -> Int
