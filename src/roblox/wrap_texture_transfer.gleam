...
import roblox/types.{type Actor, type Content, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector2, type WrapTextureTransfer}

/// Creates a new Roblox `WrapTextureTransfer` instance.
///
/// Roblox: `Instance.new("WrapTextureTransfer")`
@target(luau)
@luau.global("Instance.new(\"WrapTextureTransfer\")")
pub fn new() -> WrapTextureTransfer
...
pub fn set_parent(instance: WrapTextureTransfer, value: parent) -> WrapTextureTransfer
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: WrapTextureTransfer) -> Nil
...
pub fn get_attribute_changed_signal(instance: WrapTextureTransfer, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: WrapTextureTransfer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: WrapTextureTransfer) -> List(String)
...
pub fn wait_for_child(instance: WrapTextureTransfer, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: WrapTextureTransfer, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: WrapTextureTransfer, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: WrapTextureTransfer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: WrapTextureTransfer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: WrapTextureTransfer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: WrapTextureTransfer, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: WrapTextureTransfer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: WrapTextureTransfer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: WrapTextureTransfer) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: WrapTextureTransfer, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: WrapTextureTransfer, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: WrapTextureTransfer) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: WrapTextureTransfer, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector2, _: Content, _: WrapTextureTransfer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}