...
import roblox/types.{type Actor, type AspectType, type DominantAxis, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UIAspectRatioConstraint, type UIBase, type UIComponent, type UIConstraint, type UniqueId}

/// Creates a new Roblox `UIAspectRatioConstraint` instance.
///
/// Roblox: `Instance.new("UIAspectRatioConstraint")`
@target(luau)
@luau.global("Instance.new(\"UIAspectRatioConstraint\")")
...
pub fn set_parent(instance: UIAspectRatioConstraint, value: parent) -> UIAspectRatioConstraint
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIAspectRatioConstraint) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIAspectRatioConstraint, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIAspectRatioConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIAspectRatioConstraint) -> List(String)
...
pub fn wait_for_child(instance: UIAspectRatioConstraint, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIAspectRatioConstraint, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIAspectRatioConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIAspectRatioConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIAspectRatioConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIAspectRatioConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIAspectRatioConstraint, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIAspectRatioConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIAspectRatioConstraint, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIAspectRatioConstraint, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIAspectRatioConstraint) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIAspectRatioConstraint, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DominantAxis, _: AspectType, _: UIAspectRatioConstraint, _: UIConstraint, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}