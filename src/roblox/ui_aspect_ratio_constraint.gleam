...
import roblox/types.{
  type Actor, type AspectType, type DominantAxis, type Instance, type Int64,
  type Object, type SecurityCapabilities, type UIAspectRatioConstraint,
  type UIBase, type UIComponent, type UIConstraint, type UniqueId,
}
...
pub fn set_aspect_ratio(
  instance: UIAspectRatioConstraint,
  value: Float,
...
pub fn get_source_asset_id(instance: UIAspectRatioConstraint) -> Int64
