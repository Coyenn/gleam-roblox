...
import roblox/types.{
  type Actor, type AudioPitchShifter, type AudioWindowSize, type Instance,
...
pub fn get_source_asset_id(instance: AudioPitchShifter) -> Int64
