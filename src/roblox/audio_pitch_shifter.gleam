...
import roblox/types.{type Actor, type AudioPitchShifter, type AudioWindowSize, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Wire}

/// Creates a new Roblox `AudioPitchShifter` instance.
///
/// Roblox: `Instance.new("AudioPitchShifter")`
@target(luau)
@luau.global("Instance.new(\"AudioPitchShifter\")")
pub fn new() -> AudioPitchShifter
...
pub fn get_input_pins(instance: AudioPitchShifter) -> List(String)
...
pub fn get_output_pins(instance: AudioPitchShifter) -> List(String)
...
pub fn wiring_changed(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Bool, String, Wire, Instance) -> Nil)

/// Connects to Roblox event `AudioPitchShifter.WiringChanged`.
///
/// Fires when another instance is connected to or disconnected from the AudioPitchShifter via a Wire.
///
/// Roblox: `AudioPitchShifter.WiringChanged`
...
pub fn on_wiring_changed(instance: AudioPitchShifter, callback: fn(Bool, String, Wire, Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: AudioPitchShifter, value: parent) -> AudioPitchShifter
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AudioPitchShifter) -> Nil
...
pub fn get_attribute_changed_signal(instance: AudioPitchShifter, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AudioPitchShifter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AudioPitchShifter) -> List(String)
...
pub fn wait_for_child(instance: AudioPitchShifter, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AudioPitchShifter, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AudioPitchShifter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AudioPitchShifter, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AudioPitchShifter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AudioPitchShifter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AudioPitchShifter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AudioPitchShifter) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AudioPitchShifter, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AudioPitchShifter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AudioPitchShifter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AudioPitchShifter) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AudioPitchShifter, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AudioPitchShifter, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AudioPitchShifter) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AudioPitchShifter, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Wire, _: AudioWindowSize, _: AudioPitchShifter, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}