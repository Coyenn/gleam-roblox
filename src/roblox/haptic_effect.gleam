...
import roblox/types.{type Actor, type HapticEffect, type HapticEffectType, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `HapticEffect` instance.
///
/// Roblox: `Instance.new("HapticEffect")`
@target(luau)
@luau.global("Instance.new(\"HapticEffect\")")
pub fn new() -> HapticEffect
...
@target(luau)
@luau.event("Ended")
pub fn ended(instance: HapticEffect) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `HapticEffect.Ended`.
///
/// Fires when the HapticEffect has completed playback and stopped.
///
/// Roblox: `HapticEffect.Ended`
...
pub fn on_ended(instance: HapticEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: HapticEffect, value: parent) -> HapticEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: HapticEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: HapticEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: HapticEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: HapticEffect) -> List(String)
...
pub fn wait_for_child(instance: HapticEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: HapticEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: HapticEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: HapticEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: HapticEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: HapticEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: HapticEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: HapticEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: HapticEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: HapticEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: HapticEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: HapticEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: HapticEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: HapticEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: HapticEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: HapticEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: HapticEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: HapticEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: HapticEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: HapticEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: HapticEffectType, _: Vector3, _: HapticEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}