...
import roblox/types.{
  type Actor, type HapticEffect, type HapticEffectType, type Instance,
...
pub fn set_type_(
  instance: HapticEffect,
  value: HapticEffectType,
) -> HapticEffect
...
pub fn get_source_asset_id(instance: HapticEffect) -> Int64
