...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SoundGroup, type UniqueId}

/// Creates a new Roblox `SoundGroup` instance.
///
/// Roblox: `Instance.new("SoundGroup")`
@target(luau)
@luau.global("Instance.new(\"SoundGroup\")")
...
pub fn set_parent(instance: SoundGroup, value: parent) -> SoundGroup
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SoundGroup) -> Nil
...
pub fn get_attribute_changed_signal(instance: SoundGroup, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SoundGroup, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SoundGroup) -> List(String)
...
pub fn wait_for_child(instance: SoundGroup, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SoundGroup) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SoundGroup, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SoundGroup) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SoundGroup, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SoundGroup) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SoundGroup, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SoundGroup) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SoundGroup, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SoundGroup) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SoundGroup, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SoundGroup) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SoundGroup, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SoundGroup) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SoundGroup, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SoundGroup) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SoundGroup, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SoundGroup, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SoundGroup) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SoundGroup, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SoundGroup, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}