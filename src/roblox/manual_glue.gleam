...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type ManualGlue, type ManualSurfaceJointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: ManualGlue, value: parent) -> ManualGlue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ManualGlue) -> Nil
...
pub fn get_attribute_changed_signal(instance: ManualGlue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ManualGlue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ManualGlue) -> List(String)
...
pub fn wait_for_child(instance: ManualGlue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ManualGlue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ManualGlue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ManualGlue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ManualGlue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ManualGlue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ManualGlue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ManualGlue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ManualGlue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ManualGlue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ManualGlue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ManualGlue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ManualGlue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ManualGlue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ManualGlue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ManualGlue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ManualGlue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ManualGlue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ManualGlue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ManualGlue, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: ManualGlue, _: ManualSurfaceJointInstance, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}