...
import roblox/types.{type Actor, type CapturesPages, type Instance, type Object, type OptionDouble, type OptionInt64, type Pages, type SecurityCapabilities, type UniqueId}

/// Treats `CapturesPages` as its Roblox ancestor `Pages`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_pages(instance: CapturesPages) -> Pages

/// Treats `CapturesPages` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: CapturesPages) -> Instance

/// Treats `CapturesPages` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: CapturesPages) -> Object
...
pub fn set_parent(instance: CapturesPages, value: parent) -> CapturesPages
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CapturesPages) -> Nil
...
pub fn get_attribute_changed_signal(instance: CapturesPages, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CapturesPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CapturesPages) -> List(String)
...
pub fn wait_for_child(instance: CapturesPages, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CapturesPages) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CapturesPages, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CapturesPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CapturesPages, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CapturesPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CapturesPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CapturesPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CapturesPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CapturesPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CapturesPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CapturesPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CapturesPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CapturesPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CapturesPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CapturesPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CapturesPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CapturesPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CapturesPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CapturesPages, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CapturesPages, _: Pages, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}