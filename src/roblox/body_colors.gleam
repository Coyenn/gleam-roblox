...
import roblox/types.{type Actor, type BodyColors, type BrickColor, type CharacterAppearance, type Color3, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `BodyColors` instance.
///
/// Roblox: `Instance.new("BodyColors")`
@target(luau)
@luau.global("Instance.new(\"BodyColors\")")
...
/// Sets Roblox property `BodyColors.HeadColor`.
///
/// Sets the color of the head, as a BrickColor.
///
/// Roblox: `BodyColors.HeadColor`
...
/// Gets Roblox property `BodyColors.HeadColor3`.
///
...
/// Sets Roblox property `BodyColors.HeadColor3`.
///
/// Sets the color of the head, as a Color3.
///
/// Roblox: `BodyColors.HeadColor3`
...
/// Gets Roblox property `BodyColors.LeftArmColor`.
///
...
/// Sets Roblox property `BodyColors.LeftArmColor`.
///
/// Sets the color of the left arm, as a BrickColor.
///
/// Roblox: `BodyColors.LeftArmColor`
...
/// Gets Roblox property `BodyColors.LeftArmColor3`.
///
...
/// Sets Roblox property `BodyColors.LeftArmColor3`.
///
/// Sets the color of the left arm, as a Color3.
///
/// Roblox: `BodyColors.LeftArmColor3`
...
/// Gets Roblox property `BodyColors.LeftLegColor`.
///
...
/// Sets Roblox property `BodyColors.LeftLegColor`.
///
/// Sets the color of the left leg, as a BrickColor.
///
/// Roblox: `BodyColors.LeftLegColor`
...
/// Gets Roblox property `BodyColors.LeftLegColor3`.
///
...
/// Sets Roblox property `BodyColors.LeftLegColor3`.
///
/// Sets the color of the left leg, as a Color3.
///
/// Roblox: `BodyColors.LeftLegColor3`
...
/// Gets Roblox property `BodyColors.RightArmColor`.
///
...
/// Sets Roblox property `BodyColors.RightArmColor`.
///
/// Sets the color of the right arm, as a BrickColor.
///
/// Roblox: `BodyColors.RightArmColor`
...
/// Gets Roblox property `BodyColors.RightArmColor3`.
///
...
/// Sets Roblox property `BodyColors.RightArmColor3`.
///
/// Sets the color of the right arm, as a Color3.
///
/// Roblox: `BodyColors.RightArmColor3`
...
/// Gets Roblox property `BodyColors.RightLegColor`.
///
...
/// Sets Roblox property `BodyColors.RightLegColor`.
///
/// Sets the color of the right leg, as a BrickColor.
///
/// Roblox: `BodyColors.RightLegColor`
...
/// Gets Roblox property `BodyColors.RightLegColor3`.
///
...
/// Sets Roblox property `BodyColors.RightLegColor3`.
///
/// Sets the color of the right leg, as a Color3.
///
/// Roblox: `BodyColors.RightLegColor3`
...
/// Gets Roblox property `BodyColors.TorsoColor`.
///
...
/// Sets Roblox property `BodyColors.TorsoColor`.
///
/// Sets the color of the torso, as a BrickColor.
///
/// Roblox: `BodyColors.TorsoColor`
...
/// Gets Roblox property `BodyColors.TorsoColor3`.
///
...
/// Sets Roblox property `BodyColors.TorsoColor3`.
///
/// Sets the color of the torso, as a Color3.
///
/// Roblox: `BodyColors.TorsoColor3`
...
pub fn set_parent(instance: BodyColors, value: parent) -> BodyColors
...
pub fn get_source_asset_id(instance: BodyColors) -> OptionInt64
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BodyColors) -> Nil
...
pub fn get_attribute_changed_signal(instance: BodyColors, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BodyColors, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BodyColors) -> List(String)
...
pub fn wait_for_child(instance: BodyColors, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BodyColors) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BodyColors, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BodyColors) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BodyColors, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BodyColors) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BodyColors, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BodyColors) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BodyColors, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BodyColors) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BodyColors, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BodyColors) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BodyColors, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BodyColors) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BodyColors, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BodyColors) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BodyColors, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BodyColors, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BodyColors) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BodyColors, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: BrickColor, _: BodyColors, _: CharacterAppearance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}