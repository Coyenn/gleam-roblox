...
import roblox/types.{
  type Actor, type ConfigureServerService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: ConfigureServerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ConfigureServerService) -> Int64
