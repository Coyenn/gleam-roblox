...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type Selection, type SelectionRenderMode, type UniqueId}
...
pub fn selection_changed(instance: Selection) -> RBXScriptSignal(fn() -> Nil)

/// Connects to Roblox event `Selection.SelectionChanged`.
///
/// Fires when the Instances selected in Roblox Studio changes.
///
/// Roblox: `Selection.SelectionChanged`
...
pub fn on_selection_changed(instance: Selection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Selection, value: parent) -> Selection
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Selection) -> Nil
...
pub fn get_attribute_changed_signal(instance: Selection, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Selection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Selection) -> List(String)
...
pub fn wait_for_child(instance: Selection, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Selection) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Selection, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Selection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Selection, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Selection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Selection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Selection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Selection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Selection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Selection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Selection) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Selection, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Selection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Selection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Selection) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Selection, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Selection, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Selection) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Selection, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SelectionRenderMode, _: Selection, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}