...
import roblox/types.{
  ...
  type BrickColor, type CFrame, type Constraint, type Instance, type Int64,
  type Object, type OrientationAlignmentMode, type SecurityCapabilities,
...
pub fn get_source_asset_id(instance: AlignOrientation) -> Int64
