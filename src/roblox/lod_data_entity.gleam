...
import roblox/types.{
  type Actor, type Instance, type Int64, type LodDataEntity, type Object,
...
pub fn set_entity_lod_enabled(
  instance: LodDataEntity,
  value: Bool,
) -> LodDataEntity
...
pub fn get_source_asset_id(instance: LodDataEntity) -> Int64
