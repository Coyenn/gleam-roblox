...
import roblox/types.{type Actor, type BrickColor, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type Team, type UniqueId}

/// Creates a new Roblox `Team` instance.
///
/// Roblox: `Instance.new("Team")`
@target(luau)
@luau.global("Instance.new(\"Team\")")
pub fn new() -> Team
...
pub fn player_added(instance: Team) -> RBXScriptSignal(fn(Player) -> Nil)

/// Connects to Roblox event `Team.PlayerAdded`.
///
/// Fires whenever a Player is assigned to the Team. A player is considered assigned if their Player.Team property is equal to the Team and Player.Neutral is false.
///
/// Roblox: `Team.PlayerAdded`
...
pub fn on_player_added(instance: Team, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn player_removed(instance: Team) -> RBXScriptSignal(fn(Player) -> Nil)

/// Connects to Roblox event `Team.PlayerRemoved`.
///
/// Fires whenever a Player is removed from a Team. This can be due to the Player leaving the game, Player.Neutral being set to true or the Player joining a different team.
///
/// Roblox: `Team.PlayerRemoved`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/Team#PlayerRemoved
@target(luau)
@luau.global("(function(instance, callback) return instance.PlayerRemoved:Connect(callback) end)")
pub fn on_player_removed(instance: Team, callback: fn(Player) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Team, value: parent) -> Team
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Team) -> Nil
...
pub fn get_attribute_changed_signal(instance: Team, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Team, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Team) -> List(String)
...
pub fn wait_for_child(instance: Team, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Team) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Team, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Team) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Team, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Team) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Team, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Team) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Team, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Team) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Team, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Team) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Team, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Team) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Team, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Team) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Team, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Team, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Team) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Team, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: BrickColor, _: Team, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}