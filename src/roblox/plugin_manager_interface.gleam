...
import roblox/types.{
  ...
  type PluginManagerInterface, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PluginManagerInterface,
  value: Bool,
...
pub fn get_source_asset_id(instance: PluginManagerInterface) -> Int64
