...
import roblox/types.{type Actor, type AutomaticSize, type BorderMode, type Camera, type Color3, type EasingDirection, type EasingStyle, type GuiBase, type GuiBase2d, type GuiObject, type GuiState, type InputObject, type InputSink, type Instance, type LocalizationTable, type Object, type OptionDouble, type OptionInt64, type Rect, type SecurityCapabilities, type SelectionBehavior, type SizeConstraint, type SwipeDirection, type UDim2, type UniqueId, type UserInputState, type Vector2, type Vector3, type ViewportFrame}

/// Creates a new Roblox `ViewportFrame` instance.
///
/// Roblox: `Instance.new("ViewportFrame")`
@target(luau)
@luau.global("Instance.new(\"ViewportFrame\")")
...
pub fn tween_position(instance: ViewportFrame, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size(instance: ViewportFrame, end_size: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size_and_position(instance: ViewportFrame, end_size: UDim2, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn input_began(instance: ViewportFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_began(instance: ViewportFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_changed(instance: ViewportFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_changed(instance: ViewportFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_ended(instance: ViewportFrame) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_ended(instance: ViewportFrame, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: ViewportFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_enter(instance: ViewportFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: ViewportFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_leave(instance: ViewportFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_moved(instance: ViewportFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_moved(instance: ViewportFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_backward(instance: ViewportFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_backward(instance: ViewportFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_forward(instance: ViewportFrame) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_forward(instance: ViewportFrame, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn selection_gained(instance: ViewportFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_selection_gained(instance: ViewportFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn selection_lost(instance: ViewportFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_selection_lost(instance: ViewportFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn touch_long_press(instance: ViewportFrame) -> RBXScriptSignal(fn(List(Vector2), UserInputState) -> Nil)
...
pub fn on_touch_long_press(instance: ViewportFrame, callback: fn(List(Vector2), UserInputState) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchPan")
pub fn touch_pan(instance: ViewportFrame) -> RBXScriptSignal(fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil)
...
pub fn on_touch_pan(instance: ViewportFrame, callback: fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_pinch(instance: ViewportFrame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_pinch(instance: ViewportFrame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_rotate(instance: ViewportFrame) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_rotate(instance: ViewportFrame, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_swipe(instance: ViewportFrame) -> RBXScriptSignal(fn(SwipeDirection, Int) -> Nil)
...
pub fn on_touch_swipe(instance: ViewportFrame, callback: fn(SwipeDirection, Int) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchTap")
pub fn touch_tap(instance: ViewportFrame) -> RBXScriptSignal(fn(List(Vector2)) -> Nil)
...
pub fn on_touch_tap(instance: ViewportFrame, callback: fn(List(Vector2)) -> Nil) -> RBXScriptConnection
...
pub fn selection_changed(instance: ViewportFrame) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: ViewportFrame, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ViewportFrame, value: parent) -> ViewportFrame
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ViewportFrame) -> Nil
...
pub fn get_attribute_changed_signal(instance: ViewportFrame, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ViewportFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ViewportFrame) -> List(String)
...
pub fn wait_for_child(instance: ViewportFrame, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ViewportFrame) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ViewportFrame, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ViewportFrame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ViewportFrame, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ViewportFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ViewportFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ViewportFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ViewportFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ViewportFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ViewportFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ViewportFrame) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ViewportFrame, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ViewportFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ViewportFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ViewportFrame) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ViewportFrame, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ViewportFrame, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ViewportFrame) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ViewportFrame, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: GuiObject, _: SelectionBehavior, _: LocalizationTable, _: Rect, _: Vector2, _: SwipeDirection, _: UserInputState, _: InputObject, _: UDim2, _: EasingDirection, _: EasingStyle, _: SizeConstraint, _: InputSink, _: GuiState, _: BorderMode, _: Color3, _: AutomaticSize, _: Vector3, _: Camera, _: ViewportFrame, _: GuiBase2d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}