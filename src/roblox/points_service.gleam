...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PointsService, type SecurityCapabilities, type UniqueId}
...
pub fn points_awarded(instance: PointsService) -> RBXScriptSignal(fn(OptionInt64, Int, Int, Int) -> Nil)
...
pub fn on_points_awarded(instance: PointsService, callback: fn(OptionInt64, Int, Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: PointsService, value: parent) -> PointsService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PointsService) -> Nil
...
pub fn get_attribute_changed_signal(instance: PointsService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PointsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PointsService) -> List(String)
...
pub fn wait_for_child(instance: PointsService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PointsService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PointsService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PointsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PointsService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PointsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PointsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PointsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PointsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PointsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PointsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PointsService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PointsService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PointsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PointsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PointsService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PointsService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PointsService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PointsService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PointsService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PointsService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}