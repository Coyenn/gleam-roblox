...
import roblox/types.{type Actor, type Attachment, type Instance, type Object, type OptionDouble, type OptionInt64, type PathfindingLink, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `PathfindingLink` instance.
///
/// Roblox: `Instance.new("PathfindingLink")`
@target(luau)
@luau.global("Instance.new(\"PathfindingLink\")")
pub fn new() -> PathfindingLink
...
pub fn set_parent(instance: PathfindingLink, value: parent) -> PathfindingLink
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PathfindingLink) -> Nil
...
pub fn get_attribute_changed_signal(instance: PathfindingLink, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PathfindingLink, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PathfindingLink) -> List(String)
...
pub fn wait_for_child(instance: PathfindingLink, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PathfindingLink) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PathfindingLink, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PathfindingLink) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PathfindingLink, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PathfindingLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PathfindingLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PathfindingLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PathfindingLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PathfindingLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PathfindingLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PathfindingLink) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PathfindingLink, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PathfindingLink) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PathfindingLink, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PathfindingLink) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PathfindingLink, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PathfindingLink, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PathfindingLink) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PathfindingLink, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Attachment, _: PathfindingLink, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}