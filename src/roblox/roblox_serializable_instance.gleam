...
import roblox/types.{
  type Actor, type BinaryString, type Instance, type Int64, type Object,
  type RobloxSerializableInstance, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: RobloxSerializableInstance,
  value: Bool,
...
pub fn get_source_asset_id(instance: RobloxSerializableInstance) -> Int64
