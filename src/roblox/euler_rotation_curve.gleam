...
import roblox/types.{type Actor, type CFrame, type EulerRotationCurve, type FloatCurve, type Instance, type Object, type OptionDouble, type OptionInt64, type RotationOrder, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `EulerRotationCurve` instance.
///
/// Roblox: `Instance.new("EulerRotationCurve")`
@target(luau)
@luau.global("Instance.new(\"EulerRotationCurve\")")
pub fn new() -> EulerRotationCurve
...
pub fn set_parent(instance: EulerRotationCurve, value: parent) -> EulerRotationCurve
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: EulerRotationCurve) -> Nil
...
pub fn get_attribute_changed_signal(instance: EulerRotationCurve, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: EulerRotationCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: EulerRotationCurve) -> List(String)
...
pub fn wait_for_child(instance: EulerRotationCurve, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: EulerRotationCurve) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: EulerRotationCurve, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: EulerRotationCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: EulerRotationCurve, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: EulerRotationCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: EulerRotationCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: EulerRotationCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: EulerRotationCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: EulerRotationCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: EulerRotationCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: EulerRotationCurve) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: EulerRotationCurve, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: EulerRotationCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: EulerRotationCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: EulerRotationCurve) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: EulerRotationCurve, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: EulerRotationCurve, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: EulerRotationCurve) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: EulerRotationCurve, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FloatCurve, _: CFrame, _: RotationOrder, _: EulerRotationCurve, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}