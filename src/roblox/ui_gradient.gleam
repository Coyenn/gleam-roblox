...
import roblox/types.{
  type Actor, type ColorSequence, type Instance, type Int64, type NumberSequence,
  type Object, type SecurityCapabilities, type UIBase, type UIComponent,
  type UIGradient, type UniqueId, type Vector2,
}
...
pub fn get_source_asset_id(instance: UIGradient) -> Int64
