...
import roblox/types.{type Actor, type ColorSequence, type Instance, type NumberSequence, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UIBase, type UIComponent, type UIGradient, type UniqueId, type Vector2}

/// Creates a new Roblox `UIGradient` instance.
///
/// Roblox: `Instance.new("UIGradient")`
@target(luau)
@luau.global("Instance.new(\"UIGradient\")")
...
pub fn set_parent(instance: UIGradient, value: parent) -> UIGradient
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UIGradient) -> Nil
...
pub fn get_attribute_changed_signal(instance: UIGradient, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UIGradient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UIGradient) -> List(String)
...
pub fn wait_for_child(instance: UIGradient, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UIGradient) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UIGradient, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UIGradient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UIGradient, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UIGradient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UIGradient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UIGradient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UIGradient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UIGradient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UIGradient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UIGradient) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UIGradient, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UIGradient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UIGradient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UIGradient) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UIGradient, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UIGradient, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UIGradient) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UIGradient, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NumberSequence, _: Vector2, _: ColorSequence, _: UIGradient, _: UIComponent, _: UIBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}