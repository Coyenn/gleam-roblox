...
import roblox/types.{
  ...
  type SecurityCapabilities, type SlimContentProvider, type UniqueId,
}
...
pub fn get_source_asset_id(instance: SlimContentProvider) -> Int
