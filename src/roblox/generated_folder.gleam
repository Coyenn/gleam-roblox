...
import roblox/types.{type Actor, type BasePart, type Folder, type GeneratedFolder, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `GeneratedFolder` instance.
///
/// Roblox: `Instance.new("GeneratedFolder")`
@target(luau)
@luau.global("Instance.new(\"GeneratedFolder\")")
...
pub fn set_parent(instance: GeneratedFolder, value: parent) -> GeneratedFolder
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: GeneratedFolder) -> Nil
...
pub fn get_attribute_changed_signal(instance: GeneratedFolder, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GeneratedFolder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: GeneratedFolder) -> List(String)
...
pub fn wait_for_child(instance: GeneratedFolder, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GeneratedFolder) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GeneratedFolder, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GeneratedFolder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GeneratedFolder, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: GeneratedFolder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: GeneratedFolder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GeneratedFolder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GeneratedFolder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GeneratedFolder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GeneratedFolder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GeneratedFolder) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GeneratedFolder, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: GeneratedFolder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: GeneratedFolder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GeneratedFolder) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GeneratedFolder, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GeneratedFolder, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: GeneratedFolder) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: GeneratedFolder, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: GeneratedFolder, _: Folder, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}