...
import roblox/types.{
  type Actor, type BasePart, type Folder, type GeneratedFolder, type Instance,
...
pub fn get_source_asset_id(instance: GeneratedFolder) -> Int64
