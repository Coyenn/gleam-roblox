...
import roblox/types.{
  type Actor, type CustomEventReceiver, type Instance, type Int64, type Object,
...
pub fn on_source_value_changed(
  instance: CustomEventReceiver,
...
pub fn get_source_asset_id(instance: CustomEventReceiver) -> Int64
