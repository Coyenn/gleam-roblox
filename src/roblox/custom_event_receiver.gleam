...
import roblox/types.{type Actor, type CustomEventReceiver, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn event_connected(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `CustomEventReceiver.EventConnected`.
///
/// Fires when the receiver is attached to a different CustomEvent, when the CustomEventReceiver.Source property is changed.
///
/// Roblox: `CustomEventReceiver.EventConnected`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CustomEventReceiver#EventConnected
@target(luau)
@luau.global("(function(instance, callback) return instance.EventConnected:Connect(callback) end)")
pub fn on_event_connected(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn event_disconnected(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `CustomEventReceiver.EventDisconnected`.
///
/// Fires when the receiver is attached to a different CustomEvent instance when the CustomEventReceiver.Source property is changed.
///
/// Roblox: `CustomEventReceiver.EventDisconnected`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CustomEventReceiver#EventDisconnected
@target(luau)
@luau.global("(function(instance, callback) return instance.EventDisconnected:Connect(callback) end)")
pub fn on_event_disconnected(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn source_value_changed(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Float) -> Nil)

/// Connects to Roblox event `CustomEventReceiver.SourceValueChanged`.
///
/// Fires when the value of the CustomEvent's source is changed, passing the CustomEvent's new value.
///
/// Roblox: `CustomEventReceiver.SourceValueChanged`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/CustomEventReceiver#SourceValueChanged
@target(luau)
@luau.global("(function(instance, callback) return instance.SourceValueChanged:Connect(callback) end)")
pub fn on_source_value_changed(instance: CustomEventReceiver, callback: fn(Float) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: CustomEventReceiver, value: parent) -> CustomEventReceiver
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: CustomEventReceiver) -> Nil
...
pub fn get_attribute_changed_signal(instance: CustomEventReceiver, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: CustomEventReceiver, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: CustomEventReceiver) -> List(String)
...
pub fn wait_for_child(instance: CustomEventReceiver, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: CustomEventReceiver, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: CustomEventReceiver) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: CustomEventReceiver, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: CustomEventReceiver) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: CustomEventReceiver, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: CustomEventReceiver) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: CustomEventReceiver, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: CustomEventReceiver) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: CustomEventReceiver, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: CustomEventReceiver, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: CustomEventReceiver) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: CustomEventReceiver, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CustomEventReceiver, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}