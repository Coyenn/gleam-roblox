...
import roblox/types.{
  type Actor, type ExperienceStateCaptureSelectionMode,
  type ExperienceStateCaptureService, type Instance, type Int64, type Object,
...
pub fn get_hidden_selection_enabled(
  instance: ExperienceStateCaptureService,
) -> Bool
...
pub fn get_source_asset_id(instance: ExperienceStateCaptureService) -> Int64
