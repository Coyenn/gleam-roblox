...
import roblox/types.{
  type Actor, type Instance, type MemoryStoreHashMap, type MemoryStoreQueue,
  type MemoryStoreService, type MemoryStoreSortedMap, type Object,
...
pub fn get_source_asset_id(instance: MemoryStoreService) -> Int
