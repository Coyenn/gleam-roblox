...
pub fn activated(instance: GuiButton) -> RBXScriptSignal(fn(InputObject, Int) -> Nil)
...
pub fn on_activated(instance: GuiButton, callback: fn(InputObject, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_button1_click(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_down(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_button1_down(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_up(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_button1_up(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_button2_click(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_button2_down(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_button2_down(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_button2_up(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_button2_up(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn secondary_activated(instance: GuiButton) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_secondary_activated(instance: GuiButton, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn tween_position(instance: GuiButton, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size(instance: GuiButton, end_size: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn tween_size_and_position(instance: GuiButton, end_size: UDim2, end_position: UDim2, easing_direction: EasingDirection, easing_style: EasingStyle, time: Float, override: Bool, callback: fn() -> Nil) -> Bool
...
pub fn input_began(instance: GuiButton) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_began(instance: GuiButton, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_changed(instance: GuiButton) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_changed(instance: GuiButton, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn input_ended(instance: GuiButton) -> RBXScriptSignal(fn(InputObject) -> Nil)
...
pub fn on_input_ended(instance: GuiButton, callback: fn(InputObject) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_enter(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_leave(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_mouse_moved(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_backward(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_backward(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn mouse_wheel_forward(instance: GuiButton) -> RBXScriptSignal(fn(Int, Int) -> Nil)
...
pub fn on_mouse_wheel_forward(instance: GuiButton, callback: fn(Int, Int) -> Nil) -> RBXScriptConnection
...
pub fn on_selection_gained(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn on_selection_lost(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn touch_long_press(instance: GuiButton) -> RBXScriptSignal(fn(List(Vector2), UserInputState) -> Nil)
...
pub fn on_touch_long_press(instance: GuiButton, callback: fn(List(Vector2), UserInputState) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchPan")
pub fn touch_pan(instance: GuiButton) -> RBXScriptSignal(fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil)
...
pub fn on_touch_pan(instance: GuiButton, callback: fn(List(Vector2), Vector2, Vector2, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_pinch(instance: GuiButton) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_pinch(instance: GuiButton, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_rotate(instance: GuiButton) -> RBXScriptSignal(fn(List(Vector2), Float, Float, UserInputState) -> Nil)
...
pub fn on_touch_rotate(instance: GuiButton, callback: fn(List(Vector2), Float, Float, UserInputState) -> Nil) -> RBXScriptConnection
...
pub fn touch_swipe(instance: GuiButton) -> RBXScriptSignal(fn(SwipeDirection, Int) -> Nil)
...
pub fn on_touch_swipe(instance: GuiButton, callback: fn(SwipeDirection, Int) -> Nil) -> RBXScriptConnection
...
@target(luau)
@luau.event("TouchTap")
pub fn touch_tap(instance: GuiButton) -> RBXScriptSignal(fn(List(Vector2)) -> Nil)
...
pub fn on_touch_tap(instance: GuiButton, callback: fn(List(Vector2)) -> Nil) -> RBXScriptConnection
...
pub fn selection_changed(instance: GuiButton) -> RBXScriptSignal(fn(Bool, GuiObject, GuiObject) -> Nil)
...
pub fn on_selection_changed(instance: GuiButton, callback: fn(Bool, GuiObject, GuiObject) -> Nil) -> RBXScriptConnection
...
pub fn get_attribute_changed_signal(instance: GuiButton, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: GuiButton, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: GuiButton, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: GuiButton) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: GuiButton, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: GuiButton) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: GuiButton, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn on_child_added(instance: GuiButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: GuiButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: GuiButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: GuiButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: GuiButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: GuiButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: GuiButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: GuiButton) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: GuiButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: GuiButton, property: String) -> RBXScriptSignal(fn() -> Nil)
