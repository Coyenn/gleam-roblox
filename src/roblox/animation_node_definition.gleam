...
import roblox/types.{
  type Actor, type AnimationNodeDefinition, type AnimationNodeType,
...
pub fn set_node_type(
  instance: AnimationNodeDefinition,
...
pub fn get_source_asset_id(instance: AnimationNodeDefinition) -> Int64
