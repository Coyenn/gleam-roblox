...
import roblox/types.{type Actor, type AnimationNodeDefinition, type AnimationNodeType, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `AnimationNodeDefinition` instance.
///
/// Roblox: `Instance.new("AnimationNodeDefinition")`
@target(luau)
@luau.global("Instance.new(\"AnimationNodeDefinition\")")
pub fn new() -> AnimationNodeDefinition
...
pub fn set_parent(instance: AnimationNodeDefinition, value: parent) -> AnimationNodeDefinition
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AnimationNodeDefinition) -> Nil
...
pub fn get_attribute_changed_signal(instance: AnimationNodeDefinition, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AnimationNodeDefinition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AnimationNodeDefinition) -> List(String)
...
pub fn wait_for_child(instance: AnimationNodeDefinition, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AnimationNodeDefinition, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AnimationNodeDefinition, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AnimationNodeDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AnimationNodeDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AnimationNodeDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AnimationNodeDefinition, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AnimationNodeDefinition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AnimationNodeDefinition, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AnimationNodeDefinition, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AnimationNodeDefinition) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AnimationNodeDefinition, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AnimationNodeType, _: AnimationNodeDefinition, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}