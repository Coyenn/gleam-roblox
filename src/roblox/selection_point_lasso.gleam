...
import roblox/types.{type Actor, type Color3, type GuiBase, type GuiBase3d, type Humanoid, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SelectionLasso, type SelectionPointLasso, type UniqueId, type Vector3}
...
pub fn set_parent(instance: SelectionPointLasso, value: parent) -> SelectionPointLasso
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SelectionPointLasso) -> Nil
...
pub fn get_attribute_changed_signal(instance: SelectionPointLasso, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SelectionPointLasso, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SelectionPointLasso) -> List(String)
...
pub fn wait_for_child(instance: SelectionPointLasso, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SelectionPointLasso) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SelectionPointLasso, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SelectionPointLasso) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SelectionPointLasso, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SelectionPointLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SelectionPointLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SelectionPointLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SelectionPointLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SelectionPointLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SelectionPointLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SelectionPointLasso) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SelectionPointLasso, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SelectionPointLasso) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SelectionPointLasso, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SelectionPointLasso) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SelectionPointLasso, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SelectionPointLasso, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SelectionPointLasso) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SelectionPointLasso, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Humanoid, _: Vector3, _: SelectionPointLasso, _: SelectionLasso, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}