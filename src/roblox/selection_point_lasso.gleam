...
import roblox/types.{
  ...
  type SelectionLasso, type SelectionPointLasso, type UniqueId, type Vector3,
}
...
pub fn get_source_asset_id(instance: SelectionPointLasso) -> Int64
