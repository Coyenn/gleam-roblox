...
import roblox/types.{type Actor, type InputContext, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `InputContext` instance.
///
/// Roblox: `Instance.new("InputContext")`
@target(luau)
@luau.global("Instance.new(\"InputContext\")")
...
pub fn set_parent(instance: InputContext, value: parent) -> InputContext
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InputContext) -> Nil
...
pub fn get_attribute_changed_signal(instance: InputContext, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InputContext, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InputContext) -> List(String)
...
pub fn wait_for_child(instance: InputContext, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InputContext) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InputContext, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InputContext) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InputContext, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InputContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InputContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InputContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InputContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InputContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InputContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InputContext) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InputContext, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InputContext) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InputContext, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InputContext) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InputContext, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InputContext, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InputContext) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InputContext, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: InputContext, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}