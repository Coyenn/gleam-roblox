...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PlaybackState, type SecurityCapabilities, type Tween, type TweenBase, type TweenInfo, type UniqueId}

/// Creates a new Roblox `Tween` instance.
///
/// Roblox: `Instance.new("Tween")`
@target(luau)
@luau.global("Instance.new(\"Tween\")")
pub fn new() -> Tween
...
pub fn completed(instance: Tween) -> RBXScriptSignal(fn(PlaybackState) -> Nil)

/// Connects to Roblox event `TweenBase.Completed`.
///
/// Fires when the tween finishes playing or when stopped with TweenBase:Cancel().
///
/// Roblox: `TweenBase.Completed`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/TweenBase#Completed
@target(luau)
@luau.global("(function(instance, callback) return instance.Completed:Connect(callback) end)")
pub fn on_completed(instance: Tween, callback: fn(PlaybackState) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: Tween, value: parent) -> Tween
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Tween) -> Nil
...
pub fn get_attribute_changed_signal(instance: Tween, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Tween, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Tween) -> List(String)
...
pub fn wait_for_child(instance: Tween, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Tween) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Tween, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Tween) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Tween, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Tween) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Tween, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Tween) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Tween, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Tween) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Tween, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Tween) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Tween, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Tween) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Tween, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Tween) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Tween, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Tween, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Tween) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Tween, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PlaybackState, _: TweenInfo, _: Tween, _: TweenBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}