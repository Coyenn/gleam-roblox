...
import roblox/types.{type Actor, type BlurEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `BlurEffect` instance.
///
/// Roblox: `Instance.new("BlurEffect")`
@target(luau)
@luau.global("Instance.new(\"BlurEffect\")")
...
pub fn set_parent(instance: BlurEffect, value: parent) -> BlurEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BlurEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: BlurEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BlurEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BlurEffect) -> List(String)
...
pub fn wait_for_child(instance: BlurEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BlurEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BlurEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BlurEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BlurEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BlurEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BlurEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BlurEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BlurEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BlurEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BlurEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BlurEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BlurEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BlurEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BlurEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BlurEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BlurEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BlurEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BlurEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BlurEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BlurEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}