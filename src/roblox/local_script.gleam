...
import roblox/types.{type Actor, type BaseScript, type Instance, type LocalScript, type LuaSourceContainer, type Object, type OptionDouble, type OptionInt64, type ProtectedString, type RunContext, type Script, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `LocalScript` instance.
///
/// Roblox: `Instance.new("LocalScript")`
@target(luau)
@luau.global("Instance.new(\"LocalScript\")")
...
pub fn set_parent(instance: LocalScript, value: parent) -> LocalScript
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: LocalScript) -> Nil
...
pub fn get_attribute_changed_signal(instance: LocalScript, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: LocalScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: LocalScript) -> List(String)
...
pub fn wait_for_child(instance: LocalScript, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: LocalScript) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: LocalScript, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: LocalScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: LocalScript, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: LocalScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: LocalScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: LocalScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: LocalScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: LocalScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: LocalScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: LocalScript) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: LocalScript, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: LocalScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: LocalScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: LocalScript) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: LocalScript, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: LocalScript, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: LocalScript) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: LocalScript, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RunContext, _: ProtectedString, _: LocalScript, _: Script, _: BaseScript, _: LuaSourceContainer, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}