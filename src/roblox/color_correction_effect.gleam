...
import roblox/types.{type Actor, type Color3, type ColorCorrectionEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ColorCorrectionEffect` instance.
///
/// Roblox: `Instance.new("ColorCorrectionEffect")`
@target(luau)
@luau.global("Instance.new(\"ColorCorrectionEffect\")")
...
pub fn set_parent(instance: ColorCorrectionEffect, value: parent) -> ColorCorrectionEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ColorCorrectionEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: ColorCorrectionEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ColorCorrectionEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ColorCorrectionEffect) -> List(String)
...
pub fn wait_for_child(instance: ColorCorrectionEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ColorCorrectionEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ColorCorrectionEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ColorCorrectionEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ColorCorrectionEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ColorCorrectionEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ColorCorrectionEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ColorCorrectionEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ColorCorrectionEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ColorCorrectionEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ColorCorrectionEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ColorCorrectionEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: ColorCorrectionEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}