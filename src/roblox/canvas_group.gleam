...
import roblox/types.{
  type Actor, type AutomaticSize, type BorderMode, type CanvasGroup, type Color3,
...
pub fn get_source_asset_id(instance: CanvasGroup) -> Int64
