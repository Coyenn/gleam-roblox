...
import roblox/types.{type Actor, type FriendPages, type Instance, type Object, type OptionDouble, type OptionInt64, type Pages, type SecurityCapabilities, type UniqueId}

/// Treats `FriendPages` as its Roblox ancestor `Pages`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_pages(instance: FriendPages) -> Pages

/// Treats `FriendPages` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: FriendPages) -> Instance

/// Treats `FriendPages` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: FriendPages) -> Object
...
pub fn set_parent(instance: FriendPages, value: parent) -> FriendPages
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: FriendPages) -> Nil
...
pub fn get_attribute_changed_signal(instance: FriendPages, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FriendPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: FriendPages) -> List(String)
...
pub fn wait_for_child(instance: FriendPages, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FriendPages) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FriendPages, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FriendPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FriendPages, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FriendPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FriendPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FriendPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FriendPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FriendPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FriendPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FriendPages) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FriendPages, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: FriendPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: FriendPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FriendPages) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FriendPages, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FriendPages, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: FriendPages) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: FriendPages, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: FriendPages, _: Pages, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}