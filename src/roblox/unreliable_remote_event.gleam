...
import roblox/types.{type Actor, type BaseRemoteEvent, type Instance, type Object, type OptionDouble, type OptionInt64, type Player, type SecurityCapabilities, type UniqueId, type UnreliableRemoteEvent}

/// Creates a new Roblox `UnreliableRemoteEvent` instance.
///
/// Roblox: `Instance.new("UnreliableRemoteEvent")`
@target(luau)
@luau.global("Instance.new(\"UnreliableRemoteEvent\")")
...
pub fn on_client_event(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Dynamic) -> Nil)

/// Connects to Roblox event `UnreliableRemoteEvent.OnClientEvent`.
///
/// Fires from a LocalScript when either FireClient() or FireAllClients() is called on the same UnreliableRemoteEvent instance from a Script, although this firing is not guaranteed even if one of the above methods are called. This can occur due to packet loss or to maintain optimal engine performance.
///
/// Roblox: `UnreliableRemoteEvent.OnClientEvent`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/UnreliableRemoteEvent#OnClientEvent
@target(luau)
@luau.global("(function(instance, callback) return instance.OnClientEvent:Connect(callback) end)")
pub fn on_on_client_event(instance: UnreliableRemoteEvent, callback: fn(Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn on_server_event(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Player, Dynamic) -> Nil)

/// Connects to Roblox event `UnreliableRemoteEvent.OnServerEvent`.
///
/// Fires from a Script when FireServer() is called on the same UnreliableRemoteEvent instance from a LocalScript, although this firing is not guaranteed even if the above methods is called. This can occur due to packet loss or to maintain optimal engine performance.
///
/// Roblox: `UnreliableRemoteEvent.OnServerEvent`
...
/// See: https://create.roblox.com/docs/reference/engine/classes/UnreliableRemoteEvent#OnServerEvent
@target(luau)
@luau.global("(function(instance, callback) return instance.OnServerEvent:Connect(callback) end)")
pub fn on_on_server_event(instance: UnreliableRemoteEvent, callback: fn(Player, Dynamic) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: UnreliableRemoteEvent, value: parent) -> UnreliableRemoteEvent
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UnreliableRemoteEvent) -> Nil
...
pub fn get_attribute_changed_signal(instance: UnreliableRemoteEvent, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UnreliableRemoteEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UnreliableRemoteEvent) -> List(String)
...
pub fn wait_for_child(instance: UnreliableRemoteEvent, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UnreliableRemoteEvent, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UnreliableRemoteEvent, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UnreliableRemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UnreliableRemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UnreliableRemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UnreliableRemoteEvent, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UnreliableRemoteEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UnreliableRemoteEvent, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UnreliableRemoteEvent, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UnreliableRemoteEvent) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UnreliableRemoteEvent, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Player, _: UnreliableRemoteEvent, _: BaseRemoteEvent, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}