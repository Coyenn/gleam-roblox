...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TestCase, type UniqueId}
...
pub fn set_parent(instance: TestCase, value: parent) -> TestCase
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: TestCase) -> Nil
...
pub fn get_attribute_changed_signal(instance: TestCase, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: TestCase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: TestCase) -> List(String)
...
pub fn wait_for_child(instance: TestCase, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: TestCase) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: TestCase, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: TestCase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: TestCase, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: TestCase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: TestCase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: TestCase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: TestCase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: TestCase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: TestCase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: TestCase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: TestCase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: TestCase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: TestCase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: TestCase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: TestCase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: TestCase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: TestCase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: TestCase, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TestCase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}