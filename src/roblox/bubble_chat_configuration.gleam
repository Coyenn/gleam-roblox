...
import roblox/types.{type Actor, type BubbleChatConfiguration, type Color3, type Font, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type TextChatConfigurations, type UniqueId, type Vector3}
...
pub fn set_parent(instance: BubbleChatConfiguration, value: parent) -> BubbleChatConfiguration
...
pub fn get_attribute_changed_signal(instance: BubbleChatConfiguration, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BubbleChatConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: BubbleChatConfiguration, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BubbleChatConfiguration, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BubbleChatConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BubbleChatConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BubbleChatConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BubbleChatConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BubbleChatConfiguration, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BubbleChatConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BubbleChatConfiguration, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BubbleChatConfiguration, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BubbleChatConfiguration) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BubbleChatConfiguration, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: Vector3, _: Font, _: BubbleChatConfiguration, _: TextChatConfigurations, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}