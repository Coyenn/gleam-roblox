...
import roblox/types.{type Actor, type Instance, type MaterialGenerationService, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `MaterialGenerationService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: MaterialGenerationService) -> Instance

/// Treats `MaterialGenerationService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: MaterialGenerationService) -> Object
...
pub fn set_parent(instance: MaterialGenerationService, value: parent) -> MaterialGenerationService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: MaterialGenerationService) -> Nil
...
pub fn get_attribute_changed_signal(instance: MaterialGenerationService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: MaterialGenerationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: MaterialGenerationService) -> List(String)
...
pub fn wait_for_child(instance: MaterialGenerationService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: MaterialGenerationService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: MaterialGenerationService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: MaterialGenerationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: MaterialGenerationService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: MaterialGenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: MaterialGenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: MaterialGenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: MaterialGenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: MaterialGenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: MaterialGenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: MaterialGenerationService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: MaterialGenerationService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: MaterialGenerationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: MaterialGenerationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: MaterialGenerationService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: MaterialGenerationService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: MaterialGenerationService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: MaterialGenerationService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: MaterialGenerationService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: MaterialGenerationService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}