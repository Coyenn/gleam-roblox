...
import roblox/types.{
  type Actor, type Instance, type Int64, type MaterialGenerationService,
...
pub fn set_archivable(
  instance: MaterialGenerationService,
  value: Bool,
...
pub fn get_source_asset_id(instance: MaterialGenerationService) -> Int64
