...
import roblox/types.{type Actor, type ArcHandles, type Axes, type Axis, type BasePart, type Color3, type GuiBase, type GuiBase3d, type HandlesBase, type Instance, type Object, type OptionDouble, type OptionInt64, type PartAdornment, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `ArcHandles` instance.
///
/// Roblox: `Instance.new("ArcHandles")`
@target(luau)
@luau.global("Instance.new(\"ArcHandles\")")
...
pub fn mouse_button1_down(instance: ArcHandles) -> RBXScriptSignal(fn(Axis) -> Nil)

/// Connects to Roblox event `ArcHandles.MouseButton1Down`.
///
/// Fired when the left mouse button goes down on one of the GUI handles.
///
/// Roblox: `ArcHandles.MouseButton1Down`
...
pub fn on_mouse_button1_down(instance: ArcHandles, callback: fn(Axis) -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_up(instance: ArcHandles) -> RBXScriptSignal(fn(Axis) -> Nil)

/// Connects to Roblox event `ArcHandles.MouseButton1Up`.
///
/// Fired when the left mouse button is released on one of the GUI handles.
///
/// Roblox: `ArcHandles.MouseButton1Up`
...
pub fn on_mouse_button1_up(instance: ArcHandles, callback: fn(Axis) -> Nil) -> RBXScriptConnection
...
pub fn mouse_drag(instance: ArcHandles) -> RBXScriptSignal(fn(Axis, Float, Float) -> Nil)

/// Connects to Roblox event `ArcHandles.MouseDrag`.
///
/// Fired when the mouse moves while the MouseButton1Down event has fired, but the left mouse button has not been released yet.
///
/// Roblox: `ArcHandles.MouseDrag`
...
pub fn on_mouse_drag(instance: ArcHandles, callback: fn(Axis, Float, Float) -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: ArcHandles) -> RBXScriptSignal(fn(Axis) -> Nil)

/// Connects to Roblox event `ArcHandles.MouseEnter`.
///
/// Fired when a mouse "enters" the GUI handle.
///
/// Roblox: `ArcHandles.MouseEnter`
...
pub fn on_mouse_enter(instance: ArcHandles, callback: fn(Axis) -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: ArcHandles) -> RBXScriptSignal(fn(Axis) -> Nil)

/// Connects to Roblox event `ArcHandles.MouseLeave`.
///
/// Fired when the mouse leaves the GUI handle.
///
/// Roblox: `ArcHandles.MouseLeave`
...
pub fn on_mouse_leave(instance: ArcHandles, callback: fn(Axis) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ArcHandles, value: parent) -> ArcHandles
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ArcHandles) -> Nil
...
pub fn get_attribute_changed_signal(instance: ArcHandles, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ArcHandles, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ArcHandles) -> List(String)
...
pub fn wait_for_child(instance: ArcHandles, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ArcHandles) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ArcHandles, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ArcHandles) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ArcHandles, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ArcHandles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ArcHandles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ArcHandles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ArcHandles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ArcHandles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ArcHandles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ArcHandles) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ArcHandles, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ArcHandles) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ArcHandles, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ArcHandles) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ArcHandles, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ArcHandles, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ArcHandles) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ArcHandles, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: BasePart, _: Axis, _: Axes, _: ArcHandles, _: HandlesBase, _: PartAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}