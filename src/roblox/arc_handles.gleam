...
import roblox/types.{
  type Actor, type ArcHandles, type Axes, type Axis, type BasePart, type Color3,
  type GuiBase, type GuiBase3d, type HandlesBase, type Instance, type Int64,
  type Object, type PartAdornment, type SecurityCapabilities, type UniqueId,
}
...
pub fn mouse_drag(
  instance: ArcHandles,
) -> RBXScriptSignal(fn(Axis, Float, Float) -> Nil)
...
pub fn on_mouse_drag(
  instance: ArcHandles,
  callback: fn(Axis, Float, Float) -> Nil,
) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: ArcHandles) -> Int64
