...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PoseBase, type PoseEasingDirection, type PoseEasingStyle, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PoseBase, value: parent) -> PoseBase
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PoseBase) -> Nil
...
pub fn get_attribute_changed_signal(instance: PoseBase, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PoseBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PoseBase) -> List(String)
...
pub fn wait_for_child(instance: PoseBase, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PoseBase) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PoseBase, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PoseBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PoseBase, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PoseBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PoseBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PoseBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PoseBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PoseBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PoseBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PoseBase) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PoseBase, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PoseBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PoseBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PoseBase) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PoseBase, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PoseBase, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PoseBase) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PoseBase, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: PoseEasingStyle, _: PoseEasingDirection, _: PoseBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}