...
import roblox/types.{type Actor, type Instance, type Object, type ObjectValue, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `ObjectValue` instance.
///
/// Roblox: `Instance.new("ObjectValue")`
@target(luau)
@luau.global("Instance.new(\"ObjectValue\")")
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ObjectValue) -> RBXScriptSignal(fn(Instance) -> Nil)

/// Connects to Roblox event `ObjectValue.Changed`.
///
/// Fires whenever the ObjectValue.Value is changed.
///
/// Roblox: `ObjectValue.Changed`
...
pub fn on_changed(instance: ObjectValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: ObjectValue, value: parent) -> ObjectValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ObjectValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: ObjectValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ObjectValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ObjectValue) -> List(String)
...
pub fn wait_for_child(instance: ObjectValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ObjectValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ObjectValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ObjectValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ObjectValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ObjectValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ObjectValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ObjectValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ObjectValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ObjectValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ObjectValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ObjectValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ObjectValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ObjectValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ObjectValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ObjectValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ObjectValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ObjectValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ObjectValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}