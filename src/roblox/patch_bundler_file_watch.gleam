...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type PatchBundlerFileWatch,
...
pub fn set_archivable(
  instance: PatchBundlerFileWatch,
  value: Bool,
...
pub fn get_source_asset_id(instance: PatchBundlerFileWatch) -> Int64
