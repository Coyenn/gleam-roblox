...
import roblox/types.{type Actor, type BasePart, type CFrame, type Instance, type JointInstance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: JointInstance, value: parent) -> JointInstance
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: JointInstance) -> Nil
...
pub fn get_attribute_changed_signal(instance: JointInstance, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: JointInstance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: JointInstance) -> List(String)
...
pub fn wait_for_child(instance: JointInstance, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: JointInstance) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: JointInstance, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: JointInstance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: JointInstance, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: JointInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: JointInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: JointInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: JointInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: JointInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: JointInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: JointInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: JointInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: JointInstance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: JointInstance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: JointInstance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: JointInstance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: JointInstance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: JointInstance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: JointInstance, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: BasePart, _: CFrame, _: JointInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}