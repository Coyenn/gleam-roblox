...
import roblox/types.{type Actor, type AvatarBodyRules, type AvatarSettingsAppearanceMode, type AvatarSettingsBuildMode, type AvatarSettingsCustomBodyType, type AvatarSettingsScaleMode, type Instance, type NumberRange, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn get_attribute_changed_signal(instance: AvatarBodyRules, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AvatarBodyRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: AvatarBodyRules, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AvatarBodyRules) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AvatarBodyRules, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AvatarBodyRules) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AvatarBodyRules, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AvatarBodyRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AvatarBodyRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AvatarBodyRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AvatarBodyRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AvatarBodyRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AvatarBodyRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AvatarBodyRules) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AvatarBodyRules, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: AvatarBodyRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AvatarBodyRules) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AvatarBodyRules, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AvatarBodyRules, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: AvatarBodyRules, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AvatarSettingsScaleMode, _: NumberRange, _: AvatarSettingsCustomBodyType, _: AvatarSettingsBuildMode, _: AvatarSettingsAppearanceMode, _: AvatarBodyRules, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}