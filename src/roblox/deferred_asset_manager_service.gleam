...
import roblox/types.{
  type Actor, type DeferredAssetManagerService, type Instance, type Int64,
...
pub fn set_archivable(
  instance: DeferredAssetManagerService,
  value: Bool,
...
pub fn get_source_asset_id(instance: DeferredAssetManagerService) -> Int64
