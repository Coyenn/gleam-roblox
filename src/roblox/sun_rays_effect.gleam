...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type SunRaysEffect, type UniqueId}

/// Creates a new Roblox `SunRaysEffect` instance.
///
/// Roblox: `Instance.new("SunRaysEffect")`
@target(luau)
@luau.global("Instance.new(\"SunRaysEffect\")")
...
pub fn set_parent(instance: SunRaysEffect, value: parent) -> SunRaysEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: SunRaysEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: SunRaysEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: SunRaysEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: SunRaysEffect) -> List(String)
...
pub fn wait_for_child(instance: SunRaysEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: SunRaysEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: SunRaysEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: SunRaysEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: SunRaysEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: SunRaysEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: SunRaysEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: SunRaysEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: SunRaysEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: SunRaysEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: SunRaysEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: SunRaysEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: SunRaysEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: SunRaysEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: SunRaysEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: SunRaysEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: SunRaysEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: SunRaysEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: SunRaysEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: SunRaysEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: SunRaysEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}