...
import roblox/types.{type Actor, type ColorGradingEffect, type Instance, type Object, type OptionDouble, type OptionInt64, type PostEffect, type SecurityCapabilities, type TonemapperPreset, type UniqueId}

/// Creates a new Roblox `ColorGradingEffect` instance.
///
/// Roblox: `Instance.new("ColorGradingEffect")`
@target(luau)
@luau.global("Instance.new(\"ColorGradingEffect\")")
...
pub fn set_parent(instance: ColorGradingEffect, value: parent) -> ColorGradingEffect
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ColorGradingEffect) -> Nil
...
pub fn get_attribute_changed_signal(instance: ColorGradingEffect, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ColorGradingEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ColorGradingEffect) -> List(String)
...
pub fn wait_for_child(instance: ColorGradingEffect, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ColorGradingEffect) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ColorGradingEffect, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ColorGradingEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ColorGradingEffect, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ColorGradingEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ColorGradingEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ColorGradingEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ColorGradingEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ColorGradingEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ColorGradingEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ColorGradingEffect) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ColorGradingEffect, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ColorGradingEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ColorGradingEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ColorGradingEffect) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ColorGradingEffect, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ColorGradingEffect, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ColorGradingEffect) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ColorGradingEffect, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: TonemapperPreset, _: ColorGradingEffect, _: PostEffect, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}