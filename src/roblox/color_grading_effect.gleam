...
import roblox/types.{
  type Actor, type ColorGradingEffect, type Instance, type Int64, type Object,
  type PostEffect, type SecurityCapabilities, type TonemapperPreset,
  type UniqueId,
}
...
pub fn set_tonemapper_preset(
  instance: ColorGradingEffect,
  value: TonemapperPreset,
) -> ColorGradingEffect
...
pub fn get_source_asset_id(instance: ColorGradingEffect) -> Int64
