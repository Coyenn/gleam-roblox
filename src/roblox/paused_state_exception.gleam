...
import roblox/types.{
  ...
  type PausedState, type PausedStateException, type SecurityCapabilities,
  type UniqueId,
}
...
pub fn get_source_asset_id(instance: PausedStateException) -> Int64
