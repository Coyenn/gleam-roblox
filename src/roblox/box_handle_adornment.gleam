...
import roblox/types.{type Actor, type AdornCullingMode, type AdornShading, type BoxHandleAdornment, type CFrame, type Color3, type GuiBase, type GuiBase3d, type HandleAdornment, type Instance, type Object, type OptionDouble, type OptionInt64, type PVAdornment, type PVInstance, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `BoxHandleAdornment` instance.
///
/// Roblox: `Instance.new("BoxHandleAdornment")`
@target(luau)
@luau.global("Instance.new(\"BoxHandleAdornment\")")
...
pub fn mouse_button1_down(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_down(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_button1_up(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_button1_up(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_enter(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_enter(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn mouse_leave(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_mouse_leave(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: BoxHandleAdornment, value: parent) -> BoxHandleAdornment
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BoxHandleAdornment) -> Nil
...
pub fn get_attribute_changed_signal(instance: BoxHandleAdornment, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BoxHandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BoxHandleAdornment) -> List(String)
...
pub fn wait_for_child(instance: BoxHandleAdornment, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BoxHandleAdornment, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BoxHandleAdornment, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BoxHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BoxHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BoxHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BoxHandleAdornment, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BoxHandleAdornment) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BoxHandleAdornment, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BoxHandleAdornment, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BoxHandleAdornment) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BoxHandleAdornment, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: PVInstance, _: Vector3, _: CFrame, _: AdornCullingMode, _: AdornShading, _: BoxHandleAdornment, _: HandleAdornment, _: PVAdornment, _: GuiBase3d, _: GuiBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}