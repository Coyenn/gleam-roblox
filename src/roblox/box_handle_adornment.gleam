...
import roblox/types.{
  type Actor, type AdornCullingMode, type AdornShading, type BoxHandleAdornment,
  type CFrame, type Color3, type GuiBase, type GuiBase3d, type HandleAdornment,
...
pub fn get_source_asset_id(instance: BoxHandleAdornment) -> Int64
