...
import roblox/types.{type ActivityHistoryEventService, type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Treats `ActivityHistoryEventService` as its Roblox ancestor `Instance`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_instance(instance: ActivityHistoryEventService) -> Instance

/// Treats `ActivityHistoryEventService` as its Roblox ancestor `Object`.
@target(luau)
@luau.global("(function(x) return x end)")
pub fn as_object(instance: ActivityHistoryEventService) -> Object
...
pub fn set_parent(instance: ActivityHistoryEventService, value: parent) -> ActivityHistoryEventService
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: ActivityHistoryEventService) -> Nil
...
pub fn get_attribute_changed_signal(instance: ActivityHistoryEventService, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: ActivityHistoryEventService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: ActivityHistoryEventService) -> List(String)
...
pub fn wait_for_child(instance: ActivityHistoryEventService, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: ActivityHistoryEventService, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: ActivityHistoryEventService, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: ActivityHistoryEventService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: ActivityHistoryEventService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: ActivityHistoryEventService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: ActivityHistoryEventService, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: ActivityHistoryEventService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: ActivityHistoryEventService, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: ActivityHistoryEventService, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: ActivityHistoryEventService) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: ActivityHistoryEventService, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ActivityHistoryEventService, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}