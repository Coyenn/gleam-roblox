...
import roblox/types.{
  type ActivityHistoryEventService, type Actor, type Instance, type Int64,
...
pub fn set_archivable(
  instance: ActivityHistoryEventService,
  value: Bool,
...
pub fn get_source_asset_id(instance: ActivityHistoryEventService) -> Int64
