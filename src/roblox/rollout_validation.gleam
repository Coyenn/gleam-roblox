...
import roblox/types.{
  type Actor, type Instance, type Int64, type Object, type RolloutValidation,
...
pub fn get_source_asset_id(instance: RolloutValidation) -> Int64
