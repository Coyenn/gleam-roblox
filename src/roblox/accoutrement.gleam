...
import roblox/types.{
  type Accoutrement, type Actor, type CFrame, type Instance, type Int64,
...
pub fn get_source_asset_id(instance: Accoutrement) -> Int64
