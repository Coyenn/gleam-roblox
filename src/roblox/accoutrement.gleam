...
import roblox/types.{type Accoutrement, type Actor, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}

/// Creates a new Roblox `Accoutrement` instance.
///
/// Roblox: `Instance.new("Accoutrement")`
@target(luau)
@luau.global("Instance.new(\"Accoutrement\")")
pub fn new() -> Accoutrement

/// Treats `Accoutrement` as its Roblox ancestor `Instance`.
@target(luau)
...
/// Sets Roblox property `Accoutrement.AttachmentForward`.
///
/// Sets the offset position of the object on the Player.
///
/// Roblox: `Accoutrement.AttachmentForward`
...
/// Gets Roblox property `Accoutrement.AttachmentPoint`.
///
...
/// Sets Roblox property `Accoutrement.AttachmentPoint`.
///
/// The exact CFrame of the Accoutrement.
///
/// Roblox: `Accoutrement.AttachmentPoint`
...
/// Gets Roblox property `Accoutrement.AttachmentPos`.
///
...
/// Sets Roblox property `Accoutrement.AttachmentPos`.
///
/// Sets the position of the object on the Player.
///
/// Roblox: `Accoutrement.AttachmentPos`
...
/// Gets Roblox property `Accoutrement.AttachmentRight`.
///
/// Sets the offset position of the object on the Player.
///
...
/// Sets Roblox property `Accoutrement.AttachmentRight`.
///
/// Sets the offset position of the object on the Player.
///
/// Roblox: `Accoutrement.AttachmentRight`
...
/// Gets Roblox property `Accoutrement.AttachmentUp`.
///
/// Sets the offset position of the object on the Player.
///
...
/// Sets Roblox property `Accoutrement.AttachmentUp`.
///
/// Sets the offset position of the object on the Player.
///
/// Roblox: `Accoutrement.AttachmentUp`
...
pub fn set_parent(instance: Accoutrement, value: parent) -> Accoutrement
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Accoutrement) -> Nil
...
pub fn get_attribute_changed_signal(instance: Accoutrement, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Accoutrement, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Accoutrement) -> List(String)
...
pub fn wait_for_child(instance: Accoutrement, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Accoutrement) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Accoutrement, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Accoutrement) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Accoutrement, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Accoutrement) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Accoutrement, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Accoutrement) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Accoutrement, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Accoutrement) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Accoutrement, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Accoutrement) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Accoutrement, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Accoutrement) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Accoutrement, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Accoutrement) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Accoutrement, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Accoutrement, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Accoutrement) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Accoutrement, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: CFrame, _: Accoutrement, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}