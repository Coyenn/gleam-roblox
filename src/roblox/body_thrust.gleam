...
import roblox/types.{type Actor, type BodyMover, type BodyThrust, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type Vector3}
...
pub fn set_parent(instance: BodyThrust, value: parent) -> BodyThrust
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: BodyThrust) -> Nil
...
pub fn get_attribute_changed_signal(instance: BodyThrust, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: BodyThrust, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: BodyThrust) -> List(String)
...
pub fn wait_for_child(instance: BodyThrust, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: BodyThrust) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: BodyThrust, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: BodyThrust) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: BodyThrust, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: BodyThrust) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: BodyThrust, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: BodyThrust) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: BodyThrust, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: BodyThrust) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: BodyThrust, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: BodyThrust) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: BodyThrust, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: BodyThrust) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: BodyThrust, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: BodyThrust) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: BodyThrust, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: BodyThrust, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: BodyThrust) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: BodyThrust, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Vector3, _: BodyThrust, _: BodyMover, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}