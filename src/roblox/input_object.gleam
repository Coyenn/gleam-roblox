...
import roblox/types.{
  type Actor, type InputObject, type Instance, type KeyCode, type ModifierKey,
  type Object, type SecurityCapabilities, type UniqueId, type UserInputState,
  type UserInputType, type Vector3,
}
...
pub fn get_source_asset_id(instance: InputObject) -> Int
