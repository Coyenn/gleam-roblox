...
import roblox/types.{type Actor, type InputObject, type Instance, type KeyCode, type ModifierKey, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type UserInputState, type UserInputType, type Vector3}
...
pub fn set_parent(instance: InputObject, value: parent) -> InputObject
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: InputObject) -> Nil
...
pub fn get_attribute_changed_signal(instance: InputObject, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: InputObject, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: InputObject) -> List(String)
...
pub fn wait_for_child(instance: InputObject, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: InputObject) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: InputObject, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: InputObject) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: InputObject, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: InputObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: InputObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: InputObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: InputObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: InputObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: InputObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: InputObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: InputObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: InputObject) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: InputObject, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: InputObject) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: InputObject, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: InputObject, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: InputObject) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: InputObject, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ModifierKey, _: UserInputType, _: UserInputState, _: Vector3, _: KeyCode, _: InputObject, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}