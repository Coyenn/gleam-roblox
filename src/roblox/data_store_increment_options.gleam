...
import roblox/types.{
  type Actor, type DataStoreIncrementOptions, type Instance, type Int64,
...
pub fn set_metadata(
  instance: DataStoreIncrementOptions,
  attributes: Dynamic,
) -> Nil
...
pub fn get_source_asset_id(instance: DataStoreIncrementOptions) -> Int64
