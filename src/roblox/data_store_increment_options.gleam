...
import roblox/types.{type Actor, type DataStoreIncrementOptions, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `DataStoreIncrementOptions` instance.
///
/// Roblox: `Instance.new("DataStoreIncrementOptions")`
@target(luau)
@luau.global("Instance.new(\"DataStoreIncrementOptions\")")
pub fn new() -> DataStoreIncrementOptions
...
pub fn set_parent(instance: DataStoreIncrementOptions, value: parent) -> DataStoreIncrementOptions
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStoreIncrementOptions) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStoreIncrementOptions, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStoreIncrementOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStoreIncrementOptions) -> List(String)
...
pub fn wait_for_child(instance: DataStoreIncrementOptions, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStoreIncrementOptions, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStoreIncrementOptions, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStoreIncrementOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStoreIncrementOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStoreIncrementOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStoreIncrementOptions, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStoreIncrementOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStoreIncrementOptions, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStoreIncrementOptions, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStoreIncrementOptions) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStoreIncrementOptions, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreIncrementOptions, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}