...
import roblox/types.{
  ...
  type PluginConnectionService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PluginConnectionService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PluginConnectionService) -> Int64
