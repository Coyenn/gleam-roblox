...
import roblox/types.{type Actor, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type PluginToolbarButton, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PluginToolbarButton, value: parent) -> PluginToolbarButton
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PluginToolbarButton) -> Nil
...
pub fn get_attribute_changed_signal(instance: PluginToolbarButton, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PluginToolbarButton, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PluginToolbarButton) -> List(String)
...
pub fn wait_for_child(instance: PluginToolbarButton, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PluginToolbarButton) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PluginToolbarButton, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PluginToolbarButton) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PluginToolbarButton, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PluginToolbarButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PluginToolbarButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PluginToolbarButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PluginToolbarButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PluginToolbarButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PluginToolbarButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PluginToolbarButton) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PluginToolbarButton, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PluginToolbarButton) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PluginToolbarButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PluginToolbarButton) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PluginToolbarButton, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PluginToolbarButton, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PluginToolbarButton) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PluginToolbarButton, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: ContentId, _: PluginToolbarButton, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}