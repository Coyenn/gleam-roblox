...
import roblox/types.{
  ...
  type PluginToolbarButton, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_clickable_when_viewport_hidden(
...
pub fn get_source_asset_id(instance: PluginToolbarButton) -> Int64
