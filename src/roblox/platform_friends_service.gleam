...
import roblox/types.{
  ...
  type PlatformFriendsService, type SecurityCapabilities, type UniqueId,
}
...
pub fn set_archivable(
  instance: PlatformFriendsService,
  value: Bool,
...
pub fn get_source_asset_id(instance: PlatformFriendsService) -> Int64
