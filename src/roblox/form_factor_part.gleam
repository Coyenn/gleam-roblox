...
pub fn touch_ended(instance: FormFactorPart) -> RBXScriptSignal(fn(BasePart) -> Nil)
...
pub fn on_touch_ended(instance: FormFactorPart, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn on_touched(instance: FormFactorPart, callback: fn(BasePart) -> Nil) -> RBXScriptConnection
...
pub fn get_source_asset_id(instance: FormFactorPart) -> OptionInt64
...
pub fn get_attribute_changed_signal(instance: FormFactorPart, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: FormFactorPart, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn wait_for_child(instance: FormFactorPart, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: FormFactorPart) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: FormFactorPart, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: FormFactorPart) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: FormFactorPart, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: FormFactorPart) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: FormFactorPart, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: FormFactorPart) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: FormFactorPart, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: FormFactorPart) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: FormFactorPart, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: FormFactorPart) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: FormFactorPart, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn on_destroying(instance: FormFactorPart, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: FormFactorPart) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: FormFactorPart, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: FormFactorPart, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_changed(instance: FormFactorPart, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: BasePart, _: CollisionFidelity, _: RenderFidelity, _: Vector3, _: Player, _: NormalId, _: SurfaceType, _: Faces, _: Material, _: PhysicalProperties, _: Color3, _: BrickColor, _: FormFactorPart, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}