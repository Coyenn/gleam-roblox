...
import roblox/types.{type Actor, type AuroraScript, type AuroraScriptObject, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: AuroraScriptObject, value: parent) -> AuroraScriptObject
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: AuroraScriptObject) -> Nil
...
pub fn get_attribute_changed_signal(instance: AuroraScriptObject, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: AuroraScriptObject, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: AuroraScriptObject) -> List(String)
...
pub fn wait_for_child(instance: AuroraScriptObject, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: AuroraScriptObject) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: AuroraScriptObject, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: AuroraScriptObject) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: AuroraScriptObject, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: AuroraScriptObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: AuroraScriptObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: AuroraScriptObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: AuroraScriptObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: AuroraScriptObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: AuroraScriptObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: AuroraScriptObject) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: AuroraScriptObject, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: AuroraScriptObject) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: AuroraScriptObject, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: AuroraScriptObject) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: AuroraScriptObject, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: AuroraScriptObject, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: AuroraScriptObject) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: AuroraScriptObject, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: AuroraScript, _: AuroraScriptObject, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}