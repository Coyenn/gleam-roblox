...
import roblox/types.{
  type Actor, type AuroraScript, type AuroraScriptObject, type Instance,
...
pub fn set_prior_frame_invoked(
  instance: AuroraScriptObject,
  value: Int,
) -> AuroraScriptObject
...
pub fn get_source_asset_id(instance: AuroraScriptObject) -> Int64
