...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type Ray, type RayValue, type SecurityCapabilities, type UniqueId, type ValueBase}

/// Creates a new Roblox `RayValue` instance.
///
/// Roblox: `Instance.new("RayValue")`
@target(luau)
@luau.global("Instance.new(\"RayValue\")")
pub fn new() -> RayValue
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RayValue) -> RBXScriptSignal(fn(Ray) -> Nil)

/// Connects to Roblox event `RayValue.Changed`.
///
/// Fired when RayValue.Value is changed.
///
/// Roblox: `RayValue.Changed`
...
pub fn on_changed(instance: RayValue, callback: fn(Ray) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: RayValue, value: parent) -> RayValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RayValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: RayValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RayValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RayValue) -> List(String)
...
pub fn wait_for_child(instance: RayValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RayValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RayValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RayValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RayValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RayValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RayValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RayValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RayValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RayValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RayValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RayValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RayValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RayValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RayValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RayValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RayValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RayValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Ray, _: RayValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}