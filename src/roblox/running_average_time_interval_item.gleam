...
import roblox/types.{type Actor, type Instance, type Object, type OptionDouble, type OptionInt64, type RunningAverageTimeIntervalItem, type SecurityCapabilities, type StatsItem, type UniqueId}
...
pub fn set_parent(instance: RunningAverageTimeIntervalItem, value: parent) -> RunningAverageTimeIntervalItem
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: RunningAverageTimeIntervalItem) -> Nil
...
pub fn get_attribute_changed_signal(instance: RunningAverageTimeIntervalItem, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: RunningAverageTimeIntervalItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: RunningAverageTimeIntervalItem) -> List(String)
...
pub fn wait_for_child(instance: RunningAverageTimeIntervalItem, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: RunningAverageTimeIntervalItem, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: RunningAverageTimeIntervalItem, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: RunningAverageTimeIntervalItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: RunningAverageTimeIntervalItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: RunningAverageTimeIntervalItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: RunningAverageTimeIntervalItem, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: RunningAverageTimeIntervalItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: RunningAverageTimeIntervalItem, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: RunningAverageTimeIntervalItem, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: RunningAverageTimeIntervalItem) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: RunningAverageTimeIntervalItem, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: RunningAverageTimeIntervalItem, _: StatsItem, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}