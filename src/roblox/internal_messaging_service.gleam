...
import roblox/types.{
  type Actor, type Instance, type Int64, type InternalMessagingService,
...
pub fn set_archivable(
  instance: InternalMessagingService,
  value: Bool,
...
pub fn get_source_asset_id(instance: InternalMessagingService) -> Int64
