...
import roblox/types.{type Actor, type GenericSettings, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type ServiceProvider, type UniqueId, type UserSettings}
...
@target(luau)
@luau.event("Close")
pub fn close(instance: UserSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_close(instance: UserSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn service_added(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_service_added(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn service_removing(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_service_removing(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: UserSettings, value: parent) -> UserSettings
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: UserSettings) -> Nil
...
pub fn get_attribute_changed_signal(instance: UserSettings, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: UserSettings, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: UserSettings) -> List(String)
...
pub fn wait_for_child(instance: UserSettings, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: UserSettings) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: UserSettings, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: UserSettings) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: UserSettings, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: UserSettings) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: UserSettings, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: UserSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: UserSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: UserSettings) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: UserSettings, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: UserSettings, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: UserSettings) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: UserSettings, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: UserSettings, _: GenericSettings, _: ServiceProvider, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}