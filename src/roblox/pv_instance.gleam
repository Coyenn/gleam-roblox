...
import roblox/types.{type Actor, type CFrame, type Instance, type Object, type OptionDouble, type OptionInt64, type PVInstance, type SecurityCapabilities, type UniqueId}
...
pub fn set_parent(instance: PVInstance, value: parent) -> PVInstance
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: PVInstance) -> Nil
...
pub fn get_attribute_changed_signal(instance: PVInstance, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: PVInstance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: PVInstance) -> List(String)
...
pub fn wait_for_child(instance: PVInstance, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: PVInstance) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: PVInstance, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: PVInstance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: PVInstance, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: PVInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: PVInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: PVInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: PVInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: PVInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: PVInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: PVInstance) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: PVInstance, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: PVInstance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: PVInstance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: PVInstance) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: PVInstance, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: PVInstance, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: PVInstance) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: PVInstance, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: CFrame, _: PVInstance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}