...
import roblox/types.{type Actor, type Instance, type Noise, type NoiseType, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Noise` instance.
///
/// Roblox: `Instance.new("Noise")`
@target(luau)
@luau.global("Instance.new(\"Noise\")")
pub fn new() -> Noise
...
pub fn set_parent(instance: Noise, value: parent) -> Noise
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Noise) -> Nil
...
pub fn get_attribute_changed_signal(instance: Noise, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Noise, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Noise) -> List(String)
...
pub fn wait_for_child(instance: Noise, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Noise) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Noise, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Noise) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Noise, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Noise) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Noise, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Noise) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Noise, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Noise) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Noise, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Noise) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Noise, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Noise) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Noise, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Noise) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Noise, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Noise, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Noise) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Noise, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: NoiseType, _: Noise, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}