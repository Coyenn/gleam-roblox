...
import roblox/types.{type Actor, type DataStore, type DataStoreGetOptions, type DataStoreIncrementOptions, type DataStoreKeyPages, type DataStoreSetOptions, type DataStoreVersionPages, type GlobalDataStore, type Instance, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type SortDirection, type UniqueId}
...
pub fn increment_async(instance: DataStore, key: String, delta: Int, user_ids: List(Int), options: DataStoreIncrementOptions) -> Dynamic
...
pub fn set_async(instance: DataStore, key: String, value: Dynamic, user_ids: List(Int), options: DataStoreSetOptions) -> Dynamic
...
pub fn set_parent(instance: DataStore, value: parent) -> DataStore
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: DataStore) -> Nil
...
pub fn get_attribute_changed_signal(instance: DataStore, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: DataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: DataStore) -> List(String)
...
pub fn wait_for_child(instance: DataStore, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: DataStore) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: DataStore, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: DataStore) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: DataStore, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: DataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: DataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: DataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: DataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: DataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: DataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: DataStore) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: DataStore, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: DataStore) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: DataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: DataStore) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: DataStore, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: DataStore, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: DataStore) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: DataStore, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: DataStoreSetOptions, _: DataStoreIncrementOptions, _: DataStoreGetOptions, _: DataStoreVersionPages, _: SortDirection, _: DataStoreKeyPages, _: DataStore, _: GlobalDataStore, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}