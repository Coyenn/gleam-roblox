...
import roblox/types.{
  type Actor, type FloatCurve, type FloatCurveKey, type Instance, type Int64,
  type Object, type OptionFloat, type SecurityCapabilities, type UniqueId,
}
...
pub fn get_source_asset_id(instance: FloatCurve) -> Int64
