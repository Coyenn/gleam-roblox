...
import roblox/types.{type Actor, type Instance, type IntConstrainedValue, type Object, type OptionDouble, type OptionInt64, type SecurityCapabilities, type UniqueId, type ValueBase}
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: IntConstrainedValue) -> RBXScriptSignal(fn(OptionInt64) -> Nil)
...
pub fn on_changed(instance: IntConstrainedValue, callback: fn(OptionInt64) -> Nil) -> RBXScriptConnection
...
pub fn set_parent(instance: IntConstrainedValue, value: parent) -> IntConstrainedValue
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: IntConstrainedValue) -> Nil
...
pub fn get_attribute_changed_signal(instance: IntConstrainedValue, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: IntConstrainedValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: IntConstrainedValue) -> List(String)
...
pub fn wait_for_child(instance: IntConstrainedValue, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: IntConstrainedValue) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: IntConstrainedValue, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: IntConstrainedValue) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: IntConstrainedValue, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: IntConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: IntConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: IntConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: IntConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: IntConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: IntConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: IntConstrainedValue) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: IntConstrainedValue, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: IntConstrainedValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: IntConstrainedValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: IntConstrainedValue) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: IntConstrainedValue, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: IntConstrainedValue, property: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: IntConstrainedValue, _: ValueBase, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}