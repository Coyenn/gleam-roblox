...
import roblox/types.{type Actor, type CharacterAppearance, type Clothing, type Color3, type ContentId, type Instance, type Object, type OptionDouble, type OptionInt64, type Pants, type SecurityCapabilities, type UniqueId}

/// Creates a new Roblox `Pants` instance.
///
/// Roblox: `Instance.new("Pants")`
@target(luau)
@luau.global("Instance.new(\"Pants\")")
pub fn new() -> Pants
...
pub fn set_parent(instance: Pants, value: parent) -> Pants
...
@target(luau)
@luau.method("Destroy")
pub fn destroy_instance(instance: Pants) -> Nil
...
pub fn get_attribute_changed_signal(instance: Pants, attribute: String) -> RBXScriptSignal(fn() -> Nil)
...
pub fn get_styled_property_changed_signal(instance: Pants, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.method("GetTags")
pub fn get_tags(instance: Pants) -> List(String)
...
pub fn wait_for_child(instance: Pants, child_name: String, time_out: OptionDouble) -> Option(Instance)
...
pub fn ancestry_changed(instance: Pants) -> RBXScriptSignal(fn(Instance, Instance) -> Nil)
...
pub fn on_ancestry_changed(instance: Pants, callback: fn(Instance, Instance) -> Nil) -> RBXScriptConnection
...
pub fn attribute_changed(instance: Pants) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_attribute_changed(instance: Pants, callback: fn(String) -> Nil) -> RBXScriptConnection
...
pub fn child_added(instance: Pants) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_added(instance: Pants, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn child_removed(instance: Pants) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_child_removed(instance: Pants, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_added(instance: Pants) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_added(instance: Pants, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn descendant_removing(instance: Pants) -> RBXScriptSignal(fn(Instance) -> Nil)
...
pub fn on_descendant_removing(instance: Pants, callback: fn(Instance) -> Nil) -> RBXScriptConnection
...
pub fn destroying(instance: Pants) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_destroying(instance: Pants, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn styled_properties_changed(instance: Pants) -> RBXScriptSignal(fn() -> Nil)
...
pub fn on_styled_properties_changed(instance: Pants, callback: fn() -> Nil) -> RBXScriptConnection
...
pub fn get_property_changed_signal(instance: Pants, property: String) -> RBXScriptSignal(fn() -> Nil)
...
@target(luau)
@luau.event("Changed")
pub fn changed(instance: Pants) -> RBXScriptSignal(fn(String) -> Nil)
...
pub fn on_changed(instance: Pants, callback: fn(String) -> Nil) -> RBXScriptConnection


/// Keeps Roblox imports reachable when checking non-Luau targets.
pub fn javascript_type_anchor(_: Instance, _: OptionDouble, _: Actor, _: UniqueId, _: OptionInt64, _: SecurityCapabilities, _: Color3, _: ContentId, _: Pants, _: Clothing, _: CharacterAppearance, _: Object, _: Option(Nil), _: Dynamic, _: RBXScriptSignal(fn() -> Nil), _: RBXScriptConnection) -> Nil {
  Nil
}